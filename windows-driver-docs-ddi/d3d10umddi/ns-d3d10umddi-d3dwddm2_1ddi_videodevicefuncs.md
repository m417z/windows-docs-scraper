...
The driver must support the WDDM 2.1 version of the user-mode DDI. When the DDI is supported, the runtime will call [**PFND3D10DDI_RETRIEVESUBOBJECT**](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d10ddi_retrievesubobject) to retrieve the **D3DWDDM2_1DDI_VIDEODEVICEFUNCS** video device functions.
...
The entry point for the driver's [**VideoProcessorSetOutputHDRMetaData**](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3dwddm2_1ddi_videoprocessorsetoutputhdrmetadata) function. Added in WDDM 2.1.

### `pfnVideoProcessorSetStreamHDRMetaData`

The entry point for the driver's [**VideoProcessorSetStreamHDRMetaData**](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3dwddm2_1ddi_videoprocessorsetstreamhdrmetadata) function. Added in WDDM 2.1.