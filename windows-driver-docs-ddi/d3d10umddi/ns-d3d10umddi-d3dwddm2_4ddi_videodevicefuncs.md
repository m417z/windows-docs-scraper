...
The driver must support the WDDM 2.4 version of the user-mode DDI. When the DDI is supported, the runtime will call [**PFND3D10DDI_RETRIEVESUBOBJECT**](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d10ddi_retrievesubobject) to retrieve the **D3DWDDM2_4DDI_VIDEODEVICEFUNCS** video device functions.
...
The entry point for the driver's [**VideoDecoderSubmitBuffers2**](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3dwddm2_4ddi_videodecodersubmitbuffers) function.
...
The entry point for the driver's [**VideoProcessorSetOutputHDRMetaData**](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3dwddm2_1ddi_videoprocessorsetoutputhdrmetadata) function.

### `pfnVideoProcessorSetStreamHDRMetaData`

The entry point for the driver's [**VideoProcessorSetStreamHDRMetaData**](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3dwddm2_1ddi_videoprocessorsetstreamhdrmetadata) function.

### `pfnNegotiateCryptoSessionKeyExchangeMT`

The entry point for the driver's [**NegotiateCryptoSessionKeyExchangeMT**](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_negotiatecryptosessionkeyeschange) function.