...
A pointer to the driver's [DefaultConstantBufferUpdateSubresourceUP(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_resourceupdatesubresourceup) function.

### `pfnVsSetConstantBuffers`

A pointer to the driver's [VsSetConstantBuffers(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_setconstantbuffers) function.
...
A pointer to the driver's [PsSetConstantBuffers(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_setconstantbuffers) function.
...
A pointer to the driver's [GsSetConstantBuffers(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_setconstantbuffers) function.
...
A pointer to the driver's [ResourceCopyRegion(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_resourcecopyregion) function.

### `pfnResourceUpdateSubresourceUP`

A pointer to the driver's [ResourceUpdateSubresourceUP(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_resourceupdatesubresourceup) function.
...
A pointer to the driver's [Flush(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_flush) function.
...
A pointer to the driver's [RelocateDeviceFuncs(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_relocatedevicefuncs) function.
...
A pointer to the driver's [CalcPrivateBlendStateSize(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_calcprivateblendstatesize) function.

### `pfnCreateBlendState`

A pointer to the driver's [CreateBlendState(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_createblendstate) function.
...
A pointer to the driver's [CalcPrivateRasterizerStateSize(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_calcprivaterasterizerstatesize) function.

### `pfnCreateRasterizerState`

A pointer to the driver's [CreateRasterizerState(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_createrasterizerstate) function.
...
A pointer to the driver's [CalcPrivateShaderSize(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_calcprivateshadersize) function.

### `pfnCreateVertexShader`

A pointer to the driver's [CreateVertexShader(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_createvertexshader) function.

### `pfnCreateGeometryShader`

A pointer to the driver's [CreateGeometryShader(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_creategeometryshader) function.

### `pfnCreatePixelShader`

A pointer to the driver's [CreatePixelShader(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_createpixelshader) function.

### `pfnCalcPrivateGeometryShaderWithStreamOutput`

A pointer to the driver's [CalcPrivateGeometryShaderWithStreamOutput(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_calcprivategeometryshaderwithstreamoutput) function.

### `pfnCreateGeometryShaderWithStreamOutput`

A pointer to the driver's [CreateGeometryShaderWithStreamOutput(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_creategeometryshaderwithstreamoutput) function.
...
A pointer to the driver's [HsSetConstantBuffers(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_setconstantbuffers) function.
...
A pointer to the driver's [DsSetConstantBuffers(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_setconstantbuffers) function.

### `pfnCreateHullShader`

A pointer to the driver's [CreateHullShader(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_createhullshader) function.

### `pfnCreateDomainShader`

A pointer to the driver's [CreateDomainShader(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_createdomainshader) function.
...
A pointer to the driver's [CalcPrivateTessellationShaderSize(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11ddi_calcprivatetessellationshadersize) function.
...
A pointer to the driver's [CsSetConstantBuffers(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_setconstantbuffers) function.
...
A pointer to the driver's [Discard(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_discard) function.

### `pfnAssignDebugBinary`

A pointer to the driver's [AssignDebugBinary](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_assigndebugbinary) function.
...
A pointer to the driver's [CheckDirectFlipSupport(D3D11_1)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_checkdirectflipsupport) function.

### `pfnClearView`

A pointer to the driver's [ClearView](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_clearview) function.

### `pfnUpdateTileMappings`

A pointer to the driver's [UpdateTileMappings](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3dwddm1_3ddi_updatetilemappings) function.

### `pfnCopyTileMappings`

A pointer to the driver's [CopyTileMappings](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3dwddm1_3ddi_copytilemappings) function.

### `pfnCopyTiles`

A pointer to the driver's [CopyTiles](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3dwddm1_3ddi_copytiles) function.

### `pfnUpdateTiles`

A pointer to the driver's [UpdateTiles](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3dwddm1_3ddi_updatetiles) function.

### `pfnTiledResourceBarrier`

A pointer to the driver's [TiledResourceBarrier](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3dwddm1_3ddi_tiledresourcebarrier) function.

### `pfnGetMipPacking`

A pointer to the driver's [GetMipPacking](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3dwddm1_3ddi_getmippacking) function.

### `pfnResizeTilePool`

A pointer to the driver's [ResizeTilePool](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3dwddm1_3ddi_resizetilepool) function.

### `pfnSetMarker`

A pointer to the driver's [SetMarker](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3dwddm1_3ddi_setmarker) function.

### `pfnSetMarkerMode`

A pointer to the driver's [SetMarkerMode](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3dwddm1_3ddi_setmarkermode) function.

## Remarks

The order of user-mode display driver functions (that is, the order of the members of the **D3DWDDM1_3DDI_DEVICEFUNCS** structure) is in decreasing order of priority (in regard to performance).

The user-mode display driver can use different names for these functions because the address of the function table (this structure) is shared between the Direct3D 11.2 runtime and the driver through the call to the driver's [CreateDevice(D3D10)](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d10ddi_createdevice) function.
