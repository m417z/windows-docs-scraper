typedef enum _DXGK_DRIVER_FEATURE {
  ...
  DXGK_DRIVER_FEATURE_EXTENDED_SEGMENT_FLAGS,
  DXGK_DRIVER_FEATURE_FAULT_AND_STALL,
  DXGK_DRIVER_FEATURE_SINGLE_ADAPTER_HYBRID_MODE,
  DXGK_DRIVER_FEATURE_SYNC_PRESENT_RENDER_HWQ_ONLY,
  DXGK_DRIVER_FEATURE_UNIFIED_SCHEDULING_MODEL,
  DXGK_DRIVER_FEATURE_NOTIFY_RESIDENCY2,
  DXGK_DRIVER_FEATURE_PROCESS_DEBUG_BLOB_COLLECTION,
  DXGK_DRIVER_FEATURE_PANEL_BUFFER_CONTROL,
