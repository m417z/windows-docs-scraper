...
The values of **DEBUG_FLR_PARAM_TYPE** enumeration are tags that indicate the kind of information that is stored in [failure analysis entry](https://learn.microsoft.com/windows-hardware/drivers/debugger/failure-analysis-entries).

The **DEBUG_FLR_PARAM_TYPE** enumeration is also called the [FA_TAG](https://learn.microsoft.com/windows-hardware/drivers/debugger/writing-an-analysis-extension-to-extend--analyze) enumeration.
...
For more information about tags, see [Failure Analysis Entries, Tags, and Data Types](https://learn.microsoft.com/windows-hardware/drivers/debugger/writing-an-analysis-extension-to-extend--analyze)

## See also

[FA_TAG enumeration](https://learn.microsoft.com/windows-hardware/drivers/debugger/writing-an-analysis-extension-to-extend--analyze)
