...
Pointer to a routine that determines whether the USB device is operating at high speed. This routine returns **TRUE** if the USB device is operating at high speed (USB 2.0-compliant device). Otherwise this routine returns **FALSE**. For more information about this routine, see [IsDeviceHighSpeed](https://learn.microsoft.com/windows-hardware/drivers/ddi/usbbusif/nc-usbbusif-pusb_busiffn_is_device_high_speed).
