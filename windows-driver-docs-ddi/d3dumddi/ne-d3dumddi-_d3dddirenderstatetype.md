...
A [D3DZBUFFERTYPE](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ne-d3d9types-_d3dzbuffertype) depth-buffering state that can either be used to enable z-buffering, enable w-buffering, disable depth buffering.

### `D3DDDIRS_FILLMODE`

A [D3DFILLMODE](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ne-d3d9types-_d3dfillmode) enumeration that specifies the fill mode for primitives.

### `D3DDDIRS_SHADEMODE`

A [D3DSHADEMODE](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ne-d3d9types-_d3dshademode) that specifies shading operations that the device can perform.
...
A [D3DBLEND](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ne-d3d9types-_d3dblend) enumeration type. The default value is D3DBLEND_ONE.

### `D3DDDIRS_DESTBLEND`

A [D3DBLEND](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ne-d3d9types-_d3dblend) enumeration type. The default value is D3DBLEND_ZERO.

### `D3DDDIRS_CULLMODE`

A [D3DCULL](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ne-d3d9types-_d3dcull) enumerated type that specifies how back-facing triangles are culled, if at all. The default value is D3DCULL_CCW.

### `D3DDDIRS_ZFUNC`

A [D3DCMPFUNC](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ne-d3d9types-_d3dcmpfunc) enumerated type that enables an application to accept or reject a pixel, based on its distance from the camera. The default value is D3DCMP_LESSEQUAL.
...
A [D3DCMPFUNC](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ne-d3d9types-_d3dcmpfunc) enumerated type that enables an application to accept or reject a pixel, based on its alpha value. The default value is D3DCMP_ALWAYS.
...
A [D3DCOLORVALUE](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ns-d3d9types-_d3dcolorvalue) value that indicates the diffuse color that is emitted by the light. The default value is 0.

### `D3DDDIRS_FOGTABLEMODE`

A [D3DFOGMODE](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ne-d3d9types-_d3dfogmode) that contains the fog formula to be used for pixel fog.
...
A [D3DSTENCILOP](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ne-d3d9types-_d3dstencilop) stencil operation to perform if the stencil test fails. The default value is D3DSTENCILOP_KEEP.

### `D3DDDIRS_STENCILZFAIL`

A [D3DSTENCILOP](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ne-d3d9types-_d3dstencilop) stencil operation to perform if the stencil test passes and the depth test (z-test) fails. The default value is D3DSTENCILOP_KEEP.

### `D3DDDIRS_STENCILPASS`

A [D3DSTENCILOP](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ne-d3d9types-_d3dstencilop) stencil operation to perform if both the stencil and the depth (z) tests pass. The default value is D3DSTENCILOP_KEEP.

### `D3DDDIRS_STENCILFUNC`

A [D3DSTENCILOP](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ne-d3d9types-_d3dstencilop) comparison function for the stencil test. The default value is D3DCMP_ALWAYS.
...
A [D3DCOLORVALUE](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ns-d3d9types-_d3dcolorvalue) color used for multiple-texture blending.
...
A [D3DCOLORVALUE](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ns-d3d9types-_d3dcolorvalue) that specifies the ambient light color. The default value is 0.

### `D3DDDIRS_FOGVERTEXMODE`

A [D3DFOGMODE](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ne-d3d9types-_d3dfogmode) fog formula to be used for vertex fog. The default value is D3DFOG_NONE.
...
A [D3DMATERIALCOLORSOURCE](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ne-d3d9types-_d3dmaterialcolorsource) that specifies the diffuse color source for lighting calculations. The default value is D3DMCS_COLOR1. The value for this render state is used only if the D3DRS_COLORVERTEX render state is set to TRUE.
...
A [D3DBLENDOP](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d9types/ne-d3d9types-_d3dblendop) setting value that is used to select the arithmetic operation applied when the alpha blending render state, D3DRS_ALPHABLENDENABLE, is set to TRUE. The default value is D3DBLENDOP_ADD.
