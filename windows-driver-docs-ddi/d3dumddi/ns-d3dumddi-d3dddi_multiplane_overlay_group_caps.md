...
The overlay capabilities, given as a bitwise **OR** of values from the [D3DDDI_MULTIPLANE_OVERLAY_FEATURE_CAPS](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3dumddi/ne-d3dumddi-_d3dddi_multiplane_overlay_feature_caps) enumeration.

## See also

[D3DDDI_MULTIPLANE_OVERLAY_FEATURE_CAPS](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3dumddi/ne-d3dumddi-_d3dddi_multiplane_overlay_feature_caps)