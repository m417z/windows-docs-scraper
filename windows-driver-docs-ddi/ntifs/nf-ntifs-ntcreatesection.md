...
The **NtCreateSection** routine creates a [section object](https://learn.microsoft.com/windows-hardware/drivers/kernel/section-objects-and-views).
...
For more information, see [Managing Memory Sections](https://learn.microsoft.com/windows-hardware/drivers/kernel/managing-memory-sections).
