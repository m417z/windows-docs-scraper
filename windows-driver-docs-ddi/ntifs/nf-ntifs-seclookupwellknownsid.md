...
A pointer to a buffer that receives the [SID](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/ns-ntifs-_sid) structure that corresponds to the **SidType** parameter. If this parameter is **NULL**, **SidBufferSize** is zero.

### `SidBufferSize` [in]

A variable that specifies the size of the **Sid** buffer in bytes.

### `SidSize` [in_out, optional]
...
[**SecLookupAccountName**](https://learn.microsoft.com/previous-versions/ff554795(v=vs.85))

[**SecLookupAccountSid**](https://learn.microsoft.com/previous-versions/ff556579(v=vs.85))