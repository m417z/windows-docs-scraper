...
A call to **NtSetQuotaInformationFile** will result in an [**IRP_MJ_SET_QUOTA**](https://learn.microsoft.com/windows-hardware/drivers/ifs/irp-mj-set-quota) request being sent to the device object that is associated with the file object whose handle is stored in the **FileHandle** parameter.
...
> [!NOTE]
> If the call to the **NtSetQuotaInformationFile** function occurs in kernel mode, you should use the name "[**ZwSetQuotaInformationFile**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/nf-ntifs-zwsetquotainformationfile)" instead of "**NtSetQuotaInformationFile**".
...
[**NtQueryQuotaInformationFile**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/nf-ntifs-ntqueryquotainformationfile)