...
[in] Pointer to an opaque [ACCESS_TOKEN](https://learn.microsoft.com/windows/win32/secauthz/access-tokens) structure for the primary token. This structure provides the token's information needed to perform an access check.
