...
> [!NOTE]
> If the call to the **ZwSetInformationToken** function occurs in user mode, you should use the name [**NtSetInformationToken**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/nf-ntifs-ntsetinformationtoken)" instead of "**ZwSetInformationToken**".
>
