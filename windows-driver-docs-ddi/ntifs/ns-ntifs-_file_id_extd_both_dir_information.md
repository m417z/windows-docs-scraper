...
* Call [**ZwQueryDirectoryFile**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/nf-ntifs-zwqueryvirtualmemory), passing **FileIdExtdBothDirectoryInformation** as the value of **FileInformationClass** and passing a caller-allocated, **FILE_ID_EXTD_BOTH_DIR_INFORMATION**-structured buffer as the value of **FileInformation**.
