...
The type of the power request. Set this parameter to the following [**POWER_REQUEST_TYPE**](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdm/ne-wdm-_power_request_type) enumeration value:
