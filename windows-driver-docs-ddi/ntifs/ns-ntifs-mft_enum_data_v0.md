...
The **MFT_ENUM_DATA_V0** structure contains information defining the boundaries for and starting place of an enumeration of update sequence number (USN) change journal records. It is used as the input buffer for the [**FSCTL_ENUM_USN_DATA**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/ni-ntifs-fsctl_enum_usn_data) control code. Prior to Windows Server 2012 this structure was named MFT_ENUM_DATA.
