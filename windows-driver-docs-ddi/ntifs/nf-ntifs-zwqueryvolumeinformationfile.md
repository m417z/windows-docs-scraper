...
A handle to a file object returned by [**ZwCreateFile**](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-zwcreatefile) or [**ZwOpenFile**](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-zwopenfile) for an open file, directory, storage device, or volume for which volume information is being requested.
