...
* Call [**ZwQueryDirectoryFile**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/nf-ntifs-zwqueryvirtualmemory), passing FileIdFullDirectoryInformation as the value of **FileInformationClass** and passing a caller-allocated, FILE_ID_FULL_DIR_INFORMATION-structured buffer as the value of **FileInformation**.
