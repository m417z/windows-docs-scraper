...
To specify attributes for the access token handle, use [**NtOpenProcessTokenEx**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/nf-ntifs-ntopenprocesstokenex) instead.

The handle can be accessed by the process in whose context the driver is running.

Any handle obtained by calling **NtOpenProcessToken** must eventually be released by calling [**NtClose**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/nf-ntifs-ntclose).
...
[**NtOpenProcessTokenEx**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/nf-ntifs-ntopenprocesstokenex)
