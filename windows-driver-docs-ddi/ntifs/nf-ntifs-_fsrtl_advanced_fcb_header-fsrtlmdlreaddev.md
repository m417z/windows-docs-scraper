...
The routine is similar to [CcMdlRead](https://learn.microsoft.com/previous-versions/ff539159(v=vs.85)) and [FltFastIoMdlRead](https://learn.microsoft.com/windows-hardware/drivers/ddi/fltkernel/nf-fltkernel-fltfastiomdlread). **FltFastIoMdlRead**, **CcMdlRead**, and **FsRtlMdlReadDev** lock the pages that contain the cached file data to prevent the system from swapping these pages to the page file. The pages remain locked in memory until the caller invokes the [FsRtlMdlReadCompleteDev](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/nf-ntifs-_fsrtl_advanced_fcb_header-fsrtlmdlreadcompletedev) routine.

## See also

[CcMdlRead](https://learn.microsoft.com/previous-versions/ff539159(v=vs.85))

[FsRtlMdlReadCompleteDev](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/nf-ntifs-_fsrtl_advanced_fcb_header-fsrtlmdlreadcompletedev)

[FsRtlMdlReadEx](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/nf-ntifs-_fsrtl_advanced_fcb_header-fsrtlmdlreadex)