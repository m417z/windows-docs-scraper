...
* Call [**ZwQueryDirectoryFile**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/nf-ntifs-zwqueryvirtualmemory), passing **FileId64ExtdBothDirectoryInformation** as the value of [**FileInformationClass**](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdm/ne-wdm-_file_information_class) and passing a caller-allocated, **FILE_ID_64_EXTD_BOTH_DIR_INFORMATION**-structured buffer as the value of **FileInformation**.
