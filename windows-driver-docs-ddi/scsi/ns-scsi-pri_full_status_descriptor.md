...
The **PRI_FULL_STATUS_DESCRIPTOR** structure is used to construct the **[PRI_FULL_STATUS_LIST](https://learn.microsoft.com/windows-hardware/drivers/ddi/scsi/ns-scsi-pri_full_status_list)** structure that is returned in response to a Persistent Reserve In command with `ServiceAction=RESERVATION_ACTION_READ_FULL_STATUS`.

## Members

### `Header`

Contains the **[PRI_FULL_STATUS_DESCRIPTOR_HEADER](https://learn.microsoft.com/windows-hardware/drivers/ddi/scsi/ns-scsi-pri_full_status_descriptor_header)** structure.
...
- **[PRI_FULL_STATUS_DESCRIPTOR_HEADER](https://learn.microsoft.com/windows-hardware/drivers/ddi/scsi/ns-scsi-pri_full_status_descriptor_header)**