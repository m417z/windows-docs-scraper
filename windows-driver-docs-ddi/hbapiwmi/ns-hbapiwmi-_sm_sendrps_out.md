...
The WMI tool suite generates a declaration of the SM_SendRPS_OUT structure in *Hbapiwmi.h* when it compiles the MS_SM_FabricAndDomainManagementMethod WMI class.