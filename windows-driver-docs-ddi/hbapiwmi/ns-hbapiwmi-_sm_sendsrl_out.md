...
The WMI tool suite generates a declaration of the SM_SendSRL_OUT structure in *Hbapiwmi.h* when it compiles the MS_SM_FabricAndDomainManagementMethod WMI class.