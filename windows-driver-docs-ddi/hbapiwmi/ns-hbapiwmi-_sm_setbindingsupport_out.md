...
The WMI tool suite generates a declaration of the SM_SetBindingSupport_OUT structure in *Hbapiwmi.h* when it compiles the MS_SM_TargetInformationMethods WMI class.