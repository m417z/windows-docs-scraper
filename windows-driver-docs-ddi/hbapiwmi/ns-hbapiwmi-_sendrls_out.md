...
The SendRLS_OUT structure is used to report the output parameter data of the [SendRLS](https://learn.microsoft.com/windows-hardware/drivers/storage/sendrls) WMI method to the WMI client.
...
The WMI tool suite generates a declaration of the SendRLS_OUT structure in *Hbapiwmi.h* when it compiles the [MSFC_HBAAdapterMethods WMI Class](https://learn.microsoft.com/windows-hardware/drivers/storage/msfc-hbaadaptermethods-wmi-class).
