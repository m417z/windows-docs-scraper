...
The WMI tool suite generates a declaration of the SM_GetBindingCapability_OUT structure in *Hbapiwmi.h* when it compiles the MS_SM_TargetInformationMethods WMI class.