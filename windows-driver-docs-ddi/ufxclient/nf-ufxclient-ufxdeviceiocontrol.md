...
The client driver calls **UfxDeviceIoControl** to forward non-internal IOCTLs that it receives in its [EvtIoDeviceControl](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdfio/nc-wdfio-evt_wdf_io_queue_io_device_control) callback function to UFX. The following example shows how:
