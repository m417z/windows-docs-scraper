...
The client driver typically calls **UfxDeviceNotifyAttach** from its [EVT_WDF_INTERRUPT_DPC](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdfinterrupt/nc-wdfinterrupt-evt_wdf_interrupt_dpc) callback function, as shown in the following example.
