...
The **NDIS_TCP_LARGE_SEND_OFFLOAD_V1** structure is used in the
**LsoV1** member of the
[NDIS_OFFLOAD](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntddndis/ns-ntddndis-_ndis_offload) structure.
**NDIS_TCP_LARGE_SEND_OFFLOAD_V1** specifies current or supported services that a miniport adapter provides
...
[NDIS_TCP_LARGE_SEND_OFFLOAD_V2](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntddndis/ns-ntddndis-_ndis_tcp_large_send_offload_v2).
...
The
**Encapsulation** member of **NDIS_TCP_LARGE_SEND_OFFLOAD_V1** defines the LSOV1 encapsulation capabilities
...
The values in the
**TcpOptions** and
**IpOptions** members of NDIS_TCP_LARGE_SEND_OFFLOAD_V1 specify miniport adapter support in the
[OID_TCP_OFFLOAD_CURRENT_CONFIG](https://learn.microsoft.com/windows-hardware/drivers/network/oid-tcp-offload-current-config) OID or the
[NDIS_STATUS_TASK_OFFLOAD_CURRENT_CONFIG](https://learn.microsoft.com/windows-hardware/drivers/network/ndis-status-task-offload-current-config) status indication. These members can have one of the
following values:
