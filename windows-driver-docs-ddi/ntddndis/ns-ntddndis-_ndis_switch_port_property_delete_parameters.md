...
The type, revision, and size of the **NDIS_SWITCH_PORT_PROPERTY_DELETE_PARAMETERS** structure. This member is formatted as an [NDIS_OBJECT_HEADER](https://learn.microsoft.com/windows-hardware/drivers/ddi/objectheader/ns-objectheader-ndis_object_header) structure.
...
### `PropertyType`
 ...
 An [NDIS_SWITCH_PORT_PROPERTY_TYPE](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntddndis/ne-ntddndis-_ndis_switch_port_property_type) enumeration value that specifies the type of port property that will be deleted.
...
The **NDIS_SWITCH_PORT_PROPERTY_DELETE_PARAMETERS** structure is used in OID set requests of [OID_SWITCH_PORT_PROPERTY_DELETE](https://learn.microsoft.com/windows-hardware/drivers/network/oid-switch-port-property-delete).
