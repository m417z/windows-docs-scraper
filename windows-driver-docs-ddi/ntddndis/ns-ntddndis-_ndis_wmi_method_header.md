...
**Type** member of NDIS_OBJECT_HEADER to NDIS_WMI_OBJECT_TYPE_METHOD, the
**Revision** member to NDIS_GUID_HEADER_REVISION_1, and the
**Size** member to
...
[GUID_NDIS_GEN_ENUMERATE_PORTS](https://learn.microsoft.com/windows-hardware/drivers/network/guid-ndis-gen-enumerate-ports) GUID to obtain list of the ports that are associated with a miniport
adapter.
