...
The PRINTIFI32 structure is a fixed-size version of the [IFIMETRICS](https://learn.microsoft.com/windows/win32/api/winddi/ns-winddi-ifimetrics) structure, and defines information for a given typeface that GDI can use.

## Members

### `cjThis`

Specifies the size in bytes of this structure. The specified size includes any Unicode strings appended to the end of this structure, plus the size in bytes of the optional [IFIEXTRA](https://learn.microsoft.com/windows/win32/api/winddi/ns-winddi-ifiextra) structure.
...
The offsets in the [FONTSIM](https://learn.microsoft.com/windows/win32/api/winddi/ns-winddi-fontsim) structure are relative to the base of the FONTSIM structure.
...
Specifies a [POINTL](https://learn.microsoft.com/windows/win32/api/windef/ns-windef-pointl) structure that contains the intended writing direction of this font. For example, a typical Latin font specifies a value of (1,0).
...
Specifies a [RECTL](https://learn.microsoft.com/windows/win32/api/windef/ns-windef-rectl) structure that describes the bounding box of all glyphs in the font in design space.
...
Additional information for a typeface can optionally be specified in the [IFIEXTRA](https://learn.microsoft.com/windows/win32/api/winddi/ns-winddi-ifiextra) structure.

A driver's [DrvQueryFont](https://learn.microsoft.com/windows/win32/api/winddi/nf-winddi-drvqueryfont) routine fills out and returns an IFIMETRICS structure to GDI.
