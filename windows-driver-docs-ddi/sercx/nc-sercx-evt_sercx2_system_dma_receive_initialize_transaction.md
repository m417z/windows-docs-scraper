...
Your driver should implement an *EvtSerCx2EvtSerCx2SystemDmaReceiveInitializeTransaction* function if it needs to initialize the serial controller and associated hardware in preparation for a new system-DMA-receive transaction. SerCx2 calls this function, if it is implemented, before a system-DMA-receive transaction starts. In response to this call, the serial controller driver must call the [SerCx2SystemDmaReceiveInitializeTransactionComplete](https://learn.microsoft.com/windows-hardware/drivers/ddi/sercx/nf-sercx-sercx2systemdmareceiveinitializetransactioncomplete) method to notify SerCx2 after the initialization is finished.
...
[SerCx2SystemDmaReceiveInitializeTransactionComplete](https://learn.microsoft.com/windows-hardware/drivers/ddi/sercx/nf-sercx-sercx2systemdmareceiveinitializetransactioncomplete)