...
For example, to define an *EvtSerCx2FileOpen* callback function that is named `MyFileOpen`, use the **EVT_SERCX2_FILEOPEN** function type, as shown in this code example:
