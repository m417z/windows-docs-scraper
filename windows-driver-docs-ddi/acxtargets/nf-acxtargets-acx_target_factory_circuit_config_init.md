...
A pointer to the [ACX_TARGET_FACTORY_CIRCUIT_CONFIG](https://learn.microsoft.com/windows-hardware/drivers/ddi/acxtargets/ns-acxtargets-acx_target_factory_circuit_config) structure that will be initialized.
