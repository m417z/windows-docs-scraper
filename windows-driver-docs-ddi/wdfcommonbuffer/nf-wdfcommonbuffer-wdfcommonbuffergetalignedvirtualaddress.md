...
For a code example that uses **WdfCommonBufferGetAlignedVirtualAddress**, see [WdfCommonBufferCreate](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdfcommonbuffer/nf-wdfcommonbuffer-wdfcommonbuffercreate).
