...
**WskRelease** can be declared in two different ways, depending on the type of socket. This topic describes **WskRelease** for connection-oriented or listening sockets. For datagram sockets, see [WskRelease (datagram sockets)](https://learn.microsoft.com/previous-versions/windows/hardware/drivers/mt814377(v=vs.85)).
...
should specify the
*DataIndication* parameter that was passed to its
...
**WskRelease** function to release a linked list of
[WSK_DATA_INDICATION](https://learn.microsoft.com/windows-hardware/drivers/ddi/wsk/ns-wsk-_wsk_data_indication) structures
