...
The **NET_WAKE_SOURCE_MEDIA_CHANGE_PARAMETERS_INIT** function initializes a [**NET_WAKE_SOURCE_MEDIA_CHANGE_PARAMETERS**](https://learn.microsoft.com/windows-hardware/drivers/ddi/netwakesource/ns-netwakesource-_net_wake_source_media_change_parameters) structure.

## Parameters

### `Parameters` [_Out_]

A pointer to a driver-allocated [**NET_WAKE_SOURCE_MEDIA_CHANGE_PARAMETERS**](https://learn.microsoft.com/windows-hardware/drivers/ddi/netwakesource/ns-netwakesource-_net_wake_source_media_change_parameters) structure.
