...
* [**WDI_TLV_CONNECTION_SETTINGS**](https://learn.microsoft.com/windows-hardware/drivers/netcx/wdi-tlv-connection-settings)
* [**WDI_TLV_ROAMING_NEEDED_PARAMETERS**](https://learn.microsoft.com/windows-hardware/drivers/netcx/wdi-tlv-roaming-needed-parameters)
* [**WDI_TLV_DISASSOCIATION_INDICATION_PARAMETERS**](https://learn.microsoft.com/windows-hardware/drivers/netcx/wdi-tlv-disassociation-indication-parameters)