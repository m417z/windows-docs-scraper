...
The **WDI_CONNECTION_QUALITY_HINT** enumeration is a value in the [**WDI_TLV_FTM_RESPONSE**](https://learn.microsoft.com/windows-hardware/drivers/netcx/wdi-tlv-connection-quality-parameters) TLV.

## See also

[**WDI_TLV_FTM_RESPONSE**](https://learn.microsoft.com/windows-hardware/drivers/netcx/wdi-tlv-connection-quality-parameters)