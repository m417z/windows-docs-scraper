...
The **WDI_PHY_TYPE** enum is a value in the [**WDI_TLV_PHY_TYPE_LIST**](https://learn.microsoft.com/windows-hardware/drivers/netcx/wdi-tlv-phy-type-list) and [**WDI_TLV_PHY_STATISTICS**](https://learn.microsoft.com/windows-hardware/drivers/netcx/wdi-tlv-phy-statistics) TLVs.

## See also

[**WDI_TLV_PHY_TYPE_LIST**](https://learn.microsoft.com/windows-hardware/drivers/netcx/wdi-tlv-phy-type-list)

[**WDI_TLV_PHY_STATISTICS**](https://learn.microsoft.com/windows-hardware/drivers/netcx/wdi-tlv-phy-statistics)