...
The driver returns the [**STORAGE_DEVICE_NUMBER**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntddstor/ns-ntddstor-_storage_device_number) data in the buffer at **Irp->AssociatedIrp.SystemBuffer**.
...
[**STORAGE_DEVICE_NUMBER**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntddstor/ns-ntddstor-_storage_device_number)