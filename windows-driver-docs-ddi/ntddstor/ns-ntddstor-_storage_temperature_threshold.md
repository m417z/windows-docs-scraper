...
This structure is used to set the over or under temperature threshold of a storage device (via [IOCTL_STORAGE_SET_TEMPERATURE_THRESHOLD](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntddstor/ni-ntddstor-ioctl_storage_set_temperature_threshold)).
