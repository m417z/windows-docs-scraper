...
The **OutputPromptVaList** method formats and sends a user prompt to the [output callback objects](https://learn.microsoft.com/windows-hardware/drivers/debugger/using-callback-objects).
