...
The **AddSyntheticSymbolWide** method adds a synthetic symbol to a module in the [current process](https://learn.microsoft.com/windows-hardware/drivers/debugger/c).
