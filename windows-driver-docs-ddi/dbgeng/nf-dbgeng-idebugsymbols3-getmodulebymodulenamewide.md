...
The **GetModuleByModuleNameWide** method searches through the target's [modules](https://learn.microsoft.com/windows-hardware/drivers/debugger/modules) for one with the specified name.
