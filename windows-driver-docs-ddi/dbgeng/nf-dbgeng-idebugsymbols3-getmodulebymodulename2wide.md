...
The **GetModuleByModuleName2Wide** method searches through the process's [modules](https://learn.microsoft.com/windows-hardware/drivers/debugger/modules) for one with the specified name.
