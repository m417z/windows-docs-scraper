...
The **GetModuleByOffset2** method searches through the process's [modules](https://learn.microsoft.com/windows-hardware/drivers/debugger/modules) for one whose memory allocation includes the specified location.
...
[GetModuleByOffset](https://learn.microsoft.com/windows-hardware/drivers/ddi/dbgeng/nf-dbgeng-idebugsymbols3-getmodulebyoffset)
