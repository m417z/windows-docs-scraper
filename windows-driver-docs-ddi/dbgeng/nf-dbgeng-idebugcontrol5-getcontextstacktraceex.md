...
The stack trace returned to *Frames* and *FrameContexts* can be printed using [OutputContextStackTraceEx](https://learn.microsoft.com/windows-hardware/drivers/ddi/dbgeng/nf-dbgeng-idebugcontrol5-outputcontextstacktraceex).
...
[OutputContextStackTraceEx](https://learn.microsoft.com/windows-hardware/drivers/ddi/dbgeng/nf-dbgeng-idebugcontrol5-outputcontextstacktraceex)
