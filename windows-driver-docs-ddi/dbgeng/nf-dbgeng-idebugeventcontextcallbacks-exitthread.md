...
Refer to [IDebugEventCallbacks::ExitThread](https://learn.microsoft.com/windows-hardware/drivers/ddi/dbgeng/nf-dbgeng-idebugeventcallbacks-exitthread) for parameter description and additional information.
