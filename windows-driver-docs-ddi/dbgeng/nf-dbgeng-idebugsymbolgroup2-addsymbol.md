...
The **AddSymbol** method adds a symbol to a [symbol group](https://learn.microsoft.com/windows-hardware/drivers/debugger/s).
...
The index of the entry in the symbol group. When you are calling **AddSymbol** or [AddSymbolWide](https://learn.microsoft.com/windows-hardware/drivers/ddi/dbgeng/nf-dbgeng-idebugsymbolgroup2-addsymbolwide), *Index* should point to the index of the symbol that you want. Or, if *Index* points to DEBUG_ANY_ID, the symbol is appended to the end of the list.
