...
The **GetOutputCallbacksWide** method returns the [output callbacks](https://learn.microsoft.com/windows-hardware/drivers/debugger/using-input-and-output) object registered with the client.
