...
The **OpenLogFileWide** method opens a log file that will receive output from the [client objects](https://learn.microsoft.com/windows-hardware/drivers/debugger/client-objects).
