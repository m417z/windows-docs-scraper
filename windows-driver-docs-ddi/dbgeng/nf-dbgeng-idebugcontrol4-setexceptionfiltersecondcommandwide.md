...
The **SetExceptionFilterSecondCommandWide** method sets the command that will be executed by the [debugger engine](https://learn.microsoft.com/windows-hardware/drivers/debugger/introduction) on the second chance of a specified [exception](https://learn.microsoft.com/windows-hardware/drivers/).
