...
The **OutputVaListWide** method formats a string and sends the result to the [output callbacks](https://learn.microsoft.com/windows-hardware/drivers/debugger/using-input-and-output) that are registered with the engine's clients.
