...
Receives the module name of the module. This size includes the space for the '\0' terminating character. If *ModuleNameBuffer* is **NULL**, this information is not returned.
