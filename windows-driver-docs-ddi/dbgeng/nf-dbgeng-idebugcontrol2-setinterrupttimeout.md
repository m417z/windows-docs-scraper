...
The **SetInterruptTimeout** method sets the number of seconds that the [debugger engine](https://learn.microsoft.com/windows-hardware/drivers/debugger/introduction) should wait when requesting a break into the debugger.
...
The engine requests a break into the debugger when [SetInterrupt](https://learn.microsoft.com/windows-hardware/drivers/ddi/dbgeng/nf-dbgeng-idebugcontrol3-setinterrupt) is called with the DEBUG_INTERRUPT_ACTIVE flag.
