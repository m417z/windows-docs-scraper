...
Specifies the flags that control the behavior of this method. For a description of these flags, see [DEBUG_FIND_SOURCE_XXX](https://learn.microsoft.com/previous-versions/ff541495(v=vs.85)).
