...
AddExtension does not complete the process of loading and initializing the extension DLL. To make the extension available for use, make a subsequent call to the [GetExtensionFunction](https://learn.microsoft.com/windows-hardware/drivers/ddi/dbgeng/nf-dbgeng-idebugcontrol-getextensionfunction).
...
[GetExtensionFunction](https://learn.microsoft.com/windows-hardware/drivers/ddi/dbgeng/nf-dbgeng-idebugcontrol-getextensionfunction)

[GetExtensionByPath](https://learn.microsoft.com/windows-hardware/drivers/ddi/dbgeng/nf-dbgeng-idebugcontrol-getextensionbypath)
