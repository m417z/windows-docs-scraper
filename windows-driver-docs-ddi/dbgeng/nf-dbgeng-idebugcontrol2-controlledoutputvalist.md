...
The **ControlledOutputVaList** method formats a string and sends the result to [output callbacks](https://learn.microsoft.com/windows-hardware/drivers/debugger/using-input-and-output) that were registered with some of the engine's clients.
