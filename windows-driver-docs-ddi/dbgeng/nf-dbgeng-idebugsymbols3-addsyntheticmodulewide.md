...
The **AddSyntheticModuleWide** method adds a synthetic module to the module list the debugger maintains for the [current process](https://learn.microsoft.com/windows-hardware/drivers/debugger/c).
