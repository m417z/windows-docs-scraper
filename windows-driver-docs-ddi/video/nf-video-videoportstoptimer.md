...
The **VideoPortStopTimer** function disables calls to a miniport driver's [HwVidTimer](https://learn.microsoft.com/windows-hardware/drivers/ddi/video/nc-video-pvideo_hw_timer) function.
...
After a miniport driver calls [VideoPortStartTimer](https://learn.microsoft.com/windows-hardware/drivers/ddi/video/nf-video-videoportstarttimer), its *HwVidTimer* function is called at approximately one-second intervals until the miniport driver calls **VideoPortStopTimer**. A miniport driver's *HwVidTimer* function *must not* call **VideoPortStopTimer**.
