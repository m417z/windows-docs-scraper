...
A miniport driver's [HwVidInterrupt](https://learn.microsoft.com/windows-hardware/drivers/ddi/video/nc-video-pvideo_hw_interrupt) or [HwVidSynchronizeExecutionCallback](https://learn.microsoft.com/windows-hardware/drivers/ddi/video/nc-video-pminiport_synchronize_routine) function can call **VideoPortWriteRegisterUlong**.

Callers of **VideoPortWriteRegisterUlong** can be running at any IRQL, provided that the memory pointed to by the *Register* parameter is resident, mapped device memory.
