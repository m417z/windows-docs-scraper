...
The **WDF_DEVICE_POWER_STATE** enumeration is used as a member type in the [WDF_DEVICE_POWER_NOTIFICATION_DATA](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdfdevice/ns-wdfdevice-_wdf_device_power_notification_data) structure and as the return type for the [WdfDeviceGetDevicePowerState](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdfdevice/nf-wdfdevice-wdfdevicegetdevicepowerstate) method.