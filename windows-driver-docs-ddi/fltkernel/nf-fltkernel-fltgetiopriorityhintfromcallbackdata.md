...
The **FltGetIoPriorityHintFromCallbackData** routine returns an IO priority hint retrieved from the *Data*[FLT_CALLBACK_DATA](https://learn.microsoft.com/windows-hardware/drivers/ddi/fltkernel/ns-fltkernel-_flt_callback_data) structure.

If the [FLT_CALLBACK_DATA](https://learn.microsoft.com/windows-hardware/drivers/ddi/fltkernel/ns-fltkernel-_flt_callback_data) structure does not have an IO priority, the routine returns IoPriorityNormal.
