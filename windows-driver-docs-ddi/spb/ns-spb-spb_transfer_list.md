...
The **SPB_TRANSFER_LIST** structure describes an [I/O transfer sequence](https://learn.microsoft.com/windows-hardware/drivers/spb/i-o-transfer-sequences).
