...
The **SPB_MULTI_SPI_WRITE_TRANSFER_INIT** function initializes an [SPB_MULTI_SPI_WRITE_TRANSFER](https://learn.microsoft.com/windows-hardware/drivers/ddi/spb/ns-spb-spb_multi_spi_write_transfer) structure.
