...
**NdisInitiateOffload** function to offload TCP chimney state objects.
...
**NdisInitiateOffload** function to propagate an initiate offload operation that was initiated by the
...
*MiniportInitiateOffload* function, the intermediate driver constructs an
