...
**NdisInvalidateOffload** function to invalidate previously offloaded TCP chimney state objects.
...
**NdisInvalidateOffload** function to propagate an invalidate offload operation that was initiated by
...
[MiniportInvalidateOffload](https://learn.microsoft.com/windows-hardware/drivers/ddi/ndischimney/nc-ndischimney-w_invalidate_offload_handler) function, the intermediate driver constructs an
