...
**FwpmTransactionAbort0** is a specific implementation of **FwpmTransactionAbort**. See [WFP Version-Independent Names and Targeting Specific Versions of Windows](https://learn.microsoft.com/windows/desktop/FWP/wfp-version-independent-names-and-targeting-specific-versions-of-windows) for more information.
...
- **[FwpmTransactionCommit0](https://learn.microsoft.com/windows-hardware/drivers/ddi/fwpmk/nf-fwpmk-fwpmtransactioncommit0)**
