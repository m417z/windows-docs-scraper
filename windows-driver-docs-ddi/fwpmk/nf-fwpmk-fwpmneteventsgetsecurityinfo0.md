...
### `securityDescriptor` [out, optional]
...
**FwpmNetEventsGetSecurityInfo0** is a specific implementation of **FwpmNetEventsGetSecurityInfo**. See [WFP Version-Independent Names and Targeting Specific Versions of Windows](https://learn.microsoft.com/windows/desktop/FWP/wfp-version-independent-names-and-targeting-specific-versions-of-windows) for more information.

## See also

- **[FwpmNetEventsSetSecurityInfo0](https://learn.microsoft.com/windows-hardware/drivers/ddi/fwpmk/nf-fwpmk-fwpmneteventssetsecurityinfo0)**
