...
Handle for a callout enumeration created by a call to **[FwpmCalloutCreateEnumHandle0](https://learn.microsoft.com/windows-hardware/drivers/ddi/fwpmk/nf-fwpmk-fwpmcalloutcreateenumhandle0)**.
