...
**FwpmNetEventEnum5** returns only events that were logged prior to the creation of the *enumHandle* parameter. See [Logging](https://learn.microsoft.com/windows/desktop/FWP/logging) for more information.

**FwpmNetEventEnum5** is a specific implementation of **FwpmNetEventEnum**. See [WFP Version-Independent Names and Targeting Specific Versions of Windows](https://learn.microsoft.com/windows/desktop/FWP/wfp-version-independent-names-and-targeting-specific-versions-of-windows) for more information.
...
- [FWPM_NET_EVENT5](https://learn.microsoft.com/windows/desktop/api/fwpmtypes/ns-fwpmtypes-fwpm_net_event5)
