...
Handle for a layer enumeration created by a call to **[FwpmLayerCreateEnumHandle0](https://learn.microsoft.com/windows-hardware/drivers/ddi/fwpmk/nf-fwpmk-fwpmlayercreateenumhandle0)**.
