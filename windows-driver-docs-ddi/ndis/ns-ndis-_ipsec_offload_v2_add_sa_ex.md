...
**Revision** member to NDIS_IPSEC_OFFLOAD_V2_ADD_SA_EX_REVISION_1, and the
**Size** member to NDIS_SIZEOF_IPSEC_OFFLOAD_V2_ADD_SA_EX_REVISION_1.
...
[OID_TCP_TASK_IPSEC_OFFLOAD_V2_ADD_SA_EX](https://learn.microsoft.com/windows-hardware/drivers/network/oid-tcp-task-ipsec-offload-v2-add-sa-ex) request. The TCP/IP transport must specify this handle in the
...
**KeyOffset** contains key information for one followed by the other. The beginning and the length of
the key are specified by the
[IPSEC_OFFLOAD_V2_ALGORITHM_INFO](https://learn.microsoft.com/windows-hardware/drivers/ddi/ndis/ns-ndis-_ipsec_offload_v2_algorithm_info) structure's **KeyOffsetBytes** and
...
used with the
[OID_TCP_TASK_IPSEC_OFFLOAD_V2_ADD_SA_EX](https://learn.microsoft.com/windows-hardware/drivers/network/oid-tcp-task-ipsec-offload-v2-add-sa-ex) OID.
...
example, if
**SrcAddr** is set to zero, the specified SA can apply to a packet that contains any source address.
...
[IPSEC_OFFLOAD_V2_ADD_SA](https://learn.microsoft.com/windows-hardware/drivers/ddi/ndis/ns-ndis-_ipsec_offload_v2_add_sa). The **Next** and **KeyData** members have been removed. The **KeyOffset**, **SourceSwitchPortId** and **VlanId** members have been added.
...
[OID_TCP_TASK_IPSEC_OFFLOAD_V2_ADD_SA_EX](https://learn.microsoft.com/windows-hardware/drivers/network/oid-tcp-task-ipsec-offload-v2-add-sa)
