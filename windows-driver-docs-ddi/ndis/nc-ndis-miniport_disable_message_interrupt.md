...
*MiniportDisableMessageInterrupt* handler to disable a message interrupt for diagnostic and
troubleshooting purposes.

**Note** You must declare the function by using the **MINIPORT_DISABLE_MESSAGE_INTERRUPT** type.
...
*MiniportDisableMessageInterrupt* function if the driver calls the
[NdisMRegisterInterruptEx](https://learn.microsoft.com/windows-hardware/drivers/ddi/ndis/nf-ndis-ndismregisterinterruptex) function
...
NDIS calls the
[MiniportEnableMessageInterrupt](https://learn.microsoft.com/windows-hardware/drivers/ddi/ndis/nc-ndis-miniport_enable_message_interrupt) and
*MiniportDisableMessageInterrupt* functions to enable and disable interrupts for diagnostic and
