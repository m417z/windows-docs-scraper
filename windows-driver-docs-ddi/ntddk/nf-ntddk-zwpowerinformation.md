...
[NtPowerInformation](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntpowerinformation) and **ZwPowerInformation** are two versions of the same Windows Native System Services routine.
