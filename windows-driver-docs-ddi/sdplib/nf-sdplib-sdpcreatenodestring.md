...
The Bluetooth
**SdpCreateNodeString** function is used to allocate and initialize an
[SDP_NODE](https://learn.microsoft.com/windows-hardware/drivers/ddi/sdpnode/ns-sdpnode-_sdp_node) structure to a string type.
...
After the
**SdpCreateNodeString** function allocates an
...
**SdpCreateNodeString** function is copied into the node, and the original data can be freed at any
time.
