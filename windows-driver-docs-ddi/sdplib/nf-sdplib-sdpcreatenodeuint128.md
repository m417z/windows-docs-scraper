...
The Bluetooth
**SdpCreateNodeUInt128** function is used to allocate and initialize an
[SDP_NODE](https://learn.microsoft.com/windows-hardware/drivers/ddi/sdpnode/ns-sdpnode-_sdp_node) structure to an unsigned 128-bit integer
type.
...
After the
**SdpCreateNodeUInt128** function allocates an
...
**SdpCreateNodeUInt128** function is copied into the node, and the original data can be freed at any
time.
