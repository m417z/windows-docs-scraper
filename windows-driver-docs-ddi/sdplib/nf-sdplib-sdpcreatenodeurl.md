...
The Bluetooth
**SdpCreateNodeUrl** function is used to allocate and initialize an
[SDP_NODE](https://learn.microsoft.com/windows-hardware/drivers/ddi/sdpnode/ns-sdpnode-_sdp_node) structure to a URL type.
...
After the
**SdpCreateNodeUrl** function allocates an
...
**SdpCreateNodeUrl** function is copied into the node, and the original data can be freed at any
time.
