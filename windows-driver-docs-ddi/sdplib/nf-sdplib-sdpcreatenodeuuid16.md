...
The Bluetooth
**SdpCreateNodeUUID16** function is used to allocate and initialize an
[SDP_NODE](https://learn.microsoft.com/windows-hardware/drivers/ddi/sdpnode/ns-sdpnode-_sdp_node) structure to a 16-bit UUID type.
...
After the
**SdpCreateNodeUUID16** function allocates an
...
**SdpCreateNodeUUID16** function is copied into the node, and the original data can be freed at any
time.
