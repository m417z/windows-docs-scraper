...
The Bluetooth
**SdpCreateNodeInt8** function is used to allocate and initialize an
[SDP_NODE](https://learn.microsoft.com/windows-hardware/drivers/ddi/sdpnode/ns-sdpnode-_sdp_node) structure to an 8-bit integer type.
...
After the
**SdpCreateNodeInt8** function allocates an
...
**SdpCreateNodeInt8** function is copied into the node, and the original data can be freed at any
time.
