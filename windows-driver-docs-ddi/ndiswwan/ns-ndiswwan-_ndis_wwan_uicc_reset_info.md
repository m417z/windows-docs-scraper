...
The header with type, revision, and size information about the **NDIS_WWAN_UICC_RESET_INFO** structure.
...
| Revision | NDIS_WWAN_UICC_RESET_INFO_REVISION_1 |
| Size | sizeof(NDIS_WWAN_UICC_RESET_INFO) |
...
A formatted [WWAN_UICC_RESET_INFO](https://learn.microsoft.com/windows-hardware/drivers/ddi/wwan/ns-wwan-_wwan_uicc_reset_info) structure that represents the passthrough status of the miniport adapter.
