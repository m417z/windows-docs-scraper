...
| Revision | NDIS_WWAN_SET_PIN_REVISION_1 |
| Size | sizeof(NDIS_WWAN_SET_PIN) |
...
A formatted
[WWAN_PIN_ACTION](https://learn.microsoft.com/windows-hardware/drivers/ddi/wwan/ns-wwan-_wwan_pin_action) object that represents an
