...
The header with type, revision, and size information about the **NDIS_WWAN_MODEM_CONFIG_INFO** structure.
...
A formatted [WWAN_MODEM_CONFIG_INFO](https://learn.microsoft.com/windows-hardware/drivers/ddi/wwan/ns-wwan-_wwan_modem_config_info) structure that represents the modem's configuration information.
