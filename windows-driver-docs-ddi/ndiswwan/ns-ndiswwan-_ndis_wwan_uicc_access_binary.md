...
A formatted [**WWAN_UICC_ACCESS_BINARY**](https://learn.microsoft.com/windows-hardware/drivers/ddi/wwan/ns-wwan-_wwan_uicc_access_binary) structure that describes the binary UICC file.

## Remarks

This structure is used in the payload of an [OID_WWAN_UICC_ACCESS_BINARY](https://learn.microsoft.com/windows-hardware/drivers/network/oid-wwan-uicc-access-binary) Query or Set request.
...
[NDIS_STATUS_WWAN_UICC_BINARY_RESPONSE](https://learn.microsoft.com/windows-hardware/drivers/network/ndis-status-wwan-uicc-binary-response)

[**WWAN_UICC_ACCESS_BINARY**](https://learn.microsoft.com/windows-hardware/drivers/ddi/wwan/ns-wwan-_wwan_uicc_access_binary)