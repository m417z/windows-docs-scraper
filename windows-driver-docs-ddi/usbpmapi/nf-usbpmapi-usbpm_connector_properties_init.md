...
A pointer to a [**USBPM_CONNECTOR_PROPERTIES**](https://learn.microsoft.com/windows-hardware/drivers/ddi/usbpmapi/ns-usbpmapi-_usbpm_connector_properties) to initialize.
