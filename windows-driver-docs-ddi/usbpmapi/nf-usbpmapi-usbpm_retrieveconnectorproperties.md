...
### `ConnectorProperties` [Out]

A pointer to a driver-provided [**USBPM_CONNECTOR_PROPERTIES**](https://learn.microsoft.com/windows-hardware/drivers/ddi/usbpmapi/ns-usbpmapi-_usbpm_connector_properties) structure that receives the connector properties. Initialize the structure by calling [**USBPM_CONNECTOR_PROPERTIES_INIT**](https://learn.microsoft.com/windows-hardware/drivers/ddi/usbpmapi/nf-usbpmapi-usbpm_connector_properties_init).
