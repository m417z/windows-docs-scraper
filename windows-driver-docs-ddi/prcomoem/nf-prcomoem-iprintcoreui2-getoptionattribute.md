...
Pointer to a caller-supplied buffer containing an ASCII string specifying the single option keyword to query for. This value can be obtained from a prior call to [IPrintCoreUI2::EnumOptions](https://learn.microsoft.com/windows-hardware/drivers/ddi/prcomoem/nf-prcomoem-iprintcoreui2-enumoptions).
...
Pointer to a memory location that receives a value specifying the data type of the requested attribute. This value is an enumerator of the [EATTRIBUTE_DATATYPE](https://learn.microsoft.com/windows-hardware/drivers/ddi/printoem/ne-printoem-_eattribute_datatype) enumeration.
...
| **E_INVALIDARG** | The method attempted to query for a nonexistent attribute.<br><br>The feature keyword name or option keyword name were not recognized.<br><br>The *poemuiobj* parameter pointed to an invalid context object. |
...
[IPrintCoreUI2::GetFeatureAttribute](https://learn.microsoft.com/windows-hardware/drivers/ddi/prcomoem/nf-prcomoem-iprintcoreui2-getfeatureattribute)
