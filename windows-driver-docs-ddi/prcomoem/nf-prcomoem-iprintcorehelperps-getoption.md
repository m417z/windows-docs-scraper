...
Feature keywords are as defined in the PPD file. In addition, the Pscript5 driver supports several reserved keywords for options that are stored in its private [DEVMODEW](https://learn.microsoft.com/windows/win32/api/wingdi/ns-wingdi-devmodew)structure. For the list of Pscript5 features, see [Keyword Mapping](https://learn.microsoft.com/windows-hardware/drivers/print/keyword-mapping).
