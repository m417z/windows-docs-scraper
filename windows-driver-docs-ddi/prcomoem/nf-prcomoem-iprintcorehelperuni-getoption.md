...
Feature keywords are as defined in the GPD file. In addition, the Unidrv driver supports several reserved keywords for options that are stored in its private [DEVMODEW](https://learn.microsoft.com/windows/win32/api/wingdi/ns-wingdi-devmodew) structure. For the list of Unidrv features, see [Keyword Mapping](https://learn.microsoft.com/windows-hardware/drivers/print/keyword-mapping).
