...
**Note** You must declare the function by using the **MINIPORT_WDI_RX_THROTTLE** type. For more
...
A [WDI_RX_THROTTLE_LEVEL](https://learn.microsoft.com/windows-hardware/drivers/ddi/dot11wdi/ne-dot11wdi-_wdi_rx_throttle_level) enumeration value that specifies the throttle level.
...
[WDI_RX_THROTTLE_LEVEL](https://learn.microsoft.com/windows-hardware/drivers/ddi/dot11wdi/ne-dot11wdi-_wdi_rx_throttle_level)