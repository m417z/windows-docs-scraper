...
The **StorPortInterlockedInsertTailList** routine atomically inserts an entry at the end of a doubly linked list of [**STOR_LIST_ENTRY**](https://learn.microsoft.com/windows-hardware/drivers/ddi/storport/ns-storport-_stor_list_entry) structures.
