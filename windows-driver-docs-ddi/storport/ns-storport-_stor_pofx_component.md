...
The **STOR_POFX_COMPONENT** structure describes the power state attributes of a storage device component. The [**STOR_POFX_COMPONENT_V2**](https://learn.microsoft.com/windows-hardware/drivers/ddi/storport/ns-storport-_stor_pofx_component_v2) structure provides additional power state control.
...
[**STOR_POFX_COMPONENT_V2**](https://learn.microsoft.com/windows-hardware/drivers/ddi/storport/ns-storport-_stor_pofx_component_v2)
