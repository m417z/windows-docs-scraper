...
Returns the status of the completed request. This member should be set by the miniport driver before it notifies the operating system-specific driver that the request has completed by calling [**StorPortNotification**](https://learn.microsoft.com/windows-hardware/drivers/ddi/storport/nf-storport-storportnotification) with **RequestComplete**. The value of this member can be one of the following:
...
| Value | Meaning |
| ----- | ------- |
| SRB_FUNCTION_EXECUTE_SCSI (0x00) | A SCSI device I/O request should be executed on the target logical unit. When **NumSrbExData** > 0, one or more of the following extended request block structures are located at the offsets specified in **SrbExDataOffset**: [SRBEX_DATA_SCSI_CDB16](https://learn.microsoft.com/windows-hardware/drivers/ddi/srb/ns-srb-_srbex_data_scsi_cdb16), [SRBEX_DATA_SCSI_CDB32](https://learn.microsoft.com/windows-hardware/drivers/ddi/srb/ns-srb-_srbex_data_scsi_cdb32), [SRBEX_DATA_SCSI_CDB_VAR](https://learn.microsoft.com/windows-hardware/drivers/ddi/srb/ns-srb-_srbex_data_scsi_cdb_var), [SRBEX_DATA_BIDIRECTIONAL](https://learn.microsoft.com/windows-hardware/drivers/ddi/srb/ns-srb-_srbex_data_bidirectional), [SRBEX_DATA_IO_INFO](https://learn.microsoft.com/windows-hardware/drivers/ddi/srb/ns-srb-_srbex_data_io_info) |
