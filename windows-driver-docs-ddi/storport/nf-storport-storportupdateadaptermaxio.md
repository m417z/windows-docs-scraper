...
**StorPortUpdateAdapterMaxIO** is valid only within a [**HwInitialize**](https://learn.microsoft.com/windows-hardware/drivers/ddi/storport/nc-storport-hw_initialize)/[**HwPassiveInitRoutine**](https://learn.microsoft.com/windows-hardware/drivers/ddi/storport/nc-storport-hw_passive_initialize_routine) callback and has effect only during adapter initialization.
...
[**StorPortUpdatePortConfigMaxIOInfo**](https://learn.microsoft.com/windows-hardware/drivers/ddi/storport/nf-storport-storportupdateportconfigmaxioinfo)