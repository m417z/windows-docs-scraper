...
[CWiauPropertyList::SetValidValues(LONG, range)](https://learn.microsoft.com/windows-hardware/drivers/ddi/wiautil/nf-wiautil-cwiaupropertylist-setvalidvalues(int_long_long_long_long_long).md)