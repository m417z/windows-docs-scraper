...
The WIAS_LTRACE macro obsolete and is not recommended for use because it does not record its output to the *Wiatrace.log* diagnostic Log file. It is recommended that the [WIAS_TRACE](https://learn.microsoft.com/windows-hardware/drivers/ddi/wiamdef/nf-wiamdef-wias_trace) macro be used instead.
