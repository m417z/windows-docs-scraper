...
The IOCTL_HID_SET_FEATURE request sends a feature report to a [top-level collection](https://learn.microsoft.com/windows-hardware/drivers/hid/top-level-collections).
