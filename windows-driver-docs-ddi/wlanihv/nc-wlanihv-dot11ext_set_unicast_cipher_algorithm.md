...
**Dot11ExtSetUnicastCipherAlgorithm** function to enable a unicast cipher
...
**Note** The value of
*dwUnicastCipherAlgo* must match the value of a cipher algorithm returned by the Native 802.11
