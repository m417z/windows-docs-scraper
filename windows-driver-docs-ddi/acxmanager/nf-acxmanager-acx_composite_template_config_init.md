...
The **ACX_COMPOSITE_TEMPLATE_CONFIG_INIT** function initializes an [ACX_COMPOSITE_TEMPLATE_CONFIG](https://learn.microsoft.com/windows-hardware/drivers/ddi/acxmanager/ns-acxmanager-acx_composite_template_config) structure.

## Parameters

### `Config` [out]

A pointer to the [ACX_COMPOSITE_TEMPLATE_CONFIG](https://learn.microsoft.com/windows-hardware/drivers/ddi/acxmanager/ns-acxmanager-acx_composite_template_config) structure to initialize.
