...
The **AtaPortRegistryControllerKeyRead** routine reads the data that is associated with the indicated value name under the registry key `HKLM\CurrentControlSet\Services\\ControllerN`, where *N* is the number of the controller.
