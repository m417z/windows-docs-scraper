...
The **AtaPortRegistryChannelSubKeyWrite** routine writes data to the indicated value name under the registry key `HKLM\CurrentControlSet\Services\\ControllerN\ChannelM`, where *N* is the number of the controller and *M* is the number of the channel.
