...
The ACPI notification ID. This parameter specifies the type of ACPI notification that PoFx is sending. For a list of ACPI notification IDs, see [ACPI notifications](https://learn.microsoft.com/windows-hardware/drivers/ddi/).
