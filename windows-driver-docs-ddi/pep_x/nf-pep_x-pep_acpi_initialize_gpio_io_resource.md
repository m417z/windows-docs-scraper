...
The **PEP_ACPI_INITIALIZE_GPIO_IO_RESOURCE** function initializes a platform extension plug-in's (PEP) [PEP_ACPI_GPIO_RESOURCE](https://learn.microsoft.com/windows-hardware/drivers/ddi/pepfx/ns-pepfx-_pep_acpi_gpio_resource) structure.
