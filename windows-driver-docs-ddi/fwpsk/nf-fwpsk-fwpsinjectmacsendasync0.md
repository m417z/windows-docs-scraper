...
**Note** **FwpsInjectMacSendAsync0** is a specific version of **FwpsInjectMacSendAsync**. See [WFP Version-Independent Names and Targeting Specific Versions of Windows](https://learn.microsoft.com/windows/desktop/FWP/wfp-version-independent-names-and-targeting-specific-versions-of-windows) for more information.
...
[FwpsAllocateNetBufferAndNetBufferList0](https://learn.microsoft.com/windows-hardware/drivers/ddi/fwpsk/nf-fwpsk-fwpsallocatenetbufferandnetbufferlist0) function. The NET_BUFFER_LIST structure must begin with a MAC header.
...
The
**FwpsInjectMacSendAsync0** function returns one of the following NTSTATUS codes.
