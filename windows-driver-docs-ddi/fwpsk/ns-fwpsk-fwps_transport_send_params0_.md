...
The **FWPS_TRANSPORT_SEND_PARAMS0** structure defines properties of an outbound transport layer
packet.

**Note** **FWPS_TRANSPORT_SEND_PARAMS0** is the specific version of **FWPS_TRANSPORT_SEND_PARAMS** used in Windows Vista and later. See [WFP Version-Independent Names and Targeting Specific Versions of Windows](https://learn.microsoft.com/windows/desktop/FWP/wfp-version-independent-names-and-targeting-specific-versions-of-windows) for more information. For Windows 7, [FWPS_TRANSPORT_SEND_PARAMS1](https://learn.microsoft.com/windows-hardware/drivers/ddi/fwpsk/ns-fwpsk-fwps_transport_send_params1_) is available.
...
of the
[classifyFn](https://learn.microsoft.com/windows-hardware/drivers/ddi/_netvista/) function, and the **controlData** buffer must be kept valid
