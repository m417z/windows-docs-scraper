...
**WWAN_PROVISIONED_CONTEXT_V2** is used as a response to [OID_WWAN_PROVISIONED_CONTEXT](https://learn.microsoft.com/windows-hardware/drivers/network/oid-wwan-provisioned-contexts) set requests.
