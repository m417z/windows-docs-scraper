...
The **WWAN_READY_INFO_REV2_PRE2170** structure is the older version of the [**WWAN_READY_INFO**](https://learn.microsoft.com/windows-hardware/drivers/ddi/wwan/ns-wwan-_wwan_ready_info) structure, previous to Windows 11.
