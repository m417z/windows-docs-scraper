...
The **D3DDeviceDesc_V3** structure is obsolete; only [**D3DDeviceDesc_V1**](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3dhal/ns-d3dhal-_d3ddevicedesc_v1) should be used.
