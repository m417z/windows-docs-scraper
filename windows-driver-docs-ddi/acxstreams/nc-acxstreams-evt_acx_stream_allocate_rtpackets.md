...
A pointer that receives a pointer to an array of [ACX_RTPACKET structures](https://learn.microsoft.com/windows-hardware/drivers/ddi/acxstreams/ns-acxstreams-acx_rtpacket) that describes the location and size of the packets.
...
EvtAcxStreamAllocateRtPackets is called before [EvtAcxStreamPrepareHardware](https://learn.microsoft.com/windows-hardware/drivers/ddi/acxstreams/nc-acxstreams-evt_acx_stream_prepare_hardware) to allow the RT packet allocation to occur before EvtAcxStreamPrepareHardware.
