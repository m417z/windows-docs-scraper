...
**ScsiDebugPrint** calls [**DbgPrintEx**](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-dbgprintex), passing the **DebugMessage** pointer and a debug level value mapped from **DebugPrintLevel** as follows.
