...
The context data from the miniport driver. The system sends this context with the [OID_DOT11_WFD_SEND_GO_NEGOTIATION_CONFIRMATION](https://learn.microsoft.com/windows-hardware/drivers/network/oid-dot11-wfd-send-go-negotiation-confirmation) request.
