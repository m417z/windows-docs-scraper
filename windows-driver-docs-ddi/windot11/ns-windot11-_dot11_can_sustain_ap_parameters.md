...
If the value of
**ulReason** is in the range of DOT11_CAN_SUSTAIN_AP_REASON_IHV_START and
...
makes an
[NDIS_STATUS_DOT11_CAN_SUSTAIN_AP](https://learn.microsoft.com/windows-hardware/drivers/network/ndis-status-dot11-can-sustain-ap) status indication.

## See also

[NDIS_STATUS_DOT11_CAN_SUSTAIN_AP](https://learn.microsoft.com/windows-hardware/drivers/network/ndis-status-dot11-can-sustain-ap)
