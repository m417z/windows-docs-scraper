...
On input, a pointer to an [FCP_FRAME](https://learn.microsoft.com/windows-hardware/drivers/ddi/61883/ns-61883-_fcp_frame) structure that contains the FCP response to send to the device.
