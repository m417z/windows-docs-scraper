...
The size, in bytes, of the private portion of Unidrv's [**DEVMODEW**](https://learn.microsoft.com/windows/win32/api/wingdi/ns-wingdi-devmodew) structure.
...
[PSCRIPT5_PRIVATE_DEVMODE](https://learn.microsoft.com/windows-hardware/drivers/ddi/printoem/ns-printoem-_pscript5_private_devmode)