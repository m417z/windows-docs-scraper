...
The **ReadUShortFromUser** function safely reads a USHORT value from user-mode memory.
...
This function provides a safe way to read a USHORT value from user-mode memory. It ensures the provided address is a user-mode address before reading it.
...
[**ReadUShortFromMode**](https://learn.microsoft.com/windows-hardware/drivers/ddi/usermode_accessors/nf-usermode_accessors-readushortfrommode)

[**WriteUShortToUser**](https://learn.microsoft.com/windows-hardware/drivers/ddi/usermode_accessors/nf-usermode_accessors-writeushorttouser)