...
The **WriteUShortToUserRelease** function safely writes a USHORT value to user-mode memory with [release semantics](https://learn.microsoft.com/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
[**ReadUShortFromUserAcquire**](https://learn.microsoft.com/windows-hardware/drivers/ddi/usermode_accessors/nf-usermode_accessors-readushortfromuseracquire)