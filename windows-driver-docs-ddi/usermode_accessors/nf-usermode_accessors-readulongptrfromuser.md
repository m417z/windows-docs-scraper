...
This function provides a safe way to read a ULONG_PTR value from user-mode memory. It ensures the provided address is a user-mode address before reading it.
