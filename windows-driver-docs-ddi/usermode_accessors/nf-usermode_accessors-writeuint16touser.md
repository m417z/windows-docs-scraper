...
The **WriteUInt16ToUser** function safely writes a UINT16 value to user-mode memory.
...
[**WriteUInt16ToMode**](https://learn.microsoft.com/windows-hardware/drivers/ddi/usermode_accessors/nf-usermode_accessors-writeuint16tomode)