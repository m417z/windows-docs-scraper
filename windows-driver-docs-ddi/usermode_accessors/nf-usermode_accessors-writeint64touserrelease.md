...
The **WriteInt64ToUserRelease** function safely writes a INT64 value to user-mode memory with [release semantics](https://learn.microsoft.com/windows-hardware/drivers/kernel/acquire-and-release-semantics).

## Parameters

### `Destination`

[out] A pointer to the user-mode memory location where the INT64 value will be written.
...
[**WriteInt64ToUser**](https://learn.microsoft.com/windows-hardware/drivers/ddi/usermode_accessors/nf-usermode_accessors-writeint64touser)

[**ReadInt64FromUserAcquire**](https://learn.microsoft.com/windows-hardware/drivers/ddi/usermode_accessors/nf-usermode_accessors-readint64fromuseracquire)