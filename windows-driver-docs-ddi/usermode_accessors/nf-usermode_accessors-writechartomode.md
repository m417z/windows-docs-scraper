...
The **WriteCharToMode** function safely writes a CHAR value to memory based on the specified processor mode.

## Parameters

### `Destination`

[out] A pointer to the memory location where the CHAR value will be written.
