...
The **ReadCharFromUser** function safely reads a CHAR value from user-mode memory.
...
This function provides a safe way to read a CHAR value from user-mode memory. It ensures the provided address is a user-mode address before reading it.
...
[**ReadCharFromMode**](https://learn.microsoft.com/windows-hardware/drivers/ddi/usermode_accessors/nf-usermode_accessors-readcharfrommode)
