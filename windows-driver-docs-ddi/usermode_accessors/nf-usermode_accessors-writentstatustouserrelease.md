...
The **WriteNtStatusToUserRelease** function safely writes an NTSTATUS value to user-mode memory with [release semantics](https://learn.microsoft.com/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
[**WriteNtStatusToUser**](https://learn.microsoft.com/windows-hardware/drivers/ddi/usermode_accessors/nf-usermode_accessors-writentstatustouser)

[**ReadNtStatusFromUserAcquire**](https://learn.microsoft.com/windows-hardware/drivers/ddi/usermode_accessors/nf-usermode_accessors-readntstatusfromuseracquire)