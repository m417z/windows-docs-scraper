...
The **WriteUInt8ToMode** function safely writes a UINT8 value to memory based on the specified processor mode.

## Parameters

### `Destination`

[out] A pointer to the memory location where the UINT8 value will be written.
