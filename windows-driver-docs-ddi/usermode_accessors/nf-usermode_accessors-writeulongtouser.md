...
The **WriteULongToUser** function safely writes a ULONG value to user-mode memory.
...
[**WriteULongToMode**](https://learn.microsoft.com/windows-hardware/drivers/ddi/usermode_accessors/nf-usermode_accessors-writeulongtomode)
