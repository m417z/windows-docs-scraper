...
The **WriteULargeIntegerToUser** function safely writes a ULARGE_INTEGER value to user-mode memory.

## Parameters

### `Destination`

[out] A pointer to the user-mode memory location where the ULARGE_INTEGER value will be written.
...
[**ReadULargeIntegerFromUser**](https://learn.microsoft.com/windows-hardware/drivers/ddi/usermode_accessors/nf-usermode_accessors-readulargeintegerfromuser)

[**WriteULargeIntegerToMode**](https://learn.microsoft.com/windows-hardware/drivers/ddi/usermode_accessors/nf-usermode_accessors-writeulargeintegertomode)