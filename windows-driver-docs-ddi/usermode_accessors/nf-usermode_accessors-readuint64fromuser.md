...
The **ReadUInt64FromUser** function safely reads a UINT64 value from user-mode memory.
...
[**ReadUInt64FromMode**](https://learn.microsoft.com/windows-hardware/drivers/ddi/usermode_accessors/nf-usermode_accessors-readuint64frommode)
