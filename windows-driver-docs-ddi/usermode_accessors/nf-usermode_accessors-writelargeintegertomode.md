...
The **WriteLargeIntegerToMode** function safely writes a LARGE_INTEGER value to memory based on the specified processor mode.

## Parameters

### `Destination`

[out] A pointer to the memory location where the LARGE_INTEGER value will be written.
...
This function provides a safe way to write a LARGE_INTEGER value to memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**WriteLargeIntegerToUser**](https://learn.microsoft.com/windows-hardware/drivers/ddi/usermode_accessors/nf-usermode_accessors-writelargeintegertouser)

[**ReadLargeIntegerFromMode**](https://learn.microsoft.com/windows-hardware/drivers/ddi/usermode_accessors/nf-usermode_accessors-readlargeintegerfrommode)