...
The buffer at **Irp->AssociatedIrp.SystemBuffer** contains the [DRIVE_LAYOUT_INFORMATION](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntdddisk/ns-ntdddisk-_drive_layout_information) values to be set.
...
Returns updated [DRIVE_LAYOUT_INFORMATION](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntdddisk/ns-ntdddisk-_drive_layout_information), possibly with modified partition numbers, to the buffer at **Irp->AssociatedIrp.SystemBuffer**.

### Output buffer length

Length of a [DRIVE_LAYOUT_INFORMATION](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntdddisk/ns-ntdddisk-_drive_layout_information).
