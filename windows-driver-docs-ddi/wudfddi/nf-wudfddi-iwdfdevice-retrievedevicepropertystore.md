...
A pointer to a buffer that receives a pointer to the [IWDFNamedPropertyStore](https://learn.microsoft.com/windows-hardware/drivers/ddi/wudfddi/nn-wudfddi-iwdfnamedpropertystore) interface. The driver uses this interface to access values in the registry.
