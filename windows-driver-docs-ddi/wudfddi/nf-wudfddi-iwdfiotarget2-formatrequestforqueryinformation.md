...
A [WDF_FILE_INFORMATION_CLASS](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdffileobject/ne-wdffileobject-_wdf_file_information_class)-typed value that specifies the type of information to obtain.
...
A pointer to the [IWDFMemory](https://learn.microsoft.com/windows-hardware/drivers/ddi/wudfddi/nn-wudfddi-iwdfmemory) interface of a memory object. This object represents the output buffer, which receives the file information that the *InformationClass* parameter specifies. This parameter is optional and can be **NULL**.
...
Use the **FormatRequestForQueryInformation** method, followed by the [IWDFIoRequest::Send](https://learn.microsoft.com/windows-hardware/drivers/ddi/wudfddi/nf-wudfddi-iwdfiorequest-send) method, to send requests either synchronously or asynchronously to an [I/O target](https://learn.microsoft.com/windows-hardware/drivers/wdf/using-i-o-targets-in-umdf).
...
[IWDFIoTarget2::FormatRequestForSetInformation](https://learn.microsoft.com/windows-hardware/drivers/ddi/wudfddi/nf-wudfddi-iwdfiotarget2-formatrequestforsetinformation)