...
A pointer to the [IWDFDevice](https://learn.microsoft.com/windows-hardware/drivers/ddi/wudfddi/nn-wudfddi-iwdfdevice) interface for the device object of the device for which the self-managed I/O operations are suspended.

## Return value

If the **OnSelfManagedIoSuspend** callback encounters no errors, it must return
