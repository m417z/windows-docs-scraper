...
A pointer to the [IWDFDevice](https://learn.microsoft.com/windows-hardware/drivers/ddi/wudfddi/nn-wudfddi-iwdfdevice) interface for the device object of the device that will be removed.
...
For more information about the **OnQueryRemove** callback method, see [A User Unplugs a Device](https://learn.microsoft.com/windows-hardware/drivers/wdf/a-user-unplugs-a-device).
