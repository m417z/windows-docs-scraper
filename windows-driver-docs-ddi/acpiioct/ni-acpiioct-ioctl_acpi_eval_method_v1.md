...
The [IOCTL_ACPI_EVAL_METHOD_V1](https://learn.microsoft.com/windows-hardware/drivers/ddi/acpiioct/ni-acpiioct-ioctl_acpi_async_eval_method_v1) control code synchronously evaluates an ACPI control method that is supported by the device.
