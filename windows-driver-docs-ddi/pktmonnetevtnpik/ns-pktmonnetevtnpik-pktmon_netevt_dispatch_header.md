...
The **PKTMON_NETEVT_DISPATCH_HEADER** structure contains the header for a **[PKTMON_NETEVT_PROVIDER_DISPATCH](https://learn.microsoft.com/windows-hardware/drivers/ddi/pktmonnetevtnpik/ns-pktmonnetevtnpik-pktmon_netevt_provider_dispatch)** structure.
...
The size of the **[PKTMON_NETEVT_CLIENT_DISPATCH](https://learn.microsoft.com/windows-hardware/drivers/ddi/pktmonnetevtnpik/ns-pktmonnetevtnpik-pktmon_netevt_client_dispatch)** structure.
