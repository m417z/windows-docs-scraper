...
The **TmPrePrepareEnlistment** routine is a pointer-based version of the [ZwPrePrepareEnlistment](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntpreprepareenlistment) routine.
