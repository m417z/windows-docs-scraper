...
Opaque push lock pointer specified in the [**ExAcquirePushLockShared**](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-exacquirepushlockshared) call. This pointer must have been initialized by a previous call to [**ExInitializePushLock**](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-exinitializepushlock).
