...
Pointer to a [UNICODE_STRING](https://learn.microsoft.com/windows/win32/api/ntdef/ns-ntdef-_unicode_string) structure that receives the string representation of *Value*. The buffer specified by the *Buffer* of *String* must be large enough to hold the result.
