...
This member can be set to the following flag bit: **PO_FX_COMPONENT_FLAG_F0_ON_DX**. For more information, see Remarks.
...
A value that specifies the number of components this component depends on. For more information, see *Component dependencies* under Remarks.

### `Providers`

A pointer to an array of component indexes this component depends on. For more information, see *Component dependencies* under Remarks.
