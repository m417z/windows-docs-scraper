...
The **V1** member of the [DMA_TRANSFER_INFO](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdm/ns-wdm-_dma_transfer_info) structure is a structure of type **DMA_TRANSFER_INFO_V1**.
