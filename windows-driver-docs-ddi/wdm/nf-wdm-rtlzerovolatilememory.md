...
The **RtlZeroVolatileMemory** function is a convenience wrapper around [**RtlFillVolatileMemory**](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-rtlfillvolatilememory).
