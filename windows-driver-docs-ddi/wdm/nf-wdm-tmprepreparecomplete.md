...
The **TmPrePrepareComplete** routine is a pointer-based version of the [ZwPrePrepareComplete](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-ntprepreparecomplete) routine.
