...
Beginning with Windows Vista, drivers should call [IoCallDriver](https://learn.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-iocalldriver), not **PoCallDriver** to pass a power IRP to the next-lower driver. However, on Windows Server 2003, Windows XP, and Windows 2000, drivers must call **PoCallDriver**, not **IoCallDriver** to pass a power IRP to the next-lower driver. On Windows Server 2003, Windows XP, and Windows 2000, drivers must also call [PoStartNextPowerIrp](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/nf-ntifs-postartnextpowerirp) before calling **PoCallDriver**.
