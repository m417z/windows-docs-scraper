...
A pointer to a [D3DKMT_DESTROYALLOCATION2](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3dkmthk/ns-d3dkmthk-_d3dkmt_destroyallocation2) structure that contains information for releasing allocations.
