...
| STATUS_NO_MEMORY | [D3DKMTAcquireKeyedMutex](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3dkmthk/nf-d3dkmthk-d3dkmtacquirekeyedmutex) could not complete because of insufficient memory. |
