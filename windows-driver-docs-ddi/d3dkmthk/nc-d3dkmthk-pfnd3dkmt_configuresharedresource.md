...
| **STATUS_NO_MEMORY** | [D3DKMTConfigureSharedResource](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3dkmthk/nf-d3dkmthk-d3dkmtconfiguresharedresource) could not complete because of insufficient memory. |
