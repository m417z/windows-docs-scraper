...
| **STATUS_NO_MEMORY** | [D3DKMTOpenKeyedMutex2](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3dkmthk/nf-d3dkmthk-d3dkmtopenkeyedmutex2) could not complete because of insufficient memory. |
