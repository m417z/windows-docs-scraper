...
**D3DKMT_SIGNALSYNCHRONIZATIONOBJECTFROMGPU2** is used with [D3DKMTSignalSynchronizationObjectFromGpu2](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3dkmthk/nf-d3dkmthk-d3dkmtsignalsynchronizationobjectfromgpu2) to signal a monitored fence.
