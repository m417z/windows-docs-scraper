...
| **STATUS_NO_MEMORY** | [D3DKMTOutputDuplPresent](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3dkmthk/nf-d3dkmthk-d3dkmtoutputduplpresent) could not complete because of insufficient memory. |
