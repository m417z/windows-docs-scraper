...
**D3DKMTReleaseKeyedMutex2** behaves like the [D3DKMTReleaseKeyedMutex](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3dkmthk/nf-d3dkmthk-d3dkmtreleasekeyedmutex) function but lets the caller specify private data to associate with the keyed mutex.
