...
For a description of ownership levels of video present sources, see the [D3DKMTSetVidPnSourceOwnerfunction](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3dkmthk/nf-d3dkmthk-d3dkmtsetvidpnsourceowner) and the [D3DKMT_SETVIDPNSOURCEOWNER](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3dkmthk/ns-d3dkmthk-_d3dkmt_setvidpnsourceowner) structure. An exclusive level of ownership is represented by the *D3DKMT_VIDPNSOURCEOWNER_EXCLUSIVE* or *D3DKMT_VIDPNSOURCEOWNER_EXCLUSIVEGDI* owner type, which can be specified in one of the elements in the array that the *pType* member of **D3DKMT_SETVIDPNSOURCEOWNER** specifies.
