...
| DDPF_FOURCC | The [FOURCC](https://learn.microsoft.com/windows/win32/directshow/fourcc-codes) code is valid. |
...
Specifies a surface format code including any of the codes in the D3DFORMAT enumerated type. Some [FOURCC](https://learn.microsoft.com/windows/win32/directshow/fourcc-codes) codes are part of D3DFORMAT. For more information about D3DFORMAT, see the SDK documentation. Hardware vendors can also define and supply format codes that are specific to their hardware.
