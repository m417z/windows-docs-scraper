...
The KSPROPERTY_CAMERACONTROL_FOCAL_LENGTH_S structure returns filter-specific data requested using the [KSPROPERTY_CAMERACONTROL_FOCAL_LENGTH](https://learn.microsoft.com/windows-hardware/drivers/stream/ksproperty-cameracontrol-focal-length) property.
...
[KSPROPERTY_CAMERACONTROL_NODE_FOCAL_LENGTH_S](https://learn.microsoft.com/windows-hardware/drivers/ddi/ksmedia/ns-ksmedia-ksproperty_cameracontrol_node_focal_length_s)
