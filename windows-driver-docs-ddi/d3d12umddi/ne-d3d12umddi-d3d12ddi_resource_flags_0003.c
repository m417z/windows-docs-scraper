typedef enum D3D12DDI_RESOURCE_FLAGS_0003 {
  ...
  D3D12DDI_RESOURCE_FLAG_0106_VIDEO_PROCESS_3DLUT_ONLY,
  D3D12DDI_RESOURCE_FLAG_0111_USE_TIGHT_ALIGNMENT,
  D3D12DDI_RESOURCE_FLAG_0106_VIDEO_PROCESS_1DLUT_ONLY
} ;