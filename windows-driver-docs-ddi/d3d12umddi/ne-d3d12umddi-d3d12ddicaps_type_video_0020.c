typedef enum D3D12DDICAPS_TYPE_VIDEO_0020 {
  ...
  D3D12DDICAPS_TYPE_VIDEO_0102_ENCODER_RESOURCE_REQUIREMENTS1,
  D3D12DDICAPS_TYPE_VIDEO_0103_ENCODER_QPMAP_INPUT,
  D3D12DDICAPS_TYPE_VIDEO_0103_ENCODER_DIRTY_REGIONS,
  D3D12DDICAPS_TYPE_VIDEO_0107_ENCODER_MOTION_SEARCH,
  D3D12DDICAPS_TYPE_VIDEO_0103_ENCODER_RESOLVE_INPUT_PARAM_LAYOUT,
  D3D12DDICAPS_TYPE_VIDEO_0106_PROCESS_SUPPORT1,
  D3D12DDICAPS_TYPE_VIDEO_0106_PROCESSOR_SIZE2,
  D3D12DDICAPS_TYPE_VIDEO_0107_ENCODER_SUPPORT2,
  D3D12DDICAPS_TYPE_VIDEO_0110_ENCODER_HEAP_SIZE1,
  D3D12DDICAPS_TYPE_VIDEO_0110_ENCODER_RATE_CONTROL_FRAME_ANALYSIS
} ;