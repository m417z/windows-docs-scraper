...
[in] Pointer to a [**D3D12DDI_DISPATCH_GRAPH_DESC_0108**](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d12umddi/ns-d3d12umddi-d3d12ddi_dispatch_graph_desc_0108) structure that describes the work graph.
