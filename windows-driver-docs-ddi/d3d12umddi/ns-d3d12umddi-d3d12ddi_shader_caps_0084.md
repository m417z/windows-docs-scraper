...
A [**D3D12DDI_WAVE_MMA_TIER**](https://learn.microsoft.com/windows-hardware/drivers/ddi/d3d12umddi/ne-d3d12umddi-d3d12ddi_wave_mma_tier) value that indicates the wave matrix-matrix multiply-accumulate (MMA) tier supported by the driver.
