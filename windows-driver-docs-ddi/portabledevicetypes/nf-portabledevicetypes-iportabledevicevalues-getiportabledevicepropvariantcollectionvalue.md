...
Address of a variable that receives a pointer to the retrieved [IPortableDevicePropVariantCollection](https://learn.microsoft.com/windows-hardware/drivers/ddi/portabledevicetypes/nn-portabledevicetypes-iportabledevicepropvariantcollection) interface. The caller is responsible for calling **Release** on the retrieved interface.
...
| **DISP_E_TYPEMISMATCH** | The property specified by *key* is not an **IPortableDevicePropVariantCollection** interface. |
...
[IPortableDeviceValues::SetIPortableDevicePropVariantCollectionValue](https://learn.microsoft.com/windows-hardware/drivers/ddi/portabledevicetypes/nf-portabledevicetypes-iportabledevicevalues-setiportabledevicepropvariantcollectionvalue)