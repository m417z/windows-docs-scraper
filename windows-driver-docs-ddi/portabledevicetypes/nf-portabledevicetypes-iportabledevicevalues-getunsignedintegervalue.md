...
| **DISP_E_TYPEMISMATCH** | The property specified by *key* is not a **ULONG** type. |
...
[IPortableDeviceValues::SetUnsignedIntegerValue](https://learn.microsoft.com/windows-hardware/drivers/ddi/portabledevicetypes/nf-portabledevicetypes-iportabledevicevalues-setunsignedintegervalue)