...
A buffer containing a [SIDEBANDAUDIO_ENDPOINT_DESCRIPTOR2](https://learn.microsoft.com/windows-hardware/drivers/ddi/sidebandaudio/ns-sidebandaudio-_sidebandaudio_endpoint_descriptor2) structure followed by any other data referenced by the structure. This is returned, if the output buffer size is sufficient and the request succeeds. In particular, the buffer includes storage for the string referenced by the *FriendlyName* field of the **SIDEBANDAUDIO_ENDPOINT_DESCRIPTOR2** structure.

### Output buffer length

The size of a **SIDEBANDAUDIO_ENDPOINT_DESCRIPTOR2** structure and referenced data.
...
**Note** This can be larger than the size of the **SIDEBANDAUDIO_ENDPOINT_DESCRIPTOR2** structure, as the output buffer may contain other data referenced by the structure
...
[SIDEBANDAUDIO_ENDPOINT_DESCRIPTOR2](https://learn.microsoft.com/windows-hardware/drivers/ddi/sidebandaudio/ns-sidebandaudio-_sidebandaudio_endpoint_descriptor2)
