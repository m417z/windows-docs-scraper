...
A [DEVPROPERTY structure](https://learn.microsoft.com/previous-versions/windows/hardware/drivers/dn315030(v=vs.85)) that defines custom device properties that are added to the audio device's interface.
