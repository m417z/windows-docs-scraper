...
This message provides a way to determine which device is preferred for audio functions in general, in contrast to the [**DRVM\_MAPPER\_CONSOLEVOICECOM\_GET**](https://learn.microsoft.com/windows-hardware/drivers/audio/drvm-mapper-consolevoicecom-get) message, which determines which device is preferred specifically for voice communications.
...
[**Accessing the Preferred Device ID**](https://learn.microsoft.com/windows-hardware/drivers/audio/accessing-the-preferred-device-id)

[**DRVM\_MAPPER\_CONSOLEVOICECOM\_GET**](https://learn.microsoft.com/windows-hardware/drivers/audio/drvm-mapper-consolevoicecom-get)
