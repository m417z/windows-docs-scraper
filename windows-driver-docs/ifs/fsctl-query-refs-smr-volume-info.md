...
- **lpOutBuffer** [out]: A pointer to a buffer that receives a [**REFS_SMR_VOLUME_INFO_OUTPUT**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/ns-ntifs-_refs_smr_volume_info_output) structure which specifies a volume's current state on space and garbage collection activities.
...
[**REFS_SMR_VOLUME_INFO_OUTPUT**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/ns-ntifs-_refs_smr_volume_info_output)

[**REFS_SMR_VOLUME_GC_STATE**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/ne-ntifs-_refs_smr_volume_gc_state)