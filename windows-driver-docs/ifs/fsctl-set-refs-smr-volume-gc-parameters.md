...
- **lpInBuffer** [in]: A pointer to a caller-allocated [**REFS_SMR_VOLUME_GC_PARAMETERS**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/ns-ntifs-_refs_smr_volume_gc_parameters) structure.
