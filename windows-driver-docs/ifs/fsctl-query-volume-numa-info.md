...
- **lpOutBuffer** [out]: A pointer to a buffer that receives a [**FSCTL_QUERY_VOLUME_NUMA_INFO_OUTPUT**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/ns-ntifs-_fsctl_query_volume_numa_info_output) structure which specifies a Non Uniform Memory Architecture (NUMA) volume's current node.
...
[**FSCTL_QUERY_VOLUME_NUMA_INFO_OUTPUT**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ntifs/ns-ntifs-_fsctl_query_volume_numa_info_output)