...
The ACPI_ENUM_CHILD_LENGTH_FROM_CHILD macro calculates the size, in bytes, of a variable-length [**ACPI_ENUM_CHILD**](https://learn.microsoft.com/windows-hardware/drivers/ddi/acpiioct/ns-acpiioct-_acpi_enum_child) structure.
...
A driver can use this macro to calculate the size, in bytes, of the **ACPI_ENUM_CHILD** structures in an [**ACPI_ENUM_CHILDREN_OUTPUT_BUFFER**](https://learn.microsoft.com/windows-hardware/drivers/ddi/acpiioct/ns-acpiioct-_acpi_enum_children_output_buffer) structure.
