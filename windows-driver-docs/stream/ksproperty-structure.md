...
The [**KSEVENT**](https://learn.microsoft.com/windows-hardware/drivers/stream/ksevent-structure), [**KSMETHOD**](https://learn.microsoft.com/windows-hardware/drivers/stream/ksmethod-structure), and **KSPROPERTY** structures are aliases for the [**KSIDENTIFIER**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ks/ns-ks-ksidentifier) structure. As such, their definitions are identical.
...
Specifies the request type. If you are writing a stream class minidriver, also see [**KSPROPERTY_ITEM**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ks/ns-ks-ksproperty_item) for class-specific flag information.
