...
The **KSPIN_MEDIUM** structure is an alias for the [**KSIDENTIFIER**](https://learn.microsoft.com/windows-hardware/drivers/ddi/ks/ns-ks-ksidentifier) structure. As such, their definitions are identical.
...
[**KSPROPERTY_PIN_MEDIUMS**](https://learn.microsoft.com/windows-hardware/drivers/stream/ksproperty-pin-mediums)
