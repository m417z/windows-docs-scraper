...
The **NdisQueryMdlOffset** macro provides an MDL-based version of the [**NdisQueryBufferOffset**](https://learn.microsoft.com/previous-versions/windows/hardware/network/ff554411(v=vs.85)) function.
...
[**NdisQueryBufferOffset**](https://learn.microsoft.com/previous-versions/windows/hardware/network/ff554411(v=vs.85))