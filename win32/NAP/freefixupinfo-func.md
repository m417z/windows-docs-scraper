...
The **FreeFixupInfo** function frees a [**FixupInfo**](https://learn.microsoft.com/windows/win32/api/naptypes/ns-naptypes-fixupinfo) data structure.

## Parameters

*fixupInfo* \[in\]

A pointer to the [**FixupInfo**](https://learn.microsoft.com/windows/win32/api/naptypes/ns-naptypes-fixupinfo) data structure to free.
...
[**AllocFixupInfo**](https://learn.microsoft.com/windows/win32/nap/allocfixupinfo-func)
