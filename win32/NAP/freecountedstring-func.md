...
The **FreeCountedString** function frees a [**CountedString**](https://learn.microsoft.com/windows/win32/api/naptypes/ns-naptypes-countedstring) data structure.

## Parameters

*countedString* \[in\]

A pointer to the [**CountedString**](https://learn.microsoft.com/windows/win32/api/naptypes/ns-naptypes-countedstring) data structure to free.
...
[**AllocCountedString**](https://learn.microsoft.com/windows/win32/nap/alloccountedstring-func)
