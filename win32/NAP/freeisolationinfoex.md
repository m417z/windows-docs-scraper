...
The **FreeIsolationInfoEx** function frees an [**IsolationInfoEx**](https://learn.microsoft.com/windows/win32/api/naptypes/ns-naptypes-isolationinfoex) data structure.

## Parameters

*isolationInfo* \[in\]

A pointer to the [**IsolationInfoEx**](https://learn.microsoft.com/windows/win32/api/naptypes/ns-naptypes-isolationinfoex) data structure to free.
