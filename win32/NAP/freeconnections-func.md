...
The **FreeConnections** function frees a [**Connections**](https://learn.microsoft.com/windows/win32/nap/connections-struct) data structure.

## Parameters

*connections* \[in\]

A pointer to the [**Connections**](https://learn.microsoft.com/windows/win32/nap/connections-struct) structure to free.
...
[**AllocConnections**](https://learn.microsoft.com/windows/win32/nap/allocconnections-func)
