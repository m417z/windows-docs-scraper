...
The **FreeIsolationInfo** function frees an [**IsolationInfo**](https://learn.microsoft.com/windows/win32/api/naptypes/ns-naptypes-isolationinfo) data structure.

## Parameters

*isolationInfo* \[in\]

A pointer to the [**IsolationInfo**](https://learn.microsoft.com/windows/win32/api/naptypes/ns-naptypes-isolationinfo) data structure to free.
