...
The **FreeSoHAttributeValue** function frees an [**SoHAttributeValue**](https://learn.microsoft.com/windows/win32/nap/sohattributevalue-union) data structure.

## Parameters

*type* \[in\]

A [**SoHAttributeType**](https://learn.microsoft.com/windows/win32/nap/sohattributetype-enum) value that specifies the type of SoH attribute value to free.

*value* \[in\]

A pointer to the [**SoHAttributeValue**](https://learn.microsoft.com/windows/win32/nap/sohattributevalue-union) to free.
