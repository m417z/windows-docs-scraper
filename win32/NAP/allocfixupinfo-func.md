...
The **AllocFixupInfo** function allocates memory for a [**FixupInfo**](https://learn.microsoft.com/windows/win32/api/naptypes/ns-naptypes-fixupinfo) structure of the specified size.

## Parameters

*fixupInfo* \[in, out\]

A pointer to the address of a newly allocated [**FixupInfo**](https://learn.microsoft.com/windows/win32/api/naptypes/ns-naptypes-fixupinfo) structure.
...
[**FreeFixupInfo**](https://learn.microsoft.com/windows/win32/nap/freefixupinfo-func)
