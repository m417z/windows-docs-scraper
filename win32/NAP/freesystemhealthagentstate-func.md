...
The **FreeSystemHealthAgentState** function frees a [**SystemHealthAgentState**](https://learn.microsoft.com/windows/win32/api/naptypes/ns-naptypes-systemhealthagentstate) data structure.

## Parameters

*state* \[in\]

A pointer to the [**SystemHealthAgentState**](https://learn.microsoft.com/windows/win32/api/naptypes/ns-naptypes-systemhealthagentstate) data structure to free.
