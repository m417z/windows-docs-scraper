...
The **FreeNetworkSoH** function frees a [**NetworkSoH**](https://learn.microsoft.com/windows/win32/api/naptypes/ns-naptypes-networksoh) data structure.

## Parameters

*networkSoh* \[in\]

A pointer to the [**NetworkSoH**](https://learn.microsoft.com/windows/win32/api/naptypes/ns-naptypes-networksoh) data structure to free.
