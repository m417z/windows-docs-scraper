...
The **FreeRepairInfos** function deallocates the memory allocated internally to an array of [**RepairInfo**](https://learn.microsoft.com/windows/win32/api/ndattrib/ns-ndattrib-repairinfo) structures. This function calls [**CoTaskMemFree**](https://learn.microsoft.com/windows/desktop/api/combaseapi/nf-combaseapi-cotaskmemfree) to deallocate memory.
