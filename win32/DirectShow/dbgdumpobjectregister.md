...
In debug builds, the debug library maintains a list of active objects. The list includes any objects that derive from [**CBaseObject**](https://learn.microsoft.com/windows/win32/directshow/cbaseobject), were created by the current module, and have not been destroyed. The **CBaseObject** constructor and destructor methods update the list.
