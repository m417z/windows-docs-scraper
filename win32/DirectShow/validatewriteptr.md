...
Verifies that the calling process has write access to a memory block. If not, the macro calls the [**DbgBreak**](https://learn.microsoft.com/windows/win32/directshow/dbgbreak) macro.
