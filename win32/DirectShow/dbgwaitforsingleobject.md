...
In a debug build, this function triggers an assert if the time-out interval expires before the object is signaled. To set the time-out interval, call the [**DbgSetWaitTimeout**](https://learn.microsoft.com/windows/win32/directshow/dbgsetwaittimeout) function.
