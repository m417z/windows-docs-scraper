...
When the [**CBaseObject**](https://learn.microsoft.com/windows/win32/directshow/cbaseobject) destructor destroys the object that loaded OleAut32.dll, it will unload the library if it is still loaded.
