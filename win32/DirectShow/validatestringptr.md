...
Verifies that the calling process has read access to a string. If not, the macro calls the [**DbgBreak**](https://learn.microsoft.com/windows/win32/directshow/dbgbreak) macro.
