...
The `CheckVideoInfoType` function checks a media type that contains a [**VIDEOINFOHEADER**](https://learn.microsoft.com/previous-versions/windows/desktop/api/amvideo/ns-amvideo-videoinfoheader) format structure for certain common errors that can cause buffer overruns or integer overflows.
