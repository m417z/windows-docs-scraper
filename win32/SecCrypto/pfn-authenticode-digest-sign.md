...
The **PFN\_AUTHENTICODE\_DIGEST\_SIGN** user supplied callback function implements digest signing. You must implement this function as part of your provided dll. This function is currently called by [**SignerSignEx3**](https://learn.microsoft.com/windows/win32/seccrypto/signersignex3) for digest signing.

## Parameters

*pSigningCert* \[in\]

A pointer to a [**CERT\_CONTEXT**](https://learn.microsoft.com/windows/desktop/api/Wincrypt/ns-wincrypt-cert_context) structure that specifies the certificate used to create the digital signature.
