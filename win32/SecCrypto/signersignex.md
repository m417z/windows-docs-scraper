...
| **SPC\_INC\_PE\_PAGE\_HASHES\_FLAG**<br>0x100 | Include page hashes when creating SIP indirect data for the PE file.<br> **Windows Server 2003 and Windows XP:** This value is not supported.<br> |
