...
The **PFN_AUTHENTICODE_DIGEST_SIGN_EX** user supplied callback function implements digest signing. You must implement this function as part of your provided dll. This function is currently called by [**SignerSignEx3**](https://learn.microsoft.com/windows/win32/seccrypto/signersignex3) for digest signing.
