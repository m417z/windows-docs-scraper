...
The **FreePrinterNotifyInfo** function frees a system-allocated buffer created by the [**FindNextPrinterChangeNotification**](https://learn.microsoft.com/windows/win32/printdocs/findnextprinterchangenotification) function.

## Parameters

*pPrinterNotifyInfo* \[in\]

Pointer to a [**PRINTER\_NOTIFY\_INFO**](https://learn.microsoft.com/windows/win32/printdocs/printer-notify-info) buffer returned from a call to the [**FindNextPrinterChangeNotification**](https://learn.microsoft.com/windows/win32/printdocs/findnextprinterchangenotification) function. **FreePrinterNotifyInfo** deallocates this buffer.
