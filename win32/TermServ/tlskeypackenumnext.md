...
Continues from a previous call to the [**TLSKeyPackEnumBegin**](https://learn.microsoft.com/windows/win32/termserv/tlskeypackenumbegin) function and returns the next key pack that is installed on a Remote Desktop license server that matches the search criteria.
...
Pointer to a [**LSKeyPack**](https://learn.microsoft.com/windows/win32/termserv/lskeypack) structure that receives the next key pack that matches the search criteria.
...
The calling sequence was not valid. Must call the [**TLSKeyPackEnumBegin()**](https://learn.microsoft.com/windows/win32/termserv/tlskeypackenumbegin) function before this.
