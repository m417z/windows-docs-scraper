...
Continues from a previous call to the [**TLSKeyPackEnumBegin**](https://learn.microsoft.com/windows/win32/termserv/tlskeypackenumbegin) function and terminates the enumeration.
