...
1. Call [**WinHttpConnectionDeletePolicyEntries**](https://learn.microsoft.com/windows/win32/winhttp/winhttpconnectiondeletepolicyentries) to clear stale entries.
