...
Address of a pointer to the asynchronous-data loader (see [**ID3DX11DataLoader Interface**](https://learn.microsoft.com/windows/win32/direct3d11/id3dx11dataloader)).
