...
> [!Note]
> Instead of using this function, we recommend that you compile offline by using the Fxc.exe command-line compiler or use one of the HLSL compile APIs, like the [**D3DCompileFromFile**](https://learn.microsoft.com/windows/desktop/direct3dhlsl/d3dcompilefromfile) API.
...
For more information about **D3DX11CompileFromFile**, see [**D3DCompile**](https://learn.microsoft.com/windows/desktop/direct3dhlsl/d3dcompile).
