...
Contains the response to a [**D3DAUTHENTICATEDQUERY\_RESTRICTEDSHAREDRESOURCEPROCESSCOUNT**](https://learn.microsoft.com/windows/win32/medfound/d3dauthenticatedquery-restrictedsharedresourceprocesscount) query.
