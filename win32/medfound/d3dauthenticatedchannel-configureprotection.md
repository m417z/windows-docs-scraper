...
Contains input data for a [**D3DAUTHENTICATEDCONFIGURE\_PROTECTION**](https://learn.microsoft.com/windows/win32/medfound/d3dauthenticatedconfigure-protection) command.
