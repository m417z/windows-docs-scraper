...
Contains input data for a [**D3DAUTHENTICATEDQUERY\_OUTPUTIDCOUNT**](https://learn.microsoft.com/windows/win32/medfound/d3dauthenticatedquery-outputidcount) query.
