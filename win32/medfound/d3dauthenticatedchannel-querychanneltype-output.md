...
Contains the response to a [**D3DAUTHENTICATEDQUERY\_CHANNELTYPE**](https://learn.microsoft.com/windows/win32/medfound/d3dauthenticatedquery-channeltype) query.
...
A [**D3DAUTHENTICATEDCHANNELTYPE**](https://learn.microsoft.com/windows/win32/medfound/d3dauthenticatedchanneltype) value that specifies the channel type.
