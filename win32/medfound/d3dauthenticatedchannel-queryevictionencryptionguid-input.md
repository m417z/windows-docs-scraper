...
Contains input data for a [**D3DAUTHENTICATEDQUERY\_ENCRYPTIONWHENACCESSIBLEGUID**](https://learn.microsoft.com/windows/win32/medfound/d3dauthenticatedquery-encryptionwhenaccessibleguid) query.
