...
Contains the response to a [**D3DAUTHENTICATEDQUERY\_DEVICEHANDLE**](https://learn.microsoft.com/windows/win32/medfound/d3dauthenticatedquery-devicehandle) query.
