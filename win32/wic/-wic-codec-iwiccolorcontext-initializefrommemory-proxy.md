...
Proxy function for the [**InitializeFromMemory**](https://learn.microsoft.com/windows/desktop/api/Wincodec/nf-wincodec-iwiccolorcontext-initializefrommemory) method.
