...
Proxy function for the [**CreateFastMetadataEncoderFromFrameDecode**](https://learn.microsoft.com/windows/desktop/api/Wincodec/nf-wincodec-iwicimagingfactory-createfastmetadataencoderfromframedecode) method.
...
A pointer that receives a pointer to a new [**IWICFastMetadataEncoder**](https://learn.microsoft.com/windows/desktop/api/Wincodec/nn-wincodec-iwicfastmetadataencoder).
