...
A pointer to a [DLP_POSTOP_STATUS](https://learn.microsoft.com/windows/win32/lwef/enpointdlp-dlp_postop_status) structure containing status information about the print operation.
