...
Pointer to a [**D3DXVECTOR2**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvector2) structure that is made up of the largest components of the two vectors.
...
[**D3DXVec2Minimize**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvec2minimize)
