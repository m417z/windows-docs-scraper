...
This function returns a pointer to a [**D3DXCOLOR**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxcolor) structure that is the difference between two color values.
...
[**D3DXColorAdd**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxcoloradd)
