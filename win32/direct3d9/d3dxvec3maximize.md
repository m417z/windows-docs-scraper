...
Pointer to a [**D3DXVECTOR3**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvector3) structure that is made up of the largest components of the two vectors.
...
[**D3DXVec3Minimize**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvec3minimize)
