...
Pointer to a [**D3DXVECTOR4**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvector4) structure that is the transformed array.

## Remarks

This function transforms the array *pV* (x, y, 0, 1) by the matrix *pM*.

The return value for this function is the same value returned in the *pOut* parameter. In this way, the [**D3DXVec2Transform**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvec2transform) function can be used as a parameter for another function.
...
[**D3DXVec2TransformCoord**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvec2transformcoord)

[**D3DXVec2TransformNormal**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvec2transformnormal)
