...
Evaluates a [directional light](https://learn.microsoft.com/windows/win32/direct3d9/light-types) and returns spectral spherical harmonic (SH) data.
...
On the sphere with unit radius, as shown in the following illustration, direction can be specified simply with theta, the angle about the z-axis in the [right-handed direction](https://learn.microsoft.com/windows/win32/direct3d9/coordinate-systems), and phi, the angle from z.

![illustration of a sphere with unit radius](https://learn.microsoft.com/windows/win32/direct3d9/images/spherical-coordinates.png)
...
![equations of the relationship between cartesian and spherical coordinates](https://learn.microsoft.com/windows/win32/direct3d9/images/spherical-coordinates-equations.png)
