...
Pointer to a [**D3DXVECTOR2**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvector2) structure that is the difference of two vectors.
...
[**D3DXVec2Add**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvec2add)
