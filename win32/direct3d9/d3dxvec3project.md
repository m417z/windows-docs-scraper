...
Pointer to a [**D3DXVECTOR3**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvector3) structure that is the vector projected from object space to screen space.
...
[**D3DXVec3Unproject**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvec3unproject)
