...
Pointer to a [**D3DXMATRIX**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxmatrix) structure that is the inverse of the matrix. If matrix inversion fails, **NULL** is returned.
