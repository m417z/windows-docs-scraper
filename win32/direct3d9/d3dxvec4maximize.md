...
Pointer to a [**D3DXVECTOR4**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvector4) structure that is made up of the largest components of the two vectors.
...
[**D3DXVec4Minimize**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvec4minimize)
