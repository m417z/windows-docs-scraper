...
This function returns a pointer to a [**D3DXVECTOR3**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvector3) structure that identifies the quaternion's axis of rotation.
