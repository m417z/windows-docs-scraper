...
Calculate per-triangle IMT's from per-texel data. This function is similar to [**D3DXComputeIMTFromTexture**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxcomputeimtfromtexture), but it uses a float array to pass in the data, and it can calculate higher dimensional values than 4.
