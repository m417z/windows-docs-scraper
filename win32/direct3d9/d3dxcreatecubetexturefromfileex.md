...
Creates a cube texture from a file. This is a more advanced function than [**D3DXCreateCubeTextureFromFile**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxcreatecubetexturefromfile).
...
A combination of one or more [D3DX\_FILTER](https://learn.microsoft.com/windows/win32/direct3d9/d3dx-filter) constants, controlling how the image is filtered. Specifying D3DX\_DEFAULT for this parameter is the equivalent of specifying D3DX\_FILTER\_TRIANGLE \| D3DX\_FILTER\_DITHER.
...
[**D3DXCreateCubeTextureFromFile**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxcreatecubetexturefromfile)
