...
The [**D3DXMatrixOrthoLH**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxmatrixortholh) function is a special case of the **D3DXMatrixOrthoOffCenterLH** function. To create the same projection using **D3DXMatrixOrthoOffCenterLH**, use the following values: l = -w/2, r = w/2, b = -h/2, and t = h/2.
