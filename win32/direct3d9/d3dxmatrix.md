...
C programmers cannot use the D3DXMATRIX structure, they must use the [**D3DMATRIX**](https://learn.microsoft.com/windows/win32/direct3d9/d3dmatrix) structure. C++ programmers can take advantage of overloaded constructors and assignment, unary, and binary (including equality) operators.
...
[**D3DMATRIX**](https://learn.microsoft.com/windows/win32/direct3d9/d3dmatrix)
