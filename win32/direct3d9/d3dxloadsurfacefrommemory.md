...
Member of the [D3DFORMAT](https://learn.microsoft.com/windows/win32/direct3d9/d3dformat) enumerated type, the pixel format of the source image.
...
Pointer to a [**RECT**](https://learn.microsoft.com/windows/win32/api/windef/ns-windef-rect) structure. Specifies the dimensions of the source image in memory. This value cannot be **NULL**.
