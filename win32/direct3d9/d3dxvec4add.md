...
Pointer to a [**D3DXVECTOR4**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvector4) structure that is the sum of the two vectors.
...
[**D3DXVec4Scale**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvec4scale)
