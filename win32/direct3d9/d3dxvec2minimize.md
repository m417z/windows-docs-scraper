...
Pointer to a [**D3DXVECTOR2**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvector2) structure that is made up of the smallest components of the two vectors.
...
[**D3DXVec2Maximize**](https://learn.microsoft.com/windows/win32/direct3d9/d3dxvec2maximize)
