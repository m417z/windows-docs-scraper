...
The **MCI\_VCR\_SEEK\_PARMS** structure contains parameters for the [**MCI\_SEEK**](https://learn.microsoft.com/windows/win32/multimedia/mci-seek) command for video-cassette recorders.
