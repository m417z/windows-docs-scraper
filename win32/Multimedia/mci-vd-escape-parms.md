...
The **MCI\_VD\_ESCAPE\_PARMS** structure contains the command sent to a device for the [**MCI\_ESCAPE**](https://learn.microsoft.com/windows/win32/multimedia/mci-escape) command for videodisc devices.
...
[**MCI\_ESCAPE**](https://learn.microsoft.com/windows/win32/multimedia/mci-escape)
