...
The **MCI\_GETDEVCAPS\_PARMS** structure contains device-capability information for the [**MCI\_GETDEVCAPS**](https://learn.microsoft.com/windows/win32/multimedia/mci-getdevcaps) command.
...
Capability being queried. This member can be one of the constants listed in the reference material for the [**MCI\_GETDEVCAPS**](https://learn.microsoft.com/windows/win32/multimedia/mci-getdevcaps) command.
...
[**MCI\_GETDEVCAPS**](https://learn.microsoft.com/windows/win32/multimedia/mci-getdevcaps)
