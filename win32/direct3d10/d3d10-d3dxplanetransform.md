...
Pointer to the [**D3DXPLANE**](https://learn.microsoft.com/windows/win32/direct3d10/d3d10-d3dxplane) that contains the resulting transformed plane. See example.
...
Pointer to the source [**D3DXMATRIX**](https://learn.microsoft.com/windows/win32/direct3d10/d3d10-d3dxmatrix) structure, which contains the transformation values. This matrix must contain the inverse transpose of the transformation values.
