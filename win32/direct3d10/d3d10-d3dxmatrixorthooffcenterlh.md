...
The [**D3DXMatrixOrthoLH**](https://learn.microsoft.com/windows/win32/direct3d10/d3d10-d3dxmatrixortholh) is a special case of the D3DXMatrixOrthoOffCenterLH function. To create the same projection using D3DXMatrixOrthoOffCenterLH, use the following values:
