...
> [!Note]
> Ln is the API method [**D3DXQuaternionLn**](https://learn.microsoft.com/windows/win32/direct3d10/d3d10-d3dxquaternionln) and Exp is the API method [**D3DXQuaternionExp**](https://learn.microsoft.com/windows/win32/direct3d10/d3d10-d3dxquaternionexp).
