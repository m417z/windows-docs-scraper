...
A pointer to the devive (see [**ID3D10Device Interface**](https://learn.microsoft.com/windows/desktop/api/D3D10/nn-d3d10-id3d10device)).
...
This API does creates a data-processor interface and loads the texture; [**D3DX10CreateAsyncTextureInfoProcessor**](https://learn.microsoft.com/windows/win32/direct3d10/d3dx10createasynctextureinfoprocessor) creates the data-processor interface.
