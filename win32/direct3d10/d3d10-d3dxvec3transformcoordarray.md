...
The return value for this function is the same value returned in the pOut parameter. In this way, the [**D3DXVec3TransformCoord**](https://learn.microsoft.com/windows/win32/direct3d10/d3d10-d3dxvec3transformcoord) function can be used as a parameter for another function.
