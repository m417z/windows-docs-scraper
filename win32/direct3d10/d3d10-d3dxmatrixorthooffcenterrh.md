...
The [**D3DXMatrixOrthoRH**](https://learn.microsoft.com/windows/win32/direct3d10/d3d10-d3dxmatrixorthorh) function is a special case of the D3DXMatrixOrthoOffCenterRH function. To create the same projection using D3DXMatrixOrthoOffCenterRH, use the following values:
