...
The [**D3DXQuaternionSquadSetup**](https://learn.microsoft.com/windows/win32/direct3d10/d3d10-d3dxquaternionsquadsetup) method can also be used to set up the control points of a quaternion.
