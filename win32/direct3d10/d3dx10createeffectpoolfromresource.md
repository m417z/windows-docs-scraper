...
A handle to the resource module containing the effect. HMODULE can be obtained with [GetModuleHandle Function](https://learn.microsoft.com/windows/win32/api/libloaderapi/nf-libloaderapi-getmodulehandlea).
