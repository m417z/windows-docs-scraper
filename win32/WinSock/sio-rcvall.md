...
The socket handle passed to the [**WSAIoctl**](https://learn.microsoft.com/windows/desktop/api/winsock2/nf-winsock2-wsaioctl) or **WSPIoctl** function must be one of the following:
...
For more information on raw sockets, see [**TCP/IP Raw Sockets**](https://learn.microsoft.com/windows/desktop/winsock/tcp-ip-raw-sockets-2).
...
Once the socket is bound and the IOCTL completes successfully, calls to the [**WSARecv**](https://learn.microsoft.com/windows/desktop/api/winsock2/nf-winsock2-wsarecv) or [**recv**](https://learn.microsoft.com/windows/desktop/api/winsock/nf-winsock-recv) functions return IPv4 datagrams passing through the given IPv4 interface or return IPv6 datagrams passing through the given IPv6 interface.
