...
The [**SIO_QUERY_WFP_CONNECTION_REDIRECT_RECORDS**](https://learn.microsoft.com/windows/win32/winsock/sio-query-wfp-connection-redirect-records) IOCTL is used by a WFP-based redirect service to retrieve the redirect record from the accepted TCP/IP packet connection (the connected socket for a TCP socket or a UDP socket, for example) redirected to it by its companion kernel-mode callout registered at **ALE\_CONNECT\_REDIRECT** layers in a kernel-mode driver.
The [**SIO_QUERY_WFP_CONNECTION_REDIRECT_CONTEXT**](https://learn.microsoft.com/windows/win32/winsock/sio-query-wfp-connection-redirect-context) IOCTL retrieves the redirect context for a redirect record, which is used.
...
[**SIO_QUERY_WFP_CONNECTION_REDIRECT_RECORDS**](https://learn.microsoft.com/windows/win32/winsock/sio-query-wfp-connection-redirect-records)
