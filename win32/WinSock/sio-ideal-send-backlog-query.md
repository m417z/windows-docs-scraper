...
On Windows Server 2008, Windows Vista with SP1, and later versions of the operating system, the [**SIO\_IDEAL\_SEND\_BACKLOG\_CHANGE**](https://learn.microsoft.com/windows/win32/winsock/sio-ideal-send-backlog-change) and **SIO\_IDEAL\_SEND\_BACKLOG\_QUERY** IOCTLs are supported on stream-oriented sockets that are in a connected state.

The range for the ISB value for a TCP connection can theoretically vary from 0 to a maximum of 16 megabytes.

The typical usage of the [**SIO\_IDEAL\_SEND\_BACKLOG\_CHANGE**](https://learn.microsoft.com/windows/win32/winsock/sio-ideal-send-backlog-change) and **SIO\_IDEAL\_SEND\_BACKLOG\_QUERY** IOCTLs is based on the send method used by the applications.
...
Otherwise the [**WSAIoctl**](https://learn.microsoft.com/windows/desktop/api/winsock2/nf-winsock2-wsaioctl) or **WSPIoctl** function will fail with **WSAENOTCONN**.
...
It is recommended that these inline functions be used instead of using the [**SIO\_IDEAL\_SEND\_BACKLOG\_CHANGE**](https://learn.microsoft.com/windows/win32/winsock/sio-ideal-send-backlog-change) and **SIO\_IDEAL\_SEND\_BACKLOG\_QUERY** IOCTLs directly.

The inline wrapper function for the [**SIO\_IDEAL\_SEND\_BACKLOG\_CHANGE**](https://learn.microsoft.com/windows/win32/winsock/sio-ideal-send-backlog-change) IOCTL is the **idealsendbacklognotify** function.
...
With dynamic send buffering on Windows 7 and Windows Server 2008 R2, the use of the [**SIO\_IDEAL\_SEND\_BACKLOG\_CHANGE**](https://learn.microsoft.com/windows/win32/winsock/sio-ideal-send-backlog-change) and **SIO\_IDEAL\_SEND\_BACKLOG\_QUERY** IOCTLs are needed only in special circumstances.

## See also

[**SIO_IDEAL_SEND_BACKLOG_CHANGE**](https://learn.microsoft.com/windows/win32/winsock/sio-ideal-send-backlog-change)
