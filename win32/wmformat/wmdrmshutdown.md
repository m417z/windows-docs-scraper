...
To avoid memory leaks, you must call this function for every call of the [**WMDRMStartup**](https://learn.microsoft.com/windows/win32/wmformat/wmdrmstartup) function.
