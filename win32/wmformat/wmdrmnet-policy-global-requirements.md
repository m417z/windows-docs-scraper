...
[**WMDRMNET\_POLICY\_MINIMUM\_ENVIRONMENT**](https://learn.microsoft.com/windows/win32/wmformat/wmdrmnet-policy-minimum-environment) structure containing the minimum security requirements for Windows Media DRM for Network Devices.
