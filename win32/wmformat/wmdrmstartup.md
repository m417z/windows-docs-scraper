...
For every call of this function, you must call [**WMDRMShutdown**](https://learn.microsoft.com/windows/win32/wmformat/wmdrmshutdown) to release the resources used.
