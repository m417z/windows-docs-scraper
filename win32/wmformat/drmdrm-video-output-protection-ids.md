...
Address of an array of **DRM\_VIDEO\_OUTPUT\_PROTECTION** structures. **DRM\_VIDEO\_OUTPUT\_PROTECTION** is a type defined as [**DRM\_OUTPUT\_PROTECTION**](https://learn.microsoft.com/windows/win32/wmformat/drm-output-protection).
