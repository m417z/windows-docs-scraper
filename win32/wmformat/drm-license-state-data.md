...
The **DRM\_LICENSE\_STATE\_DATA** structure contains [*license*](https://learn.microsoft.com/windows/win32/wmformat/wmformat-glossary) information about a specified [*DRM*](https://learn.microsoft.com/windows/win32/wmformat/wmformat-glossary) right.
...
Category of string to be displayed. See [**DRM\_LICENSE\_STATE\_CATEGORY**](https://learn.microsoft.com/windows/win32/wmformat/drm-license-state-category) for possible values and their meaning.
...
This structure is returned (encapsulated in a [**WM\_LICENSE\_STATE\_DATA**](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/dd757942(v=vs.85)) structure) from a call to [**IWMDRMReader::GetDRMProperty**](https://learn.microsoft.com/previous-versions/windows/desktop/api/Wmsdkidl/nf-wmsdkidl-iwmdrmreader-getdrmproperty) when you specify one of the DRM license state properties. These properties are:

- [**DRM\_LicenseState\_Playback**](https://learn.microsoft.com/windows/win32/wmformat/drm-licensestate-playback)
- [**DRM\_LicenseState\_CopyToCD**](https://learn.microsoft.com/windows/win32/wmformat/drm-licensestate-copytocd)
- [**DRM\_LicenseState\_CopyToSDMIDevice**](https://learn.microsoft.com/windows/win32/wmformat/drm-licensestate-copytosdmidevice)
- [**DRM\_LicenseState\_CopyToNonSDMIDevice**](https://learn.microsoft.com/windows/win32/wmformat/drm-licensestate-copytononsdmidevice)
- [**DRM\_LicenseState\_CollaborativePlay**](https://learn.microsoft.com/windows/win32/wmformat/drm-licensestate-collaborativeplay)
- [**DRM\_LicenseState\_Copy**](https://learn.microsoft.com/windows/win32/wmformat/drm-licensestate-copy)
- [**DRM\_LicenseState\_PlaylistBurn**](https://learn.microsoft.com/windows/win32/wmformat/drm-licensestate-playlistburn)
