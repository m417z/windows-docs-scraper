...
This structure is used as a member of the [**DRM\_COPY\_OPL**](https://learn.microsoft.com/windows/win32/wmformat/drmdrm-copy-opl) and [**DRM\_PLAY\_OPL**](https://learn.microsoft.com/windows/win32/wmformat/drmdrm-play-opl) structures to identify groups of output identifiers.
