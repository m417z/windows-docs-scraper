...
The **glGetPixelMapfv**, [**glGetPixelMapuiv**](https://learn.microsoft.com/windows/win32/opengl/glgetpixelmapuiv), and [**glGetPixelMapusv**](https://learn.microsoft.com/windows/win32/opengl/glgetpixelmapusv) functions return the specified pixel map.
