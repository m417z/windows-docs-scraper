...
| Each pixel is a single value, a color index. <br>
...
| Each pixel is a single value, a stencil index. <br>
...
| Each pixel is a single-depth component. <br>
...
| Each pixel is a four-component group in this order: red, green, blue, alpha. <br>
...
| Single bits in unsigned 8-bit integers<br> |
|
