...
The **glGetTexLevelParameterfv** and [**glGetTexLevelParameteriv**](https://learn.microsoft.com/windows/win32/opengl/glgettexlevelparameteriv) functions return texture parameter values for a specific level of detail.
