...
| **GL\_BGRA\_EXT** | Each pixel is a group of four components in this order: blue, green, red, alpha. GL\_BGRA\_EXT provides a format that matches the memory layout of Windows device-independent bitmaps (DIBs). Thus your applications can use the same data with Windows function calls and OpenGL pixel function calls.<br> |
