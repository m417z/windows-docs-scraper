...
The [**glGetColorTableParameterfvEXT**](https://learn.microsoft.com/windows/win32/opengl/glgetcolortableparameterfvext) and **glGetColorTableParameterivEXT** functions get palette parameters from color tables.
