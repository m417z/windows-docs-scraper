...
The **gluBeginCurve** and [**gluEndCurve**](https://learn.microsoft.com/windows/win32/opengl/gluendcurve) functions delimit a Non-Uniform Rational B-Spline ([NURBS](https://learn.microsoft.com/windows/win32/opengl/using-nurbs-curves-and-surfaces)) curve definition.
