...
The [**glMultMatrixd**](https://learn.microsoft.com/windows/win32/opengl/glmultmatrixd) and **glMultMatrixf** functions multiply the current matrix by an arbitrary matrix.
