...
The [**glLoadMatrixd**](https://learn.microsoft.com/windows/win32/opengl/glloadmatrixd) and **glLoadMatrixf** functions replace the current matrix with an arbitrary matrix.
