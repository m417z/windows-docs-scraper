...
The **glGetTexGendv**, [**glGetTexGenfv**](https://learn.microsoft.com/windows/win32/opengl/glgettexgenfv), and [**glGetTexGeniv**](https://learn.microsoft.com/windows/win32/opengl/glgettexgeniv) functions return texture coordinate generation parameters.
