...
The [**gluBeginSurface**](https://learn.microsoft.com/windows/win32/opengl/glubeginsurface) and **gluEndSurface** functions delimit a Non-Uniform Rational B-Spline ([NURBS](https://learn.microsoft.com/windows/win32/opengl/using-nurbs-curves-and-surfaces)) surface definition.
...
The [**gluBeginSurface**](https://learn.microsoft.com/windows/win32/opengl/glubeginsurface) and **gluEndSurface** functions mark the beginning and end of NURBS surface definitions, which are defined with calls to **gluNurbsSurface**.
...
The [**gluBeginTrim**](https://learn.microsoft.com/windows/win32/opengl/glubegintrim), [**gluPwlCurve**](https://learn.microsoft.com/windows/win32/opengl/glupwlcurve), [**gluNurbsCurve**](https://learn.microsoft.com/windows/win32/opengl/glunurbscurve), and **gluEndTrim** functions support trimming of NURBS surfaces.
