...
The mappings specified by **glMapGrid** are used identically by [glEvalMesh](https://learn.microsoft.com/windows/win32/opengl/glevalmesh-functions) and [**glEvalPoint**](https://learn.microsoft.com/windows/win32/opengl/glevalpoint).
