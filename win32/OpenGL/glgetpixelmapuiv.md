...
The [**glGetPixelMapfv**](https://learn.microsoft.com/windows/win32/opengl/glgetpixelmapfv), **glGetPixelMapuiv**, and [**glGetPixelMapusv**](https://learn.microsoft.com/windows/win32/opengl/glgetpixelmapusv) functions return the specified pixel map.
