...
The [**glGetTexParameterfv**](https://learn.microsoft.com/windows/win32/opengl/glgettexparameterfv) and **glGetTexParameteriv** functions return texture parameter values.
