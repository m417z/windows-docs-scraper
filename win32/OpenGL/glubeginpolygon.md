...
\[The **gluBeginPolygon** function is obsolete and is provided for backward compatibility only. The **gluBeginPolygon** function is mapped to [**gluTessBeginPolygon**](https://learn.microsoft.com/windows/win32/opengl/glutessbeginpolygon) followed by [**gluTessBeginContour**](https://learn.microsoft.com/windows/win32/opengl/glutessbegincontour).\]

The **gluBeginPolygon** and [**gluEndPolygon**](https://learn.microsoft.com/windows/win32/opengl/gluendpolygon) functions delimit a polygon description.
