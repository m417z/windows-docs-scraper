...
The **glNewList** and [**glEndList**](https://learn.microsoft.com/windows/win32/opengl/glendlist) functions create or replace a display list.
...
| Name | Meaning |
|-------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------|
| **GL\_INVALID\_VALUE** | *list* was zero.<br> |
...
[**glEndList**](https://learn.microsoft.com/windows/win32/opengl/glendlist)
