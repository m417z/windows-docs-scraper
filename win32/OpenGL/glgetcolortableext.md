...
| Value | Meaning |
|-------|---------|
| **GL_RGBA** | Each pixel is a group of four components in the following order: red, green, blue, alpha. The RGBA format is determined in this way: <br>
