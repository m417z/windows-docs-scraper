...
The material parameter of the face or faces being updated. The parameters that can be specified using [**glMaterialiv**](https://learn.microsoft.com/windows/win32/opengl/glmaterialfv), and their interpretations by the lighting equation, are as follows.
...
The material parameters can be updated at any time. In particular, [**glMaterialiv**](https://learn.microsoft.com/windows/win32/opengl/glmaterialf) can be called between a call to [**glBegin**](https://learn.microsoft.com/windows/win32/opengl/glbegin) and the corresponding call to [**glEnd**](https://learn.microsoft.com/windows/win32/opengl/glend). If only a single material parameter is to be changed per vertex, however, [**glColorMaterial**](https://learn.microsoft.com/windows/win32/opengl/glcolormaterial) is preferred over **glMaterialiv**.

The following function retrieves information related to [**glMaterialiv**](https://learn.microsoft.com/windows/win32/opengl/glmaterialf):
