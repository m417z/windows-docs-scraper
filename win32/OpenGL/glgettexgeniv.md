...
The [**glGetTexGendv**](https://learn.microsoft.com/windows/win32/opengl/glgettexgendv), [**glGetTexGenfv**](https://learn.microsoft.com/windows/win32/opengl/glgettexgenfv), and **glGetTexGeniv** functions return texture coordinate generation parameters.
