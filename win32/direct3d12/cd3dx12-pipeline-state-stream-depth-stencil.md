...
Implicit conversion to a [**CD3DX12\_DEPTH\_STENCIL\_DESC**](https://learn.microsoft.com/windows/win32/direct3d12/cd3dx12-depth-stencil-desc) structure.

## Remarks

CD3DX12\_PIPELINE\_STATE\_STREAM\_DEPTH\_STENCIL is a typedef specialization of the [**CD3DX12\_PIPELINE\_STATE\_STREAM\_SUBOBJECT**](https://learn.microsoft.com/windows/win32/direct3d12/cd3dx12-pipeline-state-stream-subobject) template, and is defined as follows:
