...
Creates a new instance of a CD3DX12\_PIPELINE\_STATE\_STREAM\_BLEND\_DESC, initialized with a subobject type of **D3D12\_PIPELINE\_STATE\_SUBOBJECT\_TYPE\_BLEND** and subobject data copied from *i*, a [**CD3DX12\_BLEND\_DESC**](https://learn.microsoft.com/windows/win32/direct3d12/cd3dx12-blend-desc) structure.
...
Implicit conversion to a [**CD3DX12\_BLEND\_DESC**](https://learn.microsoft.com/windows/win32/direct3d12/cd3dx12-blend-desc) structure.

## Remarks

CD3DX12\_PIPELINE\_STATE\_STREAM\_BLEND\_DESC is a typedef specialization of the [**CD3DX12\_PIPELINE\_STATE\_STREAM\_SUBOBJECT**](https://learn.microsoft.com/windows/win32/direct3d12/cd3dx12-pipeline-state-stream-subobject) template, and is defined as follows:
