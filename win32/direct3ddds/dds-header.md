...
Type: **[**DDS\_PIXELFORMAT**](https://learn.microsoft.com/windows/win32/direct3ddds/dds-pixelformat)**

The pixel format (see [**DDS\_PIXELFORMAT**](https://learn.microsoft.com/windows/win32/direct3ddds/dds-pixelformat)).
...
Use this structure in combination with a [**DDS\_HEADER\_DXT10**](https://learn.microsoft.com/windows/win32/direct3ddds/dds-header-dxt10) to store a resource array in a DDS file. For more information, see [texture arrays](https://learn.microsoft.com/windows/win32/direct3ddds/dx-graphics-dds-pguide).
