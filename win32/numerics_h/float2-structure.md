...
This type is available only in C++. Its .NET equivalent is [System.Numerics.Vector2](https://learn.microsoft.com/dotnet/api/system.numerics.vector2).
...
| `float2(Windows::Foundation::Point const& value)` | Converts a [**Windows.Foundation.Point**](https://learn.microsoft.com/uwp/api/Windows.Foundation.Point) to a float2. |
| `float2(Windows::Foundation::Size const& value)` | Converts a [**Windows.Foundation.Size**](https://learn.microsoft.com/uwp/api/Windows.Foundation.Size) to a float2. |
...
| Name | Description |
|-|-|
| `operator Windows::Foundation::Point() const` | Converts a float2 to a [**Windows.Foundation.Point**](https://learn.microsoft.com/uwp/api/Windows.Foundation.Point). |
| `operator Windows::Foundation::Size() const` | Converts a float2 to a [**Windows.Foundation.Size**](https://learn.microsoft.com/uwp/api/Windows.Foundation.Size). |
...
| Header | Windowsnumerics.h |

## See also

[windowsnumerics.h APIs](https://learn.microsoft.com/windows/win32/numerics_h/windowsnumerics-h-apis-portal)