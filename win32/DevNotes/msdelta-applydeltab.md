...
[in] A [DELTA_INPUT](https://learn.microsoft.com/previous-versions/bb417345(v=msdn.10)#delta-input-structure) structure containing a pointer to the buffer containing the delta data.
