...
0x00000001 | An MS-DOS style path.\ | | **HID\_DATABASE\_FULLPATH**

0x00000002 | A full path.\ | | **HID\_NO\_DATABASE**

0x00000004 | The *pszDatabasePath* parameter is ignored and no database is opened.\ | | **HID\_DATABASE\_TYPE\_MASK**

0xF00F0000 | This parameter specifies a predefined database. The *pszDatabasePath* parameter is ignored.\ | If *dwFlags* contains **HID\_DATA\_TYPE\_MASK**, this parameter can also include one of the following values. | Value | Meaning | |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------| | **SDB\_DATABASE\_MAIN\_SHIM**

0x80030000 | Application shim database.\ | | **SDB\_DATABASE\_MAIN\_MSI**

0x80020000 | MSI database.\ | | **SDB\_DATABASE\_MAIN\_DRIVERS**

0x80040000 | Database of drivers to be blocked.\ |
