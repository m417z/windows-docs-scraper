...
To cancel I/O operations from another thread, use the [**NtCancelIoFileEx**](https://learn.microsoft.com/windows/win32/devnotes/nt-cancel-io-file-ex) function.

> [!NOTE]
> This function is the user-mode equivalent to the [**CancelIo**](https://learn.microsoft.com/windows/win32/fileio/cancelio) Win32 function.
...
[**CancelIoEx**](https://learn.microsoft.com/windows/win32/devnotes/nt-cancel-io-file-ex)