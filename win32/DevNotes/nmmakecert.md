...
| Delete the old certificate without creating a new one. <br> |
|

**NMMKCERT\_F\_DELETEOLDCERT**

0x00000001

| Delete the old certificate previously created with this function. <br> |
|

**NMMKCERT\_F\_LOCAL\_MACHINE**

0x00000002

| Create the certificate in the local machine certificate store. <br> |
