...
Recevies a pointer to the enterprise ID if the data is enterprise. Otherwise the value will is NULL. Must be freed with [HeapFree](https://learn.microsoft.com/windows/win32/api/heapapi/nf-heapapi-heapfree).
