...
The information returned by this function relates to the data used by [SetClipboardData](https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-setclipboarddata) and [GetClipboardData](https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-getclipboarddata). For example if the clipboard contains image and text, dataInfo will contain “Image | Text”.
