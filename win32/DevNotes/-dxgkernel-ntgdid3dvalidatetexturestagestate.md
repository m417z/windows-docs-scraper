...
Pointer to a [**D3DNTHAL\_VALIDATETEXTURESTAGESTATEDATA**](https://learn.microsoft.com/windows-hardware/drivers/ddi/) structure that contains the information required for the driver to determine and return the number of passes required to perform the blending operations.
