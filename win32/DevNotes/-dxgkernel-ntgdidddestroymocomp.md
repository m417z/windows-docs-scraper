...
Handle to a [**DD\_MOTIONCOMP\_LOCAL**](https://learn.microsoft.com/windows/win32/api/ddrawint/ns-ddrawint-dd_motioncomp_local) structure that contains a description of the motion compensation object to be destroyed.

*puBeginFrameData* \[in, out\]

Pointer to a [**DD\_DESTROYMOCOMPDATA**](https://learn.microsoft.com/windows/win32/api/ddrawint/ns-ddrawint-dd_destroymocompdata) structure that contains the information needed to finish motion compensation.
