...
Handle to a [**DD\_MOTIONCOMP\_LOCAL**](https://learn.microsoft.com/windows/win32/api/ddrawint/ns-ddrawint-dd_motioncomp_local) structure that contains a description of the motion compensation being requested.

*puRenderMoCompData* \[in, out\]

Pointer to a [**DD\_RENDERMOCOMPDATA**](https://learn.microsoft.com/windows/win32/api/ddrawint/ns-ddrawint-dd_rendermocompdata) structure that contains the information needed to render a frame.

## Return value

**NtGdiDdRenderMoComp** returns one of the following callback codes.
