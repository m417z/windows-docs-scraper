...
| A 64-byte object identifier assigned by the link-tracking service.<br> |
|
...
| The value is contained in the file record and immediately follows the attribute record header.<br> |
|
...
| The value is contained in other sectors on the disk.<br> |
