...
In the presence of WIP policy, frees protector list returned by [QueryIdentityProtectors](https://learn.microsoft.com/windows/win32/devnotes/queryidentityprotectors-function).

## Parameters

### ProtectorsList

A [ENCRYPTION_PROTECTOR_LIST](https://learn.microsoft.com/windows/win32/devnotes/encryption_protector_list-structure) structure returned by **QueryIdentityProtectors**.
