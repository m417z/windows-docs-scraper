...
Pointer to a [**DD\_MOTIONCOMP\_LOCAL**](https://learn.microsoft.com/windows/win32/api/ddrawint/ns-ddrawint-dd_motioncomp_local) structure that contains a description of the motion compensation being requested.

*puQueryMoCompStatusData* \[in, out\]

Pointer to a [**DD\_QUERYMOCOMPSTATUSDATA**](https://learn.microsoft.com/windows/win32/api/ddrawint/ns-ddrawint-dd_querymocompstatusdata) structure that contains the information needed to query the status.
