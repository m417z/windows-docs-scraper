...
Pointer to a [**D3DNTHAL\_CONTEXTDESTROYDATA**](https://learn.microsoft.com/windows-hardware/drivers/ddi/) structure that contains the information required for the driver to destroy the context.
