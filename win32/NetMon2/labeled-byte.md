...
The **lpLabeledByteTable** member of the [SET](https://learn.microsoft.com/windows/win32/netmon2/set) structure points to an array of **SET** structures that define one or more **Label** members of the BYTE value pairs. These pairs are used when you want to display a label in place of a specific BYTE value that is found in the protocol packet.
