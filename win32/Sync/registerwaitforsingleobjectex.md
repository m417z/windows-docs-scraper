...
A pointer to the application-defined function of type **WAITORTIMERCALLBACK** to be executed when *hObject* is in the signaled state, or *dwMilliseconds* elapses. For more information, see [WaitOrTimerCallback](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/ms687066(v=vs.85)).
...
The
**RegisterWaitForSingleObjectEx** function can wait for the following objects:
