...
Options for [JetDupCursor(JET_SESID, JET_TABLEID, JET_TABLEID, DupCursorGrbit)](https://learn.microsoft.com/windows/win32/extensible-storage-engine/api.jetdupcursor-method).
