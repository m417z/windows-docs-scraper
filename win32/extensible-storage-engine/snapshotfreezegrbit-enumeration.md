...
Options for [JetOSSnapshotFreeze(JET_OSSNAPID, Int32, \[\], SnapshotFreezeGrbit)](https://learn.microsoft.com/windows/win32/extensible-storage-engine/api.jetossnapshotfreeze-method).
