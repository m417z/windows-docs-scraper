...
The folder where the backup is located. The backup should have been generated using the [JetBackup](https://learn.microsoft.com/windows/win32/extensible-storage-engine/jetbackup-function) function.
...
**JetRestore** functions must be called on an instance before [JetInit](https://learn.microsoft.com/windows/win32/extensible-storage-engine/jetinit-function) is called for that instance.
