...
Pointer to the new scaling size structure ([AMVPSIZE](https://learn.microsoft.com/previous-versions/windows/desktop/api/vptype/ns-vptype-amvpsize)) to use to specify the width and height.
