...
Type: **[D3D12_SHADER_BUFFER_DESC](https://learn.microsoft.com/windows/desktop/api/d3d12shader/ns-d3d12shader-d3d12_shader_buffer_desc)***

A shader-buffer description, as a pointer to a [D3D12_SHADER_BUFFER_DESC](https://learn.microsoft.com/windows/desktop/api/d3d12shader/ns-d3d12shader-d3d12_shader_buffer_desc) structure.
