...
| --- | --- |
| **S_OK** | Success. |
| **VFW_E_NOT_CONNECTED** | The parse time is not available, because the input pin is not connected |
...
[IAMParse Interface](https://learn.microsoft.com/windows/desktop/api/amparse/nn-amparse-iamparse)