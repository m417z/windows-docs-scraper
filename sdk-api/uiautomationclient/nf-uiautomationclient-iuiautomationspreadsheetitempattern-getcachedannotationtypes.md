...
Receives the cached array of annotation type identifiers. For a list of possible values, see [Annotation Type Identifiers](https://learn.microsoft.com/windows/desktop/WinAuto/uiauto-annotation-type-identifiers).
