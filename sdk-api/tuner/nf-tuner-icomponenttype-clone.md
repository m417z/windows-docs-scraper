...
Address of the [IComponentType](https://learn.microsoft.com/previous-versions/windows/desktop/api/tuner/nn-tuner-icomponenttype) interface pointer that will be set to the returned interface.
