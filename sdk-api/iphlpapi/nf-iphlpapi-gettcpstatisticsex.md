...
The
**GetTcpStatisticsEx** function retrieves the Transmission Control Protocol (TCP) statistics for the current computer. The
**GetTcpStatisticsEx** function differs from the
**GetTcpStatistics** function in that
**GetTcpStatisticsEx** also supports the Internet Protocol version 6 (IPv6) protocol family.
