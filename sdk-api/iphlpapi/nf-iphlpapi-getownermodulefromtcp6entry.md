...
A pointer to a [MIB_TCP6ROW_OWNER_MODULE](https://learn.microsoft.com/windows/desktop/api/tcpmib/ns-tcpmib-mib_tcp6row_owner_module) structure that contains the IPv6 TCP endpoint entry used to obtain the owner module.
...
A pointer to a buffer that contains a [TCPIP_OWNER_MODULE_BASIC_INFO](https://learn.microsoft.com/windows/desktop/api/iprtrmib/ns-iprtrmib-tcpip_owner_module_basic_info) structure with the owner module data. The type of data returned in this buffer is indicated by the value of the *Class* parameter.
...
| **ERROR_NOT_FOUND** | The element was not found. This value is returned if the **dwOwningPid** member of the [MIB_TCP6ROW_OWNER_MODULE](https://learn.microsoft.com/windows/desktop/api/tcpmib/ns-tcpmib-mib_tcp6row_owner_module) pointed to by the *pTcpEntry* parameter was zero or could not be found. |
...
[TCPIP_OWNER_MODULE_INFO_CLASS](https://learn.microsoft.com/windows/desktop/api/iprtrmib/ne-iprtrmib-tcpip_owner_module_info_class)