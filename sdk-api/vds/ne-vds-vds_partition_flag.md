...
This enumeration provides the values for the *ulFlags* member of the [VDS_PARTITION_PROP](https://learn.microsoft.com/windows/desktop/api/vds/ns-vds-vds_partition_prop) structure.
