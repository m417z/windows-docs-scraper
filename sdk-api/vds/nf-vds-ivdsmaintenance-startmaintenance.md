...
Once an operation begins, it runs until the caller invokes either the [StopMaintenance](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdsmaintenance-stopmaintenance) method or the [PulseMaintenance](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdsmaintenance-pulsemaintenance) method. When
**StopMaintenance** is called on a running operation, the operation stops immediately. When **PulseMaintenance** is called on a running operation, the operation pulses the specified number of times and then stops.

Calling **StartMaintenance** on a pulsing operation causes the operation to start and run until either [StopMaintenance](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdsmaintenance-stopmaintenance) is called to stop it or [PulseMaintenance](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdsmaintenance-pulsemaintenance) is called to set it pulsing it again.
