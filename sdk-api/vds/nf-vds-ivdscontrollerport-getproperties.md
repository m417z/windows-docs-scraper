...
The address of a member of the [VDS_PORT_PROP](https://learn.microsoft.com/windows/desktop/api/vdshwprv/ns-vdshwprv-vds_port_prop)
structure that is allocated and passed in by the caller. VDS allocates memory for the
**pwszFriendlyName** and **pwszIdentification** strings. Callers
must free the strings by using the [CoTaskMemFree](https://learn.microsoft.com/windows/desktop/api/combaseapi/nf-combaseapi-cotaskmemfree)
function.
...
| --- | --- |
| **S_OK** | The properties were successfully retrieved. |
