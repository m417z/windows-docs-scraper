...
The flags enumerated by [VDS_SERVICE_FLAG](https://learn.microsoft.com/windows/desktop/api/vds/ne-vds-vds_service_flag). Callers can clear the **VDS_SVF_AUTO_MOUNT_OFF** flag.
