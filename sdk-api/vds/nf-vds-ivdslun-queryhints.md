...
Callers can specify hints by passing in the *pHints* parameter to the
[IVdsSubSystem::CreateLun](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdssubsystem-createlun) method when
creating a LUN or by using the [IVdsLun::ApplyHints](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdslun-applyhints)
