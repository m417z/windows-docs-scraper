...
The address of the [VDS_LUN_PROP](https://learn.microsoft.com/windows/desktop/api/vdshwprv/ns-vdshwprv-vds_lun_prop) structure
allocated and passed in by the caller. VDS allocates memory for the **pwszFriendlyName**,
**pwszIdentification**, and **pwszUnmaskingList** member strings.
