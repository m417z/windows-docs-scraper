...
Pointer to a [VDS_FILE_SYSTEM_PROP](https://learn.microsoft.com/windows/desktop/api/vds/ns-vds-vds_file_system_prop) structure that upon successful completion receives the properties of the file system volume on the partition.
