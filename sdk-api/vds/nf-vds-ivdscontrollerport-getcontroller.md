...
The address of an [IVdsController](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nn-vdshwprv-ivdscontroller) interface pointer.
...
| --- | --- |
| **S_OK** | The controller object was successfully retrieved. |
