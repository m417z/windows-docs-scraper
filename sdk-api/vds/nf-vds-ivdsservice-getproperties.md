...
The address of the [VDS_SERVICE_PROP](https://learn.microsoft.com/windows/desktop/api/vds/ns-vds-vds_service_prop) structure
allocated and passed in by the caller. VDS allocates memory for the
**pwszVersion** member string. Callers must free the string by using the
