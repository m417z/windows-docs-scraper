...
The address of an [IVdsIscsiTarget](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nn-vdshwprv-ivdsiscsitarget). VDS initializes the
...
| --- | --- |
| **S_OK** | The target object was returned successfully. |
