...
| --- | --- |
| **S_OK** | The friendly name was set successfully. |
| **VDS_S_NAME_TRUNCATED**<br><br>0x00042700L | The name was set successfully but had to be truncated due to limitations in the subsystem. The name that was set might not match the name passed in the *pwszFriendlyName* parameter. |
