...
| --- | --- |
| **S_OK** | The enumeration of associated LUNs was returned successfully. If the target has no associated LUNs, the enumeration is empty. |
...
[IVdsLunIscsi::AssociateTargets](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdsluniscsi-associatetargets) method.
...
[IVdsLun::SetMask](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdslun-setmask)