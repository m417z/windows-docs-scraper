...
### `ppInitiatorAdapter` [out]

The address of an [IVdsIscsiInitiatorAdapter](https://learn.microsoft.com/windows/desktop/api/vds/nn-vds-ivdsiscsiinitiatoradapter)
...
| --- | --- |
| ****S_OK**** | The initiator adapter was returned successfully. |

## See also

[IVdsIscsiInitiatorAdapter](https://learn.microsoft.com/windows/desktop/api/vds/nn-vds-ivdsiscsiinitiatoradapter)

[IVdsIscsiInitiatorPortal](https://learn.microsoft.com/windows/desktop/api/vds/nn-vds-ivdsiscsiinitiatorportal)