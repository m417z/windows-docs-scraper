...
Gets the disk [SAN policy](https://learn.microsoft.com/windows/desktop/api/vds/ne-vds-vds_san_policy) for the operating system.

## Parameters

### `pSanPolicy` [out]

A pointer to a variable that receives a value from the [VDS_SAN_POLICY](https://learn.microsoft.com/windows/desktop/api/vds/ne-vds-vds_san_policy) enumeration.
