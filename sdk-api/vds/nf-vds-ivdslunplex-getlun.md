...
The address of an [IVdsLun](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nn-vdshwprv-ivdslun) interface pointer. Callers must release the interface.
