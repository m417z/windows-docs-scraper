...
The address of the [VDS_PACK_PROP](https://learn.microsoft.com/windows/desktop/api/vds/ns-vds-vds_pack_prop) structure
passed in by the caller. VDS allocates memory for the **pwszName** member. Callers must
free the string by using the [CoTaskMemFree](https://learn.microsoft.com/windows/desktop/api/combaseapi/nf-combaseapi-cotaskmemfree)
function.
