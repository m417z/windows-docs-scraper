...
The address of an [IVdsSubSystem](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nn-vdshwprv-ivdssubsystem) interface pointer.
...
| --- | --- |
| **S_OK** | The subsystem was retrieved successfully. |
