...
The
**get_LocalAccessCode** method gets the local access code.

## Parameters

### `ppCode` [out]

Pointer to **BSTR** representation of local access code.
...
The value that this method returns corresponds to the **dwLocalAccessCodeSize** and **dwLocalAccessCodeOffset** members of TAPI 2's
