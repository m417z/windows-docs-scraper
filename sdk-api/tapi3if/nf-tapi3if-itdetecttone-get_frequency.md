...
The
**get_Frequency** method retrieves the frequency of the tone for which the TAPI Server generates a tone event.
...
[put_Frequency](https://learn.microsoft.com/windows/desktop/api/tapi3if/nf-tapi3if-itdetecttone-put_frequency)