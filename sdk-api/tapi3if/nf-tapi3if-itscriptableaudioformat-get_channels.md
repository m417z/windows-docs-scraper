...
The
**get_Channels** method returns the value for the **nChannels** member in the
...
Pointer to the value of the **nChannels** member in the
[WAVEFORMATEX](https://learn.microsoft.com/previous-versions/dd757713(v=vs.85)) structure.
...
[put_Channels](https://learn.microsoft.com/windows/desktop/api/tapi3if/nf-tapi3if-itscriptableaudioformat-put_channels)