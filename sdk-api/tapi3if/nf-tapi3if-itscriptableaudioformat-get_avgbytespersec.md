...
The
**get_AvgBytesPerSec** method returns the value for the **nAvgBytesPerSec** member in the
...
Pointer to the value for the **nAvgBytesPerSec** member in the
[WAVEFORMATEX](https://learn.microsoft.com/previous-versions/dd757713(v=vs.85)) structure.
...
[put_AvgBytesPerSec](https://learn.microsoft.com/windows/desktop/api/tapi3if/nf-tapi3if-itscriptableaudioformat-put_avgbytespersec)