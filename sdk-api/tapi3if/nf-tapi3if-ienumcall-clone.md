...
[IEnumCall](https://learn.microsoft.com/windows/desktop/api/tapi3if/nn-tapi3if-ienumcall) interface returned by **IEnumCall::Clone**. The application must call [Release](https://learn.microsoft.com/windows/desktop/api/unknwn/nf-unknwn-iunknown-release) on the
