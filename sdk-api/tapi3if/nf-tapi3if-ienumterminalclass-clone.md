...
Pointer to new
[IEnumTerminalClass](https://learn.microsoft.com/windows/desktop/api/tapi3if/nn-tapi3if-ienumterminalclass) interface.
...
[IEnumTerminalClass](https://learn.microsoft.com/windows/desktop/api/tapi3if/nn-tapi3if-ienumterminalclass) interface returned by **IEnumTerminalClass::Clone**. The application must call [Release](https://learn.microsoft.com/windows/desktop/api/unknwn/nf-unknwn-iunknown-release) on the
