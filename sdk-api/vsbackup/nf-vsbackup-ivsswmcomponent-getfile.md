...
The
**GetFile** method obtains a file descriptor associated with a file group.

## Parameters

### `iFile` [in]

Offset between 0 and *n*-1, where *n* is the number of files in the file group as specified by the **cFileCount** member of the
...
| **VSS_E_OBJECT_NOT_FOUND** | The specified file does not exist. |
