...
The
**GetDatabaseLogFile** method obtains a file descriptor for the log file associated with the specified database backup component.
...
| **VSS_E_OBJECT_NOT_FOUND** | The specified database log file does not exist. |
