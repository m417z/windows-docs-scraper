...
If the key is not on the reflection list, the function succeeds but has no effect. For more information, see [Registry Redirector](https://learn.microsoft.com/windows/desktop/WinProg64/registry-redirector) and [Registry Reflection](https://learn.microsoft.com/windows/desktop/WinProg64/registry-reflection).
...
To restore registry reflection for a disabled key, use the [RegEnableReflectionKey](https://learn.microsoft.com/windows/desktop/api/winreg/nf-winreg-regenablereflectionkey) function.
