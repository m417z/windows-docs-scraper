...
Consider using the [RegSetKeyValue](https://learn.microsoft.com/windows/desktop/api/winreg/nf-winreg-regsetkeyvaluew) function, which provides a more convenient way to set the value of a registry key.
...
[RegSetKeyValue](https://learn.microsoft.com/windows/desktop/api/winreg/nf-winreg-regsetkeyvaluew)

[RegCreateKeyEx](https://learn.microsoft.com/windows/desktop/api/winreg/nf-winreg-regcreatekeyexw)

[RegFlushKey](https://learn.microsoft.com/windows/desktop/api/winreg/nf-winreg-regflushkey)

[RegOpenKeyEx](https://learn.microsoft.com/windows/desktop/api/winreg/nf-winreg-regopenkeyexw)

[RegQueryValueEx](https://learn.microsoft.com/windows/desktop/api/winreg/nf-winreg-regqueryvalueexw)
