...
To set the disk cache information, use the [IOCTL_DISK_SET_CACHE_INFORMATION](https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-ioctl_disk_set_cache_information) control code.
...
* [IOCTL_DISK_SET_CACHE_INFORMATION](https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-ioctl_disk_set_cache_information)