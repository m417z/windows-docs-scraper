...
The output buffer for the StorageDeviceIoCapabilityProperty as defined in [STORAGE_PROPERTY_ID](https://learn.microsoft.com/windows/desktop/api/winioctl/ne-winioctl-storage_property_id).
