...
**Tip** Applications targeting Windows 10 can access additional statistics through [FILESYSTEM_STATISTICS_EX](https://learn.microsoft.com/windows/desktop/api/winioctl/ns-winioctl-filesystem_statistics_ex).
...
| **FILESYSTEM_STATISTICS_TYPE_NTFS**<br><br>1 | The file system is the NTFS file system.<br><br>If this value is set, this structure is followed by an [NTFS_STATISTICS](https://learn.microsoft.com/windows/desktop/api/winioctl/ns-winioctl-ntfs_statistics) structure. |
...
**FILESYSTEM_STATISTICS** is 0x38, the size of
[NTFS_STATISTICS](https://learn.microsoft.com/windows/desktop/api/winioctl/ns-winioctl-ntfs_statistics) is 0xD8, and if there are 2
processors, the buffer allocated must be 0x280.

sizeof(**FILESYSTEM_STATISTICS**) =
0x38

sizeof([NTFS_STATISTICS](https://learn.microsoft.com/windows/desktop/api/winioctl/ns-winioctl-ntfs_statistics)) = 0xD8
...
[NTFS_STATISTICS](https://learn.microsoft.com/windows/desktop/api/winioctl/ns-winioctl-ntfs_statistics)