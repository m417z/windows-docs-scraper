...
This operation creates an object identifier if the object does not already have one. To test for the presence of an object identifier, and retrieve it if it exists, use the [FSCTL_GET_OBJECT_ID](https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_get_object_id) operation. To manually assign an object identifier, use the [FSCTL_SET_OBJECT_ID](https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_set_object_id) operation.
