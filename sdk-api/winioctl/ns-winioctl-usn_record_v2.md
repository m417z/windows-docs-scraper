...
**USN_RECORD**. Use that name to compile with older SDKs and
compilers.
...
Because **USN_RECORD_V2** is a variable size, the
...
to determine the size of the **USN_RECORD_V2** structure. For
...
| **USN_REASON_RENAME_NEW_NAME**<br><br>0x00002000 | A file or directory is renamed, and the file name in the **USN_RECORD_V2** structure is the new name. |
| **USN_REASON_RENAME_OLD_NAME**<br><br>0x00001000 | The file or directory is renamed, and the file name in the **USN_RECORD_V2** structure is the previous name. |
...
operations that work with **USN_RECORD_V2**, all records are
...
**USN_RECORD_V2** structure. Your code should examine these
...
**USN_RECORD_V2** structure members are still valid, but that new
...
**USN_RECORD_V2** structure may have undergone major changes, and
