...
**Tip** Applications targeting Windows 10 can access additional statistics through [NTFS_STATISTICS_EX](https://learn.microsoft.com/windows/desktop/api/winioctl/ns-winioctl-ntfs_statistics_ex).
...
For additional statistics that are only available with Windows 10, use [NTFS_STATISTICS_EX](https://learn.microsoft.com/windows/desktop/api/winioctl/ns-winioctl-ntfs_statistics_ex).
