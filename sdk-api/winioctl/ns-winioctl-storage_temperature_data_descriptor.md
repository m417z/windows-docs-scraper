...
This structure is used in conjunction with [IOCTL_STORAGE_QUERY_PROPERTY](https://learn.microsoft.com/windows/desktop/api/winioctl/ni-winioctl-ioctl_storage_query_property) to return temperature data from a storage device or adapter.
...
Specifies the number of [STORAGE_TEMPERATURE_INFO](https://learn.microsoft.com/windows/desktop/api/winioctl/ns-winioctl-storage_temperature_info) structures reported in **TemperatureInfo**. More than one set of temperature data may be returned when there are multiple sensors in the drive.
...
Device temperature data, of type [STORAGE_TEMPERATURE_INFO](https://learn.microsoft.com/windows/desktop/api/winioctl/ns-winioctl-storage_temperature_info).
