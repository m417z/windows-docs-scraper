...
A pointer to the output buffer that is to receive the [**DRIVE_LAYOUT_INFORMATION_EX**](https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-drive_layout_information_ex) data returned by the operation.
