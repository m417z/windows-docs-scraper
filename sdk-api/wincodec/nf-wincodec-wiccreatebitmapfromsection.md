...
The **WICCreateBitmapFromSection** function calls the [WICCreateBitmapFromSectionEx](https://learn.microsoft.com/windows/desktop/api/wincodec/nf-wincodec-wiccreatebitmapfromsectionex) function with the *desiredAccessLevel* parameter set to **WICSectionAccessLevelRead**.