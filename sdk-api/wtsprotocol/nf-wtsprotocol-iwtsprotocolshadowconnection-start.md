...
[**IWTSProtocolShadowConnection::Start** is no longer available for use as of Windows Server 2012. Instead, use [IWRdsProtocolShadowConnection::Start](https://learn.microsoft.com/windows/desktop/api/wtsprotocol/nf-wtsprotocol-iwrdsprotocolshadowconnection-start).]
...
A pointer to an [IWTSProtocolShadowCallback](https://learn.microsoft.com/windows/desktop/api/wtsprotocol/nn-wtsprotocol-iwtsprotocolshadowcallback) interface that the protocol can use to call back into the Remote Desktop Services service.
