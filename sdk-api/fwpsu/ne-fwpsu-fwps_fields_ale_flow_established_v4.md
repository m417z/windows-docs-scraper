...
Specifies the data field identifiers for the [FWPS_LAYER_ALE_FLOW_ESTABLISHED_V4](https://learn.microsoft.com/windows/win32/api/fwpsu/ne-fwpsu-fwps_builtin_layers) and **FWPS_LAYER_ALE_FLOW_ESTABLISHED_V4_DISCARD** run-time filtering layers.
