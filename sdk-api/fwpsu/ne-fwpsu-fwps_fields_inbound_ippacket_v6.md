...
Specifies the data field identifiers for the [FWPS_LAYER_INBOUND_IPPACKET_V6](https://learn.microsoft.com/windows/win32/api/fwpsu/ne-fwpsu-fwps_builtin_layers) and **FWPS_LAYER_INBOUND_IPPACKET_V6_DISCARD** run-time filtering layers.
