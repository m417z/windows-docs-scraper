...
Specifies the data field identifiers for the [FWPS_LAYER_ALE_RESOURCE_RELEASE_V6](https://learn.microsoft.com/windows/win32/api/fwpsu/ne-fwpsu-fwps_builtin_layers) run-time filtering layer.
