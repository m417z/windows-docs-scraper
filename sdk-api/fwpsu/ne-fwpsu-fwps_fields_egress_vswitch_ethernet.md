...
The **FWPS_FIELDS_EGRESS_VSWITCH_ETHERNET** (formerly **FWPS_FIELDS_EGRESS_VSWITCH_802_3**) enumeration type specifies the data field identifiers for the [FWPS_LAYER_EGRESS_VSWITCH_ETHERNET](https://learn.microsoft.com/windows/win32/api/fwpsu/ne-fwpsu-fwps_builtin_layers) run-time filtering layer.
