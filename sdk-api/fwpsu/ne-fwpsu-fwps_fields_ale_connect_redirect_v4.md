...
Specifies the data field identifiers for the [FWPS_LAYER_ALE_CONNECT_REDIRECT_V4](https://learn.microsoft.com/windows/win32/api/fwpsu/ne-fwpsu-fwps_builtin_layers) run-time filtering layer.
...
The following macros in `fwpsu.h` are defined with **FWPS_FIELDS_ALE_CONNECT_REDIRECT_V4** enumeration values:
