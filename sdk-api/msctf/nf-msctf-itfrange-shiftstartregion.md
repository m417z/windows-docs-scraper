...
Contains one of the [TfShiftDir](https://learn.microsoft.com/windows/win32/api/msctf/ne-msctf-tfshiftdir) values that specifies which adjacent region the start anchor is moved to.
