...
Pointer to an [IEnumTfDocumentMgrs](https://learn.microsoft.com/windows/desktop/api/msctf/nn-msctf-ienumtfdocumentmgrs) interface pointer that receives the new enumerator.
