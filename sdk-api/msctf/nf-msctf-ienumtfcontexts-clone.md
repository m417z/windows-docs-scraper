...
Pointer to an [IEnumTfContexts](https://learn.microsoft.com/windows/desktop/api/msctf/nn-msctf-ienumtfcontexts) interface pointer that receives the new enumerator.
