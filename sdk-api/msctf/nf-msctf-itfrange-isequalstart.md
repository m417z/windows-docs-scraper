...
| Value | Meaning |
| --- | --- |
| **TF_ANCHOR_START** | Compares this range start anchor with the specified range start anchor. |
| **TF_ANCHOR_END** | Compares this range start anchor with the specified range end anchor. |
...
This method is identical to, but more efficient than, [ITfRange::CompareStart](https://learn.microsoft.com/windows/desktop/api/msctf/nf-msctf-itfrange-comparestart).
