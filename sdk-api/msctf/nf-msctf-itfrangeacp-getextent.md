...
Pointer to a **LONG** value that receives the application character position of the range start anchor.

### `pcch` [out]

Pointer to a **LONG** value that receives the number of characters in the range.
...
[ITfRangeACP::SetExtent](https://learn.microsoft.com/windows/desktop/api/msctf/nf-msctf-itfrangeacp-setextent)