...
Pointer to a BOOL that, on exit, indicates if the key event would be handled. If this value receives **TRUE**, the key event would be handled. If this value receives **FALSE**, the key event would not be handled.
...
[ITfKeyEventSink](https://learn.microsoft.com/windows/desktop/api/msctf/nn-msctf-itfkeyeventsink), [WM_KEYUP](https://learn.microsoft.com/windows/desktop/inputdev/wm-keyup), [Keyboard Input](https://learn.microsoft.com/windows/desktop/inputdev/keyboard-input)