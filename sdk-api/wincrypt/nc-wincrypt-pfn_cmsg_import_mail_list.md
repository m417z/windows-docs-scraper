...
A pointer to a [CMSG_CTRL_MAIL_LIST_DECRYPT_PARA](https://learn.microsoft.com/windows/desktop/api/wincrypt/ns-wincrypt-cmsg_ctrl_mail_list_decrypt_para) structure that contains information about the mailing list recipient.
