...
The **CRYPT_AES_256_KEY_STATE** structure specifies the 256-bit [symmetric key](https://learn.microsoft.com/windows/desktop/SecGloss/s-gly) information for an [Advanced Encryption Standard](https://learn.microsoft.com/windows/desktop/SecGloss/a-gly) (AES) cipher.

## Members

### `Key`

An array of hexadecimal values that specify a 256-bit [cipher](https://learn.microsoft.com/windows/desktop/SecGloss/c-gly) key.
...
The **CRYPT_AES_256_KEY_STATE** structure is used by the [CPImportKey](https://learn.microsoft.com/previous-versions/aa379853(v=vs.85)) and [CPExportKey](https://learn.microsoft.com/previous-versions/aa378203(v=vs.85)) functions when the [key BLOB](https://learn.microsoft.com/windows/desktop/SecGloss/k-gly) was created by using the *dwBlobType* parameter set to the **KEYSTATEBLOB** value.
