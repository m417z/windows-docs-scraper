...
**StringCchPrintf_l** is similar to [StringCchPrintf](https://learn.microsoft.com/windows/desktop/api/strsafe/nf-strsafe-stringcchprintfa) but includes a parameter for locale information.
...
Neither *pszFormat* nor *pszDest* should be **NULL**. See [StringCchPrintf_lEx](https://learn.microsoft.com/windows/desktop/api/strsafe/nf-strsafe-stringcchprintf_lexa) if you require the handling of null string pointer values.
