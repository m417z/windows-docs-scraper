...
**StringCchPrintf_lEx** is similar to [StringCchPrintfEx](https://learn.microsoft.com/windows/desktop/api/strsafe/nf-strsafe-stringcchprintfexa) but includes a parameter for locale information.
