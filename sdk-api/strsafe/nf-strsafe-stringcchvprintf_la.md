...
**StringCchVPrintf_l** is similar to [StringCchVPrintf](https://learn.microsoft.com/windows/desktop/api/strsafe/nf-strsafe-stringcchvprintfa) but includes a parameter for locale information.
...
Neither *pszFormat* nor *pszDest* should be **NULL**. See [StringCchVPrintf_lEx](https://learn.microsoft.com/windows/desktop/api/strsafe/nf-strsafe-stringcchvprintf_lexa) if you require the handling of null string pointer values.
