...
## Description
 ...
 Places glyphs output from the [GetGlyphs](https://learn.microsoft.com/windows/win32/api/dwrite/nf-dwrite-idwritetextanalyzer-getglyphs) method according to the font
...
If this is **NULL**, the default mapping based on the script is used.
