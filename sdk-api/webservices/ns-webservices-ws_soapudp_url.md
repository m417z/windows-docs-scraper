...
The base type from which this URL subtype and all other URL subtypes derive. The [WS_URL_SCHEME_TYPE](https://learn.microsoft.com/windows/desktop/api/webservices/ne-webservices-ws_url_scheme_type) is **WS_URL_SOAPUDP_SCHEME_TYPE**.
...
[WS_HTTPS_URL](https://learn.microsoft.com/windows/desktop/api/webservices/ns-webservices-ws_https_url)
