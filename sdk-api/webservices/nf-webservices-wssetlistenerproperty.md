...
A pointer to the **Listener** object with the property to set. The pointer must reference a valid [WS_LISTENER](https://learn.microsoft.com/windows/desktop/wsw/ws-listener) and may not be **NULL**.
