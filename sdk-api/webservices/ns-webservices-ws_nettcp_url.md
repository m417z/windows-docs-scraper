...
The base type from which this URL subtype and all other URL subtypes derive. The [WS_URL_SCHEME_TYPE](https://learn.microsoft.com/windows/desktop/api/webservices/ne-webservices-ws_url_scheme_type) is **WS_URL_NETTCP_SCHEME_TYPE**.
