...
The message must be in [WS_MESSAGE_STATE_WRITING](https://learn.microsoft.com/windows/desktop/api/webservices/ne-webservices-ws_message_state) state. Upon success, it will
