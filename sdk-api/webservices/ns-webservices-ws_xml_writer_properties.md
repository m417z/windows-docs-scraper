...
A structure that is used to specify a set of [WS_XML_WRITER_PROPERTY](https://learn.microsoft.com/windows/desktop/api/webservices/ns-webservices-ws_xml_writer_property)s.
