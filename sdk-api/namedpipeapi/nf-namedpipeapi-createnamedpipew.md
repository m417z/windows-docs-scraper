...
[WaitNamedPipe](https://learn.microsoft.com/windows/desktop/api/namedpipeapi/nf-namedpipeapi-waitnamedpipew) function specifies **NMPWAIT_USE_DEFAULT_WAIT**. Each instance of a named pipe must specify the same value.
...
If the function fails, the return value is **INVALID_HANDLE_VALUE**. To get extended error information, call [GetLastError](https://learn.microsoft.com/windows/desktop/api/errhandlingapi/nf-errhandlingapi-getlasterror).
...
For an example, see [Multithreaded Pipe Server](https://learn.microsoft.com/windows/desktop/ipc/multithreaded-pipe-server).
...
[WaitNamedPipe](https://learn.microsoft.com/windows/desktop/api/namedpipeapi/nf-namedpipeapi-waitnamedpipew)
