...
The job generates the reports if [ReportEnabled](https://learn.microsoft.com/previous-versions/windows/desktop/api/fsrmreports/nf-fsrmreports-ifsrmfilemanagementjob-get_reportenabled) is **VARIANT_TRUE**.
