...
The
**RtmReleaseNextHopInfo** function releases a next-hop structure.
...
Pointer to the
[RTM_NEXTHOP_INFO](https://learn.microsoft.com/windows/desktop/api/rtmv2/ns-rtmv2-rtm_nexthop_info) structure to release. The next hop was obtained with a previous call to
