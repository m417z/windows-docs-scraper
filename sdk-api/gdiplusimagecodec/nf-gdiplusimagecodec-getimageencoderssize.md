...
The **GetImageEncodersSize** function gets the number of available image encoders and the total size of the array of
[ImageCodecInfo](https://learn.microsoft.com/previous-versions/ms534466(v=vs.85)) objects that is returned by the [GetImageEncoders](https://learn.microsoft.com/windows/desktop/api/gdiplusimagecodec/nf-gdiplusimagecodec-getimageencoders) function.
...
Pointer to a
**UINT** that receives the number of available image encoders.
...
[ImageCodecInfo](https://learn.microsoft.com/previous-versions/ms534466(v=vs.85)) objects that is returned by [GetImageEncoders](https://learn.microsoft.com/windows/desktop/api/gdiplusimagecodec/nf-gdiplusimagecodec-getimageencoders).
