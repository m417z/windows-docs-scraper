...
To allow the ink collector to collect ink from all tablets, call the [SetAllTabletsMode](https://learn.microsoft.com/windows/desktop/api/msinkaut/nf-msinkaut-iinkpicture-setalltabletsmode) method.
...
When this method is called, the [Cursors](https://learn.microsoft.com/windows/desktop/api/msinkaut/nf-msinkaut-iinkpicture-get_cursors) property of the ink collector is set to the empty collection.
