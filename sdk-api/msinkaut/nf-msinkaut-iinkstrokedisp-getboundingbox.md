...
Retrieves the bounding box in **ink space** coordinates for either all of the strokes in an [InkDisp](https://learn.microsoft.com/windows/desktop/tablet/inkdisp-class) object, an individual stroke, or an [InkStrokes](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/ms703293(v=vs.85)) collection.
...
For more details about the use of stroke characteristics to calculate a bounding box, see the [BoundingBoxMode](https://learn.microsoft.com/windows/desktop/api/msinkaut/ne-msinkaut-inkboundingboxmode) enumeration type.
