...
You can use the **CollectingInk** property to see if ink is being drawn on an ink collector rather than monitoring the [Stroke](https://learn.microsoft.com/windows/desktop/tablet/inkcollector-stroke) event.
