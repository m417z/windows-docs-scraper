...
When a mouse is enabled as an input device on the [InkCollector](https://learn.microsoft.com/windows/desktop/tablet/inkcollector-class) (when the *useMouse* parameter of the [SetAllTabletsMode](https://learn.microsoft.com/windows/desktop/api/msinkaut/nf-msinkaut-iinkpicture-setalltabletsmode) method is **TRUE**), the mouse is added to the [IInkCursors](https://learn.microsoft.com/windows/desktop/api/msinkaut/nn-msinkaut-iinkcursors) collection after the **InkCollector** encounters any other cursor, such as a pen. This is because the pen also acts like a mouse.

**Note** The [CursorInRange](https://learn.microsoft.com/windows/desktop/tablet/inkpicture-cursorinrange) event is received for the mouse cursor after any other cursor, such as a pen, draws a stroke (which fires the [Stroke](https://learn.microsoft.com/windows/desktop/tablet/inkpicture-stroke) event).
...
* The tablet mode is changed (for example, from [SetSingleTabletIntegratedMode](https://learn.microsoft.com/windows/desktop/api/msinkaut/nf-msinkaut-iinkpicture-setsingletabletintegratedmode) to [SetAllTabletsMode](https://learn.microsoft.com/windows/desktop/api/msinkaut/nf-msinkaut-iinkpicture-setalltabletsmode)).
* The [SetSingleTabletIntegratedMode](https://learn.microsoft.com/windows/desktop/api/msinkaut/nf-msinkaut-iinkpicture-setsingletabletintegratedmode) method is called.
