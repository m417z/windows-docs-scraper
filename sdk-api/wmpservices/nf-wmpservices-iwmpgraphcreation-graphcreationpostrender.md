...
Return a success **HRESULT** code to allow playback to continue or a failure code to terminate playback.

## Remarks

You can call **QueryInterface** through *pFilterGraph* to retrieve the DirectShow filter graph interfaces you need.
