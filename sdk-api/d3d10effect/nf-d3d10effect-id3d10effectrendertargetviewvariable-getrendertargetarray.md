...
A pointer to an array of render-target-view interfaces. See [ID3D10RenderTargetView Interface](https://learn.microsoft.com/windows/desktop/api/d3d10/nn-d3d10-id3d10rendertargetview).
