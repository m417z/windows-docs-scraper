...
To derive key material by using a persisted secret instead, use the [NCryptKeyDerivation](https://learn.microsoft.com/windows/win32/api/ncrypt/nf-ncrypt-ncryptkeyderivation) function.

## Parameters

### `hSharedSecret` [in]

The secret handle to create the key from. This handle is currently obtained from the [NCryptSecretAgreement](https://learn.microsoft.com/windows/win32/api/ncrypt/nf-ncrypt-ncryptsecretagreement) function.
...
| **KDF_SECRET_PREPEND** | A value to add to the beginning of the message input to the hash function. For more information, see [Remarks](https://learn.microsoft.com/windows/win32/api/ncrypt/nf-ncrypt-ncryptderivekey#remarks). | Optional |
| **KDF_SECRET_APPEND** | A value to add to the end of the message input to the hash function. For more information, see [Remarks](https://learn.microsoft.com/windows/win32/api/ncrypt/nf-ncrypt-ncryptderivekey#remarks). | Optional |
...
The address of a [NCryptBufferDesc](https://learn.microsoft.com/windows/win32/api/bcrypt/ns-bcrypt-bcryptbufferdesc) structure that contains the KDF parameters. This parameter is optional and can be `NULL` if it is not needed.
...
[NCryptBufferDesc](https://learn.microsoft.com/windows/win32/api/bcrypt/ns-bcrypt-bcryptbufferdesc)

[NCryptSecretAgreement](https://learn.microsoft.com/windows/win32/api/ncrypt/nf-ncrypt-ncryptsecretagreement)