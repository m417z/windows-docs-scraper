...
If
**ITextPara::GetKeepTogether** succeeds, it returns **S_OK**. If the method fails, it returns one of the following COM error codes. For more information about COM error codes, see [Error Handling in COM](https://learn.microsoft.com/windows/desktop/com/error-handling-in-com).
...
[SetKeepTogether](https://learn.microsoft.com/windows/desktop/api/tom/nf-tom-itextpara-setkeeptogether)
