...
If
*Value* contains an RGB color, generate the
[COLORREF](https://learn.microsoft.com/windows/desktop/gdi/colorref) by using the [RGB](https://learn.microsoft.com/windows/desktop/api/wingdi/nf-wingdi-rgb) macro.
...
[GetForeColor](https://learn.microsoft.com/windows/desktop/api/tom/nf-tom-itextfont-getforecolor)
