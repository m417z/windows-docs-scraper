...
| **tomAutocolor** (-9999997) | Indicates that the range uses the default system foreground color. |
...
[SetForeColor](https://learn.microsoft.com/windows/desktop/api/tom/nf-tom-itextfont-setforecolor)
