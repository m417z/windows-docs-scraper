...
### `impersonationType` [out]

Returned [MI_DestinationOptions_ImpersonationType](https://learn.microsoft.com/windows/desktop/api/mi/ne-mi-mi_destinationoptions_impersonationtype) enumeration.
