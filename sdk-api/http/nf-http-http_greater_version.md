...
The **HTTP_GREATER_VERSION** macro returns a non-zero value if an [HTTP_VERSION](https://learn.microsoft.com/windows/desktop/api/http/ns-http-http_version) structure is greater than a specified major/minor version combination, or zero otherwise.
