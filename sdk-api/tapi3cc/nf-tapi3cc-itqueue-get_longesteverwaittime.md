...
The
**get_LongestEverWaitTime** method gets the longest time any call waited in the queue (in seconds) during the current measurement period. The measurement period is switch or implementation specific. (See
