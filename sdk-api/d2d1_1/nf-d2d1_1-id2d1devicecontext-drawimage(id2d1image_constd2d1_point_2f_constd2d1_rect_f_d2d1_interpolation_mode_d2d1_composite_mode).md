...
If *compositeMode* is **D2D1_COMPOSITE_MODE_SOURCE_OVER**, **DrawImage** will use the currently selected primitive blend specified by [ID2D1DeviceContext::SetPrimitiveBlend](https://learn.microsoft.com/windows/desktop/api/d2d1_1/nf-d2d1_1-id2d1devicecontext-setprimitiveblend). If *compositeMode* is not **D2D1_COMPOSITE_MODE_SOURCE_OVER**, the image will be extended to transparent up to the current axis-aligned clip.
