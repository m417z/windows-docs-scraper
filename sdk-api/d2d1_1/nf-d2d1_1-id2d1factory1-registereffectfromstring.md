...
Type: **[PCWSTR](https://learn.microsoft.com/windows/desktop/api/chstring/nf-chstring-chstring-chstring(lpcwstr))**
...
**RegisterEffect** is both atomic and reference counted. To unregister an effect,
...
**Important** **RegisterEffect** does not hold a reference to the DLL or executable file in which
...
Aside from the [built-in effects](https://learn.microsoft.com/windows/desktop/Direct2D/built-in-effects) that are globally registered, this API registers effects only for
