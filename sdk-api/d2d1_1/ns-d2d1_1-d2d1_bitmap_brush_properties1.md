...
Describes the extend modes and the interpolation mode of an [ID2D1BitmapBrush](https://learn.microsoft.com/windows/desktop/api/d2d1/nn-d2d1-id2d1bitmapbrush).
...
[D2D1_BITMAP_INTERPOLATION_MODE](https://learn.microsoft.com/windows/desktop/api/d2d1/ne-d2d1-d2d1_bitmap_interpolation_mode)
