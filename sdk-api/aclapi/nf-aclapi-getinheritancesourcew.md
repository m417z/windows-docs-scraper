...
The **GetInheritanceSource** function returns information about the source of inherited [access control entries](https://learn.microsoft.com/windows/desktop/SecGloss/a-gly) (ACEs) in an [access control list](https://learn.microsoft.com/windows/desktop/SecGloss/a-gly) (ACL).
