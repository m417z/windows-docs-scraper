...
The **TreeResetNamedSecurityInfo** function resets specified security information in the [security descriptor](https://learn.microsoft.com/windows/desktop/SecGloss/s-gly) of a specified tree of objects. This function allows a specified [discretionary access control list](https://learn.microsoft.com/windows/desktop/SecGloss/d-gly) (DACL) or any elements in the [system access control list](https://learn.microsoft.com/windows/desktop/SecGloss/s-gly) (SACL) to be propagated throughout an entire tree. This function supports a callback function to track the progress of the tree operation.
