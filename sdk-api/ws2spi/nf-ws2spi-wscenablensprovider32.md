...
**Note** This call is a strictly 32-bit version of [WSCEnableNSProvider](https://learn.microsoft.com/windows/desktop/api/ws2spi/nf-ws2spi-wscenablensprovider) for use on 64-bit computers. It is provided to allow 64-bit processes to access the 32-bit catalogs.
...
[WSCEnableNSProvider](https://learn.microsoft.com/windows/desktop/api/ws2spi/nf-ws2spi-wscenablensprovider)
