...
A multi-string that specifies the privileges. For a list of possible values, see [Privilege Constants](https://learn.microsoft.com/windows/desktop/SecAuthZ/privilege-constants).
