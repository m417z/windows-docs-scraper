...
Extends [OleCreateLinkToFile](https://learn.microsoft.com/windows/desktop/api/ole2/nf-ole2-olecreatelinktofile) functionality by supporting more efficient instantiation of objects in containers requiring caching of multiple formats of presentations or data, instead of the single format supported by **OleCreateLinkToFile**.
...
The following call to [OleCreateLinkToFile](https://learn.microsoft.com/windows/desktop/api/ole2/nf-ole2-olecreatelinktofile):
