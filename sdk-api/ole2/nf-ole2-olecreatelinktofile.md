...
| --- | --- |
| **STG_E_FILENOTFOUND** | The file name is invalid. |
| **OLE_E_CANT_BINDTOSOURCE** | Not able to bind to source. |

## Remarks

The **OleCreateLinkToFile** function differs from the [OleCreateLink](https://learn.microsoft.com/windows/desktop/api/ole2/nf-ole2-olecreatelink) function because it can create links both to files that are not aware of OLE, as well as to those that are using the Windows Packager.
