...
If the structure receives item attributes, **pszText** is a pointer to a buffer that receives the item text. Note that although the list-view control allows any length string to be stored as item text, only the first 260 **TCHAR**s are displayed.
