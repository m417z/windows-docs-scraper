...
Gets the index of the file (or logical) line of text that includes the specified character index (text wrap delimiters are ignored). You can use this macro or send the [EM_FILELINEFROMCHAR](https://learn.microsoft.com/windows/desktop/controls/em-filelinefromchar) message explicitly.
