...
Pointer to an [MPEG1WAVEFORMAT](https://learn.microsoft.com/windows/desktop/api/mmreg/ns-mmreg-mpeg1waveformat) structure. The method copies the format data into the structure.
