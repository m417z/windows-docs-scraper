...
copies. If the shadow copy has the **VSS_VOLSNAP_ATTR_AUTORECOVER** flag set in
...
[auto-recover](https://learn.microsoft.com/windows/desktop/VSS/vssgloss-a) feature was introduced in
