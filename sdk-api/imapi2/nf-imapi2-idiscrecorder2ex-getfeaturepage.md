...
Feature page to retrieve. For possible values, see the [IMAPI_FEATURE_PAGE_TYPE](https://learn.microsoft.com/windows/desktop/api/imapi2/ne-imapi2-imapi_feature_page_type) enumeration type.
