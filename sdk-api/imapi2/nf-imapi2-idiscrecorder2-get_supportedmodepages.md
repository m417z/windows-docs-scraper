...
List of MMC mode pages that the device supports. Each element of the list is a **VARIANT** of type **VT_I4**. The **lVal** member of the variant contains the mode page type value. For possible values, see the [IMAPI_MODE_PAGE_TYPE](https://learn.microsoft.com/windows/desktop/api/imapi2/ne-imapi2-imapi_mode_page_type) enumeration type.
