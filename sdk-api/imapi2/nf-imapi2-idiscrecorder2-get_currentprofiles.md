...
List of supported profiles that are marked as current for the device. Each element of the list is a **VARIANT** of type **VT_I4**. The **lVal** member of the variant contains the profile type. For possible values, see the [IMAPI_PROFILE_TYPE](https://learn.microsoft.com/windows/desktop/api/imapi2/ne-imapi2-imapi_profile_type) enumeration.
