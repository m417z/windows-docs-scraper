...
List of supported feature pages that are marked as current for the device. Each element of the list is a **VARIANT** of type **VT_I4**. The **lVal** member of the variant contains the feature page type. For possible values, see the [IMAPI_FEATURE_PAGE_TYPE](https://learn.microsoft.com/windows/desktop/api/imapi2/ne-imapi2-imapi_feature_page_type) enumeration.
