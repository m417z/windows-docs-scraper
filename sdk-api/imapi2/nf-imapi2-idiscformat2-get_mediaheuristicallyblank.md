...
For a positive check that a disc is blank, call the [IDiscFormat2::get_MediaPhysicallyBlank](https://learn.microsoft.com/windows/desktop/api/imapi2/nf-imapi2-idiscformat2-get_mediaphysicallyblank) method.

## See also

[IDiscFormat2](https://learn.microsoft.com/windows/desktop/api/imapi2/nn-imapi2-idiscformat2)

[IDiscFormat2::get_MediaPhysicallyBlank](https://learn.microsoft.com/windows/desktop/api/imapi2/nf-imapi2-idiscformat2-get_mediaphysicallyblank)