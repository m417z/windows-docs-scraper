...
Type of address specified in the *address* parameter, for example, if this is an LBA address or a track number. For possible values, see the [IMAPI_READ_TRACK_ADDRESS_TYPE](https://learn.microsoft.com/windows/desktop/api/imapi2/ne-imapi2-imapi_read_track_address_type) enumeration type.

### `trackInformation` [out]
