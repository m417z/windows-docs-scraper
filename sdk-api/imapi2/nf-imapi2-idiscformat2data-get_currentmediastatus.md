...
State of the media in the disc device. For possible values, see the [IMAPI_FORMAT2_DATA_MEDIA_STATE](https://learn.microsoft.com/windows/desktop/api/imapi2/ne-imapi2-imapi_format2_data_media_state) enumeration type. Note that more than one state can be set.
...
For an example that uses this property, see [Checking Media Support](https://learn.microsoft.com/windows/desktop/imapi/checking-media-support).
