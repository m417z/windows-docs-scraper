...
| --- | --- |
| **E_IMAPI_DF2RAW_NO_RECORDER_SPECIFIED** | You cannot prepare the media until you choose a recorder to use.<br><br>Value: 0xC0AA060A |
...
Before calling this method, you must call the [IDiscFormat2RawCD::put_ClientName](https://learn.microsoft.com/windows/desktop/api/imapi2/nf-imapi2-idiscformat2rawcd-put_clientname) method.

Also, you must call the **IDiscFormat2RawCD::PrepareMedia** method before calling either the [IDiscFormat2RawCD::WriteMedia](https://learn.microsoft.com/windows/desktop/api/imapi2/nf-imapi2-idiscformat2rawcd-writemedia) or [IDiscFormat2RawCD::WriteMedia2](https://learn.microsoft.com/windows/desktop/api/imapi2/nf-imapi2-idiscformat2rawcd-writemedia2) method.

After the write is complete or you cancel the write operation, you must call the [IDiscFormat2RawCD::ReleaseMedia](https://learn.microsoft.com/windows/desktop/api/imapi2/nf-imapi2-idiscformat2rawcd-releasemedia) method to release the lock.

## See also

[IDiscFormat2RawCD](https://learn.microsoft.com/windows/desktop/api/imapi2/nn-imapi2-idiscformat2rawcd)

[IDiscFormat2RawCD::ReleaseMedia](https://learn.microsoft.com/windows/desktop/api/imapi2/nf-imapi2-idiscformat2rawcd-releasemedia)