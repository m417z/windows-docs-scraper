...
**Note** Some drives, such as those with slot-loading mechanisms, do not support this method. To determine if the device supports this method, call the [IDiscRecorder2::get_DeviceCanLoadMedia](https://learn.microsoft.com/windows/desktop/api/imapi2/nf-imapi2-idiscrecorder2-get_devicecanloadmedia) property.
