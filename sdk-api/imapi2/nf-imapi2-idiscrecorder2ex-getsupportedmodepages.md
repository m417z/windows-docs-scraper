...
Type of mode page data to retrieve, for example, the current settings or the settings that are write enabled. For possible values, see the [IMAPI_MODE_PAGE_REQUEST_TYPE](https://learn.microsoft.com/windows/desktop/api/imapi2/ne-imapi2-imapi_mode_page_request_type) enumeration type.

### `modePageTypes` [out]

Data buffer that contains one or more mode page types. For possible values, see the [IMAPI_MODE_PAGE_TYPE](https://learn.microsoft.com/windows/desktop/api/imapi2/ne-imapi2-imapi_mode_page_type) enumeration type.

To get the mode page data associated with the mode page type, call the [IDiscRecorder2Ex::GetModePage](https://learn.microsoft.com/windows/desktop/api/imapi2/nf-imapi2-idiscrecorder2ex-getmodepage) method.
...
[IDiscRecorder2Ex::SetModePage](https://learn.microsoft.com/windows/desktop/api/imapi2/nf-imapi2-idiscrecorder2ex-setmodepage)

[IMAPI_MODE_PAGE_TYPE](https://learn.microsoft.com/windows/desktop/api/imapi2/ne-imapi2-imapi_mode_page_type)