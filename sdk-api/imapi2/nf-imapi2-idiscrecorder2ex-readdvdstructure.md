...
Data buffer that contains the DVD structure. For details of the contents of the data buffer, see the READ DISC STRUCTURE command in the latest revision of the MMC specification at [ftp://ftp.t10.org/t10/drafts/mmc5](https://www.microsoft.com/?ref=go).
...
| **E_IMAPI_RECORDER_DVD_STRUCTURE_NOT_PRESENT** | The device failed to accept the command within the timeout period. This may be caused by the device having entered an inconsistent state, or the timeout value for the command may need to be increased.<br><br>Value: 0xC0AA020E |
...
[IDiscRecorder2Ex::SendDvdStructure](https://learn.microsoft.com/windows/desktop/api/imapi2/nf-imapi2-idiscrecorder2ex-senddvdstructure)