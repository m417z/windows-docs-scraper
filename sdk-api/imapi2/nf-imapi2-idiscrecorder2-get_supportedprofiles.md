...
List of MMC profiles that the device supports. Each element of the list is a **VARIANT** of type **VT_I4**. The **lVal** member of the variant contains the profile type value. For possible values, see the [IMAPI_PROFILE_TYPE](https://learn.microsoft.com/windows/desktop/api/imapi2/ne-imapi2-imapi_profile_type) enumeration type.
...
[IDiscRecorder2::get_CurrentProfiles](https://learn.microsoft.com/windows/desktop/api/imapi2/nf-imapi2-idiscrecorder2-get_currentprofiles)
...
[IMAPI_PROFILE_TYPE](https://learn.microsoft.com/windows/desktop/api/imapi2/ne-imapi2-imapi_profile_type)