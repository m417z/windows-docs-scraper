...
Data buffer that contains one or more profile types. For possible values, see the [IMAPI_PROFILE_TYPE](https://learn.microsoft.com/windows/desktop/api/imapi2/ne-imapi2-imapi_profile_type) enumeration type.
