...
The current write protect state of the media in the device. For possible values, see the [IMAPI_MEDIA_WRITE_PROTECT_STATE](https://learn.microsoft.com/windows/desktop/api/imapi2/ne-imapi2-imapi_media_write_protect_state) enumeration type.
