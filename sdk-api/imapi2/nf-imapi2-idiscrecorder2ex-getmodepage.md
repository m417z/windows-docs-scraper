...
### `requestedModePage` [in]

Mode page to retrieve. For possible values, see the [IMAPI_MODE_PAGE_TYPE](https://learn.microsoft.com/windows/desktop/api/imapi2/ne-imapi2-imapi_mode_page_type) enumeration type.
