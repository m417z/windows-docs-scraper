...
Retrieves the value for the bit that represents the current digital audio copy setting on the resulting media. Please see the [IMAPI_CD_TRACK_DIGITAL_COPY_SETTING](https://learn.microsoft.com/windows/desktop/api/imapi2/ne-imapi2-imapi_cd_track_digital_copy_setting) enumeration for possible values.
