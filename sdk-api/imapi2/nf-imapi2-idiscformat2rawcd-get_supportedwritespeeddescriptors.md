...
List of the detailed write configurations supported by the disc recorder and current media. Each element of the list is a **VARIANT** of type **VT_Dispatch**. Query the **pdispVal** member of the variant for the [IWriteSpeedDescriptor](https://learn.microsoft.com/windows/desktop/api/imapi2/nn-imapi2-iwritespeeddescriptor) interface, which contains the media type, write speed, rotational-speed control type.
