...
Current write action being performed. For a list of possible actions, see the [IMAPI_FORMAT2_TAO_WRITE_ACTION](https://learn.microsoft.com/windows/desktop/api/imapi2/ne-imapi2-imapi_format2_tao_write_action) enumeration type.
