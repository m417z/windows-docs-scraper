...
The [PROPERTYKEY](https://learn.microsoft.com/windows/desktop/api/wtypes/ns-wtypes-propertykey) to be retrieved.
...
| --- | --- |
| **S_OK** | Success, the value is in the cache. |
| **E_FAIL** | The value is not in the view's cache. |
