...
**SHDeleteEmptyKey** does not delete a key if it contains any subkeys or values. Use [SHDeleteKey](https://learn.microsoft.com/windows/desktop/api/shlwapi/nf-shlwapi-shdeletekeya) instead.
