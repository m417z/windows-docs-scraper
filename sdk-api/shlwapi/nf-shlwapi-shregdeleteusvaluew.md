...
One of the [SHREGDEL_FLAGS](https://learn.microsoft.com/windows/desktop/api/shlwapi/ne-shlwapi-shregdel_flags) that specifies from which base key the value will be deleted.
...
[SHRegDeleteEmptyUSKey](https://learn.microsoft.com/windows/desktop/api/shlwapi/nf-shlwapi-shregdeleteemptyuskeya)
