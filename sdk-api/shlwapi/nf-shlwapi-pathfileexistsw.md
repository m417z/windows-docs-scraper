...
**TRUE** if the file exists; otherwise, **FALSE**. Call [GetLastError](https://learn.microsoft.com/windows/desktop/api/errhandlingapi/nf-errhandlingapi-getlasterror) for extended error information. If the file does not exist, [GetLastError](https://learn.microsoft.com/windows/desktop/api/errhandlingapi/nf-errhandlingapi-getlasterror) will return [ERROR_FILE_NOT_FOUND](https://learn.microsoft.com/windows/win32/debug/system-error-codes--0-499-).
