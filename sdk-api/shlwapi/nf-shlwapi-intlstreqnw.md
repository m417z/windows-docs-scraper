...
This function retrieves the thread locale and uses [CompareString](https://learn.microsoft.com/windows/desktop/api/stringapiset/nf-stringapiset-comparestringw) to do a case-sensitive comparison of the first *nChar* characters. It is equivalent to:
