...
Gets the current input area as specified by the [PanelInputArea Enumeration](https://learn.microsoft.com/windows/win32/api/peninputpanel/ne-peninputpanel-panelinputarea).
