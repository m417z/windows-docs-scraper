...
Sets or gets the window handle of the object that the [PenInputPanel](https://learn.microsoft.com/windows/desktop/tablet/peninputpanel-class) object is attached to.
