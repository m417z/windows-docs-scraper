...
This aims to remove the complexity related to oplock usages. The caller must close the handle returned by **CfOpenFileWithOplock** with [CfCloseHandle](https://learn.microsoft.com/windows/win32/api/cfapi/nf-cfapi-cfclosehandle).
