...
Acknowledge delete flags. See [CF_OPERATION_ACK_DELETE_FLAGS](https://learn.microsoft.com/windows/win32/api/cfapi/ne-cfapi-cf_operation_ack_delete_flags) for more information.
