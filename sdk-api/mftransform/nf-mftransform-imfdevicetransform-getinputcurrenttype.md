...
Input stream identifier. To get the list of stream identifiers, call [IMFDeviceTransform::GetStreamIDs](https://learn.microsoft.com/windows/desktop/api/mftransform/nf-mftransform-imfdevicetransform-getstreamids).
...
If the specified input stream does not yet have a media type, the method returns **MF_E_TRANSFORM_TYPE_NOT_SET**.
