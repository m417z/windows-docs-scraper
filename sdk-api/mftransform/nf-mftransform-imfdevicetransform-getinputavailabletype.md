...
Input stream identifier. To get the list of stream identifiers, call [IMFDeviceTransform::GetStreamID](https://learn.microsoft.com/windows/desktop/api/mftransform/nf-mftransform-imfdevicetransform-getstreamids).
