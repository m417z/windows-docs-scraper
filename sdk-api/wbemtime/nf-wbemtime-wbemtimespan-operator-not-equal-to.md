...
Compares two [WBEMTimeSpan](https://learn.microsoft.com/windows/desktop/api/wbemtime/nl-wbemtime-wbemtimespan) objects using a not equal comparison operator.
...
**TRUE** if this time span and the time span specified by *uTarget* are not identical.