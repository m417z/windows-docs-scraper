...
Compares two [WBEMTimeSpan](https://learn.microsoft.com/windows/desktop/api/wbemtime/nl-wbemtime-wbemtimespan) objects using a greater than or equal comparison operator.
...
**TRUE** if this time span is greater than or equal to the time span specified by *uTarget*.