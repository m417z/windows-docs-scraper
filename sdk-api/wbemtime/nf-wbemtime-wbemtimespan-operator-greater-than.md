...
Compares two [WBEMTimeSpan](https://learn.microsoft.com/windows/desktop/api/wbemtime/nl-wbemtime-wbemtimespan) objects using a greater than comparison operator.
...
**TRUE** if this time span is greater than the time span specified by *uTarget*.