...
For a predefined address range, use the [Scope](https://learn.microsoft.com/previous-versions/windows/desktop/api/netfw/nf-netfw-inetfwservice-get_scope) property.
