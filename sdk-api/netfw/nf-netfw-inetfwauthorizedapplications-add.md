...
|  |  |
| --- | --- |
| **C++** | Application to add to the collection via an [INetFWAuthorizedApplication](https://learn.microsoft.com/previous-versions/windows/desktop/api/netfw/nn-netfw-inetfwauthorizedapplication) object. |
| **VB** | Application to add to the collection via an [INetFWAuthorizedApplication](https://learn.microsoft.com/previous-versions/windows/desktop/api/netfw/nn-netfw-inetfwauthorizedapplication) object. |
