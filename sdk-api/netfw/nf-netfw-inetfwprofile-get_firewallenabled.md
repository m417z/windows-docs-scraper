...
## Remarks
 ...
 The resulting firewall status is based on the local policy from the local store. Use the procedure [Checking the Effective Firewall Status](https://learn.microsoft.com/previous-versions/windows/desktop/ics/checking-the-effective-firewall-status) to determine the overall operational state.
