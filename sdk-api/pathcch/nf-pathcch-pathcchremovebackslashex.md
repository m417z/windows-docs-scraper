...
This function differs from [PathCchRemoveBackslash](https://learn.microsoft.com/windows/desktop/api/pathcch/nf-pathcch-pathcchremovebackslash) in that it can return a pointer to the new end of the string and report the number of unused characters remaining in the buffer.
...
**Note** This function, or [PathCchRemoveBackslash](https://learn.microsoft.com/windows/desktop/api/pathcch/nf-pathcch-pathcchremovebackslash), should be used in place of [PathRemoveBackslash](https://learn.microsoft.com/windows/desktop/api/shlwapi/nf-shlwapi-pathremovebackslasha) to prevent the possibility of a buffer overrun.
