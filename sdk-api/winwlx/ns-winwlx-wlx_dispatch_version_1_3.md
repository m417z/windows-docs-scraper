...
The **WLX_DISPATCH_VERSION_1_3** structure defines the format of the [Winlogon](https://learn.microsoft.com/windows/desktop/SecGloss/w-gly) version 1.3 function dispatch table passed to your [GINA](https://learn.microsoft.com/windows/desktop/SecGloss/g-gly) DLL in the
