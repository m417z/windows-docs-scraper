...
[GINA](https://learn.microsoft.com/windows/desktop/SecGloss/g-gly) calls this function to determine whether the terminal server is using Internet connector licensing and to retrieve [credentials](https://learn.microsoft.com/windows/desktop/SecGloss/c-gly) information.
...
When the return value is **TRUE**, *pCred* specifies a pointer to a
[WLX_CLIENT_CREDENTIALS_INFO_V1_0](https://learn.microsoft.com/windows/win32/api/winwlx/ns-winwlx-wlx_client_credentials_info_v1_0) structure that contains the credentials to use for auto logon.
...
| --- | --- |
| **TRUE** | Internet connector licensing is enabled. |
| **FALSE** | Internet connector licensing is not available. |
