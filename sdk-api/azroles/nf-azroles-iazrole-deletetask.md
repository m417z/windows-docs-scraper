...
The **DeleteTask** method removes the [IAzTask](https://learn.microsoft.com/windows/win32/api/azroles/nn-azroles-iaztask) object with the specified name from the role.

## Parameters

### `bstrProp` [in]

Name of the [IAzTask](https://learn.microsoft.com/windows/win32/api/azroles/nn-azroles-iaztask) object to remove from the role.
