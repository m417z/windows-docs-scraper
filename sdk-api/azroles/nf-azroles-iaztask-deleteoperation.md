...
The **DeleteOperation** method removes the [IAzOperation](https://learn.microsoft.com/windows/win32/api/azroles/nn-azroles-iazoperation) object with the specified name from the task.

## Parameters

### `bstrOp` [in]

Name of the [IAzOperation](https://learn.microsoft.com/windows/win32/api/azroles/nn-azroles-iazoperation) object to remove from the task.
