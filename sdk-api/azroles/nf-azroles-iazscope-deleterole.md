...
The **DeleteRole** method removes the [IAzRole](https://learn.microsoft.com/windows/win32/api/azroles/nn-azroles-iazrole) object with the specified name from the [IAzScope](https://learn.microsoft.com/windows/win32/api/azroles/nn-azroles-iazscope) object.
