...
To view the list of policy administrators, use the [PolicyAdministrators](https://learn.microsoft.com/windows/win32/api/azroles/nf-azroles-iazapplication-get_policyadministrators) property.

## See also

[PolicyAdministrators](https://learn.microsoft.com/windows/win32/api/azroles/nf-azroles-iazapplication-get_policyadministrators)