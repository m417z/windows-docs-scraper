...
Each **VARIANT** type in the collection contains a **BSTR** that uniquely identifies one program within the multiplex. To get more information about the program, pass the **VARIANT** to the [IGuideData::GetProgramProperties](https://learn.microsoft.com/previous-versions/windows/desktop/api/bdatif/nf-bdatif-iguidedata-getprogramproperties) method.
