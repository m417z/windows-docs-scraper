...
Loads 16-byte aligned data into an [XMVECTOR](https://learn.microsoft.com/windows/desktop/dxmath/xmvector-data-type), without type checking.

**Note** This function is provided for backward compatibility with the Xbox Math library. It is recommended that
**XMLoadInt4A** be used when loading integer data and
[XMLoadFloat4A](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmloadfloat4a) be used when loading floating point data.
