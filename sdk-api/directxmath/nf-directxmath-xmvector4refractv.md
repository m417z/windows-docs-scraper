...
This function is identical to [XMVector4Refract](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmvector4refract) except that the *RefractionIndex* is supplied using a 4D vector instead of a **float** value.
...
[XMVector4Refract](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmvector4refract)