...
Loads data into an [XMVECTOR](https://learn.microsoft.com/windows/desktop/dxmath/xmvector-data-type), without type checking.

**Note** This function is provided for backward compatibility with the Xbox Math library.
You should use
**XMLoadInt4** when you load integer data, and
[XMLoadFloat4](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmloadfloat4) when you load floating point data.
...
[XMLoadSInt4](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmloadsint4)

[XMLoadUInt4](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmloaduint4)
