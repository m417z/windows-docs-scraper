...
Address of an [XMINT3](https://learn.microsoft.com/windows/desktop/api/directxmath/ns-directxmath-xmint3) structure containing the data to load.
...
For 16-byte aligned memory, it may be faster to use [XMLoadInt3A](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmloadint3a)
