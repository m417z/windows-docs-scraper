...
The `operator *=` multiplies each component of the current instance of [XMVECTOR Data Type](https://learn.microsoft.com/windows/desktop/dxmath/xmvector-data-type) by the corresponding component in a second specified instance of **XMVECTOR**, returning a reference to the updated initial instance.
