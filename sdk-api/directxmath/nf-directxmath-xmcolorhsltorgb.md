...
**Note** `XMColorHSLToRGB` is new for DirectXMath and is not available for XNAMath 2.x.
...
[XMColorRGBToHSL](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmcolorrgbtohsl)