...
Address of an [XMUINT2](https://learn.microsoft.com/windows/desktop/direct3dhlsl/xmuint2) structure containing the data to load.
...
For 16-byte aligned memory, it may be faster to use [XMLoadInt2A](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmloadint2a)
