...
Stores an [XMMATRIX](https://learn.microsoft.com/windows/desktop/api/directxmath/ns-directxmath-xmmatrix) in an [XMFLOAT4X3](https://learn.microsoft.com/windows/desktop/api/directxmath/ns-directxmath-xmfloat4x3).
...
[XMFLOAT4X3](https://learn.microsoft.com/windows/desktop/api/directxmath/ns-directxmath-xmfloat4x3) is a row-major matrix form. This function cannot be used to write out column-major data since it assumes the last column is 0 0 0 1.
