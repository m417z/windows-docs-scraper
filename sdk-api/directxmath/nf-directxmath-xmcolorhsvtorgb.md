...
**Note** `XMColorHSVToRGB` is new for DirectXMath and is not available for XNAMath 2.x.
...
[XMColorRGBToHSV](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmcolorrgbtohsv)