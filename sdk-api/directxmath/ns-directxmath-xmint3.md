...
For a list of more functionality such as constructors and operators that are available using `XMINT3` when you
are programming in C++, see [XMINT3 Extensions](https://learn.microsoft.com/windows/desktop/dxmath/ovw-xmint3-extensions).
...
You can use [XMLoadSInt3](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmloadsint3) to load `XMINT3` into instances
of [XMVECTOR](https://learn.microsoft.com/windows/desktop/dxmath/xmvector-data-type).

You can use [XMStoreSInt3](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmstoresint3) to store instances of `XMVECTOR`
...
[XMINT3 Extensions](https://learn.microsoft.com/windows/desktop/dxmath/ovw-xmint3-extensions)