...
**Note** `XMColorRGBToYUV` is new for DirectXMath and is not available for XNAMath 2.x.
...
[XMColorYUVToRGB](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmcoloryuvtorgb)