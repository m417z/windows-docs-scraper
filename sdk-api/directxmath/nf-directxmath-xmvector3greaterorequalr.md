...
Tests whether one 3D vector is greater-than-or-equal-to another 3D vector and returns a comparison value that can be examined using functions such as [XMComparisonAllTrue](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmcomparisonalltrue).
...
[XMVector3GreaterOrEqual](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmvector3greaterorequal)