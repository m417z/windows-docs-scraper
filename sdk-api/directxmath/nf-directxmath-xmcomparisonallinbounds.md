...
function such as [XMVectorInBoundsR](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmvectorinboundsr). The names of the recording functions end
with an "R".
...
The `DoStuff` function will be called only if all four components of *V* are within the volume
