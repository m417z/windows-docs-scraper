...
**Note** `XMColorSRGBToXYZ` is new for DirectXMath and is not available for XNAMath 2.x.
...
[XMColorXYZToSRGB](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmcolorxyztosrgb)