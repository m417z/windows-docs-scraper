...
**Note** `XMColorYUVToRGB` is new for DirectXMath and is not available for XNAMath 2.x.
...
[XMColorRGBToYUV](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmcolorrgbtoyuv)