...
**Note** `XMColorRGBToHSL` is new for DirectXMath and is not available for XNAMath 2.x.
...
[XMColorHSLToRGB](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmcolorhsltorgb)