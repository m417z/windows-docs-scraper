...
[XMVECTOR Data Type](https://learn.microsoft.com/windows/desktop/dxmath/xmvector-data-type) containing floating-point data, referenced by index.

## Parameters

### `f` [out]

Pointer to an instance of a floating-point object that will receive the value of the *i* component of the
