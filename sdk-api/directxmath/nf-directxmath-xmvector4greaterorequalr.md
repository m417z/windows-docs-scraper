...
Tests whether one 4D vector is greater-than-or-equal-to another 4D vector and returns a comparison value that can be examined using functions such as [XMComparisonAllTrue](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmcomparisonalltrue).
...
[XMVector4GreaterOrEqual](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmvector4greaterorequal)