...
Tests whether two 3D vectors are equal. In addition, this function returns a comparison value that can be examined using functions such as [XMComparisonAllTrue](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmcomparisonalltrue).
...
[XMVector3Equal](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmvector3equal)