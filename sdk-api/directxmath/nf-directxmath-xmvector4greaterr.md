...
Tests whether one 4D vector is greater than another 4D vector and returns a comparison value that can be examined using functions such as [XMComparisonAllTrue](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmcomparisonalltrue).
...
[XMVector4Greater](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmvector4greater)