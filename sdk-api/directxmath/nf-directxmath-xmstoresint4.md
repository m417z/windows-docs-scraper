...
Stores signed integer data from an [XMVECTOR](https://learn.microsoft.com/windows/desktop/dxmath/xmvector-data-type) in an **XMINT4** structure.

## Parameters

### `pDestination` [out]

Address of an [XMINT4](https://learn.microsoft.com/windows/desktop/direct3dhlsl/xmint4) structure in which to store the data.
