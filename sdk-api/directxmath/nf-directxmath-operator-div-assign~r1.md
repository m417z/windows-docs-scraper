...
The `operator /=` divides each component of the current instance of [XMVECTOR Data Type](https://learn.microsoft.com/windows/desktop/dxmath/xmvector-data-type) by a specified floating point value, returning a reference to the updated current instance.
