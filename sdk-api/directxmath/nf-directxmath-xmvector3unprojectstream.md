...
Address of the first [XMFLOAT3](https://learn.microsoft.com/windows/desktop/api/directxmath/ns-directxmath-xmfloat3) in the stream to be transformed. X,Y are in pixels, while Z is 0.0 (at *ViewportMinZ*) to 1.0 (at *ViewportMaxZ*).
...
[XMVector3Unproject](https://learn.microsoft.com/windows/desktop/api/directxmath/nf-directxmath-xmvector3unproject)