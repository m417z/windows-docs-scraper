...
Receives a handle to the window, as an [OAHWND](https://learn.microsoft.com/windows/desktop/DirectShow/oahwnd) type. If no message drain was set, this parameter receives the value **NULL**.
...
[IVideoWindow::put_MessageDrain](https://learn.microsoft.com/windows/desktop/api/control/nf-control-ivideowindow-put_messagedrain)