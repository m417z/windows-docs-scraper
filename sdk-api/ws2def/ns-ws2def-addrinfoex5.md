...
The **ADDRINFOEX5** structure is used by the [GetAddrInfoExW](https://learn.microsoft.com/windows/win32/api/ws2tcpip/nf-ws2tcpip-getaddrinfoexw) function to hold host address information when the **AI_EXTENDED** or **AI_RETURN_TTL** bits are set in the *ai_flags* member passed in through the **GetAddrInfoExW** *hints* parameter.

The **ADDRINFOEX5** structure is an extension of the [ADDRINFOEX4](https://learn.microsoft.com/windows/win32/api/ws2def/ns-ws2def-addrinfoex4) structure. In addition to all fields from the [ADDRINFOEX4](https://learn.microsoft.com/windows/win32/api/ws2def/ns-ws2def-addrinfoex4) structure, it also holds in the *ai_ttl* member the individual DNS TTL for each returned IP address.
