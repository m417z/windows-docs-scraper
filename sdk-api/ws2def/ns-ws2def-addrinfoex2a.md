...
[GetAddrInfoEx](https://learn.microsoft.com/windows/desktop/api/ws2tcpip/nf-ws2tcpip-getaddrinfoexa) function to hold host address information when both a canonical name and a fully qualified domain name have been requested.
...
A pointer to a
[sockaddr](https://learn.microsoft.com/windows/desktop/WinSock/sockaddr-2) structure. The **ai_addr** member in each returned **addrinfoex2** structure points to a filled-in socket address structure. The length, in bytes, of each returned **addrinfoex2** structure is specified in the **ai_addrlen** member.
