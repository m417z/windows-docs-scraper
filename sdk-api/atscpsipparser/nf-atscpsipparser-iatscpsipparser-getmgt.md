...
The **GetMGT** method retrieves the master guide table (MGT).

## Parameters

### `ppMGT` [out]

Receives an [IATSC_MGT](https://learn.microsoft.com/previous-versions/windows/desktop/api/atscpsipparser/nn-atscpsipparser-iatsc_mgt) interface pointer. The caller must release the interface.
