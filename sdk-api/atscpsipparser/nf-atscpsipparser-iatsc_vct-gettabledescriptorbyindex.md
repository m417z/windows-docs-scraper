...
The **GetTableDescriptorByIndex** method returns a table-wide descriptor for the VCT.

## Parameters

### `dwIndex` [in]

Specifies which descriptor to retrieve, indexed from zero. Call the [IATSC_VCT::GetCountOfTableDescriptors](https://learn.microsoft.com/previous-versions/windows/desktop/api/atscpsipparser/nf-atscpsipparser-iatsc_vct-getcountoftabledescriptors) method to get the number of table descriptors in the VCT.
