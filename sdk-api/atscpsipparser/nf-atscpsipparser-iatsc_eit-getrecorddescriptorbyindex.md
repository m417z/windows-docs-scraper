...
The **GetRecordDescriptorByIndex** method returns a descriptor for a specified record in the EIT.
...
Specifies which descriptor to retrieve, indexed from zero. Call the [IATSC_EIT::GetRecordCountOfDescriptors](https://learn.microsoft.com/previous-versions/windows/desktop/api/atscpsipparser/nf-atscpsipparser-iatsc_eit-getrecordcountofdescriptors) method to get the number of descriptors for a particular record.
