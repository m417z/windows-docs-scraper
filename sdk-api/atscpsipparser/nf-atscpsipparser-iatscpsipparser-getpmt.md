...
Receives an [IPMT](https://learn.microsoft.com/windows/desktop/api/mpeg2psiparser/nn-mpeg2psiparser-ipmt) interface pointer. The caller must release the interface.
