...
Receives an [ISCTE_EAS](https://learn.microsoft.com/previous-versions/windows/desktop/api/atscpsipparser/nn-atscpsipparser-iscte_eas) interface pointer. The caller must release the interface.
