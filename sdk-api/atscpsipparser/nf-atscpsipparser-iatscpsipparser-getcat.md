...
Receives an [ICAT](https://learn.microsoft.com/windows/desktop/api/mpeg2psiparser/nn-mpeg2psiparser-icat) interface pointer. The caller must release the interface.
