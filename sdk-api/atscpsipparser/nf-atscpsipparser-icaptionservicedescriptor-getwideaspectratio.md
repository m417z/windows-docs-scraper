...
The **GetWideAspectRatio** method queries whether a caption service is formatted for wide-screen displays.
...
| Value | Description |
| --- | --- |
| 0 | The caption service is formatted for a 4:3 aspect ratio. |
| 1 | The caption service is formatted for a 16:9 aspect ratio. |
