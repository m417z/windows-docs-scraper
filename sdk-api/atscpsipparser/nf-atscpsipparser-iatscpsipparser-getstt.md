...
The **GetSTT** method retrieves the system time table (STT).

## Parameters

### `ppSTT` [out]

Receives an [IATSC_STT](https://learn.microsoft.com/previous-versions/windows/desktop/api/atscpsipparser/nn-atscpsipparser-iatsc_stt) interface pointer. The caller must release the interface.
