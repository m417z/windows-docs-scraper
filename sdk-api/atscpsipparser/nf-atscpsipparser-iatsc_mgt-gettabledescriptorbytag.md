...
The **GetTableDescriptorByTag** method searches the MGT for a table-wide descriptor with the specified descriptor tag.
...
Receives an [IGenericDescriptor](https://learn.microsoft.com/windows/desktop/api/mpeg2psiparser/nn-mpeg2psiparser-igenericdescriptor) interface pointer. Use this interface to retrieve the information in the descriptor. The caller must release the interface.
