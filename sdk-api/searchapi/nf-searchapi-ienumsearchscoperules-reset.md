...
Moves the internal counter to the beginning of the list so that a subsequent call to [IEnumSearchScopeRules::Next](https://learn.microsoft.com/windows/desktop/api/searchapi/nf-searchapi-ienumsearchscoperules-next) retrieves from the beginning.
