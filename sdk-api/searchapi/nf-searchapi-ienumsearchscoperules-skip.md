...
Moves the internal counter a specified number of elements forward so that a subsequent call to [IEnumSearchScopeRules::Next](https://learn.microsoft.com/windows/desktop/api/searchapi/nf-searchapi-ienumsearchscoperules-next) starts from that number.
