...
The current indexer prioritization level as the [PRIORITY_LEVEL](https://learn.microsoft.com/windows/win32/api/searchapi/ne-searchapi-priority_level) enumeration.

### `scopeStatisticsEventFrequency` [out]
