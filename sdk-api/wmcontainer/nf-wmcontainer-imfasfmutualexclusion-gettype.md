...
A variable that receives the type identifier. For a list of predefined mutual exclusion type constants, see [ASF Mutual Exclusion Type GUIDs](https://learn.microsoft.com/windows/desktop/medfound/asf-mutual-exclusion-type-guids).
...
[IMFASFMutualExclusion::SetType](https://learn.microsoft.com/windows/desktop/api/wmcontainer/nf-wmcontainer-imfasfmutualexclusion-settype)
