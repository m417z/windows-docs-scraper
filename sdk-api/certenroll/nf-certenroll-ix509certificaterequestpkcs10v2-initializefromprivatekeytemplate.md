...
The **InitializeFromPrivateKeyTemplate** method initializes the certificate request by using an [IX509PrivateKey](https://learn.microsoft.com/windows/desktop/api/certenroll/nn-certenroll-ix509privatekey) object and a certificate template.
...
| --- | --- |
| **E_POINTER** | The *pPrivateKey*, *pPolicyServer*, or *pTemplate* parameters are **NULL**. |
