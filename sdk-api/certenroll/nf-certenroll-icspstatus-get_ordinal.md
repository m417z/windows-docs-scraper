...
The **Ordinal** property specifies or retrieves the position of the [ICspStatus](https://learn.microsoft.com/windows/desktop/api/certenroll/nn-certenroll-icspstatus) object in the [ICspStatuses](https://learn.microsoft.com/windows/desktop/api/certenroll/nn-certenroll-icspstatuses) collection.
...
To iterate through the [ICspStatuses](https://learn.microsoft.com/windows/desktop/api/certenroll/nn-certenroll-icspstatuses) collection by ordinal, call the [ItemByOrdinal](https://learn.microsoft.com/windows/desktop/api/certenroll/nf-certenroll-icspstatuses-get_itembyordinal) property. The ordinal order of the [ICspStatus](https://learn.microsoft.com/windows/desktop/api/certenroll/nn-certenroll-icspstatus) objects in the collection can vary each time the collection is enumerated for a variety of reasons including, but not limited to, the following:
