...
The **Remove** method removes an [ICryptAttribute](https://learn.microsoft.com/windows/desktop/api/certenroll/nn-certenroll-icryptattribute) object from the collection by index number.
