...
## Remarks
 ...
 Specify the property to initialize by calling the [PropertyId](https://learn.microsoft.com/windows/desktop/api/certenroll/nf-certenroll-icertproperty-get_propertyid) property. You can call the [RawData](https://learn.microsoft.com/windows/desktop/api/certenroll/nf-certenroll-icertproperty-get_rawdata) property to retrieve an encoded string that contains the property.
