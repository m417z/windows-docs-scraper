...
The **InitializeEncode** method initializes the extension from an [ISmimeCapabilities](https://learn.microsoft.com/windows/desktop/api/certenroll/nn-certenroll-ismimecapabilities) collection.

## Parameters

### `pValue` [in]

Pointer to the [ISmimeCapabilities](https://learn.microsoft.com/windows/desktop/api/certenroll/nn-certenroll-ismimecapabilities) interface.
