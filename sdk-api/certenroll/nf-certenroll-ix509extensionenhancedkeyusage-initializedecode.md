...
* The [EnhancedKeyUsage](https://learn.microsoft.com/windows/desktop/api/certenroll/nf-certenroll-ix509extensionenhancedkeyusage-get_enhancedkeyusage) property retrieves the collection of OIDs that identify the intended uses of the [public key](https://learn.microsoft.com/windows/desktop/SecGloss/p-gly) (the raw extension data).
