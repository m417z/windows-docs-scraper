...
* Sets the [CriticalExtensions](https://learn.microsoft.com/windows/desktop/api/certenroll/nf-certenroll-ix509certificaterequestpkcs10-get_criticalextensions) property with the decoded critical extensions.
