...
The **InitializeDecode** method initializes the object from a [Distinguished Encoding Rules](https://learn.microsoft.com/windows/desktop/SecGloss/d-gly) (DER) encoded byte array that contains the encrypted [private key](https://learn.microsoft.com/windows/desktop/SecGloss/p-gly). The byte array is represented by a Unicode-encoded string.
...
The [object identifier](https://learn.microsoft.com/windows/desktop/SecGloss/o-gly) (OID) for this attribute is **XCN_OID_ARCHIVED_KEY_ATTR** (1.3.6.1.4.1.311.21.13). For more information, see [CERTENROLL_OBJECTID](https://learn.microsoft.com/windows/desktop/api/certenroll/ne-certenroll-certenroll_objectid).
