...
The **SignerCertificate** property specifies or retrieves a certificate used to sign the certificate request.
...
You must initialize the PKCS #7 request object before calling this property. For more information, see the following topics:
