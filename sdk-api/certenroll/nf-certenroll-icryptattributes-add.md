...
The **Add** method adds an [ICryptAttribute](https://learn.microsoft.com/windows/desktop/api/certenroll/nn-certenroll-icryptattribute) object to the collection.

## Parameters

### `pVal` [in]

Pointer to an [ICryptAttribute](https://learn.microsoft.com/windows/desktop/api/certenroll/nn-certenroll-icryptattribute) interface that represents the attribute to add.
