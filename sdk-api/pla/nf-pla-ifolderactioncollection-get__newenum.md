...
The items of the enumeration are variants whose type is VT_UNKNOWN. To query for the [IFolderAction](https://learn.microsoft.com/previous-versions/windows/desktop/api/pla/nn-pla-ifolderaction) interface, use the **punkVal** member of the variant.
