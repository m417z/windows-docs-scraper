...
The items of the enumeration are variants whose type is VT_UNKNOWN. To query for the [IValueMapItem](https://learn.microsoft.com/previous-versions/windows/desktop/api/pla/nn-pla-ivaluemapitem) interface, use the **punkVal** member of the variant.
