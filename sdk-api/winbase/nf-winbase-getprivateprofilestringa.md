...
In the event the initialization file specified by *lpFileName* is not found, or contains invalid values, this function will set **errorno** with a value of '0x2' (File Not Found). To retrieve extended error information, call [GetLastError](https://learn.microsoft.com/windows/win32/api/errhandlingapi/nf-errhandlingapi-getlasterror).
