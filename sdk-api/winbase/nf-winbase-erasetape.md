...
| Value | Meaning |
| --- | --- |
| **TAPE_ERASE_LONG**<br><br>1L | Erases the tape from the current position to the end of the current partition. |
| **TAPE_ERASE_SHORT**<br><br>0L | Writes an erase gap or end-of-data marker at the current position. |
