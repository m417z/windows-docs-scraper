...
A pointer to a
[SECURITY_ATTRIBUTES](https://learn.microsoft.com/windows/win32/api/wtypesbase/ns-wtypesbase-security_attributes) structure. If this parameter is **NULL**, the semaphore handle cannot be inherited by child processes.
...
* A child process created by the
  ...
  [CreateSemaphoreEx](https://learn.microsoft.com/windows/desktop/api/winbase/nf-winbase-createsemaphoreexa) enabled inheritance.
...
* A process can specify the name of a semaphore object in a call to the
  [OpenSemaphore](https://learn.microsoft.com/windows/win32/api/synchapi/nf-synchapi-signalobjectandwait) or
  [CreateSemaphoreEx](https://learn.microsoft.com/windows/desktop/api/winbase/nf-winbase-createsemaphoreexa) function.
