...
**LookupAccountSidLocalW** is defined as a macro that calls [LookupAccountSidW](https://learn.microsoft.com/windows/win32/api/winbase/nf-winbase-lookupaccountsidw) with `NULL` as the first parameter. Retrieves the name of the account for the specified SID on the local machine.
