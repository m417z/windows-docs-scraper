...
or the result of the [GetTempPath2](https://learn.microsoft.com/windows/desktop/api/fileapi/nf-fileapi-gettemppath2a) function. The string
...
**GetTempFileName** can perform poorly when creating a large
...
files call [DeleteFile](https://learn.microsoft.com/windows/desktop/api/fileapi/nf-fileapi-deletefilea).

To avoid problems resulting when converting an ANSI string, an application should call the
[CreateFile](https://learn.microsoft.com/windows/desktop/api/fileapi/nf-fileapi-createfilea) function to create a temporary file.
...
[GetTempPath2](https://learn.microsoft.com/windows/desktop/api/fileapi/nf-fileapi-gettemppath2a)
