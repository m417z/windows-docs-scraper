...
* Horizontal mode
  The boundary lines are parallel to the left (and right) of the rectangle *rect*. The starting and ending boundary lines are the left and right, respectively, of the rectangle *rect*.
