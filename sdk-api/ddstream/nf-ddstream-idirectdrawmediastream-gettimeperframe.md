...
Pointer to a **STREAM_TIME** value that indicates the average time per frame in 100-nanosecond units. (See [Multimedia Streaming Data Types](https://learn.microsoft.com/windows/desktop/DirectShow/multimedia-streaming-data-types).)
