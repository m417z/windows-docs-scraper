...
Contains information that defines the format of a number string. The [GetNumberFormat](https://learn.microsoft.com/windows/desktop/api/winnls/nf-winnls-getnumberformata) function uses this information to customize a number string for a specified locale.

## Members

### `NumDigits`

Number of fractional digits. This value is equivalent to the locale information specified by the value [LOCALE_IDIGITS](https://learn.microsoft.com/windows/desktop/Intl/locale-idigits).

### `LeadingZero`

A value indicating if leading zeros should be used in decimal fields. This value is equivalent to the locale information specified by the value [LOCALE_ILZERO](https://learn.microsoft.com/windows/desktop/Intl/locale-ilzero).
...
Negative number mode. This mode is equivalent to the locale information specified by the value [LOCALE_INEGNUMBER](https://learn.microsoft.com/windows/desktop/Intl/locale-ineg-constants).
