...
Gets the main module types array element associated with the type identifier size and offset in a [FILEMUIINFO](https://learn.microsoft.com/windows/desktop/api/winnls/ns-winnls-filemuiinfo) structure. The information is provided in the **dwTypeIDMainSize** and **dwTypeIDMainOffset** members of the structure.
