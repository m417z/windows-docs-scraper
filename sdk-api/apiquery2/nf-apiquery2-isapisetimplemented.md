...
Windows editions share a common base of OS components that is called the *core OS* (in some contexts this is also called *OneCore*). In core OS components, Win32 APIs are organized into functional groups called [API sets](https://learn.microsoft.com/windows/win32/apiindex/windows-apisets).
...
For a complete example, see [Detect API set availability](https://learn.microsoft.com/windows/win32/apiindex/detect-api-set-availability). For delay-load configuration, see [Linker support for delay-loaded DLLs](https://learn.microsoft.com/cpp/build/reference/linker-support-for-delay-loaded-dlls).

A versioned contract name gates APIs added in a later contract version; [GetApiSetModuleBaseName](https://learn.microsoft.com/windows/win32/api/apiquery2/nf-apiquery2-getapisetmodulebasename) is an example.
...
[GetApiSetModuleBaseName](https://learn.microsoft.com/windows/win32/api/apiquery2/nf-apiquery2-getapisetmodulebasename)

[Building for OneCore](https://learn.microsoft.com/windows-hardware/drivers/develop/building-for-onecore)

[Validating Windows drivers](https://learn.microsoft.com/windows-hardware/drivers/develop/validating-windows-drivers)