...
The **NdrClientCall** function is the client-side entry point for the [/Oicf](https://learn.microsoft.com/windows/desktop/Midl/-oi) mode stub.
...
The **NdrClientCall** function is used by the [/Oicf /robust](https://learn.microsoft.com/windows/desktop/Midl/-oi) client-side stub. The **/Oi** and **/Oic** client-side stubs are obsolete as of MIDL version 6.0.359 and should not be used. The **NdrClientCall** function transmits all [in] data to the remote server, and upon receipt of the response packet, returns the [out] value to the client-side application.

## See also

[/Oicf](https://learn.microsoft.com/windows/desktop/Midl/-oi)

[/robust](https://learn.microsoft.com/windows/desktop/Midl/-robust)