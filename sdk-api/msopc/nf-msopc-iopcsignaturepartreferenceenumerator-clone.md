...
Creates a copy of the current [IOpcSignaturePartReferenceEnumerator](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsignaturepartreferenceenumerator) interface pointer and all its descendants.

## Parameters

### `copy` [out, retval]

A pointer to a copy of the [IOpcSignaturePartReferenceEnumerator](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsignaturepartreferenceenumerator) interface pointer.
