...
Moves the current position of the enumerator to the previous [IOpcSignatureRelationshipReference](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsignaturerelationshipreference) interface pointer.

## Parameters

### `hasPrevious` [out, retval]

A Boolean value that indicates the status of the [IOpcSignatureRelationshipReference](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsignaturerelationshipreference) interface pointer at the current position.
