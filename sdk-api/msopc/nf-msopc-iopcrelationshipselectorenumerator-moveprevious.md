...
Moves the current position of the enumerator to the previous [IOpcRelationshipSelector](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcrelationshipselector) interface pointer.

## Parameters

### `hasPrevious` [out, retval]

A Boolean value that indicates the status of the [IOpcRelationshipSelector](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcrelationshipselector) interface pointer at the current position.
