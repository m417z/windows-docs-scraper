...
| **E_POINTER** | The *signingTime* parameter is **NULL**. |

## Remarks

This method allocates memory used by the string returned in *signingTime*. If the method succeeds, call the [CoTaskMemFree](https://learn.microsoft.com/windows/desktop/api/combaseapi/nf-combaseapi-cotaskmemfree) function to free the memory.

To get the format of the *signingTime*  string, call the [GetTimeFormat](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nf-msopc-iopcdigitalsignature-gettimeformat) method.

**Caution** This is not a trusted time stamp.
