...
Moves the current position of the enumerator to the previous [IOpcSignaturePartReference](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsignaturepartreference) interface pointer.

## Parameters

### `hasPrevious` [out, retval]

A Boolean value that indicates the status of the [IOpcSignaturePartReference](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsignaturepartreference) interface pointer at the current position.
