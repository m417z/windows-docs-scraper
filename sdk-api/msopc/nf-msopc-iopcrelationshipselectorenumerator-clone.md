...
Creates a copy of the current [IOpcRelationshipSelectorEnumerator](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcrelationshipselectorenumerator) interface pointer and all its descendants.

## Parameters

### `copy` [out, retval]

A pointer to a copy of the [IOpcRelationshipSelectorEnumerator](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcrelationshipselectorenumerator) interface pointer.
