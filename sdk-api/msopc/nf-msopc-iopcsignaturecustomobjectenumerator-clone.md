...
Creates a copy of the current [IOpcSignatureCustomObjectEnumerator](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsignaturecustomobjectenumerator) interface pointer and all its descendants.

## Parameters

### `copy` [out, retval]

A pointer to a copy of the [IOpcSignatureCustomObjectEnumerator](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcsignaturecustomobjectenumerator) interface pointer.
