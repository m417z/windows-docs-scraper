...
Moves the current position of the enumerator to the previous [IOpcRelationship](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcrelationship) interface pointer.

## Parameters

### `hasPrevious` [out, retval]

A Boolean value that indicates the status of the [IOpcRelationship](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcrelationship) interface pointer at the current position.
...
| FALSE | The current position of the enumerator has been moved past the beginning of the enumerator and is no longer valid. |
