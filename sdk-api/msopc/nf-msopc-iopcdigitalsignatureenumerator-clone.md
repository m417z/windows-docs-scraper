...
Creates a copy of the current [IOpcDigitalSignatureEnumerator](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcdigitalsignatureenumerator) interface pointer and all its descendants.

## Parameters

### `copy` [out, retval]

A pointer to a copy of the [IOpcDigitalSignatureEnumerator](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcdigitalsignatureenumerator) interface pointer.
