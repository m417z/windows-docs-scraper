...
To specify a language, use the [FindResourceEx](https://learn.microsoft.com/windows/desktop/api/libloaderapi/nf-libloaderapi-findresourceexw) function.
...
The resource type. Alternately, rather than a pointer, this parameter can be [MAKEINTRESOURCE](https://learn.microsoft.com/windows/desktop/api/winuser/nf-winuser-makeintresourcew)(ID), where ID is the integer identifier of the given
...
[FindResourceEx](https://learn.microsoft.com/windows/desktop/api/libloaderapi/nf-libloaderapi-findresourceexw)
