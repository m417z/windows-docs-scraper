...
Pointer to a variable that receives a member of the [VMR9DeinterlacePrefs](https://learn.microsoft.com/previous-versions/windows/desktop/api/vmr9/ne-vmr9-vmr9deinterlaceprefs) enumeration.
