...
Pointer to a **COLORREF** variable that receives the current border color.
...
[SetBorderColor](https://learn.microsoft.com/windows/desktop/api/vmr9/nf-vmr9-ivmrwindowlesscontrol9-setbordercolor)
