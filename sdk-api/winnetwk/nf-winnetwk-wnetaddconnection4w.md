...
The **WNetAddConnection4** function is similar to the [WNetAddConnection3](https://learn.microsoft.com/windows/win32/api/winnetwk/nf-winnetwk-wnetaddconnection3w) function. The main difference is that **WNetAddConnection4** has an additional parameter that allows the caller to specify an extendable property bag of parameters. The [WNetAddConnection2](https://learn.microsoft.com/windows/win32/api/winnetwk/nf-winnetwk-wnetaddconnection2w), **WNetAddConnection3**, and **WNetAddConnection4** functions supersede the [WNetAddConnection](https://learn.microsoft.com/windows/win32/api/winnetwk/nf-winnetwk-wnetaddconnectionw) function.
...
The *hwndOwner* parameter can be **NULL**. If it is, a call to **WNetAddConnection4** is equivalent to calling the [WNetAddConnection2](https://learn.microsoft.com/windows/win32/api/winnetwk/nf-winnetwk-wnetaddconnection2w) function.
...
The **WNetAddConnection4** function ignores the other members of the [NETRESOURCE](https://learn.microsoft.com/windows/win32/api/winnetwk/ns-winnetwk-netresourcew) structure.
...
- [WNetAddConnection](https://learn.microsoft.com/windows/win32/api/winnetwk/nf-winnetwk-wnetaddconnectionw)
- [WNetAddConnection2](https://learn.microsoft.com/windows/win32/api/winnetwk/nf-winnetwk-wnetaddconnection2w)
- [WNetAddConnection3](https://learn.microsoft.com/windows/win32/api/winnetwk/nf-winnetwk-wnetaddconnection3w)