...
Pointer to a
[NETRESOURCE](https://learn.microsoft.com/windows/desktop/api/winnetwk/ns-winnetwk-netresourcea) structure that specifies the container to enumerate. If the *dwScope* parameter is not RESOURCE_GLOBALNET, this parameter must be **NULL**.
...
[NETRESOURCE](https://learn.microsoft.com/windows/desktop/api/winnetwk/ns-winnetwk-netresourcea)
