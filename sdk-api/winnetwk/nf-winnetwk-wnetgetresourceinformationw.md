...
Pointer to a
[NETRESOURCE](https://learn.microsoft.com/windows/desktop/api/winnetwk/ns-winnetwk-netresourcew) structure that specifies the network resource for which information is required.
...
[NETRESOURCE](https://learn.microsoft.com/windows/desktop/api/winnetwk/ns-winnetwk-netresourcew) structure points to \\server\share. Also, the *lplpSystem* parameter points to \dir1\dir2. Both strings are stored in the buffer pointed to by the *lpBuffer* parameter.
