...
Gets a pointer to the [IOpcPartUri](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcparturi) interface that contains the URI of the document part.

## Parameters

### `fixedDocumentName` [out, retval]

A pointer to the [IOpcPartUri](https://learn.microsoft.com/previous-versions/windows/desktop/api/msopc/nn-msopc-iopcparturi) interface that contains the URI of the document part.
...
| --- | --- |
| **E_POINTER** | *fixedDocumentName* is **NULL**. |
