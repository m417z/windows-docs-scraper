...
Retrieves a DXGI interface from an [IDirect3DDevice](https://learn.microsoft.com/uwp/api/windows.graphics.directx.direct3d11.idirect3ddevice) instance.
...
The [IDirect3DDevice](https://learn.microsoft.com/uwp/api/windows.graphics.directx.direct3d11.idirect3ddevice) instance to retrieve the DXGI interface from.
