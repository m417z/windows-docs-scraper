...
If *lpOperation* is **NULL**, the function opens the file specified by *lpFile*. If *lpOperation* is ":::no-loc text="open":::" or ":::no-loc text="explore":::", the function attempts to open or explore the folder.
...
[CreateProcessA](https://learn.microsoft.com/windows/win32/api/processthreadsapi/nf-processthreadsapi-createprocessa)
