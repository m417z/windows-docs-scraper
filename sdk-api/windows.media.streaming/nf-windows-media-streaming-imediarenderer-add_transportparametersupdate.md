...
Registers an event handler for the [TransportParametersUpdate](https://learn.microsoft.com/windows/desktop/mediastreaming/transportparametersupdate) event.

## Parameters

### `handler` [in]

A [TransportParametersUpdateHandler](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/hh829007(v=vs.85)) event handler function.
...
To unregister the event handler that was registered by this method, pass the *token* value to the [remove_TransportParametersUpdate](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/hh828941(v=vs.85)) method.
