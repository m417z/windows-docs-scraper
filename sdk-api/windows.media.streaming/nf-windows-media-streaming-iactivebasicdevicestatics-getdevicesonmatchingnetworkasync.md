...
Asynchronously gets a [DevicePair](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/dn385771(v=vs.85)) of devices that are on the same network interface.
