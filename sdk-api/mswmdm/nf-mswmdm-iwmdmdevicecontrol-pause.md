...
The current playback or record session is paused and the current file position is saved. A subsequent call to the [Resume](https://learn.microsoft.com/windows/desktop/api/mswmdm/nf-mswmdm-iwmdmdevicecontrol-resume) method restarts the play or record operation at the saved file position.
