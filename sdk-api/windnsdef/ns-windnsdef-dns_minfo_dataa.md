...
The **DNS_MINFO_DATA** structure represents a DNS mail information (MINFO) record as specified in section 3.3.7 of [RFC 1035](https://www.ietf.org/rfc/rfc1035.txt).
...
The **DNS_MINFO_DATA** structure is used in conjunction with the
