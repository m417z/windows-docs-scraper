...
Specifies the location in which Microsoft DirectDraw writes the return value of the [DxApi](https://learn.microsoft.com/previous-versions/windows/drivers/display/nf-dxapi-dxapi) function for [DD_DXAPI_LOCK](https://learn.microsoft.com/previous-versions/windows/hardware/drivers/ff550695(v=vs.85)) operations. A return code of DD_OK indicates success.
...
Specifies the [FOURCC](https://learn.microsoft.com/windows-hardware/drivers/) code. For more information about FOURCC codes, see the DirectX SDK documentation.
