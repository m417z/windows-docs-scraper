...
| Value | Meaning |
| --- | --- |
| **WLAN_AVAILABLE_NETWORK_INCLUDE_ALL_ADHOC_PROFILES**<br><br>0x00000001 | Include all ad hoc network profiles in the available network list, including profiles that are not visible.<br><br>**Note** If this flag is specified on Windows XP with SP3 and Wireless LAN API for Windows XP with SP2, it is consider considered an invalid parameter. |
| **WLAN_AVAILABLE_NETWORK_INCLUDE_ALL_MANUAL_HIDDEN_PROFILES**<br><br>0x00000002 | Include all hidden network profiles in the available network list, including profiles that are not visible.<br><br>**Note** If this flag is specified on Windows XP with SP3 and Wireless LAN API for Windows XP with SP2, it is consider considered an invalid parameter. |
...
A pointer to storage for a pointer to receive the returned list of visible networks in a [WLAN_AVAILABLE_NETWORK_LIST](https://learn.microsoft.com/windows/desktop/api/wlanapi/ns-wlanapi-wlan_available_network_list) structure.

The buffer for the [WLAN_AVAILABLE_NETWORK_LIST](https://learn.microsoft.com/windows/desktop/api/wlanapi/ns-wlanapi-wlan_available_network_list) returned is allocated by the **WlanGetAvailableNetworkList** function if the call succeeds.
...
There is a hotfix available for Wireless LAN API for Windows XP with SP2 that can help improve the performance of applications that call [WlanFreeMemory](https://learn.microsoft.com/windows/desktop/api/wlanapi/nf-wlanapi-wlanfreememory) and **WlanGetAvailableNetworkList** many times.

#### Examples

The following example enumerates the wireless LAN interfaces on the local computer, retrieves the list of available networks on each wireless LAN interface, and prints values from the retrieved [WLAN_AVAILABLE_NETWORK_LIST](https://learn.microsoft.com/windows/desktop/api/wlanapi/ns-wlanapi-wlan_available_network_list) that contains the [WLAN_AVAILABLE_NETWORK](https://learn.microsoft.com/windows/desktop/api/wlanapi/ns-wlanapi-wlan_available_network) entries.
