...
Retrieves the highest (latest) version of the [Print Schema](https://learn.microsoft.com/windows/desktop/printdocs/printschema) that the specified printer supports.
