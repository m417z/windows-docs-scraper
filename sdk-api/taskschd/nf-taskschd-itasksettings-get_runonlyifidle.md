...
When reading or writing XML for a task, this setting is specified in the [RunOnlyIfIdle](https://learn.microsoft.com/windows/desktop/TaskSchd/taskschedulerschema-runonlyifidle-settingstype-element) element of the Task Scheduler schema.
