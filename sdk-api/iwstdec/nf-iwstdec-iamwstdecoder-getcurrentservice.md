...
Specifies a pointer to an [AM_WST_SERVICE](https://learn.microsoft.com/previous-versions/windows/desktop/api/iwstdec/ne-iwstdec-am_wst_service) enumeration to receive the service currently being used.
