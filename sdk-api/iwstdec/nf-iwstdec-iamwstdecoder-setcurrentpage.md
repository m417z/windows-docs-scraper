...
Specifies an [AM_WST_PAGE](https://learn.microsoft.com/previous-versions/windows/desktop/api/iwstdec/ns-iwstdec-am_wst_page) structure that is used to assign the current page.
