...
A member of the [AM_WST_DRAWBGMODE](https://learn.microsoft.com/previous-versions/windows/desktop/api/iwstdec/ne-iwstdec-am_wst_drawbgmode) enumeration that specifies whether the caption text background is to be opaque or transparent.
