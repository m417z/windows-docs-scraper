...
Pointer to a variable that receives the state, specified as a member of the [AM_WST_STATE](https://learn.microsoft.com/previous-versions/windows/desktop/api/iwstdec/ne-iwstdec-am_wst_state) enumeration. The following values are possible.
