...
The following example shows the usage of [ISyncMgrControl::UpdateEvents](https://learn.microsoft.com/windows/desktop/api/syncmgr/nf-syncmgr-isyncmgrcontrol-updateevents) by a handler's procedure.
