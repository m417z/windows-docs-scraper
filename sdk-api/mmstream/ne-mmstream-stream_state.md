...
Change the state by calling the [IMultiMediaStream::SetState](https://learn.microsoft.com/windows/desktop/api/mmstream/nf-mmstream-imultimediastream-setstate) method.
