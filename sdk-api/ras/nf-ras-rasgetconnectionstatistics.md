...
The
**RasGetConnectionStatistics** function retrieves accumulated connection statistics for the specified connection.

## Parameters

### `hRasConn` [in]

Handle to the connection. Use [RasDial](https://learn.microsoft.com/windows/desktop/api/ras/nf-ras-rasdiala) or [RasEnumConnections](https://learn.microsoft.com/windows/desktop/api/ras/nf-ras-rasenumconnectionsa) to obtain this handle.
...
On input, set the **dwSize** member of this structure to sizeof([RAS_STATS](https://learn.microsoft.com/windows/desktop/api/ras/ns-ras-ras_stats)).
