...
A pointer to the string that specifies the text to be drawn. If the *cchText* parameter is -1, the string must be null-terminated.
...
The length, in characters, of the string. If *cchText* is -1, then the *lpchText* parameter is assumed to be a pointer to a null-terminated string and **DrawText** computes the character count automatically.
