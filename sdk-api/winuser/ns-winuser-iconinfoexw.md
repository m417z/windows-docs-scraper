...
You can use [MAKEINTRESOURCE](https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-makeintresourcew)(wResID) macro to convert resource identifier to a resource name type compatible with the [resource-management functions](https://learn.microsoft.com/windows/win32/menurc/resources-functions).
...
You can use [GetModuleHandle](https://learn.microsoft.com/windows/win32/api/libloaderapi/nf-libloaderapi-getmodulehandlew) function to convert it to the module handle compatible with the [resource-management functions](https://learn.microsoft.com/windows/win32/menurc/resources-functions).
