...
To receive additional information if the request is defined, use the [BroadcastSystemMessageEx](https://learn.microsoft.com/windows/desktop/api/winuser/nf-winuser-broadcastsystemmessageexa) function.
...
For an example, see [Terminating a Process](https://learn.microsoft.com/windows/desktop/ProcThread/terminating-a-process).
