...
The destination buffer, which receives the translated string. If the **CharToOem** function is being used as an ANSI function, the string can be translated in place by setting the
