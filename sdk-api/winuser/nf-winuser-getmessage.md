...
**GetMessage** functions like [PeekMessage](https://learn.microsoft.com/windows/desktop/api/winuser/nf-winuser-peekmessagea), however, **GetMessage** blocks until a message is posted before returning.
