...
This macro is identical to the [GET_FLAGS_LPARAM](https://learn.microsoft.com/windows/desktop/api/winuser/nf-winuser-get_flags_lparam) macro.

## See also

**Conceptual**

[GET_FLAGS_LPARAM](https://learn.microsoft.com/windows/desktop/api/winuser/nf-winuser-get_flags_lparam)
