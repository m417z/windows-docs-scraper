...
**LoadIcon** can only load an icon whose size conforms to the **SM_CXICON** and **SM_CYICON** system metric values. Use the [LoadImage](https://learn.microsoft.com/windows/desktop/api/winuser/nf-winuser-loadimagew) function to load icons of other sizes.
...
[LoadImage](https://learn.microsoft.com/windows/desktop/api/winuser/nf-winuser-loadimagew)
