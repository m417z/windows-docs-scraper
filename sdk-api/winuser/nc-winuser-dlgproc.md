...
If the dialog box procedure processes a message that requires a specific return value, the dialog box procedure should set the desired return value by calling [SetWindowLong](https://learn.microsoft.com/windows/desktop/api/winuser/nf-winuser-setwindowlonga)(*hwndDlg*, **DWL_MSGRESULT**, *lResult*) immediately before returning **TRUE**. Note that you must call **SetWindowLong** immediately before returning **TRUE**; doing so earlier may result in the **DWL_MSGRESULT** value being overwritten by a nested dialog box message.
