...
[PT_PEN](https://learn.microsoft.com/windows/win32/api/winuser/ne-winuser-tagpointer_input_type)). The most recent input is included in
the returned history and is the same as the most recent input returned by the
[GetPointerPenInfo](https://learn.microsoft.com/windows/desktop/api/winuser/nf-winuser-getpointerpeninfo) function.
...
[POINTER_PEN_INFO](https://learn.microsoft.com/windows/desktop/api/winuser/ns-winuser-pointer_pen_info) structure returned by a
call to [GetPointerPenInfo](https://learn.microsoft.com/windows/desktop/api/winuser/nf-winuser-getpointerpeninfo).

### `penInfo` [out, optional]

Address of an array of
[POINTER_PEN_INFO](https://learn.microsoft.com/windows/desktop/api/winuser/ns-winuser-pointer_pen_info) structures to receive
...
[PT_PEN](https://learn.microsoft.com/windows/win32/api/winuser/ne-winuser-tagpointer_input_type)) message, it can use the
**GetPointerPenInfoHistory** function to
...
function succeeds with the buffer containing the most recent entries and **entriesCount*
...
[PT_PEN](https://learn.microsoft.com/windows/win32/api/winuser/ne-winuser-tagpointer_input_type), this function fails with the last
error set to **ERROR_DATATYPE_MISMATCH**.
