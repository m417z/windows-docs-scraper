...
To specify a handle to the keyboard layout to use for translating the specified code, use the [MapVirtualKeyEx](https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-mapvirtualkeyexw) function.
...
- [MapVirtualKeyEx](https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-mapvirtualkeyexw)
