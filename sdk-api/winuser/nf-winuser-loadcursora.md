...
If *hInstance* is **NULL**, *lpCursorName* specifies the [identifier (beginning with the IDC\_ prefix)](https://learn.microsoft.com/windows/win32/menurc/about-cursors) of a predefined system cursor to load.
