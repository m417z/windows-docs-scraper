...
A pointer to the callback function. For more information about the callback function, see the [PropEnumProcEx](https://learn.microsoft.com/windows/desktop/api/winuser/nc-winuser-propenumprocexw) function.
