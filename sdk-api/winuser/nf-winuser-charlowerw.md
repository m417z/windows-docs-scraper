...
Note that **CharLower** always maps uppercase I to lowercase I ("i"), even when the current language is Turkish or Azerbaijani. If you need a function that is linguistically sensitive in this respect, call [LCMapString](https://learn.microsoft.com/windows/desktop/api/winnls/nf-winnls-lcmapstringa).
...
[CharLowerBuff](https://learn.microsoft.com/windows/desktop/api/winuser/nf-winuser-charlowerbuffa)
