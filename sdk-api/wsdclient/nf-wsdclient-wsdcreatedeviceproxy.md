...
The **WSDCreateDeviceProxy** function calls the [IWSDDeviceProxy::Init](https://learn.microsoft.com/windows/desktop/api/wsdclient/nf-wsdclient-iwsddeviceproxy-init) method, which initializes an instance of an [IWSDDeviceProxy](https://learn.microsoft.com/windows/desktop/api/wsdclient/nn-wsdclient-iwsddeviceproxy) object.
...
For information about troubleshooting **WSDCreateDeviceProxy** function calls, see [Troubleshooting WSDAPI Applications](https://learn.microsoft.com/windows/desktop/WsdApi/troubleshooting-wsdapi-applications).
