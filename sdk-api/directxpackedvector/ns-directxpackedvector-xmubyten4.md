...
using `XMUBYTEN4` when you are programming in C++, see [XMUBYTEN4 Extensions](https://learn.microsoft.com/windows/desktop/dxmath/ovw-xmubyten4-extensions).
...
`XMUBYTEN4` can be used to load instances of [XMVECTOR](https://learn.microsoft.com/windows/desktop/dxmath/xmvector-data-type) from
normalized values, by using [XMLoadUByteN4](https://learn.microsoft.com/windows/desktop/api/directxpackedvector/nf-directxpackedvector-xmloadubyten4), which divides each
component 255.0f, rounds the result, and then assigns the components to an
`XMVECTOR` instance.

`XMVECTOR` instances containing normalized values can be stored into `XMUBYTEN4` using [XMStoreUByteN4](https://learn.microsoft.com/windows/desktop/api/directxpackedvector/nf-directxpackedvector-xmstoreubyten4), which multiplies each component by 255.0f,
...
[XMUBYTEN4 Extensions](https://learn.microsoft.com/windows/desktop/dxmath/ovw-xmubyten4-extensions)