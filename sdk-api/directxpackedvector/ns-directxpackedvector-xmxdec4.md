...
`XMXDEC4` can be loaded into instances of [XMVECTOR](https://learn.microsoft.com/windows/desktop/dxmath/xmvector-data-type) by using
[XMLoadXDec4](https://learn.microsoft.com/windows/desktop/api/directxpackedvector/nf-directxpackedvector-xmloadxdec4).

Instances of `XMVECTOR` can be stored into an instance of `XMXDEC4` with [XMStoreXDec4](https://learn.microsoft.com/windows/desktop/api/directxpackedvector/nf-directxpackedvector-xmstorexdec4).
...
[XMXDEC4 Extensions](https://learn.microsoft.com/windows/desktop/dxmath/ovw-xmxdec4-extensions)