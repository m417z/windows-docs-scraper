...
using `XMDEC4` when you are programming in C++, see [XMDEC4 Extensions](https://learn.microsoft.com/windows/desktop/dxmath/ovw-xmdec4-extensions).
...
`XMDEC4` can be loaded into instances of  [XMVECTOR](https://learn.microsoft.com/windows/desktop/dxmath/xmvector-data-type) by
using [XMLoadDec4](https://learn.microsoft.com/windows/desktop/api/directxpackedvector/nf-directxpackedvector-xmloaddec4).

Instances of `XMVECTOR` can be stored into an instance of `XMDEC4` with [XMStoreDec4](https://learn.microsoft.com/windows/desktop/api/directxpackedvector/nf-directxpackedvector-xmstoredec4).
...
[XMDEC4 Extensions](https://learn.microsoft.com/windows/desktop/dxmath/ovw-xmdec4-extensions)