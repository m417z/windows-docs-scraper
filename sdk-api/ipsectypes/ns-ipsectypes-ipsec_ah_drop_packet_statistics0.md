...
The **IPSEC_AH_DROP_PACKET_STATISTICS0** structure stores IPsec AH drop packet statistics.
...
**IPSEC_AH_DROP_PACKET_STATISTICS0** is a specific implementation of IPSEC_AH_DROP_PACKET_STATISTICS. See [WFP Version-Independent Names and Targeting Specific Versions of Windows](https://learn.microsoft.com/windows/desktop/FWP/wfp-version-independent-names-and-targeting-specific-versions-of-windows) for more information.
