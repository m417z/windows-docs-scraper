...
Specifies whether speaker fill is enabled in an audio decoder or digital signal processor (DSP). This enumeration is used with the [AVDSPSpeakerFill](https://learn.microsoft.com/windows/desktop/DirectShow/avdspspeakerfill-property) property.
