...
### `riid` [in]
 ...
 The IID of the object to retrieve. Must be **IID_IEnumChangeUnitExceptions**.

### `ppUnk` [out]

Returns an object that implements *riid* and that can enumerate the list of **IChangeUnitException** objects that is contained in the knowledge.
