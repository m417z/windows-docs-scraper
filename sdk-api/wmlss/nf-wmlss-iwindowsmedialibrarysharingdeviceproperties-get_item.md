...
The **get_Item** method retrieves an [IWindowsMediaLibrarySharingDeviceProperty](https://learn.microsoft.com/previous-versions/windows/desktop/api/wmlss/nn-wmlss-iwindowsmedialibrarysharingdeviceproperty) interface that represents an individual property for a media device.
