...
### `customSettingsApplied` [out]

Pointer to a **VARIANT_BOOL** that receives **VARIANT_TRUE** if any custom settings are in place for the current user and **VARIANT_FALSE** if the default settings are in place for the current user.
