...
The **getAllDevices** method retrieves an [IWindowsMediaLibrarySharingDevices](https://learn.microsoft.com/previous-versions/windows/desktop/api/wmlss/nn-wmlss-iwindowsmedialibrarysharingdevices) interface that represents all of the media-sharing client devices on the home network.

## Parameters

### `devices` [out]

A pointer to a variable that receives a pointer to the [IWindowsMediaLibrarySharingDevices](https://learn.microsoft.com/previous-versions/windows/desktop/api/wmlss/nn-wmlss-iwindowsmedialibrarysharingdevices) interface.
