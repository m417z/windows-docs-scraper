...
[**IAutomaticUpdates::Resume** is no longer supported. Starting with
Windows 10 calls to **Resume** always return
**S_OK**, but do nothing.]
...
Callers should call **Resume** after calling the [Pause](https://learn.microsoft.com/windows/desktop/api/wuapi/nf-wuapi-iautomaticupdates-pause) method as soon as they no longer need to pause automatic updating.
