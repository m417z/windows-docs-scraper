...
The [IInstallationJob](https://learn.microsoft.com/windows/desktop/api/wuapi/nn-wuapi-iinstallationjob) interface that is returned by the [BeginInstall](https://learn.microsoft.com/windows/desktop/api/wuapi/nf-wuapi-iupdateinstaller-begininstall) method.

### `retval` [out]

An [IInstallationResult](https://learn.microsoft.com/windows/desktop/api/wuapi/nn-wuapi-iinstallationresult) interface that represents the overall result of the installation operation.
