...
Creates another
[IEnumBitsPeers](https://learn.microsoft.com/windows/desktop/api/bits3_0/nn-bits3_0-ienumbitspeers) enumerator that contains the same enumeration state as the current one.
