...
Optional. A pointer to a pointer for an [LDAPMessage](https://learn.microsoft.com/windows/desktop/api/winldap/ns-winldap-ldapmessage) structure that may contain a server referral message. Pass in **NULL** if you do not wish to use it.
