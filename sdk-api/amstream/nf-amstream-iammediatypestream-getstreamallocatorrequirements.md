...
Pointer to an [ALLOCATOR_PROPERTIES](https://learn.microsoft.com/windows/win32/api/strmif/ns-strmif-allocator_properties) structure that receives the stream allocator requirements.
