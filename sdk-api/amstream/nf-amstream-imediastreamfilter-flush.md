...
Boolean value that indicates whether to cancel the pin's previous end-of-stream notification. If **TRUE**, the filter decrements the internal end-of-stream count.
