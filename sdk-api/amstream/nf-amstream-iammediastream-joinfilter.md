...
### `pMediaStreamFilter` [in]

Pointer to the filter's [IMediaStreamFilter](https://learn.microsoft.com/windows/desktop/api/amstream/nn-amstream-imediastreamfilter) interface.
