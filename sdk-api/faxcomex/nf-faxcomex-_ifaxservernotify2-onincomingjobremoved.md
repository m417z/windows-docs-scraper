# _IFaxServerNotify2::OnIncomingJobRemoved

## Description

The fax service calls the **IFaxServerNotify2::OnIncomingJobRemoved** method when an incoming fax job is removed from the job queue.
