...
The fax service calls the **IFaxServerNotify2::OnOutboundRoutingRulesConfigChange** method when there is a configuration change related to outbound fax routing rules.
