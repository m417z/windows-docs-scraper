...
The fax service calls the **IFaxServerNotify2::OnOutboundRoutingGroupsConfigChange** method when there is a configuration change related to outbound fax routing groups.
