...
The fax service calls the **IFaxServerNotify2::OnIncomingArchiveConfigChange** method when there is a configuration change related to the incoming fax archive.
