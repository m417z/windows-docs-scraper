...
The **IFaxOutgoingArchive::get_HighQuotaWaterMark** property is a value that specifies the upper threshold for the size of the archive of inbound fax messages, in megabytes. If the archived fax messages in the archive exceed this value, and the [IFaxOutgoingArchive::get_SizeQuotaWarning](https://learn.microsoft.com/previous-versions/windows/desktop/fax/-mfax-faxoutgoingarchive-sizequotawarning-vb) property is equal to **TRUE**, the fax service issues a warning in the event log.
