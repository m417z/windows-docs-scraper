...
The fax service calls the **IFaxServerNotify2::OnIncomingMessageAdded** method when an incoming message is added to the inbound fax archive.
...
[IFaxServerNotify2](https://learn.microsoft.com/windows/desktop/api/faxcomex/nn-faxcomex-ifaxservernotify2)