# _IFaxServerNotify2::OnActivityLoggingConfigChange

## Description

The fax service calls the **IFaxServerNotify2::OnActivityLoggingConfigChange** method when there is a configuration change related to activity logging.
