...
This property is used only if the [ReceiveMode](https://learn.microsoft.com/previous-versions/windows/desktop/fax/-mfax-faxdevice-receivemode) property of the device is set to [fdrmAUTO_ANSWER](https://learn.microsoft.com/previous-versions/windows/desktop/api/faxcomex/ne-faxcomex-fax_device_receive_mode_enum).
