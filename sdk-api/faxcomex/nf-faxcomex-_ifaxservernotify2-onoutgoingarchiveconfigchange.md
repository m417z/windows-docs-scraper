...
The fax service calls the **IFaxServerNotify2::OnOutgoingArchiveConfigChange** method when there is a configuration change related to the outgoing fax archive.
