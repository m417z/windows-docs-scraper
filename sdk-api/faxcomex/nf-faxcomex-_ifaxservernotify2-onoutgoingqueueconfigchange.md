...
The fax service calls the **IFaxServerNotify2::OnOutgoingQueueConfigChange** method when there is a configuration change related to the outgoing fax job queue.
