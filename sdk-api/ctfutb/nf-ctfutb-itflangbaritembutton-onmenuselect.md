...
Specifies the identifier of the menu item selected. This is the value passed for the *uId* parameter in [ITfMenu::AddMenuItem](https://learn.microsoft.com/windows/desktop/api/ctfutb/nf-ctfutb-itfmenu-addmenuitem).
