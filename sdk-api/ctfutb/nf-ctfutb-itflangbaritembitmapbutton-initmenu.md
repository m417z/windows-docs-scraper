...
Pointer to an [ITfMenu](https://learn.microsoft.com/windows/desktop/api/ctfutb/nn-ctfutb-itfmenu) interface that the language bar bitmap button uses to add items to the menu that the language bar displays for the button.
