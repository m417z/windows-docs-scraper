...
Contains one of the [TfLBIClick](https://learn.microsoft.com/windows/win32/api/ctfutb/ne-ctfutb-tflbiclick) values that indicate which mouse button was used to click the balloon.
...
Pointer to a [RECT](https://learn.microsoft.com/windows/desktop/api/windef/ns-windef-rect) structure that contains the bounding rectangle, in screen coordinates, of the balloon.
