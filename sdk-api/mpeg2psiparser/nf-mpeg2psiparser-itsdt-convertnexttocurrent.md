...
This method applies only to *next* tables that have become current. Before calling this method, call [ITSDT::RegisterForWhenCurrent](https://learn.microsoft.com/windows/desktop/api/mpeg2psiparser/nf-mpeg2psiparser-itsdt-registerforwhencurrent) and wait for the event to be signaled.
