...
The **Initialize** method initializes the object using captured table section data. This method is called internally by the [IAtscPsipParser::GetTSDT](https://learn.microsoft.com/previous-versions/windows/desktop/api/atscpsipparser/nf-atscpsipparser-iatscpsipparser-gettsdt) method, so applications typically should not call it.
