...
This method applies only to *next* tables that have become current. Before calling this method, call [ICAT::RegisterForWhenCurrent](https://learn.microsoft.com/windows/desktop/api/mpeg2psiparser/nf-mpeg2psiparser-icat-registerforwhencurrent) and wait for the event to be signaled.
