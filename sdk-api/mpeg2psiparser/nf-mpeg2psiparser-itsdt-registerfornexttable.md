...
Handle to an event created by the caller. The object signals the event when the *next* table arrives. When the event is signaled, call the [ITSDT::GetNextTable](https://learn.microsoft.com/windows/desktop/api/mpeg2psiparser/nf-mpeg2psiparser-itsdt-getnexttable) method to retrieve the table.
