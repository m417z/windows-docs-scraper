...
Creates a new [IPropertyValue](https://learn.microsoft.com/windows/desktop/api/windows.foundation/nn-windows-foundation-ipropertyvalue) object that contains the specified array of [Guid](https://learn.microsoft.com/dotnet/api/system.guid) values.
...
The array of [Guid](https://learn.microsoft.com/dotnet/api/system.guid) values to store.
...
[IPropertyValue::GetGuidArray](https://learn.microsoft.com/windows/desktop/api/windows.foundation/nf-windows-foundation-ipropertyvalue-getguidarray)
