...
When this method is called, the Shell initializes the [ICopyHookA](https://learn.microsoft.com/windows/win32/api/shlobj/nn-shlobj-icopyhooka) interface directly without using an [IShellExtInit](https://learn.microsoft.com/windows/desktop/api/shobjidl_core/nn-shobjidl_core-ishellextinit) interface first.
