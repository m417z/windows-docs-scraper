...
The Shell calls this method before the [Show](https://learn.microsoft.com/windows/win32/api/shlobj/nf-shlobj-ifileviewera-show) method. The Shell specifies the name of the file to display by calling the file viewer's [IPersistFile::Load](https://learn.microsoft.com/windows/desktop/api/objidl/nf-objidl-ipersistfile-load) method.
