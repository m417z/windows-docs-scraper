...
Returns S_OK if successful, or E_UNEXPECTED if the [ShowInitialize](https://learn.microsoft.com/windows/win32/api/shlobj/nf-shlobj-ifileviewerw-showinitialize) method was not called before **IFileViewerW::Show**.
