...
The
**MsiProvideQualifiedComponent** function returns the full component path for a qualified component and performs any necessary installation. This function prompts for source if necessary, and increments the usage count for the feature.
...
| **combination of the REINSTALLMODE flags** | Call [MsiReinstallFeature](https://learn.microsoft.com/windows/desktop/api/msi/nf-msi-msireinstallfeaturea) to reinstall the feature using this parameter for the *dwReinstallMode* parameter, and then provide the component. |
...
Upon success of the
**MsiProvideQualifiedComponent** function, the *pcchPathBuf* parameter contains the length of the string in *lpPathBuf*.
