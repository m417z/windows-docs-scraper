...
The
**GetRegistryKey** method retrieves a handle to the root of the registry key for the specified section of the GPO.
...
[RegOpenKeyEx](https://learn.microsoft.com/windows/desktop/api/winreg/nf-winreg-regopenkeyexa) function to open the **Software\Policies** key.
