...
Pointer to the client-defined callback function that writes the font structure to the document stream. See [WRITEEMBEDPROC](https://learn.microsoft.com/previous-versions/dd145225(v=vs.85)).
...
For information on embedding Unicode characters from a device context, see [TTEmbedFont](https://learn.microsoft.com/windows/desktop/api/t2embapi/nf-t2embapi-ttembedfont); for information on embedding UCS-4 characters from a device context, see [TTEmbedFontEx](https://learn.microsoft.com/windows/desktop/api/t2embapi/nf-t2embapi-ttembedfontex).
