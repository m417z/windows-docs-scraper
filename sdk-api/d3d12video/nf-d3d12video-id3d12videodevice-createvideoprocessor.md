...
A pointer to a memory block that receives a pointer to the [ID3D12VideoProcessor](https://learn.microsoft.com/windows/win32/api/d3d12video/nn-d3d12video-id3d12videoprocessor) interface
