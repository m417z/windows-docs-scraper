...
Pointer to a value indicating whether the video port controls the vertical synchronization of the VGA monitor. **TRUE** if the port controls the monitor's synchronization; **FALSE** otherwise.
