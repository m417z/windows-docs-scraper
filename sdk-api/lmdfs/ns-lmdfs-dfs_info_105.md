...
namespace root cannot be changed. One **DFS_VOLUME_STATE** flag is set, and one
**DFS_VOLUME_FLAVOR** flag is set. For an example that describes the interpretation of
