...
name, status, **GUID**, time-out, namespace/root/link properties, metadata size, number of targets, and information
...
[DFS_INFO_5](https://learn.microsoft.com/windows/desktop/api/lmdfs/ns-lmdfs-dfs_info_5) instead.
