...
Pointer to a **COLORREF** variable that receives the current color key value.
...
[IVMRWindowlessControl::SetColorKey](https://learn.microsoft.com/windows/desktop/api/strmif/nf-strmif-ivmrwindowlesscontrol-setcolorkey)
