...
Pointer to a variable that receives a GUID specifying the time format. See [Time Format GUIDs](https://learn.microsoft.com/windows/desktop/DirectShow/time-format-guids).
