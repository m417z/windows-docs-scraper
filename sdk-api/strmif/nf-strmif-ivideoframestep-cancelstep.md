...
The `CancelStep` method cancels the previous [IVideoFrameStep::Step](https://learn.microsoft.com/windows/desktop/api/strmif/nf-strmif-ivideoframestep-step) operation.
