...
Specifies the state of the stream. **TRUE** means active; **FALSE** means inactive.
...
[IVMRVideoStreamControl::GetStreamActiveState](https://learn.microsoft.com/windows/desktop/api/strmif/nf-strmif-ivmrvideostreamcontrol-getstreamactivestate)
