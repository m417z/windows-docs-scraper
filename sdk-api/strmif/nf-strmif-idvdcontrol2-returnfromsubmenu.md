...
| **VFW_E_DVD_NO_GOUP_PGC** | The operation cannot be performed because no GoUp program chain (PGC) is available. |

## Remarks

If the DVD Navigator is at the top-level menu, this method calls the [IDvdControl2::Resume](https://learn.microsoft.com/windows/desktop/api/strmif/nf-strmif-idvdcontrol2-resume) method so that play continues where it left off.
...
| GoUP | * DVD_DOMAIN_VideoManagerMenu<br>* DVD_DOMAIN_VideoTitleSetMenu<br>* DVD_DOMAIN_Title |
