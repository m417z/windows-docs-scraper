...
This method freezes playback and any internal timers, similar to [IMediaControl::Pause](https://learn.microsoft.com/windows/desktop/api/control/nf-control-imediacontrol-pause). If the media file was not running, this method does nothing.
...
[IDvdControl::PauseOff](https://learn.microsoft.com/windows/desktop/api/strmif/nf-strmif-idvdcontrol-pauseoff)