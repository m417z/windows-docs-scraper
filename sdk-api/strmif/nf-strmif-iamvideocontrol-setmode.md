...
Value specifying a combination of the flags from the [VideoControlFlags](https://learn.microsoft.com/windows/desktop/api/strmif/ne-strmif-videocontrolflags) enumeration to set the video control mode.
