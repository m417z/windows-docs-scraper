...
### `ppIEnumStreamIdMap` [in]

[IEnumStreamIdMap](https://learn.microsoft.com/windows/desktop/api/strmif/nn-strmif-ienumstreamidmap) interface pointer that will be set to the returned collection.
