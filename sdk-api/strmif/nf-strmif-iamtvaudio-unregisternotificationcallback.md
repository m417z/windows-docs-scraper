...
Pointer to the [IAMTunerNotification](https://learn.microsoft.com/windows/desktop/api/strmif/nn-strmif-iamtunernotification) interface that was specified in a previous call to **RegisterNotificationCallBack**.
