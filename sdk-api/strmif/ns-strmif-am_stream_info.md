...
Bitwise combination of zero or more flags from the [AM_STREAM_INFO_FLAGS](https://learn.microsoft.com/windows/desktop/api/strmif/ne-strmif-am_stream_info_flags) enumeration.
