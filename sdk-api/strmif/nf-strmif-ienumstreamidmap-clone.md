...
### `ppIEnumStreamIdMap` [out]

Receives a pointer to the [IEnumStreamIdMap](https://learn.microsoft.com/windows/desktop/api/strmif/nn-strmif-ienumstreamidmap) interface of the new collection object. The caller must release the interface.
