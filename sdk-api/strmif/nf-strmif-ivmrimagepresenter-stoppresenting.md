...
`StopPresenting` can be called only when the VMR is in a running state.

## See also

[IVMRImagePresenter Interface](https://learn.microsoft.com/windows/desktop/api/strmif/nn-strmif-ivmrimagepresenter)

[IVMRImagePresenter::StartPresenting](https://learn.microsoft.com/windows/desktop/api/strmif/nf-strmif-ivmrimagepresenter-startpresenting)
