...
Pointer to a variable of type [DECIMATION_USAGE](https://learn.microsoft.com/windows/desktop/api/strmif/ne-strmif-decimation_usage) that receives the decimation setting.
