...
Pointer to a value representing a combination of the flags from the [VideoControlFlags](https://learn.microsoft.com/windows/desktop/api/strmif/ne-strmif-videocontrolflags) enumeration.
