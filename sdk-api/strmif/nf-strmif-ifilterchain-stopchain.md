...
Pointer to the filter at the end of the chain. If this parameter is **NULL**, the method uses the longest possible filter chain that extends downstream from the start filter.
