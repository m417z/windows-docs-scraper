...
Pointer to a variable of type [DVD_DECODER_CAPS](https://learn.microsoft.com/windows/desktop/api/strmif/ns-strmif-dvd_decoder_caps) that receives the information about the decoder.
...
| --- | --- |
| **S_OK** | Success. |
| **VFW_E_WRONG_STATE** | The filter graph has not been initialized. |
