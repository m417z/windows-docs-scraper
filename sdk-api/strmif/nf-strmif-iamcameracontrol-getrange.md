...
Specifies the property to query, as a value from the [CameraControlProperty](https://learn.microsoft.com/windows/desktop/api/strmif/ne-strmif-cameracontrolproperty) enumeration.
...
Receives one or more members of the [CameraControlFlags](https://learn.microsoft.com/windows/desktop/api/strmif/ne-strmif-cameracontrolflags) enumeration, indicating whether the property is controlled automatically, manually, or both.
