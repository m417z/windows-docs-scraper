...
Pointer to a **double** to receive the playback rate that was set using [IAMExtTransport::put_Rate](https://learn.microsoft.com/windows/desktop/api/strmif/nf-strmif-iamexttransport-put_rate).
