...
Pointer to a variable that receives a combination of flags from the [AM_PUSHSOURCE_FLAGS](https://learn.microsoft.com/windows/desktop/api/strmif/ne-strmif-_am_pushsource_flags) enumeration.
