...
### `lpdwOverlayFXCaps` [out]

Pointer to a variable that receives a value indicating the overlay effects capabilities of the overlay surface. The value is a logical combination of flags from the [AMOVERLAYFX](https://learn.microsoft.com/windows/desktop/api/strmif/ne-strmif-amoverlayfx) enumeration.
