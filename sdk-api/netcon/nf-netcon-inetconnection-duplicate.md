...
The
**Duplicate** method creates a duplicate of this connection in the connections folder.

## Parameters

### `pszwDuplicateName` [in]
...
[INetConnection](https://learn.microsoft.com/previous-versions/windows/desktop/api/netcon/nn-netcon-inetconnection) interface for the new connection.
