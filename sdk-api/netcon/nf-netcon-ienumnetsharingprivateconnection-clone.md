...
The
**Clone** method creates a new enumeration interface from this enumeration.
...
[IEnumNetSharingPrivateConnection](https://learn.microsoft.com/previous-versions/windows/desktop/api/netcon/nn-netcon-ienumnetsharingprivateconnection) interface.
