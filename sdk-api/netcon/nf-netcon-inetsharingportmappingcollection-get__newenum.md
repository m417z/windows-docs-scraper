...
The
**get__NewEnum** method retrieves an enumerator for the port mapping collection.

## Parameters

### `pVal` [out]

Pointer to an interface pointer that, on successful return, receives a pointer to an [IUnknown](https://learn.microsoft.com/windows/desktop/api/unknwn/nn-unknwn-iunknown) interface for the collection.
