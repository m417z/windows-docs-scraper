...
The
**get_Options** method retrieves the options associated with this port mapping.

## Parameters

### `pdwOptions` [out]

Pointer to a **DWORD** variable that receives the options associated with this port mapping.
