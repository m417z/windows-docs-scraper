...
The
**Next** method retrieves the specified number of port mappings that start from the current enumeration position.
...
Pointer to a
[VARIANT](https://learn.microsoft.com/windows/desktop/api/oaidl/ns-oaidl-variant) variable for the port mapping. This variant contains a pointer to an
[INetSharingPortMapping](https://learn.microsoft.com/previous-versions/windows/desktop/api/netcon/nn-netcon-inetsharingportmapping) interface.

### `pceltFetched` [out]

Pointer to a **ULONG** variable that, on successful return, specifies the number of port mappings actually returned.
