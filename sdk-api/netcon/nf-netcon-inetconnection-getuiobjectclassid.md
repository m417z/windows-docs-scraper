...
The
**GetUiObjectClassId** method retrieves the class identifier of the user interface object for this connection.

## Parameters

### `pclsid` [out]

Pointer to a **CLSID** variable that, on successful return, points to the class identifier of the user interface object for this connection.
