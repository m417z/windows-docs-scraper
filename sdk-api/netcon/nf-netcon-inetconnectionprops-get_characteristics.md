...
The
**get_Characteristics** method retrieves the media type for the connection.

## Parameters

### `pdwFlags` [out]

Media types as defined by [NETCON_MEDIATYPE](https://learn.microsoft.com/windows/desktop/api/netcon/ne-netcon-netcon_mediatype).
