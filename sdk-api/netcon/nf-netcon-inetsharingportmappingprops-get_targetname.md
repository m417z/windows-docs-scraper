...
The
**get_TargetName** method retrieves the name of the target computer for this port mapping.
...
Pointer to a
[BSTR](https://learn.microsoft.com/previous-versions/windows/desktop/automat/bstr) variable that receives the name of the target computer for this port mapping.
