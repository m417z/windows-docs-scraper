...
The
**get_Name** method retrieves the name of the connection.
...
Pointer to a
[BSTR](https://learn.microsoft.com/previous-versions/windows/desktop/automat/bstr) variable that, on successful return, receives the name of the connection.
