...
The
**get_ExternalPort** method retrieves the external port associated with this port mapping.

## Parameters

### `pusPort` [out]

Pointer to a **LONG** variable that receives the external port for this port mapping.
