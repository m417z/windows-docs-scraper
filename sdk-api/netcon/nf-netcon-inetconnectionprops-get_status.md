...
The
**get_Status** method retrieves the status of the connection.
...
[NETCON_STATUS](https://learn.microsoft.com/windows/desktop/api/netcon/ne-netcon-netcon_status) that, on successful return, receives a code that specifies the status of the connection.
