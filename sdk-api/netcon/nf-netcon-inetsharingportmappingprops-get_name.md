...
The
**get_Name** method retrieves the name for this port mapping.
...
Pointer to a
[BSTR](https://learn.microsoft.com/previous-versions/windows/desktop/automat/bstr) variable that receives the name of the port mapping.
