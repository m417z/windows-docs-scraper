...
The
**get_InternalPort** method retrieves the internal port associated with this port mapping.

## Parameters

### `pusPort` [out]

Pointer to a **LONG** variable that receives the internal port for this port mapping.
