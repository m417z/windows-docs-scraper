...
The
**get_IPProtocol** method retrieves the IP Protocol associated with this port mapping.

## Parameters

### `pucIPProt` [out]

Pointer to a **UCHAR** variable that receives the IP Protocol for the port mapping. The IP Protocol is one of the following values:
