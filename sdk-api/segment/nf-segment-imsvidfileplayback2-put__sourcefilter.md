...
The **put__SourceFilter** method sets the CLSID of a DirectShow source filter to use for this source. The CLSID is specified as a string.

## Parameters

### `FileName` [in]

**BSTR** that contains the CLSID of the source filter. The **BSTR** must use the following format: `{XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX}`.
