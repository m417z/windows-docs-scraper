...
Address of a variable that receives an [IMSVidFeature](https://learn.microsoft.com/previous-versions/windows/desktop/mstv/msvidfeature) interface pointer.
...
If the method succeeds, the [IMSVidFeature](https://learn.microsoft.com/previous-versions/windows/desktop/mstv/msvidfeature) interface has an outstanding reference count. The caller must release the interface.
