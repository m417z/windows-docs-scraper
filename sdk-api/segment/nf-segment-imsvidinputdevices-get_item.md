...
Address of a variable that receives an [IMSVidInputDevice](https://learn.microsoft.com/previous-versions/windows/desktop/mstv/msvidinputdevice) interface pointer.
...
If the method succeeds, the [IMSVidInputDevice](https://learn.microsoft.com/previous-versions/windows/desktop/mstv/msvidinputdevice) interface has an outstanding reference count. The caller must release the interface.
