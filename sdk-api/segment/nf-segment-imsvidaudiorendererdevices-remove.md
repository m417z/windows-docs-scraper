...
The *v* parameter must be a **VARIANT** that contains an integer type (VT_I4). The valid range is from 0 to [IMSVidAudioRendererDevices::get_Count](https://learn.microsoft.com/windows/desktop/api/segment/nf-segment-imsvidaudiorendererdevices-get_count) - 1.
...
[IMSVidAudioRendererDevices::Add](https://learn.microsoft.com/windows/desktop/api/segment/nf-segment-imsvidaudiorendererdevices-add)