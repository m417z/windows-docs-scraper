...
The **ResetFilterList** method clears the list of filters that were added using [IMSVidGenericSink2::AddFilter](https://learn.microsoft.com/windows/desktop/api/segment/nf-segment-imsvidgenericsink2-addfilter).
