...
This method always returns **NULL**. [GetLastError](https://learn.microsoft.com/windows/desktop/api/errhandlingapi/nf-errhandlingapi-getlasterror) will return **ERROR_CALL_NOT_IMPLEMENTED**.
