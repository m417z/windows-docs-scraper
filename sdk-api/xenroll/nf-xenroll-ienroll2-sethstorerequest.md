...
The **SetHStoreRequest** method specifies the handle to use for the request store. This method was first defined in the [IEnroll2](https://learn.microsoft.com/windows/desktop/api/xenroll/nn-xenroll-ienroll2) interface.
