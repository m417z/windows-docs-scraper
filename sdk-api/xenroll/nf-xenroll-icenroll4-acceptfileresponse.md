...
The **acceptFileResponse** method accepts delivery of the credentials issued in response to an earlier call to
[createFileRequest](https://learn.microsoft.com/windows/desktop/api/xenroll/nf-xenroll-icenroll4-createfilerequest), and it places the credentials in the appropriate store. This method was first defined in the [ICEnroll4](https://learn.microsoft.com/windows/desktop/api/xenroll/nn-xenroll-icenroll4) interface.

The response may be a [PKCS #7](https://learn.microsoft.com/windows/desktop/SecGloss/p-gly) message or a [Certificate Management over CMS](https://learn.microsoft.com/windows/desktop/SecGloss/c-gly) (CMC) response.
...
The response named in the *strResponseFileName* parameter must contain exactly one certificate; a child certificate cannot be present.
