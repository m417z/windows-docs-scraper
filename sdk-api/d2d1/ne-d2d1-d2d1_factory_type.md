...
Specifies whether Direct2D provides synchronization for an [ID2D1Factory](https://learn.microsoft.com/windows/win32/api/d2d1/nn-d2d1-id2d1factory) and the resources it creates, so that they may be safely accessed from multiple threads.
...
[CreateFactory](https://learn.microsoft.com/windows/win32/api/d2d1/nf-d2d1-d2d1createfactory)

[ID2D1Factory](https://learn.microsoft.com/windows/win32/api/d2d1/nn-d2d1-id2d1factory)

[Multithreaded Direct2D Apps](https://learn.microsoft.com/windows/win32/Direct2D/multi-threaded-direct2d-apps)