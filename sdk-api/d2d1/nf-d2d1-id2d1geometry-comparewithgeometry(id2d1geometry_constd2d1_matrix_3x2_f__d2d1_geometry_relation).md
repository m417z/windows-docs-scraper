...
When this method returns, *relation* contains a pointer to a value that describes how this geometry is related to *inputGeometry*. You must allocate storage for this parameter.
