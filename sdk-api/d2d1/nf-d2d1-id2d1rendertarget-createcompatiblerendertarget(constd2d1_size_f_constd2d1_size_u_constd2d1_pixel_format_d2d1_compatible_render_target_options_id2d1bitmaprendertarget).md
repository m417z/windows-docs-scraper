...
Type: [in] **const [D2D1_PIXEL_FORMAT](https://learn.microsoft.com/windows/win32/api/dcommon/ns-dcommon-d2d1_pixel_format)***
...
Type: [in] **[D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS](https://learn.microsoft.com/windows/win32/api/d2d1/ne-d2d1-d2d1_compatible_render_target_options)**
