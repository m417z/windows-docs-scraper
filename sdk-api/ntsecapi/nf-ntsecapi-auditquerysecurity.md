...
The **AuditQuerySecurity** function retrieves [security descriptor](https://learn.microsoft.com/windows/desktop/SecGloss/s-gly) that delegates access to audit policy.
...
The address of a pointer to a well-formed [SECURITY_DESCRIPTOR](https://learn.microsoft.com/windows/desktop/api/winnt/ns-winnt-security_descriptor) structure that controls access to the [Audit security object](https://learn.microsoft.com/windows/desktop/SecGloss/a-gly).
...
[AuditSetSecurity](https://learn.microsoft.com/windows/desktop/api/ntsecapi/nf-ntsecapi-auditsetsecurity)