...
To successfully call this function, the caller must have **SeSecurityPrivilege** or have both **AUDIT_QUERY_SYSTEM_POLICY** and **AUDIT_QUERY_USER_POLICY** access on the [Audit security object](https://learn.microsoft.com/windows/desktop/SecGloss/a-gly).