...
To successfully call this function, the caller must have **SeSecurityPrivilege** or have **AUDIT_QUERY_SYSTEM_POLICY** access on the [audit security object](https://learn.microsoft.com/windows/desktop/SecGloss/a-gly).