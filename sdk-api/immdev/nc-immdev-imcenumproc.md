...
An application must register this function by passing its address to the [ImmEnumInputContext](https://learn.microsoft.com/windows/win32/api/imm/nf-imm-immenuminputcontext) function.

## See also

[ImmEnumInputContext](https://learn.microsoft.com/windows/win32/api/imm/nf-imm-immenuminputcontext)
