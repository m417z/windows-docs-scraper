...
apply to this function. For an example of creating a device query to retrieve properties based on the specified query parameters and object ID, see [DevCreateObjectQueryFromId](https://learn.microsoft.com/windows/win32/api/devquery/nf-devquery-devcreateobjectqueryfromid).
