...
For an example of creating device query to retrieve properties based on the specified query parameters and a list of object IDs, see [DevCreateObjectQueryFromIds](https://learn.microsoft.com/windows/win32/api/devquery/nf-devquery-devcreateobjectqueryfromids).
