...
The following example demonstrates calling **DevGetObjectPropertiesEx** to retrieve a set of requested properties and then calling [DevFindProperty](https://learn.microsoft.com/windows/win32/api/devquery/nf-devquery-devfindproperty) to find a particular property within an array of **DEVPROPERTY** structures.
