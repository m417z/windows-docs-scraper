...
A multi-sz list of object identifiers for objects the query should operate on. For information about multi-sz strings, see [REG_MULTI_SZ](https://learn.microsoft.com/windows/win32/sysinfo/registry-value-types).
...
When a client wants to retrieve data about a specific set of objects given their identity, use this function rather than [DevCreateObjectQuery](https://learn.microsoft.com/windows/win32/api/devquery/nf-devquery-devcreateobjectquery) with a filter. This function is more efficient.
