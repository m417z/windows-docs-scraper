...
### `pWaveFormatCurrent` [out]

Pointer to a [WAVEFORMATEX](https://learn.microsoft.com/previous-versions/dd757713(v=vs.85)) structure that contains the current data format.
...
[IAudioData::SetFormat](https://learn.microsoft.com/windows/desktop/api/austream/nf-austream-iaudiodata-setformat)