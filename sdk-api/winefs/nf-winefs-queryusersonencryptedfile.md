...
A pointer to a
[ENCRYPTION_CERTIFICATE_HASH_LIST](https://learn.microsoft.com/windows/desktop/api/winefs/ns-winefs-encryption_certificate_hash_list) structure that receives the list of users.
...
[FreeEncryptionCertificateHashList](https://learn.microsoft.com/windows/desktop/api/winefs/nf-winefs-freeencryptioncertificatehashlist) function to free the list.
