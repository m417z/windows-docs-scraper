...
An [IMbnPin](https://learn.microsoft.com/windows/desktop/api/mbnapi/nn-mbnapi-imbnpin) interface that the PIN type.
...
| **E_MBN_FAILURE** | There is a failed attempt to use the PIN. |
...
The **OnDisableComplete** method is called by the Mobile Broadband service to report the completion status of a PIN disable operation initialized by a call to the [Disable](https://learn.microsoft.com/windows/desktop/api/mbnapi/nf-mbnapi-imbnpin-disable) method of [IMbnPin](https://learn.microsoft.com/windows/desktop/api/mbnapi/nn-mbnapi-imbnpin).
