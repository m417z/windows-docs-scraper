...
The [IMbnDeviceService](https://learn.microsoft.com/windows/desktop/api/mbnapi/nn-mbnapi-imbndeviceservice) object on which the **OpenDataSession** was requested.
...
The request ID that was assigned by the Mobile Broadband service to the **OpenDataSession** request.
