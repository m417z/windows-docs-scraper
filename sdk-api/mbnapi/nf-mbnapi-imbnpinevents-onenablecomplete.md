...
The **OnEnableComplete** method is called by the Mobile Broadband service to report the completion status of a PIN enable operation initialized by a call to the [Enable](https://learn.microsoft.com/windows/desktop/api/mbnapi/nf-mbnapi-imbnpin-enable) method of [IMbnPin](https://learn.microsoft.com/windows/desktop/api/mbnapi/nn-mbnapi-imbnpin).
