...
The **OnEnterComplete** method is called by the Mobile Broadband service to report the completion status of a PIN enter operation initialized by a call to the [Enter](https://learn.microsoft.com/windows/desktop/api/mbnapi/nf-mbnapi-imbnpin-enter) method of [IMbnPin](https://learn.microsoft.com/windows/desktop/api/mbnapi/nn-mbnapi-imbnpin).
