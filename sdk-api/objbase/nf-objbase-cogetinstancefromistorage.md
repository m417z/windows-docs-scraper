...
Creates a new object and initializes it from a storage object through an internal call to [IPersistFile::Load](https://learn.microsoft.com/windows/desktop/api/objidl/nf-objidl-ipersistfile-load).
...
A pointer to the class identifier of the object to be created. This parameter can be **NULL**, in which case there is a call to [IStorage::Stat](https://learn.microsoft.com/windows/desktop/api/objidl/nf-objidl-istorage-stat) to find the class of the object.
...
A pointer to the storage object used to initialize the object with [IPersistFile::Load](https://learn.microsoft.com/windows/desktop/api/objidl/nf-objidl-ipersistfile-load). This parameter cannot be **NULL**.
