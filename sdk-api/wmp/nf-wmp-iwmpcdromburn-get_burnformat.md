...
Pointer to a variable that receives a value from the **WMPBurnFormat** enumeration that indicates the type of CD to burn.
...
[WMPBurnFormat](https://learn.microsoft.com/windows/desktop/api/wmp/ne-wmp-wmpburnformat)