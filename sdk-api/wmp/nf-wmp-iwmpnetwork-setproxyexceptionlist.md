...
**BSTR** containing a semicolon-delimited list of hosts for which the proxy server is bypassed. Leading and trailing spaces should not be present.
...
[IWMPNetwork::getProxyExceptionList](https://learn.microsoft.com/windows/desktop/api/wmp/nf-wmp-iwmpnetwork-getproxyexceptionlist)
