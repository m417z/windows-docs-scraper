...
Pointer to a **long** containing the frame rate in frames per second (fps).
...
[IWMPNetwork::get_frameRate](https://learn.microsoft.com/windows/desktop/api/wmp/nf-wmp-iwmpnetwork-get_framerate)