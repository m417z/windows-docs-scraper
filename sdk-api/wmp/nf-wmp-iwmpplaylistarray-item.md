...
**long** containing the index that identifies the playlist that the method should retrieve.

### `ppItem` [out]

Pointer to a pointer to an **IWMPPlaylist** interface for the retrieved playlist.
...
[IWMPPlaylistArray Interface](https://learn.microsoft.com/windows/desktop/api/wmp/nn-wmp-iwmpplaylistarray)