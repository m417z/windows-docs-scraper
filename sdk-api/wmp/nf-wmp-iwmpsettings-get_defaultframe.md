...
### `pbstrDefaultFrame` [out]

Pointer to a **BSTR** containing the value of the name attribute of the target FRAME element.
...
This method is ignored when using the Netscape Navigator Java applet. In Navigator, each URL script command received will display the URL in a new browser window, regardless of the value retrieved by **get_defaultFrame**.
