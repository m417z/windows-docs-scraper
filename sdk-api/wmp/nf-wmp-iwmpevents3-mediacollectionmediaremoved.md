...
Pointer to the **IDispatch** interface that represents the media item removed from the local library. Call **QueryInterface** to retrieve a pointer to **IWMPMedia**.
