...
Address of a variable that receives the **IWMPPlaylist** pointer of the playlist to burn.
...
[IWMPCdromBurn::put_burnPlaylist](https://learn.microsoft.com/windows/desktop/api/wmp/nf-wmp-iwmpcdromburn-put_burnplaylist)
