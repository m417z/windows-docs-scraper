...
Pointer to a **BSTR** containing the name of the proxy server being used. The value retrieved is meaningful only when **IWMPNetwork::getProxySettings** retrieves a value of 2 (use manual settings).
...
[IWMPNetwork::setProxyName](https://learn.microsoft.com/windows/desktop/api/wmp/nf-wmp-iwmpnetwork-setproxyname)