...
The **add** method adds a folder to the list of monitored folders.

## Parameters

### `bstrFolder` [in]

**BSTR** containing the path to the folder.
...
[IWMPFolderMonitorServices::remove](https://learn.microsoft.com/windows/desktop/api/wmp/nf-wmp-iwmpfoldermonitorservices-remove)