...
**long** containing the volume level ranging from 0 to 100.
...
[IWMPSettings::get_volume](https://learn.microsoft.com/windows/desktop/api/wmp/nf-wmp-iwmpsettings-get_volume)