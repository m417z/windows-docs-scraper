...
### `fEnableErrorDialogs` [in]

**VARIANT_BOOL** indicating whether error dialog boxes are displayed automatically. The default is **TRUE**.
...
[IWMPSettings::get_enableErrorDialogs](https://learn.microsoft.com/windows/desktop/api/wmp/nf-wmp-iwmpsettings-get_enableerrordialogs)