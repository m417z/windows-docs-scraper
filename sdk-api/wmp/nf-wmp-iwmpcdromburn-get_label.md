...
Pointer to a **BSTR** that contains the volume label string.
...
[IWMPCdromBurn::put_label](https://learn.microsoft.com/windows/desktop/api/wmp/nf-wmp-iwmpcdromburn-put_label)