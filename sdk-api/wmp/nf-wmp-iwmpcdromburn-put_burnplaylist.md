...
Pointer to an **IWMPPlaylist** interface for the playlist to burn.
...
[IWMPCdromBurn::get_burnPlaylist](https://learn.microsoft.com/windows/desktop/api/wmp/nf-wmp-iwmpcdromburn-get_burnplaylist)
