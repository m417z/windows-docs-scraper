...
**long** containing the buffering time, which ranges from zero to 60,000 with a default value of 5,000.
...
[IWMPNetwork::get_bufferingTime](https://learn.microsoft.com/windows/desktop/api/wmp/nf-wmp-iwmpnetwork-get_bufferingtime)