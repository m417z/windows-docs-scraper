...
Pointer to a null-terminated string that specifies the domain name. This string must be the same as one of the strings returned by [DsListDomainsInSite](https://learn.microsoft.com/windows/desktop/api/ntdsapi/nf-ntdsapi-dslistdomainsinsitea) function.
...
[DS_NAME_RESULT](https://learn.microsoft.com/windows/desktop/api/ntdsapi/ns-ntdsapi-ds_name_resulta) structure that receives the list of servers in the domain. The returned structure must be freed using
