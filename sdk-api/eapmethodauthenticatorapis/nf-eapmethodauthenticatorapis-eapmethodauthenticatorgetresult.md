...
A pointer to a [EAP_METHOD_AUTHENTICATOR_RESULT](https://learn.microsoft.com/windows/win32/api/eapauthenticatoractiondefine/ns-eapauthenticatoractiondefine-eap_method_authenticator_result) structure that contains the authentication results.
