...
Gets metadata from a [security support provider](https://learn.microsoft.com/windows/desktop/SecGloss/s-gly) (SSP) when it is initiating a [security context](https://learn.microsoft.com/windows/desktop/SecGloss/c-gly).
...
A pointer to the **SpQueryMetaDataFn** function is available in the
