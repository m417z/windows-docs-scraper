...
Writes the specified credential to the [Credential Manager](https://learn.microsoft.com/windows/desktop/SecAuthN/credential-manager).
...
A pointer to an [ENCRYPTED_CREDENTIALW](https://learn.microsoft.com/windows/desktop/api/ntsecpkg/ns-ntsecpkg-encrypted_credentialw) structure that represents the credentials to write.
...
A pointer to the **CrediWrite** function is available in the
