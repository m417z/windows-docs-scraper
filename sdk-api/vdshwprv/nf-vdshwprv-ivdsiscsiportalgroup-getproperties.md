...
### `pPortalGroupProp` [out]

The address of a [VDS_ISCSI_PORTALGROUP_PROP](https://learn.microsoft.com/windows/desktop/api/vdshwprv/ns-vdshwprv-vds_iscsi_portalgroup_prop)
