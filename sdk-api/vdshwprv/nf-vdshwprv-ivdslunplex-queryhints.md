...
Pointer to the returned plex hints. See the [VDS_HINTS](https://learn.microsoft.com/windows/desktop/api/vdshwprv/ns-vdshwprv-vds_hints) structure.
...
| **VDS_E_OBJECT_DELETED**<br><br>0x8004240BL | The LUN plex object is no longer present. |
...
Callers can specify hints by passing in the *pHints* parameter to the [IVdsSubSystem::CreateLun](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdssubsystem-createlun) method when creating a LUN, or by using the [IVdsLunPlex::ApplyHints](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdslunplex-applyhints) method to apply a set of new hints to an existing plex.

Note that calls to the [IVdsLun::ApplyHints](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdslun-applyhints) method can impact the plexes that contribute to the LUN. To view hints for the entire LUN, use the [IVdsLun::QueryHints](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdslun-queryhints) method.
