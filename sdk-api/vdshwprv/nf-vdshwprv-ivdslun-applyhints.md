...
[VDS_HINTS](https://learn.microsoft.com/windows/desktop/api/vdshwprv/ns-vdshwprv-vds_hints) structure.
...
Instead of using this method, callers can specify hints by passing in the *pHints*
parameter to the [IVdsSubSystem::CreateLun](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdssubsystem-createlun)
method when creating a LUN. Use the
[IVdsLun::QueryHints](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdslun-queryhints) method to query for existing
hints.
