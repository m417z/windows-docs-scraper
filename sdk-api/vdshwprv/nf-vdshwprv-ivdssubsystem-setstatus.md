...
Values enumerated by [VDS_SUB_SYSTEM_STATUS](https://learn.microsoft.com/windows/desktop/api/vdshwprv/ne-vdshwprv-vds_sub_system_status).
Callers can pass in a subset of the possible enumeration values. Passing in
**VDS_SSS_UNKNOWN** returns **E_INVALIDARG**.
...
state. For example, if the caller passes in **VDS_SSS_OFFLINE** as the subsystem status,
