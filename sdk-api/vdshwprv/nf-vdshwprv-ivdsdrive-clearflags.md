...
The flags enumerated by [VDS_DRIVE_FLAG](https://learn.microsoft.com/windows/desktop/api/vdshwprv/ne-vdshwprv-vds_drive_flag). Callers can clear the **VDS_DRF_HOTSPARE** flag.
...
Use [IVdsDrive::SetFlags](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdsdrive-setflags) to set drive flags and [IVdsDrive::GetProperties](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdsdrive-getproperties) to get currently set flags.
...
[IVdsDrive::SetFlags](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdsdrive-setflags)
