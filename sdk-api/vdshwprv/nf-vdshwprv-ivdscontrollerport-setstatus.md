...
A value enumerated by the [VDS_PORT_STATUS](https://learn.microsoft.com/windows/desktop/api/vdshwprv/ne-vdshwprv-vds_port_status) enumeration. Passing in
**VDS_PRS_UNKNOWN** fails with **E_INVALIDARG**.
...
| --- | --- |
| **S_OK** | The status was successfully set. |
