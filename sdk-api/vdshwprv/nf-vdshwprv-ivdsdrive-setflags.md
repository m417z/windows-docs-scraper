...
Flags enumerated by [VDS_DRIVE_FLAG](https://learn.microsoft.com/windows/desktop/api/vdshwprv/ne-vdshwprv-vds_drive_flag). Callers can set the **VDS_DRF_HOTSPARE** flag.
