...
Pointer to the hints to be applied to the LUN plex. See the [VDS_HINTS](https://learn.microsoft.com/windows/desktop/api/vdshwprv/ns-vdshwprv-vds_hints) structure. Only fields relevant to a LUN plex are expected to be set; irrelevant fields are ignored.
...
Use the [IVdsLunPlex::QueryHints](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nf-vdshwprv-ivdslunplex-queryhints) method to get the current hints for the LUN plex.
