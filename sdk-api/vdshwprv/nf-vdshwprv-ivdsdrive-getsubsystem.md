...
The address of an [IVdsSubSystem](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nn-vdshwprv-ivdssubsystem) interface pointer. The caller must release the interface.
