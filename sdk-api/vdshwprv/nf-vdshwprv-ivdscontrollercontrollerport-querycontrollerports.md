...
Returns an [IEnumVdsObject](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nn-vdshwprv-ienumvdsobject) object that
...
| --- | --- |
| ****S_OK**** | The enumeration of controller ports was returned successfully. If the controller has no ports, the enumeration is empty. |
...
[IVdsControllerControllerPort](https://learn.microsoft.com/windows/desktop/api/vdshwprv/nn-vdshwprv-ivdscontrollercontrollerport)