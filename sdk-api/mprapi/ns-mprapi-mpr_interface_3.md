...
The
**MPR_INTERFACE_3** structure contains data for a router demand-dial interface.
...
The
**MPR_INTERFACE_3** structure has a number of members that are similar to members of the
