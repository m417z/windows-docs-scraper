...
The
**MprAdminPortDisconnect** function disconnects a connection on a specific port.
...
**RasAdminPortDisconnect** rather than
**MprAdminPortDisconnect**. Therefore, when using the RRAS redistributable, use
