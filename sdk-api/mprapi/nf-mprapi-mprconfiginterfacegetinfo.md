...
The
**MprConfigInterfaceGetInfo** function retrieves the configuration for the specified interface from the router.
...
| Value | Meaning |
| --- | --- |
| **ERROR_INVALID_PARAMETER** | At least one of the following is true: <br><br>* *hMprConfig* is **NULL**<br>* *hRouterInterface* is **NULL**<br>* *dwLevel* is not 0, 1, 2, or 3.<br>* *lplpBuffer* is **NULL**<br>* *lpdwBufferSize* is **NULL** |
