...
Sets the power attributes of a power key. If the *PowerSettingGuid* parameter is
**NULL** then the attribute for *SubGroupGuid* is set, otherwise the attribute for
*PowerSettingGuid* is set.
