...
*SubGroupGuid* parameter is **NULL** then the attribute for
*PowerSettingGuid* is returned. If the *PowerSettingGuid*
parameter is **NULL** then the attribute for *SubGroupGuid* is
returned. If both the *SubGroupGuid* and *PowerSettingGuid*
...
| --- | --- |
| **POWER_ATTRIBUTE_HIDE**<br><br>1 | Hide this power setting. |
