...
are **NULL**, the friendly name of the power scheme will be returned. If the
*SchemeGuid* and *SubGroupOfPowerSettingsGuid* parameters are not
**NULL** and the *PowerSettingGuid* parameter is
**NULL**, the friendly name of the subgroup will be returned. If the
*SchemeGuid*, *SubGroupOfPowerSettingsGuid*, and
*PowerSettingGuid* parameters are not **NULL**, the friendly name of
...
The subgroup of power settings. Use **NO_SUBGROUP_GUID** to refer to the
...
A pointer to a buffer that receives the friendly name. If this parameter is **NULL**,
the *BufferSize*
...
**ERROR_MORE_DATA** will be returned and the **DWORD** pointed
