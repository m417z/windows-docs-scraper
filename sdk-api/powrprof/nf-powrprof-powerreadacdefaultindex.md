# PowerReadACDefaultIndex function
...
### `SchemePersonalityGuid` [in]

The identifier for the scheme personality for this power setting. A power setting can have different default
