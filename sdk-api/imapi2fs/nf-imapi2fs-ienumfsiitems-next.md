...
Array of [IFsiItem](https://learn.microsoft.com/windows/desktop/api/imapi2fs/nn-imapi2fs-ifsiitem) interfaces. You must release each interface in rgelt when done.
