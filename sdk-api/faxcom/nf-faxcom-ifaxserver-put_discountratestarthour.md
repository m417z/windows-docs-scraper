...
Sets or retrieves the **DiscountRateStartHour** property for a [FaxServer](https://learn.microsoft.com/previous-versions/windows/desktop/fax/-mfax-faxserver-client) object. The **DiscountRateStartHour** property is a number that represents the hour the discount period begins. The discount period applies only to outgoing fax transmissions.
...
The **DiscountRateStartHour**, [DiscountRateStartMinute](https://learn.microsoft.com/previous-versions/windows/desktop/fax/-mfax-ifaxserver-get-discountratestartminute-vb), [DiscountRateEndHour](https://learn.microsoft.com/previous-versions/windows/desktop/fax/-mfax-ifaxserver-get-discountrateendhour-vb), and [DiscountRateEndMinute](https://learn.microsoft.com/previous-versions/windows/desktop/fax/-mfax-ifaxserver-get-discountrateendminute-vb) properties represent local time.
