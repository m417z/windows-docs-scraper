...
The
**INTERFACE_INFO_EX** structure is used in conjunction with the **SIO_GET_INTERFACE_LIST IOCTL** command to obtain information about an interface IP address. Unlike the [INTERFACE_INFO](https://learn.microsoft.com/windows/desktop/api/ws2ipdef/ns-ws2ipdef-interface_info) structure, **INTERFACE_INFO_EX** is address-size independent, enabling it to work with IPv6.
