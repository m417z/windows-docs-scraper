...
Pointer to a buffer that receives the user name. To find the required buffer size, set this parameter to **NULL**. If *fEncryptData* is **FALSE**, the buffer contains a wide-character string. Otherwise, the buffer contains encrypted data.
...
[IMFNetCredential::SetUser](https://learn.microsoft.com/windows/desktop/api/mfidl/nf-mfidl-imfnetcredential-setuser)