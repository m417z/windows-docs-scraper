...
The data stored in the device with this method can be retrieved with [ID3D10DeviceChild::GetPrivateData](https://learn.microsoft.com/windows/desktop/api/d3d10/nf-d3d10-id3d10device-getprivatedata).
