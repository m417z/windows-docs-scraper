...
Invalidate the pointer to the resource retrieved by [ID3D10Texture3D::Map](https://learn.microsoft.com/windows/desktop/api/d3d10/nf-d3d10-id3d10texture3d-map), and re-enable the GPU's access to the resource.
