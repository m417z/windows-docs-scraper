...
Address of a pointer to an [ID3D10VertexShader Interface](https://learn.microsoft.com/windows/desktop/api/d3d10/nn-d3d10-id3d10vertexshader). If this is **NULL**, all other parameters will be validated, and if all parameters pass validation this API will return S_FALSE instead of S_OK.
