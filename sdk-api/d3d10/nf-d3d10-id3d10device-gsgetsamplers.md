...
Get an array of sampler states from the [geometry shader](https://learn.microsoft.com/previous-versions/bb205146(v=vs.85)) pipeline stage.
...
Array of sampler-state pointers (see [ID3D10SamplerState](https://learn.microsoft.com/windows/desktop/api/d3d10/nn-d3d10-id3d10samplerstate)) to be returned by the device.
