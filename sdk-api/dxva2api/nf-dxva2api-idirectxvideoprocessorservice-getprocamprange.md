...
The
ProcAmp setting to query. See [ProcAmp Settings](https://learn.microsoft.com/windows/desktop/medfound/procamp-settings).

### `pRange` [out]

A pointer to a [DXVA2_ValueRange](https://learn.microsoft.com/windows/desktop/api/dxva2api/ns-dxva2api-dxva2_valuerange) structure that receives the range of values for the setting specified in *ProcAmpCaps*.
