...
The **IPsecSaDestroyEnumHandle0** function frees a handle returned by [IPsecSaCreateEnumHandle0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-ipsecsacreateenumhandle0).
...
Handle of the enumeration to destroy. Previously created by a call to [IPsecSaCreateEnumHandle0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-ipsecsacreateenumhandle0).
