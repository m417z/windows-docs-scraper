...
**Note** **FwpmNetEventEnum0** is the specific implementation of FwpmNetEventEnum used in Windows Vista. See [WFP Version-Independent Names and Targeting Specific Versions of Windows](https://learn.microsoft.com/windows/desktop/FWP/wfp-version-independent-names-and-targeting-specific-versions-of-windows) for more information. For Windows 7, [FwpmNetEventEnum1](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmneteventenum1) is available. For Windows 8, [FwpmNetEventEnum2](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmneteventenum2) is available.
...
Type: [FWPM_NET_EVENT0](https://learn.microsoft.com/windows/desktop/api/fwpmtypes/ns-fwpmtypes-fwpm_net_event0)***
