...
Handle of the subscribed event notification. This is the returned handle from the call to [FwpmvSwitchEventSubscribe0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmvswitcheventsubscribe0).
...
**FwpmvSwitchEventUnsubscribe0** is a specific implementation of FwpmvSwitchEventUnsubscribe. See [WFP Version-Independent Names and Targeting Specific Versions of Windows](https://learn.microsoft.com/windows/desktop/FWP/wfp-version-independent-names-and-targeting-specific-versions-of-windows) for more information.
