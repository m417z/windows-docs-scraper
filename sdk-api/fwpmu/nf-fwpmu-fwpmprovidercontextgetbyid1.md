...
A run-time identifier for the desired object. This must be the run-time identifier that was received from the system when the application called [FwpmProviderContextAdd1](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmprovidercontextadd1) for this object.
