...
Handle for an IPsec DoS Protection enumeration. Call [IPsecDospStateCreateEnumHandle0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-ipsecdospstatecreateenumhandle0) to obtain an enumeration handle.
...
Type: [IPSEC_DOSP_STATE0](https://learn.microsoft.com/windows/desktop/api/ipsectypes/ns-ipsectypes-ipsec_dosp_state0)***
...
| --- | --- |
| **ERROR_SUCCESS**<br><br>0 | The results were enumerated successfully. |
