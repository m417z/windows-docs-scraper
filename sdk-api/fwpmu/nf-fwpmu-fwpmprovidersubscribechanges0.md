...
Type: **[FWPM_PROVIDER_CHANGE_CALLBACK0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nc-fwpmu-fwpm_provider_change_callback0)**
...
The caller needs [FWPM_ACTRL_SUBSCRIBE](https://learn.microsoft.com/windows/desktop/FWP/access-right-identifiers) access to the provider's container and
**FWPM_ACTRL_READ** access to the provider. The subscriber will only get notifications for providers to which it has
...
**FwpmProviderSubscribeChanges0** is a specific implementation of FwpmProviderSubscribeChanges. See [WFP Version-Independent Names and Targeting Specific Versions of Windows](https://learn.microsoft.com/windows/desktop/FWP/wfp-version-independent-names-and-targeting-specific-versions-of-windows) for more information.

## See also

[FWPM_PROVIDER_CHANGE_CALLBACK0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nc-fwpmu-fwpm_provider_change_callback0)
