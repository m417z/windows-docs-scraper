...
Unique identifier of the sublayer. This is the same GUID that was specified when the application called [FwpmSubLayerAdd0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmsublayeradd0).
...
| --- | --- |
| **ERROR_SUCCESS**<br><br>0 | The sublayer was retrieved successfully. |
