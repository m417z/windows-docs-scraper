...
**Note** **FwpmProviderContextGetByKey1** is the specific implementation of FwpmProviderContextGetByKey used in Windows 7. See [WFP Version-Independent Names and Targeting Specific Versions of Windows](https://learn.microsoft.com/windows/desktop/FWP/wfp-version-independent-names-and-targeting-specific-versions-of-windows) for more information. For Windows 8, [FwpmProviderContextGetByKey2](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmprovidercontextgetbykey2) is available. For Windows Vista, [FwpmProviderContextGetByKey0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmprovidercontextgetbykey0) is available.
...
Pointer to a GUID that uniquely identifies the provider context. This is a pointer to the same GUID that was specified when the application called [FwpmProviderContextAdd1](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmprovidercontextadd1) for this object.
...
[FwpmProviderContextAdd1](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmprovidercontextadd1)