...
**IPsecSaDbSetSecurityInfo0** is a specific implementation of IPsecSaDbSetSecurityInfo. See [WFP Version-Independent Names and Targeting Specific Versions of Windows](https://learn.microsoft.com/windows/desktop/FWP/wfp-version-independent-names-and-targeting-specific-versions-of-windows) for more information.

## See also

[IPsecSaDbGetSecurityInfo0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-ipsecsadbgetsecurityinfo0)