...
Pointer to a function of type [FWPM_NET_EVENT_CALLBACK4](https://learn.microsoft.com/windows/win32/api/fwpmu/nc-fwpmu-fwpm_net_event_callback4), which will be invoked when a notification is ready for delivery.
