...
Unique identifier of the object being removed from the system. This is the same GUID that was specified when the application called [FwpmFilterAdd0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmfilteradd0) for this object.
...
**FwpmFilterDeleteByKey0** is a specific implementation of FwpmFilterDeleteByKey. See [WFP Version-Independent Names and Targeting Specific Versions of Windows](https://learn.microsoft.com/windows/desktop/FWP/wfp-version-independent-names-and-targeting-specific-versions-of-windows) for more information.

## See also

[FwpmFilterAdd0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmfilteradd0)

[FwpmFilterGetByKey0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmfiltergetbykey0)