...
**FwpmEngineSetSecurityInfo0** cannot be called from within a transaction. It will fail
...
[FwpmEngineGetSecurityInfo0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmenginegetsecurityinfo0)