...
Unique identifier of the filter. This GUID was specified in the **filterKey** member of the *filter* parameter when the application called [FwpmFilterAdd0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmfilteradd0) for this object.
...
**FwpmFilterGetSecurityInfoByKey0** is a specific implementation of FwpmFilterGetSecurityInfoByKey. See [WFP Version-Independent Names and Targeting Specific Versions of Windows](https://learn.microsoft.com/windows/desktop/FWP/wfp-version-independent-names-and-targeting-specific-versions-of-windows) for more information.

## See also

[FwpmFilterSetSecurityInfoByKey0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmfiltersetsecurityinfobykey0)