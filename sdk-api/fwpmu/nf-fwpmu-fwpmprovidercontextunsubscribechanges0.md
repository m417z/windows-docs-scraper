...
The **FwpmProviderContextUnsubscribeChanges0** function is used to cancel a provider context change subscription and stop receiving change notifications.
...
Handle of the subscribed change notification. This is the handle returned by [FwpmProviderContextSubscribeChanges0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmprovidercontextsubscribechanges0).
...
**FwpmProviderContextUnsubscribeChanges0** is a specific implementation of FwpmProviderContextUnsubscribeChanges. See [WFP Version-Independent Names and Targeting Specific Versions of Windows](https://learn.microsoft.com/windows/desktop/FWP/wfp-version-independent-names-and-targeting-specific-versions-of-windows) for more information.
