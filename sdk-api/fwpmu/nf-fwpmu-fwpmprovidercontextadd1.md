...
**Note** **FwpmProviderContextAdd1** is the specific implementation of FwpmProviderContextAdd used in Windows 7. See [WFP Version-Independent Names and Targeting Specific Versions of Windows](https://learn.microsoft.com/windows/desktop/FWP/wfp-version-independent-names-and-targeting-specific-versions-of-windows) for more information. For Windows 8, [FwpmProviderContextAdd2](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmprovidercontextadd2) is available. For Windows Vista, [FwpmProviderContextAdd0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmprovidercontextadd0) is available.
...
| **ERROR_NOT_SUPPORTED**<br><br>0x32 | The [IKEEXT_IPV6_CGA](https://learn.microsoft.com/windows/desktop/api/iketypes/ne-iketypes-ikeext_authentication_method_type) authentication method in the **authenticationMethods** array, but cryptographically generated address (CGA) is not enabled in the registry. |
