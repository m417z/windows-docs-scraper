...
**Note** **IPsecSaEnum1** is the specific implementation of IPsecSaEnum used in Windows 7 and later. See [WFP Version-Independent Names and Targeting Specific Versions of Windows](https://learn.microsoft.com/windows/desktop/FWP/wfp-version-independent-names-and-targeting-specific-versions-of-windows) for more information. For Windows Vista, [IPsecSaEnum0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-ipsecsaenum0) is available.
