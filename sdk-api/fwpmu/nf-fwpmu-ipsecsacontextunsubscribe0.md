...
The **IPsecSaContextUnsubscribe0** function is used to cancel an IPsec security association (SA) change subscription and stop receiving change notifications.
...
Handle of the subscribed SA change notification. This is the returned handle from the call to [IPsecSaContextSubscribe0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-ipsecsacontextsubscribe0).
