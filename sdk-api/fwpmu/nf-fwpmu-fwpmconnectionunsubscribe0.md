...
Handle of the subscribed event notification. This is the returned handle from the call to [FwpmConnectionSubscribe0](https://learn.microsoft.com/windows/desktop/api/fwpmu/nf-fwpmu-fwpmconnectionsubscribe0).
