...
**StackWalkEx** function. If the symbol handler is used with
**StackWalkEx**, use the same process handles for the calls
to each function.
...
A pointer to a [STACKFRAME_EX](https://learn.microsoft.com/windows/desktop/api/dbghelp/ns-dbghelp-stackframe_ex) structure. This
...
valid context record. This allows **StackWalkEx** to handle
...
**StackWalkEx** function needs to read memory from the
...
required because the **StackWalkEx** function does not have
...
Most callers of **StackWalkEx** can safely pass
...
**StackWalkEx** generally does not set the last error
code.

## Remarks

The **StackWalkEx** function provides a portable method
for obtaining a stack trace. Using the **StackWalkEx**
...
[STACKFRAME_EX](https://learn.microsoft.com/windows/desktop/api/dbghelp/ns-dbghelp-stackframe_ex)

[SymFunctionTableAccess64](https://learn.microsoft.com/windows/desktop/api/dbghelp/nf-dbghelp-symfunctiontableaccess)

[SymGetModuleBase64](https://learn.microsoft.com/windows/desktop/api/dbghelp/nf-dbghelp-symgetmodulebase)
