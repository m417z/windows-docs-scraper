...
To control which directory receives the source files, use the [SymSetHomeDirectory](https://learn.microsoft.com/windows/desktop/api/dbghelp/nf-dbghelp-symsethomedirectory) function.
