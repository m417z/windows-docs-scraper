...
A pointer to an
[IMAGEHLP_MODULE64](https://learn.microsoft.com/windows/desktop/api/dbghelp/ns-dbghelp-imagehlp_module) structure. The **SizeOfStruct** member must be set to the size of the
...
[IMAGEHLP_MODULE64](https://learn.microsoft.com/windows/desktop/api/dbghelp/ns-dbghelp-imagehlp_module)
