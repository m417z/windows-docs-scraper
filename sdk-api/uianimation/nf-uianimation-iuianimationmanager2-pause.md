...
When an animation manager is paused, its status is set to [UI_ANIMATION_MANAGER_IDLE](https://learn.microsoft.com/windows/win32/api/uianimation/ne-uianimation-ui_animation_manager_status).
