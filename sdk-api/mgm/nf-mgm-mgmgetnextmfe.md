...
Pointer to a
[MIB_IPMCAST_MFE](https://learn.microsoft.com/windows/desktop/api/ipmib/ns-ipmib-mib_ipmcast_mfe) structure that specifies from where to begin retrieving MFEs. The **dwSource** and **dwGroup** members of the
...
[MgmGetFirstMfe](https://learn.microsoft.com/windows/desktop/api/mgm/nf-mgm-mgmgetfirstmfe) or
**MgmGetNextMfe**.
...
[MgmGetFirstMfe](https://learn.microsoft.com/windows/desktop/api/mgm/nf-mgm-mgmgetfirstmfe) to start the retrieval process.

In general, to retrieve MFEs, first call
[MgmGetFirstMfe](https://learn.microsoft.com/windows/desktop/api/mgm/nf-mgm-mgmgetfirstmfe). Then, call
**MgmGetNextMfe** one or more times, until there are no more MFEs to return. Each call to
