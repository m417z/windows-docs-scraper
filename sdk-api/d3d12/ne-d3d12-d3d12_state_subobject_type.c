typedef enum D3D12_STATE_SUBOBJECT_TYPE {
  ...
  D3D12_STATE_SUBOBJECT_TYPE_GLOBAL_SERIALIZED_ROOT_SIGNATURE,
  D3D12_STATE_SUBOBJECT_TYPE_LOCAL_SERIALIZED_ROOT_SIGNATURE,
  D3D12_STATE_SUBOBJECT_TYPE_COMPILER_EXISITING_COLLECTION,
