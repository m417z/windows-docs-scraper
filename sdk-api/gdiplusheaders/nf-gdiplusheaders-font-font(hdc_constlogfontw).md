...
**LOGFONTW** structure, which is the wide character version of a logical font. This constructor is provided for compatibility with GDI.
...
Pointer to a
**LOGFONTW** structure variable that contains attributes of the font. The
**LOGFONTW** structure is the wide character version of the logical font.
...
A
**LOGFONTW** structure is a GDI structure. GDI+ uses only some of the attributes contained in this structure.
