...
Pointer to an [IStream](https://learn.microsoft.com/windows/desktop/api/objidl/nn-objidl-istream) interface that specifies the stream to which the converted metafile is written.
