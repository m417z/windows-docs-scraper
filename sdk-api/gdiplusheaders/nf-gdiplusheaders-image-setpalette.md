...
The **Image::SetPalette** method sets the color palette of this
...
Type: **const ColorPalette***

Pointer to a [ColorPalette](https://learn.microsoft.com/windows/desktop/api/gdipluspixelformats/ns-gdipluspixelformats-colorpalette) structure that specifies the palette.
