...
- [CancelIo](https://learn.microsoft.com/windows/win32/FileIO/cancelio) — This function cancels only operations issued by the calling thread for the specified file handle.
