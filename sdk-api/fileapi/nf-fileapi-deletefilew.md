...
The **DeleteFile** function marks a file for deletion on close. Therefore, the file deletion does not occur until the last handle to the file is closed. Subsequent calls to [CreateFile](https://learn.microsoft.com/windows/win32/api/fileapi/nf-fileapi-createfilew) to open the file fail with **ERROR_ACCESS_DENIED**.
...
[DeleteFileTransacted](https://learn.microsoft.com/windows/win32/api/winbase/nf-winbase-deletefiletransactedw)
