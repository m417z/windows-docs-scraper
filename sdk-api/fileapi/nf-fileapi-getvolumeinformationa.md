...
| **FILE_SUPPORTS_HARD_LINKS**<br>0x00400000 | The specified volume supports hard links. For more information, see [Hard Links and Junctions](https://learn.microsoft.com/windows/win32/FileIO/hard-links-and-junctions).<br><br>**Windows Server 2008, Windows Vista, Windows Server 2003 and Windows XP:** This value is not supported until Windows Server 2008 R2 and Windows 7. |
...
| **FILE_DAX_VOLUME**<br>0x20000000 | The specified volume is a direct access (DAX) volume.<br><br>**Note:**<br>This flag was introduced in Windows 10, version 1607. |
