...
The **DeleteFile2** function marks a file for deletion on close. Therefore, the file deletion does not occur until the last handle to the file is closed. Subsequent calls to [CreateFile](https://learn.microsoft.com/windows/win32/api/fileapi/nf-fileapi-createfilea), [CreateFile2](https://learn.microsoft.com/windows/win32/api/fileapi/nf-fileapi-createfile2), or [CreateFile3](https://learn.microsoft.com/windows/win32/api/fileapi/nf-fileapi-createfile3) to open the file fail with **ERROR_ACCESS_DENIED**.
