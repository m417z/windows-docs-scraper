...
Temporary files whose names have been created by this function are not automatically deleted. To delete these files call [DeleteFile](https://learn.microsoft.com/windows/win32/api/fileapi/nf-fileapi-deletefilew).

To avoid problems resulting when converting an ANSI string, an application should call the [CreateFile](https://learn.microsoft.com/windows/win32/api/fileapi/nf-fileapi-createfilew) function to create a temporary file.
...
[DeleteFile](https://learn.microsoft.com/windows/win32/api/fileapi/nf-fileapi-deletefilew)

[File Management Functions](https://learn.microsoft.com/windows/win32/FileIO/file-management-functions)

[GetTempPath2](https://learn.microsoft.com/windows/win32/api/fileapi/nf-fileapi-gettemppath2w)
