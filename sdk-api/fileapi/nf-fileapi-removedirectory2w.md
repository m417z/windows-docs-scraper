...
To perform this operation as a transacted operation, use the [RemoveDirectoryTransacted](https://learn.microsoft.com/windows/win32/api/winbase/nf-winbase-removedirectorytransactedw) function.
...
The use of POSIX delete causes the directory to be deleted while handles remain open. Subsequent calls to [CreateDirectory](https://learn.microsoft.com/windows/win32/api/fileapi/nf-fileapi-createdirectoryw) or [CreateDirectory2](https://learn.microsoft.com/windows/win32/api/fileapi/nf-fileapi-createdirectory2w) to open the directory fail with **ERROR_FILE_NOT_FOUND**.
...
[RemoveDirectoryTransacted](https://learn.microsoft.com/windows/win32/api/winbase/nf-winbase-removedirectorytransactedw)