...
**WCHARs**, including all **NULL** characters.

### `lpcchReturnLength` [out]

If the call is successful, this parameter is the number of **WCHARs** copied to
the *lpszVolumePathNames* buffer. Otherwise, this parameter is the size of the buffer
required to hold the complete list, in **WCHARs**.
