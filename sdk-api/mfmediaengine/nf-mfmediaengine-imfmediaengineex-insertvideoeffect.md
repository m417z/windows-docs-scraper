...
* A pointer to the [IMFTransform](https://learn.microsoft.com/windows/desktop/api/mftransform/nn-mftransform-imftransform) interface of a Media Foundation transform (MFT) that implements the video effect.
* A pointer to the [IMFActivate](https://learn.microsoft.com/windows/desktop/api/mfobjects/nn-mfobjects-imfactivate) interface of an activation object. The activation object must create an MFT for the video effect.
...
| --- | --- |
| **S_OK** | Success. |
| **MF_E_INVALIDREQUEST** | The maximum number of video effects was reached. |
