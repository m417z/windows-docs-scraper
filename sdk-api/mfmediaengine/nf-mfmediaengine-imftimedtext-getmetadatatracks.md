...
A pointer to a memory block that receives a pointer to the [IMFTimedTextTrackList](https://learn.microsoft.com/windows/desktop/api/mfmediaengine/nn-mfmediaengine-imftimedtexttracklist) interface that can enumerate the list of the timed-metadata tracks.
