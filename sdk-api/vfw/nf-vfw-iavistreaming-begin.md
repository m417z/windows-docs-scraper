...
The **Begin** method prepares for the streaming operation. Called when an application uses the [AVIStreamBeginStreaming](https://learn.microsoft.com/windows/desktop/api/vfw/nf-vfw-avistreambeginstreaming) function.
