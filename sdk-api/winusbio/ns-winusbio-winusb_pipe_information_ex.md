...
The **WINUSB_PIPE_INFORMATION_EX** structure contains pipe information that the [WinUsb_QueryPipeEx](https://learn.microsoft.com/windows/desktop/api/winusb/nf-winusb-winusb_querypipeex) routine retrieves.
