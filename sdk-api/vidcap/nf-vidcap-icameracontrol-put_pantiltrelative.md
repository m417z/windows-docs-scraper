...
Specifies the relative pan. See [ICameraControl::put_PanRelative](https://learn.microsoft.com/windows/desktop/api/vidcap/nf-vidcap-icameracontrol-put_panrelative).

### `TiltValue` [in]

Specifies the relative tilt. See [ICameraControl::put_TiltRelative](https://learn.microsoft.com/windows/desktop/api/vidcap/nf-vidcap-icameracontrol-put_tiltrelative).
