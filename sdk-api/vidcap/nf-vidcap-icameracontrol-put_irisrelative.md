...
Specifies the relative aperture setting. To get the range of possible values, call [ICameraControl::getRange_IrisRelative](https://learn.microsoft.com/windows/desktop/api/vidcap/nf-vidcap-icameracontrol-getrange_irisrelative).
