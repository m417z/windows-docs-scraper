...
Receives the relative exposure. To get the range of possible values, call [ICameraControl::getRange_ExposureRelative](https://learn.microsoft.com/windows/desktop/api/vidcap/nf-vidcap-icameracontrol-getrange_exposurerelative).

| Value | Description |
| --- | --- |
| 0 | Default exposure time. |
| Positive value | Incremented by one step. |
