# GetPackagePathByFullName2 function

## Description

Gets the path of the specified package, with the option to specify the type of folder path to retrieve for the package.
...
[GetPackagePathByFullName](https://learn.microsoft.com/windows/win32/api/appmodel/nf-appmodel-getpackagepathbyfullname)