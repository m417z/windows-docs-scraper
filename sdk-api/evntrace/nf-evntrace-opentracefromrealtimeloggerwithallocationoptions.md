...
The handle to the Memory Partition that should be used for memory allocations for this processing session. If NULL, the Memory Partition of the process will be used. See [MemExtendedParameterPartitionHandle](https://learn.microsoft.com/windows/win32/api/winnt/ne-winnt-mem_extended_parameter_type) for more details.
