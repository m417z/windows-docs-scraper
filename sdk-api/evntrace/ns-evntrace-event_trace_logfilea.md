...
[OpenTrace](https://learn.microsoft.com/windows/win32/api/evntrace/nf-evntrace-opentracea). The user
...
[OpenTrace](https://learn.microsoft.com/windows/win32/api/evntrace/nf-evntrace-opentracea). If the consumer
uses
[EventRecordCallback](https://learn.microsoft.com/windows/win32/api/evntrace/nc-evntrace-pevent_record_callback)
...
1. Call [OpenTrace](https://learn.microsoft.com/windows/win32/api/evntrace/nf-evntrace-opentracea). Note
