...
such as [ControlTrace](https://learn.microsoft.com/windows/win32/api/evntrace/nf-evntrace-controltracew).
...
[Configuring and Starting the Global Logger Session](https://learn.microsoft.com/windows/win32/etw/configuring-and-starting-the-global-logger-session).

### System Loggers

For the logger to be a system logger and receive events from
[SystemTraceProvider](https://learn.microsoft.com/windows/desktop/ETW/configuring-and-starting-a-systemtraceprovider-session)
or other [system providers](https://learn.microsoft.com/windows/win32/etw/system-providers), any of the
...
> [SystemTraceProvider](https://learn.microsoft.com/windows/win32/etw/configuring-and-starting-a-systemtraceprovider-session)
