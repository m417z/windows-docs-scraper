...
[EnableTrace](https://learn.microsoft.com/windows/win32/api/evntrace/nf-evntrace-enabletrace) and
...
- A provider that uses
[EventRegister](https://learn.microsoft.com/windows/win32/api/evntprov/nf-evntprov-eventregister) (e.g. a
...
[EventWriteEx](https://learn.microsoft.com/windows/win32/api/evntprov/nf-evntprov-eventwriteex) _Filter_
...
([manifest-based](https://learn.microsoft.com/windows/desktop/ETW/about-event-tracing) or
[TraceLogging](https://learn.microsoft.com/windows/desktop/tracelogging/trace-logging-about)) providers, a
...
([MOF or TMF-based WPP](https://learn.microsoft.com/windows/desktop/ETW/about-event-tracing)) providers. To
...
[EVENT_ENABLE_PROPERTY_IGNORE_KEYWORD_0](https://learn.microsoft.com/windows/win32/api/evntrace/ns-evntrace-enable_trace_parameters)
flag.)
...
[system trace provider events can be enabled using EnableTraceEx2](https://learn.microsoft.com/windows/win32/etw/system-providers).

Up to eight trace sessions can enable and receive events from the same modern
([manifest-based](https://learn.microsoft.com/windows/desktop/ETW/about-event-tracing) or
[TraceLogging](https://learn.microsoft.com/windows/desktop/tracelogging/trace-logging-about)) provider.
...
[EnableTrace](https://learn.microsoft.com/windows/desktop/ETW/enabletrace) except that the keyword value
is truncated from a 64-bit value to a 32-bit value.
- In the [ControlCallback](https://learn.microsoft.com/windows/desktop/ETW/controlcallback) callback, the
provider can call
[GetTraceEnableLevel](https://learn.microsoft.com/windows/desktop/ETW/gettraceenablelevel) to get the
level and [GetTraceEnableFlags](https://learn.microsoft.com/windows/desktop/ETW/gettraceenableflags) to
get the enable flag.
