...
This function is implemented using a compiler intrinsic where possible. For more information, see the WinBase.h header file and [_interlockedbittestandreset64](https://learn.microsoft.com/previous-versions/h1haebfw(v=vs.85)).
