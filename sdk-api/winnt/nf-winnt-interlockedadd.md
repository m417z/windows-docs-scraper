...
This function is implemented using a compiler intrinsic where possible. For more information, see the WinBase.h header file and [_InterlockedAdd](https://learn.microsoft.com/previous-versions/51s265a6(v=vs.85)).
