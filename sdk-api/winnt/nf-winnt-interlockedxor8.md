...
For the Intel Itanium-based systems and x64 architectures, this function is implemented using the compiler intrinsic. For the x86 architecture, use the [_InterlockedXor8](https://learn.microsoft.com/previous-versions/a8swb4hb(v=vs.85)) compiler intrinsic directly.

This function generates a full memory barrier (or fence) to ensure that memory operations are completed in order.

**Itanium-based systems:** For performance-critical applications, use [InterlockedXor8Acquire](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/ms684112(v=vs.85)) or [InterlockedXor8Release](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/ms684113(v=vs.85)) instead.
...
[InterlockedXor](https://learn.microsoft.com/windows/win32/api/winnt/nf-winnt-interlockedxor)

[InterlockedXor16](https://learn.microsoft.com/windows/desktop/api/winnt/nf-winnt-interlockedxor16)
