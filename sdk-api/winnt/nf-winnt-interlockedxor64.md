...
This function is implemented using a compiler intrinsic where possible. For more information, see the WinBase.h header file and [_InterlockedXor64](https://learn.microsoft.com/previous-versions/a8swb4hb(v=vs.85)).

This function generates a full memory barrier (or fence) to ensure that memory operations are completed in order.

**Itanium-based systems:** For performance-critical applications, use [InterlockedXor64Acquire](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/ms684107(v=vs.85)) or [InterlockedXor64Release](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/ms684108(v=vs.85)) instead.
