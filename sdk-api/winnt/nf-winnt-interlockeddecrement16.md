...
This function is implemented using a compiler intrinsic where possible. For more information, see the WinBase.h header file and [_InterlockedDecrement16](https://learn.microsoft.com/previous-versions/f24ya7ct(v=vs.85)).
