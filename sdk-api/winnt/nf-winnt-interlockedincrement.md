...
This function is implemented using a compiler intrinsic where possible. For more information, see the WinBase.h header file and [_InterlockedIncrement](https://learn.microsoft.com/previous-versions/2ddez55b(v=vs.85)).

This function generates a full memory barrier (or fence) to ensure that memory operations are completed in order.

**Itanium-based systems:** For performance-critical applications, use [InterlockedIncrementAcquire](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/ms683618(v=vs.85)) or [InterlockedIncrementRelease](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/ms683622(v=vs.85)) instead.
...
[InterlockedIncrement16](https://learn.microsoft.com/windows/desktop/api/winnt/nf-winnt-interlockedincrement16)
