...
For the Intel Itanium-based systems and x64 architectures, this function is implemented using the compiler intrinsic. For the x86 architecture, use the [_InterlockedAnd8](https://learn.microsoft.com/previous-versions/dsx2t7yd(v=vs.85)) compiler intrinsic directly.

This function generates a full memory barrier (or fence) to ensure that memory operations are completed in order.

**Itanium-based systems:** For performance-critical applications, use [InterlockedAnd8Acquire](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/ms683535(v=vs.85)) or [InterlockedAnd8Release](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/ms683537(v=vs.85)) instead.
...
[InterlockedAnd16](https://learn.microsoft.com/windows/desktop/api/winnt/nf-winnt-interlockedand16)
