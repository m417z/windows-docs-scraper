...
This function is implemented using a compiler intrinsic where possible. For more information, see the WinBase.h header file and [_interlockedbittestandset64](https://learn.microsoft.com/previous-versions/646k06sz(v=vs.85)).
