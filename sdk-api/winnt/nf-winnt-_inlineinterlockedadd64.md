...
This function is implemented using a compiler intrinsic where possible. For more information, see the WinBase.h header file and [_InterlockedAdd64](https://learn.microsoft.com/previous-versions/51s265a6(v=vs.85)).
...
[InterlockedAddAcquire](https://learn.microsoft.com/windows/win32/api/winnt/nf-winnt-_inlineinterlockedadd)
