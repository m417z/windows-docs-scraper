...
Retrieves a [sort order identifier](https://learn.microsoft.com/windows/desktop/Intl/sort-order-identifiers) from a [locale identifier](https://learn.microsoft.com/windows/desktop/Intl/locale-identifiers).
