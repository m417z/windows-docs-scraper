...
This function is implemented using a compiler intrinsic where possible. For more information, see the WinBase.h header file and [_InterlockedExchange64](https://learn.microsoft.com/cpp/intrinsics/interlockedexchange-intrinsic-functions).

This function generates a full memory barrier (or fence) to ensure that memory operations are completed in order.

**Itanium-based systems:** For performance-critical applications, use [InterlockedExchangeAcquire64](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/ms683596(v=vs.85)) instead.
...
[InterlockedExchange8](https://learn.microsoft.com/windows/win32/api/winnt/nf-winnt-interlockedexchange64)
