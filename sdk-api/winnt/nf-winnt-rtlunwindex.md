...
A pointer to a [CONTEXT](https://learn.microsoft.com/windows/win32/api/winnt/ns-winnt-arm64_nt_context) structure that stores context during the unwind operation.
