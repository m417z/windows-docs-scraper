...
For the Intel Itanium-based systems and x64 architectures, this function is implemented using the compiler intrinsic. For the x86 architecture, use the [_InterlockedOr8](https://learn.microsoft.com/previous-versions/b11125ze(v=vs.85)) compiler intrinsic directly.

This function generates a full memory barrier (or fence) to ensure that memory operations are completed in order.

**Itanium-based systems:** For performance-critical applications, use [InterlockedOr8Acquire](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/ms683639(v=vs.85)) or [InterlockedOr8Release](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/ms683640(v=vs.85)) instead.
