...
The **TOKEN_GROUPS** structure contains information about the group [security identifiers](https://learn.microsoft.com/windows/desktop/SecGloss/s-gly) (SIDs) in an [access token](https://learn.microsoft.com/windows/desktop/SecGloss/a-gly).
...
| **SE_GROUP_INTEGRITY**<br><br>0x00000020L | The SID is a mandatory integrity SID. |
| **SE_GROUP_INTEGRITY_ENABLED**<br><br>0x00000040L | The SID is enabled for mandatory integrity checks. |
