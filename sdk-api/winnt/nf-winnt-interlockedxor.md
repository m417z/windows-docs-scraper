...
For the Intel Itanium-based systems and x64 architectures, this function is implemented using the compiler intrinsic. For the x86 architecture, use the [_InterlockedXor](https://learn.microsoft.com/previous-versions/a8swb4hb(v=vs.85)) compiler intrinsic directly.

This function generates a full memory barrier (or fence) to ensure that memory operations are completed in order.

**Itanium-based systems:** For performance-critical applications, use [InterlockedXorAcquire](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/ms684117(v=vs.85)) or [InterlockedXorRelease](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/ms684118(v=vs.85)) instead.
