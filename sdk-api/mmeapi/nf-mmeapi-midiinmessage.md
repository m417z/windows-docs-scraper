...
This message is valid only for the [waveInMessage](https://learn.microsoft.com/previous-versions/dd743846(v=vs.85)), [waveOutMessage](https://learn.microsoft.com/previous-versions/dd743865(v=vs.85)), **midiInMessage**, [midiOutMessage](https://learn.microsoft.com/previous-versions/dd798475(v=vs.85)), [mixerMessage](https://learn.microsoft.com/previous-versions/dd757307(v=vs.85)) and [auxOutMessage](https://learn.microsoft.com/previous-versions/dd756716(v=vs.85)) functions. The system intercepts this message and returns the appropriate value without sending the message to the device driver. For general information about system-intercepted **xxxMessage** functions, see [System-Intercepted Device Messages](https://learn.microsoft.com/windows-hardware/drivers/audio/system-intercepted-device-messages).
