...
The DRV_QUERYDEVICEINTERFACE message is supported in Windows Me, and Windows 2000 and later. This message is valid only for the [waveInMessage](https://learn.microsoft.com/previous-versions/dd743846(v=vs.85)), [waveOutMessage](https://learn.microsoft.com/previous-versions/dd743865(v=vs.85)), [midiInMessage](https://learn.microsoft.com/previous-versions/dd798457(v=vs.85)), [midiOutMessage](https://learn.microsoft.com/previous-versions/dd798475(v=vs.85)), and **mixerMessage** functions. The system intercepts this message and returns the appropriate value without sending the message to the device driver. For general information about system-intercepted **xxxMessage** functions, see [System-Intercepted Device Messages](https://learn.microsoft.com/windows-hardware/drivers/audio/system-intercepted-device-messages).
...
This message is valid only for the [waveInMessage](https://learn.microsoft.com/previous-versions/dd743846(v=vs.85)), [waveOutMessage](https://learn.microsoft.com/previous-versions/dd743865(v=vs.85)), [midiInMessage](https://learn.microsoft.com/previous-versions/dd798457(v=vs.85)), [midiOutMessage](https://learn.microsoft.com/previous-versions/dd798475(v=vs.85)), and **mixerMessage** functions. The system intercepts this message and returns the appropriate value without sending the message to the device driver. For general information about system-intercepted **xxxMessage** functions, see [System-Intercepted Device Messages](https://learn.microsoft.com/windows-hardware/drivers/audio/system-intercepted-device-messages).
...
This message is valid only for the [waveInMessage](https://learn.microsoft.com/previous-versions/dd743846(v=vs.85)), [waveOutMessage](https://learn.microsoft.com/previous-versions/dd743865(v=vs.85)), [midiInMessage](https://learn.microsoft.com/previous-versions/dd798457(v=vs.85)), [midiOutMessage](https://learn.microsoft.com/previous-versions/dd798475(v=vs.85)), **mixerMessage** and [auxOutMessage](https://learn.microsoft.com/previous-versions/dd756716(v=vs.85)) functions. The system intercepts this message and returns the appropriate value without sending the message to the device driver. For general information about system-intercepted **xxxMessage** functions, see [System-Intercepted Device Messages](https://learn.microsoft.com/windows-hardware/drivers/audio/system-intercepted-device-messages).
...
This message is valid only for the [waveInMessage](https://learn.microsoft.com/previous-versions/dd743846(v=vs.85)) and [waveOutMessage](https://learn.microsoft.com/previous-versions/dd743865(v=vs.85)) functions. When a caller calls these two functions with the DRVM_MAPPER_CONSOLEVOICECOM_GET message, the caller must specify the device ID as WAVE_MAPPER, and then cast this value to the appropriate handle type. For the **waveInMessage**, **waveOutMessage**, [midiInMessage](https://learn.microsoft.com/previous-versions/dd798457(v=vs.85)), [midiOutMessage](https://learn.microsoft.com/previous-versions/dd798475(v=vs.85)), or **mixerMessage** functions, the caller must cast the device ID to a handle of type HWAVEIN, HWAVEOUT, HMIDIIN, HMIDIOUT, or HMIXER, respectively. Note that if the caller supplies a valid handle instead of a device ID for this parameter, the function fails and returns error code MMSYSERR_NOSUPPORT.
