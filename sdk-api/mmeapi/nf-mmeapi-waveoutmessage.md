...
Identifier of the waveform device that receives the message. You must cast the device ID to the **HWAVEOUT** handle type. If you supply a handle instead of a device ID, the function fails and returns the MMSYSERR_NOSUPPORT error code.
...
This message is valid only for the [waveInMessage](https://learn.microsoft.com/previous-versions/dd743846(v=vs.85)), **waveOutMessage**, [midiInMessage](https://learn.microsoft.com/previous-versions/dd798457(v=vs.85)), [midiOutMessage](https://learn.microsoft.com/previous-versions/dd798475(v=vs.85)), [mixerMessage](https://learn.microsoft.com/previous-versions/dd757307(v=vs.85)) and [auxOutMessage](https://learn.microsoft.com/previous-versions/dd756716(v=vs.85)) functions. The system intercepts this message and returns the appropriate value without sending the message to the device driver. For general information about system-intercepted **xxxMessage** functions, see [System-Intercepted Device Messages](https://learn.microsoft.com/windows-hardware/drivers/audio/system-intercepted-device-messages).
