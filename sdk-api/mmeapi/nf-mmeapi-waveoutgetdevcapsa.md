...
Pointer to a [WAVEOUTCAPSA](https://learn.microsoft.com/windows/win32/api/mmeapi/ns-mmeapi-waveoutcapsa) structure to be filled with information about the capabilities of the device.
