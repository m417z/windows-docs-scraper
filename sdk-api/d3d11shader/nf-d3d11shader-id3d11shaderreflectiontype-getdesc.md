...
Type: **[D3D11_SHADER_TYPE_DESC](https://learn.microsoft.com/windows/desktop/api/d3d11shader/ns-d3d11shader-d3d11_shader_type_desc)***

A pointer to a shader-type description (see [D3D11_SHADER_TYPE_DESC](https://learn.microsoft.com/windows/desktop/api/d3d11shader/ns-d3d11shader-d3d11_shader_type_desc)).
