...
One of the [object state constants](https://learn.microsoft.com/windows/desktop/WinAuto/object-state-constants).
...
If the string resource does not exist, or if the *lpszStateBit* parameter is not a valid pointer, the return value is zero (0). To get extended error information, call [GetLastError](https://learn.microsoft.com/windows/desktop/api/errhandlingapi/nf-errhandlingapi-getlasterror).
