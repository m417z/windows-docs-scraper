...
A string specifying the query criteria. If this parameter is **NULL**, the default query specified by the [SetDefaultQuery](https://learn.microsoft.com/windows/desktop/api/eventsys/nf-eventsys-imultiinterfaceeventcontrol-setdefaultquery) method is used. For details on forming a valid expression for this parameter, see the Remarks section below.
...
The address of a pointer to an [IEventObjectCollection](https://learn.microsoft.com/windows/desktop/api/eventsys/nn-eventsys-ieventobjectcollection) interface on a collection object that enumerates the subscriptions associated with the event object.
