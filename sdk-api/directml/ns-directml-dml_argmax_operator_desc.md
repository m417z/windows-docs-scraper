...
Type: \_Field_size\_(AxisCount) **const [UINT](https://learn.microsoft.com/windows/desktop/WinProg/windows-data-types)\***
...
When *AxisDirection* is [DML_AXIS_DIRECTION_INCREASING](https://learn.microsoft.com/windows/win32/api/directml/ne-directml-dml_axis_direction), this API is equivalent to [DML_REDUCE_OPERATOR_DESC](https://learn.microsoft.com/windows/win32/api/directml/ns-directml-dml_reduce_operator_desc) with [DML_REDUCE_FUNCTION_ARGMAX](https://learn.microsoft.com/windows/win32/api/directml/ne-directml-dml_reduce_function).

A subset of this functionality is exposed through the [DML_REDUCE_OPERATOR_DESC](https://learn.microsoft.com/windows/win32/api/directml/ns-directml-dml_reduce_operator_desc) operator, and is supported on earlier DirectML feature levels.
