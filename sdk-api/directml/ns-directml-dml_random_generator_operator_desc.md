...
An input tensor containing the internal generator state. The size and format of this input tensor depends on the [DML_RANDOM_GENERATOR_TYPE](https://learn.microsoft.com/windows/win32/api/directml/ne-directml-dml_random_generator_type).
