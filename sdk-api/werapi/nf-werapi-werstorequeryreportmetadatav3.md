...
A pointer to the report store metadata in the form of a [WER_REPORT_METADATA_V3](https://learn.microsoft.com/windows/win32/api/werapi/ns-werapi-wer_report_metadata_v3) structure.
