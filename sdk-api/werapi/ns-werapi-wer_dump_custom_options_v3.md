...
Specifies custom [Windows Error Reporting](https://learn.microsoft.com/windows/win32/api/_wer/) (WER) minidump information to be collected in the background (without pausing the process) by the [**PssCaptureSnapshot**](https://learn.microsoft.com/windows/win32/api/processsnapshot/nf-processsnapshot-psscapturesnapshot) function.
...
[WerReportAddDump function](https://learn.microsoft.com/windows/win32/api/werapi/nf-werapi-werreportadddump), [**PssCaptureSnapshot**](https://learn.microsoft.com/windows/win32/api/processsnapshot/nf-processsnapshot-psscapturesnapshot), [Windows Error Reporting](https://learn.microsoft.com/windows/desktop/wer)