...
Type: **[MFP_PAUSE_EVENT](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_pause_event)**
...
Casts an [MFP_EVENT_HEADER](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_event_header) pointer to an [MFP_PAUSE_EVENT](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_pause_event) pointer.
...
The **eEventType** member of the input structure must be **MFP_EVENT_TYPE_PAUSE**. Otherwise, the macro returns **NULL**.
