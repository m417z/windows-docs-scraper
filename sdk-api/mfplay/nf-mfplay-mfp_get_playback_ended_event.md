...
Type: **[MFP_PLAYBACK_ENDED_EVENT](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_playback_ended_event)**
...
Casts an [MFP_EVENT_HEADER](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_event_header) pointer to an [MFP_PLAYBACK_ENDED_EVENT](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_playback_ended_event) pointer.
...
The **eEventType** member of the input structure must be **MFP_EVENT_TYPE_PLAYBACK_ENDED**. Otherwise, the macro returns **NULL**.
