...
```cpp
MFP_POSITION_SET_EVENT MFP_GET_POSITION_SET_EVENT(
...
Type: **[MFP_POSITION_SET_EVENT](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_position_set_event)**

Returns a pointer to an **MFP_POSITION_SET_EVENT** structure.
...
Casts an [MFP_EVENT_HEADER](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_event_header) pointer to an [MFP_POSITION_SET_EVENT](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_position_set_event) pointer.
...
The **eEventType** member of the input structure must be **MFP_EVENT_TYPE_POSITION_SET**. Otherwise, the macro returns **NULL**.
