...
Type: **[MFP_FRAME_STEP_EVENT](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_frame_step_event)**
...
Casts an [MFP_EVENT_HEADER](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_event_header) pointer to an [MFP_FRAME_STEP_EVENT](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_frame_step_event) pointer.
...
The **eEventType** member of the input structure must be **MFP_EVENT_TYPE_FRAME_STEP**. Otherwise, the macro returns **NULL**.
