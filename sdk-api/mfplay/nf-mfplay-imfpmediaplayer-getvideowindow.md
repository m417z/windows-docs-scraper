...
The video window is specified when you first call [MFPCreateMediaPlayer](https://learn.microsoft.com/windows/desktop/api/mfplay/nf-mfplay-mfpcreatemediaplayer) to create the MFPlay player object.
