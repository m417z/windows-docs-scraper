...
Type: **[MFP_PLAY_EVENT](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_play_event)**
...
Casts an [MFP_EVENT_HEADER](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_event_header) pointer to an [MFP_PLAY_EVENT](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_play_event) pointer.
...
The **eEventType** member of the input structure must be **MFP_EVENT_TYPE_PLAY**. Otherwise, the macro returns **NULL**.
