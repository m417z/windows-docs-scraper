...
```cpp
MEDIAITEM_CLEARED_EVENT MFP_GET_MEDIAITEM_CLEARED_EVENT(
...
Type: **[MEDIAITEM_CLEARED_EVENT](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_mediaitem_cleared_event)**

Returns a pointer to an **MEDIAITEM_CLEARED_EVENT** structure.
...
Casts an [MFP_EVENT_HEADER](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_event_header) pointer to an [MEDIAITEM_CLEARED_EVENT](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_mediaitem_cleared_event) pointer.
...
The **eEventType** member of the input structure must be **MFP_EVENT_TYPE_MEDIAITEM_CLEARED**. Otherwise, the macro returns **NULL**.
