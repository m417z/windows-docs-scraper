...
Event structure for the **MFP_EVENT_TYPE_PLAY** event. This event is sent when the [IMFPMediaPlayer::Play](https://learn.microsoft.com/windows/desktop/api/mfplay/nf-mfplay-imfpmediaplayer-play) method completes.
