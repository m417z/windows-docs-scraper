...
Type: **[MFP_MF_EVENT](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_mf_event)**
...
Casts an [MFP_EVENT_HEADER](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_event_header) pointer to an [MFP_MF_EVENT](https://learn.microsoft.com/windows/desktop/api/mfplay/ns-mfplay-mfp_mf_event) pointer.
...
The **eEventType** member of the input structure must be **MFP_EVENT_TYPE_MF**. Otherwise, the macro returns **NULL**.
