...
These flags can be passed in to [CreateBindLink](https://learn.microsoft.com/windows/win32/api/bindlink/nf-bindlink-createbindlink) to change the default bind link behavior to suit the needs of the user.
