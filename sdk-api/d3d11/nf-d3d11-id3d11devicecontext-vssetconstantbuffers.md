...
If the application wants the shader to access other parts of the buffer, it must call the [VSSetConstantBuffers1](https://learn.microsoft.com/windows/desktop/api/d3d11_1/nf-d3d11_1-id3d11devicecontext1-vssetconstantbuffers1) method instead.
