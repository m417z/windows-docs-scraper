...
Receives the value **TRUE** if the source rectangle is enabled, or **FALSE** otherwise.

### `pRect` [out]

A pointer to a [RECT](https://learn.microsoft.com/windows/win32/api/windef/ns-windef-rect) structure that receives the source rectangle.
