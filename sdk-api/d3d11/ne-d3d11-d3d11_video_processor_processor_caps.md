...
If the video processor supports this capability, the **ITelecineCaps** member of the [D3D11_VIDEO_PROCESSOR_RATE_CONVERSION_CAPS](https://learn.microsoft.com/windows/desktop/api/d3d11/ns-d3d11-d3d11_video_processor_rate_conversion_caps) structure specifies which IVTC modes are supported.
