...
Address of a pointer to a [ID3D11GeometryShader](https://learn.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11geometryshader) interface. If this is **NULL**, all other parameters will be validated, and if all
...
After it is created, the shader can be set to the device by calling [ID3D11DeviceContext::GSSetShader](https://learn.microsoft.com/windows/desktop/api/d3d11/nf-d3d11-id3d11devicecontext-gssetshader).
