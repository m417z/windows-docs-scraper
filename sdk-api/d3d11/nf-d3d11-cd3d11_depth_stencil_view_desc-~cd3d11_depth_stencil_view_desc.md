...
Destroys an instance of a [CD3D11_DEPTH_STENCIL_VIEW_DESC](https://learn.microsoft.com/previous-versions/windows/desktop/legacy/jj151639(v=vs.85)) structure.
