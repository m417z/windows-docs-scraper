...
Determines the fill mode to use when rendering (see [D3D11_FILL_MODE](https://learn.microsoft.com/windows/desktop/api/d3d11/ne-d3d11-d3d11_fill_mode)).

### `CullMode`

Type: **[D3D11_CULL_MODE](https://learn.microsoft.com/windows/desktop/api/d3d11/ne-d3d11-d3d11_cull_mode)**

Indicates triangles facing the specified direction are not drawn (see [D3D11_CULL_MODE](https://learn.microsoft.com/windows/desktop/api/d3d11/ne-d3d11-d3d11_cull_mode)).
...
Rasterizer state defines the behavior of the rasterizer stage. To create a rasterizer-state object, call [ID3D11Device::CreateRasterizerState](https://learn.microsoft.com/windows/desktop/api/d3d11/nf-d3d11-id3d11device-createrasterizerstate). To set rasterizer state, call [ID3D11DeviceContext::RSSetState](https://learn.microsoft.com/windows/desktop/api/d3d11/nf-d3d11-id3d11devicecontext-rssetstate).
