...
### `pComputeShader` [in, optional]

Type: **[ID3D11ComputeShader](https://learn.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11computeshader)***

Pointer to a compute shader (see [ID3D11ComputeShader](https://learn.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11computeshader)). Passing in **NULL** disables the shader for this pipeline stage.
