...
Create a [domain shader](https://learn.microsoft.com/windows/desktop/direct3d11/direct3d-11-advanced-stages-tessellation).
...
### `ppDomainShader` [out, optional]

Type: **[ID3D11DomainShader](https://learn.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11domainshader)****

Address of a pointer to a [ID3D11DomainShader](https://learn.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11domainshader) interface. If this is **NULL**, all other parameters will be validated, and if all parameters pass validation this API will return **S_FALSE** instead of **S_OK**.
