...
Address of a pointer to a Compute shader (see [ID3D11ComputeShader](https://learn.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11computeshader)) to be returned by the method.
