...
### `pDomainShader` [in, optional]

Type: **[ID3D11DomainShader](https://learn.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11domainshader)***

Pointer to a domain shader (see [ID3D11DomainShader](https://learn.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11domainshader)). Passing in **NULL** disables the shader for this pipeline stage.
