...
### `operator` const D3D11_TEXTURE3D_DESC1&
...
This structure is used in a call to [ID3D11Device3::CreateTexture3D1](https://learn.microsoft.com/windows/desktop/api/d3d11_3/nf-d3d11_3-id3d11device3-createtexture3d1).
