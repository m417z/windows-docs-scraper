# SetupQueueCopySectionW function
...
The
**SetupQueueCopySection** function places all the files in a section of an INF file in a setup queue for copying. The section must be in the correct **Copy Files** format and the INF file must contain **SourceDisksFiles** and **SourceDisksNames** sections (or have had the INF files containing those sections appended).
