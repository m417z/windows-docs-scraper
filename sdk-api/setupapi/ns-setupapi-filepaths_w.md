...
The
**FILEPATHS** structure stores source and target path information. The setup functions send the
**FILEPATHS** structure as a parameter in several of the notifications sent to callback routines. For more information, see
...
**FILEPATHS** structure is used with a file delete operation.
