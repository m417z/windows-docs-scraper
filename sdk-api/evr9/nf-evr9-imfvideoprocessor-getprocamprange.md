...
The ProcAmp setting to query. For a list of possible values, see [ProcAmp Settings](https://learn.microsoft.com/windows/desktop/medfound/procamp-settings).

### `pPropRange` [out]

Pointer to a [DXVA2_ValueRange](https://learn.microsoft.com/windows/desktop/api/dxva2api/ns-dxva2api-dxva2_valuerange) structure that receives range of values for the specified ProcAmp setting.
