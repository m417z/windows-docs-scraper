...
Pointer to an [MFVideoAlphaBitmapParams](https://learn.microsoft.com/windows/desktop/api/evr9/ns-evr9-mfvideoalphabitmapparams) structure that receives the current blending parameters.
