...
The filter setting to query. For a list of possible values, see [DXVA Image Filter Settings](https://learn.microsoft.com/windows/desktop/medfound/dxva-image-filter-settings).

### `pValue` [out]

Pointer to a [DXVA2_Fixed32](https://learn.microsoft.com/windows/desktop/api/dxva2api/ns-dxva2api-dxva2_fixed32) structure that receives the current value.
