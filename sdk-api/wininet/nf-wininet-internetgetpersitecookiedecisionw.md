...
A pointer to an **unsigned long** that contains one of the [InternetCookieState](https://learn.microsoft.com/windows/win32/api/wininet/ne-wininet-internet_scheme) enumeration values.
