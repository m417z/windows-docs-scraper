...
A pointer to a [DOCINFO](https://learn.microsoft.com/windows/desktop/api/wingdi/ns-wingdi-docinfow) structure containing the name of the document file and the name of the output file.
