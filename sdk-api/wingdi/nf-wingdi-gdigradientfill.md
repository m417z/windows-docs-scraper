...
A pointer to an array of [TRIVERTEX](https://learn.microsoft.com/windows/desktop/api/wingdi/ns-wingdi-trivertex) structures that each define a triangle vertex.
...
**Note** This function is the same as [GradientFill](https://learn.microsoft.com/windows/desktop/api/wingdi/nf-wingdi-gradientfill).
...
Note that **GdiGradientFill** does not use the Alpha member of the [TRIVERTEX](https://learn.microsoft.com/windows/desktop/api/wingdi/ns-wingdi-trivertex) structure. To use **GdiGradientFill** with transparency, call **GdiGradientFill** and then call [GdiAlphaBlend](https://learn.microsoft.com/windows/desktop/api/wingdi/nf-wingdi-gdialphablend) with the desired values for the alpha channel of each vertex.
