...
| **GCP_NUMERICSLATIN** | Arabic/Thai only. Use standard Latin glyphs for numbers and override the system default. To determine if this option is available in the language of the font, use [GetStringTypeEx](https://learn.microsoft.com/windows/win32/api/stringapiset/nf-stringapiset-getstringtypeexw) to see if the language supports more than one number format. |
| **GCP_NUMERICSLOCAL** | Arabic/Thai only. Use local glyphs for numeric characters and override the system default. To determine if this option is available in the language of the font, use [GetStringTypeEx](https://learn.microsoft.com/windows/win32/api/stringapiset/nf-stringapiset-getstringtypeexw) to see if the language supports more than one number format. |
