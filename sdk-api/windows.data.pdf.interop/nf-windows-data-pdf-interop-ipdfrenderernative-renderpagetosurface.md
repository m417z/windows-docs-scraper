...
The **IPdfPage** interface as an instance of the [PdfPage](https://learn.microsoft.com/uwp/api/windows.data.pdf.pdfpage) class type-casted to the **IUnknown** interface, `page.as<IUnknown>().get()`, representing the page to be output.
