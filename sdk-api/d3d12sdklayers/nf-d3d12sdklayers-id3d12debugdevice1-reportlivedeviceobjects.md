...
A value from the [D3D12_RLDO_FLAGS](https://learn.microsoft.com/windows/desktop/api/d3d12sdklayers/ne-d3d12sdklayers-d3d12_rldo_flags) enumeration. This method uses the value in *Flags* to determine the amount of information to report about a device object's lifetime.
