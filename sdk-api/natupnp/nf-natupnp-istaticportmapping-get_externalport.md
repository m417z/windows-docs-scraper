...
The
**get_ExternalPort** method retrieves the external port on the NAT computer for this port mapping.

## Parameters

### `pVal` [out]

Pointer to a **long** variable that receives the external port on the NAT computer for this port mapping.
