...
The
**get_ExternalIPAddress** method retrieves the external IP address for this port mapping on the NAT computer.
...
Pointer to a
[BSTR](https://learn.microsoft.com/previous-versions/windows/desktop/automat/bstr) variable that receives the external IP address for this port mapping on the NAT computer.
