...
The **ITextStoreAnchor::GetStatus** method obtains the document status. The document status is returned through the [TS_STATUS](https://learn.microsoft.com/windows/desktop/api/textstor/ns-textstor-ts_status) structure.
