...
Use [QueryInterface](https://learn.microsoft.com/windows/desktop/api/textstor/nf-textstor-itextstoreacp-getembedded) to probe for appropriate interfaces. Prospective interfaces include those associated with embedded documents or controls such as **IOleObject** , **IDataObject** , **IViewObject** , **IPersistStorage** , **IOleCache** , or **IDispatch** .
