...
**Note** If an application does not implement **ITextStoreACP::FindNextAttrTransition**, [ITfReadOnlyProperty::EnumRanges](https://learn.microsoft.com/windows/desktop/api/msctf/nf-msctf-itfreadonlyproperty-enumranges) fails with E_FAIL.
