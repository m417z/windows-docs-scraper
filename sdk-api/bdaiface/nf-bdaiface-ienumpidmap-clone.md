...
Receives an [IEnumPIDMap](https://learn.microsoft.com/windows/desktop/api/bdaiface/nn-bdaiface-ienumpidmap) interface pointer, representing the new collection. The caller must release the interface.
