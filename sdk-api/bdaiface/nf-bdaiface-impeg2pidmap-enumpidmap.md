...
Receives an [IEnumPIDMap](https://learn.microsoft.com/windows/desktop/api/bdaiface/nn-bdaiface-ienumpidmap) pointer. Use this interface to enumerate the mapped PIDs. The caller must release the interface.
