...
Flag indicating whether the signal is present. **TRUE** means a signal is present.
...
[IBDA_SignalStatistics::get_SignalPresent](https://learn.microsoft.com/windows/desktop/api/bdaiface/nf-bdaiface-ibda_signalstatistics-get_signalpresent)