# RectF::RectF(IN const PointF &,IN const SizeF &)

## Description

Creates a [RectF](https://learn.microsoft.com/windows/desktop/api/gdiplustypes/nl-gdiplustypes-rectf) object and initializes the
**X**,
**Y**,
**Width**, and
...
[RectF Constructors](https://learn.microsoft.com/windows/desktop/gdiplus/-gdiplus-class-rectf-constructors)
