...
The format of the resource view to which the *pSrcElementFlags* parameter points must be [DXGI_FORMAT_R32_UINT](https://learn.microsoft.com/windows/desktop/api/dxgiformat/ne-dxgiformat-dxgi_format).
