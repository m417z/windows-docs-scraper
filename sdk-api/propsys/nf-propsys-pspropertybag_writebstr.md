...
The **BSTR** value to which the named property should be set.
...
[PSPropertyBag_ReadBSTR](https://learn.microsoft.com/windows/desktop/api/propsys/nf-propsys-pspropertybag_readbstr)