...
The **BOOL** value to which the named property should be set.
...
[PSPropertyBag_ReadBOOL](https://learn.microsoft.com/windows/desktop/api/propsys/nf-propsys-pspropertybag_readbool)