...
The **LONG** value to which the property should be set.
...
[PSPropertyBag_ReadLONG](https://learn.microsoft.com/windows/desktop/api/propsys/nf-propsys-pspropertybag_readlong)