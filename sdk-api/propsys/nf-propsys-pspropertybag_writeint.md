...
The **int** value to which the property should be set.
...
[PSPropertyBag_ReadInt](https://learn.microsoft.com/windows/desktop/api/propsys/nf-propsys-pspropertybag_readint)