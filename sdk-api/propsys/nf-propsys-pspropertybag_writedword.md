...
A **DWORD** value to which the named property should be set.
...
[PSPropertyBag_ReadDWORD](https://learn.microsoft.com/windows/desktop/api/propsys/nf-propsys-pspropertybag_readdword)