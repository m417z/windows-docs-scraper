...
When this function returns, contains a pointer to a **ULONGLONG** property value.
...
[PSPropertyBag_WriteULONGLONG](https://learn.microsoft.com/windows/desktop/api/propsys/nf-propsys-pspropertybag_writeulonglong)