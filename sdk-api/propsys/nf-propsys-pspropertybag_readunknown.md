...
A reference to the IID of the interface to retrieve through *ppv*. This interface IID should be [IPropertyBag](https://learn.microsoft.com/windows/win32/api/oaidl/nn-oaidl-ipropertybag) or an interface derived from **IPropertyBag**.
...
[PSPropertyBag_WriteUnknown](https://learn.microsoft.com/windows/desktop/api/propsys/nf-propsys-pspropertybag_writeunknown)