...
Identifiers for properties of the [Spot-specular lighting effect](https://learn.microsoft.com/windows/desktop/Direct2D/specular-lighting).

## Constants

### `D2D1_SPOTSPECULAR_PROP_LIGHT_POSITION:0`

The light position of the point light source. The property is a [D2D1_VECTOR_3F](https://learn.microsoft.com/windows/desktop/api/dcommon/ns-dcommon-d2d_vector_3f) defined as (x, y, z).
...
Where the spot light is focused. The property is exposed as a [D2D1_VECTOR_3F](https://learn.microsoft.com/windows/desktop/api/dcommon/ns-dcommon-d2d_vector_3f) with – (x, y, z).
...
The type is [D2D1_SPOTSPECULAR_SCALE_MODE](https://learn.microsoft.com/windows/desktop/api/d2d1effects/ne-d2d1effects-d2d1_spotspecular_scale_mode).
