...
The interpolation mode the [3D perspective transform effect](https://learn.microsoft.com/windows/desktop/Direct2D/3d-perspective-transform) uses on the image.
