...
The interpolation mode the [Point-specular lighting effect](https://learn.microsoft.com/windows/desktop/Direct2D/point-specular) uses to scale the image to the corresponding kernel unit length.
