...
The interpolation mode the [Distant-specular lighting effect](https://learn.microsoft.com/windows/desktop/Direct2D/distant-specular) uses to scale the image to the corresponding kernel unit length.
