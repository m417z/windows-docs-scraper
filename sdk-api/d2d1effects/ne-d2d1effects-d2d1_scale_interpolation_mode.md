...
The interpolation mode the [Scale effect](https://learn.microsoft.com/windows/desktop/Direct2D/high-quality-scale) uses to scale the image. There are 6 scale modes that range in quality and speed.
