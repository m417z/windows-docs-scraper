...
The interpolation mode the [Convolve matrix effect](https://learn.microsoft.com/windows/desktop/Direct2D/convolve-matrix) uses to scale the image to the corresponding kernel unit length. There are six scale modes that range in quality and speed.
