...
The interpolation mode the [Spot-diffuse lighting effect](https://learn.microsoft.com/windows/desktop/Direct2D/diffuse-lighting) uses to scale the image to the corresponding kernel unit length.
