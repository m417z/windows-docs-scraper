...
Use this method to determine whether an object should be saved before closing it. The dirty flag for an object is conditionally cleared in the [IPersistStreamInit::Save](https://learn.microsoft.com/windows/desktop/api/ocidl/nf-ocidl-ipersiststreaminit-save) method.
