...
The container format of the decoder. The native container format GUIDs are listed in [WIC GUIDs and CLSIDs](https://learn.microsoft.com/windows/desktop/wic/-wic-guids-clsids).
