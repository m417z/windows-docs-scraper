...
Pointer to an [ACMFORMATCHOOSE](https://learn.microsoft.com/windows/win32/api/msacm/nf-msacm-acmformatchoose) structure that contains information used to initialize the dialog box. When this function returns, this structure contains information about the user's format selection.
