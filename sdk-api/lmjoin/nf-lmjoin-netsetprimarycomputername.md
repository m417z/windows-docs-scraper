...
The
**NetSetPrimaryComputerName** function sets the primary computer name for the specified computer.
...
| **ERROR_INVALID_NAME** | A name parameter is incorrect. This error is returned if the *PrimaryName* parameter does not contain valid name. |
