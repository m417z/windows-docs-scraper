...
This method can cause a deadlock if a thread that calls **LockStore** waits on a thread that calls any other [IMFAttributes](https://learn.microsoft.com/windows/desktop/api/mfobjects/nn-mfobjects-imfattributes) methods on the same object.
