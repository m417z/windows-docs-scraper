...
Receives the event type. For a list of event types, see [Media Foundation Events](https://learn.microsoft.com/windows/desktop/medfound/media-foundation-events).
