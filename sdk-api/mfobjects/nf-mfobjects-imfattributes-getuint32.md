...
GUID that identifies which value to retrieve. The attribute type must be **MF_ATTRIBUTE_UINT32**.
...
| **MF_E_INVALIDTYPE** | The attribute value is not a **UINT32**. |
...
[MFGetAttributeUINT32](https://learn.microsoft.com/windows/desktop/api/mfapi/nf-mfapi-mfgetattributeuint32)
