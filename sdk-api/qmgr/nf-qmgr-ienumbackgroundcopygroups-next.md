...
Array of GUIDs that identify the groups. To retrieve a group, call the [IBackgroundCopyQMgr::GetGroup](https://learn.microsoft.com/windows/desktop/api/qmgr/nf-qmgr-ibackgroundcopyqmgr-getgroup) method with the GUID.
