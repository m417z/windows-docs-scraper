...
The
**get_StartTime** method gets the start time of the conference.
...
[ITDirectoryObjectConference::put_StartTime](https://learn.microsoft.com/windows/desktop/api/rend/nf-rend-itdirectoryobjectconference-put_starttime)