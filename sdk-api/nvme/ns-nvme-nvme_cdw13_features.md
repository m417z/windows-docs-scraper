...
This structure is used in the **CDW13** parameter of the **SETFEATURES** field in the [Command](https://learn.microsoft.com/windows/win32/api/nvme/ns-nvme-nvme_command) structure.

## Members

### `HostMemoryBuffer`

Specifies an [NVME_CDW13_FEATURE_HOST_MEMORY_BUFFER](https://learn.microsoft.com/windows/win32/api/nvme/ns-nvme-nvme_cdw13_feature_host_memory_buffer) structure containing a value that specifies the lower 32 bits of the physical location of the Host Memory Descriptor List.
