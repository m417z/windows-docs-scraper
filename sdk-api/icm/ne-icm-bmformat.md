...
> [!Note]
> The [**TranslateBitmapBits**](https://learn.microsoft.com/windows/win32/api/icm/nf-icm-translatebitmapbits) function does not support [**BM\_XYZTRIPLETS**](https://learn.microsoft.com/windows/win32/api/icm/ne-icm-bmformat) as an input.
...
> [!Note]
> The [**TranslateBitmapBits**](https://learn.microsoft.com/windows/win32/api/icm/nf-icm-translatebitmapbits) function does not support [**BM\_YxyTRIPLETS**](https://learn.microsoft.com/windows/win32/api/icm/ne-icm-bmformat) as an input.
