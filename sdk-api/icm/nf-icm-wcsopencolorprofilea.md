...
Use the [**CloseColorProfile**](https://learn.microsoft.com/windows/win32/api/icm/nf-icm-closecolorprofile) function to close an object handle that is returned by **WcsOpenColorProfile**.
