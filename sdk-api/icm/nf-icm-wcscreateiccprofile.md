...
If this function fails, the return value is **NULL**. For extended error information, call [GetLastError](https://learn.microsoft.com/windows/win32/api/errhandlingapi/nf-errhandlingapi-getlasterror).
...
When WCS encounters this ICC profile (via [**OpenColorProfileW**](https://learn.microsoft.com/windows/win32/api/icm/nf-icm-opencolorprofilew) or [**WcsOpenColorProfileW**](https://learn.microsoft.com/windows/win32/api/icm/nf-icm-wcsopencolorprofilew) ) it extracts and uses the WCS profile(s) contained in the *WcsProfilesTag*.
