...
Returns **TRUE** if the operation was successful and **FALSE** if an attempt was made to set a non-Boolean property or a property that does not exist. More information is available in the log file, Framework.log.