...
Returns **TRUE** if the operation was successful and **FALSE** if the supplied string array type is not valid for the property being returned or an attempt is made to retrieve a nonexistent property. More information is available in the log file, Framework.log.