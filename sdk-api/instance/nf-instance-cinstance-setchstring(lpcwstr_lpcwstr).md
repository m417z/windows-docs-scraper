...
The **SetCHString(LPCWSTR, const CHString&)** method sets a string property.
...
[CInstance::SetCHString](https://learn.microsoft.com/windows/desktop/WmiSdk/cinstance-setchstring)