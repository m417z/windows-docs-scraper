...
The **GetTSDT** method retrieves the transport stream description table (TSDT).

## Parameters

### `ppTSDT` [out]

Address of a variable that receives an [ITSDT](https://learn.microsoft.com/windows/desktop/api/mpeg2psiparser/nn-mpeg2psiparser-itsdt) interface pointer. The caller must release the interface.
