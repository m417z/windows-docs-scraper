...
The **GetTDT** method retrieves the time and date table (TDT).

## Parameters

### `ppTDT` [out]

Address of a variable that receives an [IDVB_TDT](https://learn.microsoft.com/previous-versions/windows/desktop/api/dvbsiparser/nn-dvbsiparser-idvb_tdt) interface pointer. The caller must release the interface.
