...
The **GetRST** method retrieves the running status table (RST).
...
Address of a variable that receives an [IDVB_RST](https://learn.microsoft.com/previous-versions/windows/desktop/api/dvbsiparser/nn-dvbsiparser-idvb_rst) interface pointer. The caller must release the interface.
