...
The **GetTOT** method retrieves the time offset table (TOT).

## Parameters

### `ppTOT` [out]

Address of a variable that receives an [IDVB_TOT](https://learn.microsoft.com/previous-versions/windows/desktop/api/dvbsiparser/nn-dvbsiparser-idvb_tot) interface pointer. The caller must release the interface.
