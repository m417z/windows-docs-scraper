...
Optional pointer to a variable that contains a table program number. You can use this value to filter the request. Otherwise, set this parameter to **NULL**.

### `ppPMT` [out]

Address of a variable that receives an [IPMT](https://learn.microsoft.com/windows/desktop/api/mpeg2psiparser/nn-mpeg2psiparser-ipmt) interface pointer. The caller must release the interface.
