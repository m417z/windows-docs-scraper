...
The **GetTableDescriptorByIndex** method retrieves a table-wide descriptor for the SIT.

## Parameters

### `dwIndex` [in]

Specifies which descriptor to retrieve, indexed from zero. Call the [IDVB_SIT::GetCountOfTableDescriptors](https://learn.microsoft.com/previous-versions/windows/desktop/api/dvbsiparser/nf-dvbsiparser-idvb_sit-getcountoftabledescriptors) method to get the number of table descriptors in the SIT.
