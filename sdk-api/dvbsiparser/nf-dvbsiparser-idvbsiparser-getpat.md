...
Address of a variable that receives an [IPAT](https://learn.microsoft.com/windows/desktop/api/mpeg2psiparser/nn-mpeg2psiparser-ipat) interface pointer. The caller must release the interface.
