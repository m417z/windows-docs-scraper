...
The **GetSIT** method retrieves the selection information table (SIT).
...
Address of a variable that receives an [IDVB_SIT](https://learn.microsoft.com/previous-versions/windows/desktop/api/dvbsiparser/nn-dvbsiparser-idvb_sit) interface pointer. The caller must release the interface.
