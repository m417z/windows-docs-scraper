...
The **Initialize** method initializes the object using captured table section data. This method is called internally by the [IDvbSiParser::GetEIT](https://learn.microsoft.com/previous-versions/windows/desktop/api/dvbsiparser/nf-dvbsiparser-idvbsiparser-geteit) method, so applications typically should not call it.
