...
For a list of content codes associated with the value returned in the *pbVal* parameter, see Table 26 in Section 6.2.9 of the DVB standards document,
[Digital Video Broadcasting Specification for Service Information (SI) in DVB systems](https://learn.microsoft.com/).
