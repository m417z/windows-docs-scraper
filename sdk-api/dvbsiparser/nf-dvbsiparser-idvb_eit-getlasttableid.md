...
The **GetLastTableId** method returns the last table identifier used. If there are multiple EITs, the event information is chronological across successive table identifiers.
