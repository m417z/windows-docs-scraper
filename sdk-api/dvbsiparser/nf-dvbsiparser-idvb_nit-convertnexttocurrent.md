...
This method applies only to *next* tables that have become current. Before calling this method, call [IDVB_NIT::RegisterForWhenCurrent](https://learn.microsoft.com/previous-versions/windows/desktop/api/dvbsiparser/nf-dvbsiparser-idvb_nit-registerforwhencurrent) and wait for the event to be signaled.
