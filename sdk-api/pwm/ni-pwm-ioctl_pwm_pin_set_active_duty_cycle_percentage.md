...
Set a desired duty cycle percentage value for the controller pin or channel. The control code specifies the percentage as a [PWM_PIN_SET_ACTIVE_DUTY_CYCLE_PERCENTAGE_INPUT](https://learn.microsoft.com/windows/desktop/DevIO/pwm-pin-set-active-duty-cycle-percentage-input) structure.

## Parameters

### Input buffer

A pointer to a buffer that contains a [PWM_PIN_SET_ACTIVE_DUTY_CYCLE_PERCENTAGE_INPUT](https://learn.microsoft.com/windows/desktop/DevIO/pwm-pin-set-active-duty-cycle-percentage-input) struct. This represents the desired duty cycle percentage for the PWM controller.
...
| *lpInBuffer* | A pointer to a buffer that contains a [PWM_PIN_SET_ACTIVE_DUTY_CYCLE_PERCENTAGE_INPUT](https://learn.microsoft.com/windows/desktop/DevIO/pwm-pin-set-active-duty-cycle-percentage-input) struct. This represents the desired duty cycle percentage for the PWM controller. |
