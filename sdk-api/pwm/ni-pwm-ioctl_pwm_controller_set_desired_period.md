...
### Output buffer
 ...
 A pointer to a buffer that contains a [PWM_CONTROLLER_SET_DESIRED_PERIOD_INPUT](https://learn.microsoft.com/windows/desktop/api/pwm/ns-pwm-pwm_controller_set_desired_period_input) struct. The associated value is the effective output signal period of the Pulse Width Modulation (PWM) controller. It can later be retrieved by using [IOCTL_PWM_CONTROLLER_GET_ACTUAL_PERIOD](https://learn.microsoft.com/windows/desktop/api/pwm/ni-pwm-ioctl_pwm_controller_get_actual_period).
...
| *lpOutBuffer* [out] | A pointer to a buffer that contains a [PWM_CONTROLLER_SET_DESIRED_PERIOD_INPUT](https://learn.microsoft.com/windows/desktop/api/pwm/ns-pwm-pwm_controller_set_desired_period_input) struct. The associated value is the effective output signal period of the Pulse Width Modulation (PWM) controller. It can later be retrieved by using [IOCTL_PWM_CONTROLLER_GET_ACTUAL_PERIOD](https://learn.microsoft.com/windows/desktop/api/pwm/ni-pwm-ioctl_pwm_controller_get_actual_period). |
