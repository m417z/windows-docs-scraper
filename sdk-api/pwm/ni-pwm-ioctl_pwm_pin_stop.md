...
Stops generation of Pulse Width Modulation (PWM) signal on a pin or channel. To check whether a pin is started, use [IOCTL_PWM_PIN_IS_STARTED](https://learn.microsoft.com/windows/desktop/api/pwm/ni-pwm-ioctl_pwm_pin_is_started).
...
| *dwIoControlCode* [in] | The control code for the operation. Use **IOCTL_PWM_PIN_STOP** for this operation. |
