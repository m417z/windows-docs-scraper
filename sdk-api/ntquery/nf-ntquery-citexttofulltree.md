...
A pointer to an output variable that receives a pointer to the [DBCOMMANDTREE](https://learn.microsoft.com/previous-versions/windows/desktop/indexsrv/dbcommandtree) structure for the command tree built by the function.
...
The following diagram shows the *pTree* parameter, created by the example code, of the [DBCOMMANDTREE](https://learn.microsoft.com/previous-versions/windows/desktop/indexsrv/dbcommandtree) structure.

![](https://learn.microsoft.com/windows/win32/api/ntquery/images/dbcmdtr2.png)
