# RpcServerUseProtseqEpA function

## Description

The
**RpcServerUseProtseqEp** function tells the RPC run-time library to use the specified protocol sequence combined with the specified endpoint for receiving remote procedure calls.
...
**RpcServerUseProtseqEp** to register one protocol sequence with the RPC run-time library. With each protocol sequence registration,
...
[Server-Side Binding](https://learn.microsoft.com/windows/desktop/Rpc/server-side-binding) and
