...
The **GetDisplayName** method retrieves the localized name of the current column in the column-enumeration sequence.
...
If the method succeeds, the method returns S_OK and the *pstrOut* parameter contains the localized name of the column.
...
If the column-enumeration sequence is not referencing a valid column, **GetDisplayName** will fail. Use one of the following methods to navigate through the enumeration:
