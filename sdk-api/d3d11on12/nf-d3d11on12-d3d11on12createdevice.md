...
One or more bitwise OR'd flags from [D3D11_CREATE_DEVICE_FLAG](https://learn.microsoft.com/windows/desktop/api/d3d11/ne-d3d11-d3d11_create_device_flag). These are the same flags as those used by [D3D11CreateDeviceAndSwapChain](https://learn.microsoft.com/windows/desktop/api/d3d11/nf-d3d11-d3d11createdeviceandswapchain). Specifies which runtime [layers](https://learn.microsoft.com/windows/desktop/direct3d11/overviews-direct3d-11-devices-layers) to enable. *Flags* must be compatible with device flags, and its *NodeMask* must be a subset of the *NodeMask* provided to the present API.
...
Pointer to the returned [ID3D11Device](https://learn.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11device). May be NULL.

### `ppImmediateContext` [out, optional]

Type: **ID3D11DeviceContext****

A pointer to the returned [ID3D11DeviceContext](https://learn.microsoft.com/windows/desktop/api/d3d11/nn-d3d11-id3d11devicecontext). May be NULL.
...
This method returns one of the [Direct3D 12 Return Codes](https://learn.microsoft.com/windows/desktop/direct3d12/d3d12-graphics-reference-returnvalues) that are documented for [D3D11CreateDevice](https://learn.microsoft.com/windows/desktop/api/d3d11/nf-d3d11-d3d11createdevice).
...
The function signature PFN_D3D11ON12_CREATE_DEVICE is provided as a typedef, so that you can use dynamic linking techniques ([GetProcAddress](https://learn.microsoft.com/windows/desktop/api/libloaderapi/nf-libloaderapi-getprocaddress)) instead of statically linking.
...
See the notes about the [Example code in the Direct3D 12 reference content](https://learn.microsoft.com/windows/win32/direct3d12/notes-on-example-code).

## See also

[11on12 Functions](https://learn.microsoft.com/windows/desktop/direct3d12/direct3d-11-on-12-functions-)