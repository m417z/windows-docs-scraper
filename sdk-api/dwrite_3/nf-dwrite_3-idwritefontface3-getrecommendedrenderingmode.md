...
A pointer to a variable that receives a [DWRITE_RENDERING_MODE1](https://learn.microsoft.com/windows/win32/api/dwrite_3/ne-dwrite_3-dwrite_rendering_mode1)-typed value for the recommended rendering mode.
