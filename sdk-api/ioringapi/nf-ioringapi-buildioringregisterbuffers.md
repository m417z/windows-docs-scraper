...
An array of [IORING_BUFFER_INFO](https://learn.microsoft.com/windows/win32/api/ntioring_x/ns-ntioring_x-ioring_buffer_info) structures representing the buffers to be registered.
