...
At present, the [Provider](https://learn.microsoft.com/windows/desktop/api/provider/nl-provider-provider) class does not support any deletion flags. Therefore, if *lFlags* is set to a value other than zero (0), **Provider::ValidateDeletionFlags** automatically returns **WBEM_E_UNSUPPORTED_PARAMETER**.
