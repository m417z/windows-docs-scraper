...
The
**ICMP_ECHO_REPLY** structure describes the data returned in response to an IPv4 echo request.
...
The IP options in the IP header of the reply, in the form of an [IP_OPTION_INFORMATION](https://learn.microsoft.com/windows/desktop/api/ipexport/ns-ipexport-ip_option_information) structure.

## Remarks

The **ICMP_ECHO_REPLY** structure is used by the [IcmpParseReplies](https://learn.microsoft.com/windows/desktop/api/icmpapi/nf-icmpapi-icmpparsereplies) function to return the response to an IPv4 echo request. On a 64-bit platform, the [ICMP_ECHO_REPLY32](https://learn.microsoft.com/windows/desktop/api/ipexport/ns-ipexport-icmp_echo_reply32) structure should be used.
