...
Bitwise **OR** of flags from the [MFVideoFlags](https://learn.microsoft.com/windows/desktop/api/mfobjects/ne-mfobjects-mfvideoflags) enumeration. Use this parameter for format information that is not contained in the **KS_VIDEOINFOHEADER2** structure.
