...
This method removes any servers that were added using the [IWMReaderNetworkConfig::AddLoggingUrl](https://learn.microsoft.com/windows/desktop/api/wmsdkidl/nf-wmsdkidl-iwmreadernetworkconfig-addloggingurl) method. Note that the originating server always receives a log, even after the list is cleared.
