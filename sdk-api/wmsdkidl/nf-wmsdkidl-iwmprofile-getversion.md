...
Pointer to a **DWORD** containing one member of the [WMT_VERSION](https://learn.microsoft.com/windows/desktop/api/wmsdkidl/ne-wmsdkidl-wmt_version) enumeration type. This value specifies the version of the Windows Media Format SDK that was used to create the profile.
