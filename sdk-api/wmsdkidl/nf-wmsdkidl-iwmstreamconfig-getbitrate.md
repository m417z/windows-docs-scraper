...
Pointer to a **DWORD** containing the bit rate, in bits per second.
...
[IWMStreamConfig::SetBitrate](https://learn.microsoft.com/windows/desktop/api/wmsdkidl/nf-wmsdkidl-iwmstreamconfig-setbitrate)