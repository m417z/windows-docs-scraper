...
Address of a pointer to the [IWMDeviceRegistration](https://learn.microsoft.com/windows/desktop/api/wmsdkidl/nn-wmsdkidl-iwmdeviceregistration) interface of the newly created device registration object.
...
| **E_INVALIDARG** | The ppDevReg parameter is **NULL**. |
