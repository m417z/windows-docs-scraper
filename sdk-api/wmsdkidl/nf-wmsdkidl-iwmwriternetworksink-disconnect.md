...
This method is equivalent to the [IWMWriterNetworkSink::Close](https://learn.microsoft.com/windows/desktop/api/wmsdkidl/nf-wmsdkidl-iwmwriternetworksink-close) method, except that it does not release the port.
