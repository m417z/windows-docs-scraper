...
You can use this method to find out whether the device is open. To open the device call [Open](https://learn.microsoft.com/windows/desktop/api/wmsdkidl/nf-wmsdkidl-iwmregistereddevice-open).
