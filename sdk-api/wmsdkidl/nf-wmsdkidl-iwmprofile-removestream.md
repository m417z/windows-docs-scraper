...
Pointer to the [IWMStreamConfig](https://learn.microsoft.com/windows/desktop/api/wmsdkidl/nn-wmsdkidl-iwmstreamconfig) interface of the stream configuration object that describes the stream you want to remove.
...
| **E_INVALIDARG** | The *pConfig* parameter is **NULL** or not valid. |
...
[IWMProfile::AddStream](https://learn.microsoft.com/windows/desktop/api/wmsdkidl/nf-wmsdkidl-iwmprofile-addstream)
