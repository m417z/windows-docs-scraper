...
Pointer to the [IWMWriterSink](https://learn.microsoft.com/windows/desktop/api/wmsdkidl/nn-wmsdkidl-iwmwritersink) interface of the sink object to remove, or **NULL** to remove all sinks.
