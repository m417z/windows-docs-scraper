...
| **E_INVALIDARG** | The pointer passed is **NULL**. |
...
[IWMBandwidthSharing::SetType](https://learn.microsoft.com/windows/desktop/api/wmsdkidl/nf-wmsdkidl-iwmbandwidthsharing-settype)