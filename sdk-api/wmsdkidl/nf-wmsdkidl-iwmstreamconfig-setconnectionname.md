...
Pointer to a wide-character **null**-terminated string containing the input name. Connection names are limited to 256 wide characters.
...
| **E_INVALIDARG** | The *pwszInputName* parameter is **NULL**. |
