...
**DWORD** containing the IP address.

### `dwPort`

**DWORD** containing the port number.

## See also

[IWMClientConnections::GetClientProperties](https://learn.microsoft.com/windows/desktop/api/wmsdkidl/nf-wmsdkidl-iwmclientconnections-getclientproperties)
