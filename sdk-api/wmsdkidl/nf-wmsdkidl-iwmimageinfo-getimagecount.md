...
| **E_INVALIDARG** | The *pcImages* parameter is **NULL**. |
...
[IWMImageInfo::GetImage](https://learn.microsoft.com/windows/desktop/api/wmsdkidl/nf-wmsdkidl-iwmimageinfo-getimage)