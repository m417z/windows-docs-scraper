...
Setting *fForceRerunDetection* to True applies to all protocols when the auto setting has been specified by the [SetProxySettings](https://learn.microsoft.com/windows/desktop/api/wmsdkidl/nf-wmsdkidl-iwmreadernetworkconfig-setproxysettings) method.
...
[IWMReaderNetworkConfig::GetForceRerunAutoProxyDetection](https://learn.microsoft.com/windows/desktop/api/wmsdkidl/nf-wmsdkidl-iwmreadernetworkconfig-getforcererunautoproxydetection)