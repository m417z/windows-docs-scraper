...
Pointer to a **DWORD** containing the quality setting.
...
For more information, see the Remarks for [SetQuality](https://learn.microsoft.com/windows/desktop/api/wmsdkidl/nf-wmsdkidl-iwmvideomediaprops-setquality).
