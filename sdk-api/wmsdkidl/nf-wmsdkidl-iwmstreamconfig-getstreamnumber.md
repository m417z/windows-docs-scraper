...
Pointer to a **WORD** containing the stream number. Stream numbers must be in the range of 1 through 63.
...
[IWMStreamConfig::SetStreamNumber](https://learn.microsoft.com/windows/desktop/api/wmsdkidl/nf-wmsdkidl-iwmstreamconfig-setstreamnumber)