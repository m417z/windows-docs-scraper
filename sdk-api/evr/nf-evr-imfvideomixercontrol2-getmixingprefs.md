...
Receives a bitwise **OR** of zero or more flags from the [MFVideoMixPrefs](https://learn.microsoft.com/windows/desktop/api/evr/ne-evr-mfvideomixprefs) enumeration.
