...
Receives a bitwise **OR** of zero or more flags from the [MFVideoRenderPrefs](https://learn.microsoft.com/windows/desktop/api/evr/ne-evr-mfvideorenderprefs) enumeration.
