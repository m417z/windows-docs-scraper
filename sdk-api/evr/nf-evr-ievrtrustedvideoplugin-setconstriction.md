...
The EVR might call this method at any time if the [IEVRTrustedVideoPlugin::CanConstrict](https://learn.microsoft.com/windows/desktop/api/evr/nf-evr-ievrtrustedvideoplugin-canconstrict) method returns **TRUE**.
