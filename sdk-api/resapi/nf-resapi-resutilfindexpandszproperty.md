...
Locates an [expandable string](https://learn.microsoft.com/previous-versions/windows/desktop/mscs/e-gly) property in a [property list](https://learn.microsoft.com/previous-versions/windows/desktop/mscs/property-lists). The **PRESUTIL_FIND_EXPAND_SZ_PROPERTY** type defines a pointer to this function.
...
If **ResUtilFindExpandSzProperty** is successful, **pszPropertyValue* points to a copy of the data stored in *pPropertyList*. Be sure to call [LocalFree](https://learn.microsoft.com/windows/desktop/api/winbase/nf-winbase-localfree) on **pszPropertyValue* to prevent memory leaks.
