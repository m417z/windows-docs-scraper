...
Sets an [expandable string](https://learn.microsoft.com/previous-versions/windows/desktop/mscs/e-gly) value in the [cluster database](https://learn.microsoft.com/previous-versions/windows/desktop/mscs/cluster-database). The **PRESUTIL_SET_EXPAND_SZ_VALUE** type defines a pointer to this function.
...
The **ResUtilSetExpandSzValue** utility function allocates memory for the new value and calls the [Cluster API](https://learn.microsoft.com/previous-versions/windows/desktop/mscs/cluster-api) function [ClusterRegSetValue](https://learn.microsoft.com/previous-versions/windows/desktop/api/clusapi/nf-clusapi-clusterregsetvalue).
...
**ResUtilSetExpandSzValue** can be safely called from any other resource DLL entry point function or from a worker thread. For more information, see [Function Calls to Avoid in Resource DLLs](https://learn.microsoft.com/previous-versions/windows/desktop/mscs/function-calls-to-avoid-in-resource-dlls).
