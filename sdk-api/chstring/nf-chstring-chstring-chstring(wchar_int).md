...
Single character that is repeated *nRepeat* times.
...
The following code example shows the use of [CHString::CHString](https://learn.microsoft.com/windows/desktop/api/chstring/nf-chstring-chstring-chstring(constchstring_)):
