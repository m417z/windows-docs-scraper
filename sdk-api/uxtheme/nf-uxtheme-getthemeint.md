...
Value of type **int** that specifies the part that contains the **int** property. See [Parts and States](https://learn.microsoft.com/windows/desktop/Controls/parts-and-states).
...
Pointer to an **int** that receives the retrieved value.
