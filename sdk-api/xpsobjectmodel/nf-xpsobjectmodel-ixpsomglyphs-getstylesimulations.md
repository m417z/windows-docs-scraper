...
### `styleSimulations` [out, retval]

The [XPS_STYLE_SIMULATION](https://learn.microsoft.com/windows/win32/api/xpsobjectmodel/ne-xpsobjectmodel-xps_style_simulation) value that describes the style simulations to be applied.
...
| **E_POINTER** | *styleSimulations* is **NULL**. |
