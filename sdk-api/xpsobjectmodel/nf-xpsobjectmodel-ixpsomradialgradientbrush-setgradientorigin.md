...
| **E_INVALIDARG** | The point described by *origin* was not valid. The [XPS_POINT](https://learn.microsoft.com/windows/win32/api/xpsobjectmodel/ns-xpsobjectmodel-xps_point) structure must contain valid and finite floating-point values. |
