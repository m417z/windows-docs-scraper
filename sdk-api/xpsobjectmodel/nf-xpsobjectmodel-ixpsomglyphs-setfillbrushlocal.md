...
Sets the [IXpsOMBrush](https://learn.microsoft.com/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsombrush) interface pointer to a local, unshared fill brush.

## Parameters

### `fillBrush` [in]

The [IXpsOMBrush](https://learn.microsoft.com/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsombrush) interface pointer to be set as the local, unshared fill brush. A **NULL** pointer releases any previously assigned brushes.
...
| **XPS_E_NO_CUSTOM_OBJECTS** | *fillBrush* does not point to a recognized interface implementation. Custom implementation of XPS Document API interfaces is not supported. |

## Remarks

After you call **SetFillBrushLocal**, the fill brush lookup key is released and [GetFillBrushLookup](https://learn.microsoft.com/windows/desktop/api/xpsobjectmodel/nf-xpsobjectmodel-ixpsomglyphs-getfillbrushlookup) returns a **NULL** pointer in the *key* parameter. The table that follows explains the relationship between the local and lookup values of this property.
...
| [SetFillBrushLookup](https://learn.microsoft.com/windows/desktop/api/xpsobjectmodel/nf-xpsobjectmodel-ixpsomglyphs-setfillbrushlookup) | The shared brush that gets retrieved, with a lookup key matching the key that is set by [SetFillBrushLookup](https://learn.microsoft.com/windows/desktop/api/xpsobjectmodel/nf-xpsobjectmodel-ixpsomglyphs-setfillbrushlookup), from the resource directory. | **NULL** pointer. | The lookup key that is set by [SetFillBrushLookup](https://learn.microsoft.com/windows/desktop/api/xpsobjectmodel/nf-xpsobjectmodel-ixpsomglyphs-setfillbrushlookup). |
| Neither **SetFillBrushLocal** nor [SetFillBrushLookup](https://learn.microsoft.com/windows/desktop/api/xpsobjectmodel/nf-xpsobjectmodel-ixpsomglyphs-setfillbrushlookup) has been called yet. | **NULL** pointer. | **NULL** pointer. | **NULL** pointer. |
