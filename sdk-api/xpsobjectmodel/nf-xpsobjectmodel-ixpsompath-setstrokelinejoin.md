...
The [XPS_LINE_JOIN](https://learn.microsoft.com/windows/win32/api/xpsobjectmodel/ne-xpsobjectmodel-xps_line_join) value to be set.
...
| **E_INVALIDARG** | *strokeLineJoin* is not a valid [XPS_LINE_JOIN](https://learn.microsoft.com/windows/win32/api/xpsobjectmodel/ne-xpsobjectmodel-xps_line_join) value. |
