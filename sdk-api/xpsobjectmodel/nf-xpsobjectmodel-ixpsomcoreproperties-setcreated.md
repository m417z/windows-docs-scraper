...
The date and time the package was created. A **NULL** pointer clears the **created** property
...
| **E_POINTER** | *created* is **NULL**. |

## Remarks

The **created** property contains the date and time the package was created.
