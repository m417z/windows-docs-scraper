...
Gets the [XPS_FILL_RULE](https://learn.microsoft.com/windows/win32/api/xpsobjectmodel/ne-xpsobjectmodel-xps_fill_rule) value that describes the fill rule to be used.
...
The value that is returned in *fillRule* corresponds to the **FillRule** attribute of the **PathGeometry** element in the document markup.
