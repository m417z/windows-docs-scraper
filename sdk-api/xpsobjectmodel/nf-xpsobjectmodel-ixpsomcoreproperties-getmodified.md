...
The date and time that are read from the **modified** property.
...
| **E_POINTER** | *modified* is **NULL**. |

## Remarks

The **modified** property contains the date and time the package was last modified.
