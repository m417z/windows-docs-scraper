...
Gets a pointer to the resolved [IXpsOMBrush](https://learn.microsoft.com/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsombrush) interface that contains the fill brush for the path.

## Parameters

### `brush` [out, retval]

A pointer to the resolved [IXpsOMBrush](https://learn.microsoft.com/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsombrush) interface that contains the fill brush for the path. If a fill brush has not been set, a **NULL** pointer is returned.
