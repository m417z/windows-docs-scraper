...
possible values are listed in [Registry Value Types](https://learn.microsoft.com/windows/desktop/SysInfo/registry-value-types).
This parameter can be **NULL** and the type of data is not returned.

### `Buffer` [out, optional]

A pointer to a variable that receives the data value. If this parameter is **NULL**,
the *BufferSize*
