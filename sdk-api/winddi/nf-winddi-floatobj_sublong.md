...
The **FLOATOBJ_SubLong** function subtracts the value of type LONG from the [FLOATOBJ](https://learn.microsoft.com/windows/desktop/api/winddi/ns-winddi-floatobj), and returns with the result in the first parameter.
