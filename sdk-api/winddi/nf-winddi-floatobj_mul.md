...
The **FLOATOBJ_Mul** function multiplies the two [FLOATOBJ](https://learn.microsoft.com/windows/desktop/api/winddi/ns-winddi-floatobj)s, and returns with the result in the first parameter.
