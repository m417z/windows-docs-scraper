...
the [PdhEnumMachines](https://learn.microsoft.com/windows/desktop/api/pdh/nf-pdh-pdhenummachinesa) function, except that it supports the use of handles to data sources.
