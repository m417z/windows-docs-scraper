...
The
**PDH_BROWSE_DLG_CONFIG_H** structure is used by the
[PdhBrowseCountersH](https://learn.microsoft.com/windows/desktop/api/pdh/nf-pdh-pdhbrowsecountersha) function to configure the **Browse Performance Counters** dialog box.
