...
The
**DeleteIpNetEntry2** function deletes a neighbor IP address entry on the local computer.
...
A pointer to a
[MIB_IPNET_ROW2](https://learn.microsoft.com/windows/desktop/api/netioapi/ns-netioapi-mib_ipnet_row2) structure entry for a neighbor IP address entry. On successful return, this entry will be deleted.
...
The **DeleteIpNetEntry2** function is used to delete a [MIB_IPNET_ROW2](https://learn.microsoft.com/windows/desktop/api/netioapi/ns-netioapi-mib_ipnet_row2) structure entry.
