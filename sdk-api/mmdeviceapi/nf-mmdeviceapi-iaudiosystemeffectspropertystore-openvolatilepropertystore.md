...
Receives a pointer to an [IPropertyStore](https://learn.microsoft.com/windows/win32/api/propsys/nn-propsys-ipropertystore) representing the volatile property store.
