...
[FWPM_PROVIDER_CONTEXT2](https://learn.microsoft.com/windows/win32/api/fwpmtypes/ns-fwpmtypes-fwpm_provider_context2) is available. For Windows Vista, [FWPM_PROVIDER_CONTEXT0](https://learn.microsoft.com/windows/win32/api/fwpmtypes/ns-fwpmtypes-fwpm_provider_context0) is available.

## Members

### `providerContextKey`

Uniquely identifies the provider context. If the GUID is zero-initialized in the call to [FwpmProviderContextAdd1](https://learn.microsoft.com/windows/win32/api/fwpmu/nf-fwpmu-fwpmprovidercontextadd1), Base Filtering Engine (BFE) will generate one.
...
See [IPSEC_TRANSPORT_POLICY1](https://learn.microsoft.com/windows/win32/api/ipsectypes/ns-ipsectypes-ipsec_transport_policy1) for more information.

### `ikeQmTunnelPolicy`

Available when **type** is **FWPM_IPSEC_IKE_QM_TUNNEL_CONTEXT**.

See [IPSEC_TUNNEL_POLICY1](https://learn.microsoft.com/windows/win32/api/ipsectypes/ns-ipsectypes-ipsec_tunnel_policy1) for more information.
...
See [IKEEXT_POLICY1](https://learn.microsoft.com/windows/win32/api/iketypes/ns-iketypes-ikeext_policy1) for more information.
...
See [IPSEC_DOSP_OPTIONS0](https://learn.microsoft.com/windows/win32/api/ipsectypes/ns-ipsectypes-ipsec_dosp_options0) for more information.
...
[FwpmProviderContextAdd1](https://learn.microsoft.com/windows/win32/api/fwpmu/nf-fwpmu-fwpmprovidercontextadd1)
