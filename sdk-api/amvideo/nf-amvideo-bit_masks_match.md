...
The `BIT_MASKS_MATCH` macro compares the color masks for two [VIDEOINFO](https://learn.microsoft.com/previous-versions/windows/desktop/api/amvideo/ns-amvideo-videoinfo) structures.
