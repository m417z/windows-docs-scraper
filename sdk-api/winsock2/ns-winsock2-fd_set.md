...
Be careful not to confuse the **FD_SET** typedef of the **fd_set** structure with the [FD_SET](https://learn.microsoft.com/windows/win32/api/winsock2/nf-winsock2-fd_set) macro. That said, the **FD_SET** macro and the **fd_set** structure are related, and often used in conjunction.
