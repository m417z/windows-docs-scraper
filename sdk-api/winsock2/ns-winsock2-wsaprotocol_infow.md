...
The
**WSAPROTOCOL_INFOW** structure is used to store or retrieve complete information for a given protocol. The protocol name is represented as an array of Unicode characters.
...
A unique identifier assigned by the WS2_32.DLL for each [WSAPROTOCOL_INFO](https://learn.microsoft.com/windows/desktop/api/winsock2/ns-winsock2-wsaprotocol_infoa) structure.
...
The maximum value that may be added to **iProtocol** member when supplying a value for the *protocol* parameter to
[socket](https://learn.microsoft.com/windows/desktop/api/winsock2/nf-winsock2-socket) and
[WSASocket](https://learn.microsoft.com/windows/desktop/api/winsock2/nf-winsock2-wsasocketa). Not all protocols allow a range of values. When this is the case **iProtocolMaxOffset** is zero.
